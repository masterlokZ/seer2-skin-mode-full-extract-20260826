   ...
   public class SweepEffect
   {
      ...
      public function add(param1:InteractiveObject, param2:DisplayObject) : void
      {
         if(!this._hashMap.containsKey(param1))
         {
            ...
            param1.addEventListener("rollOver",this.onMouseOver);
            param1.addEventListener("rollOut",this.onMouseOut);
         }
      }
      ...
      public function remove(param1:InteractiveObject) : void
      {
         if(this._hashMap.containsKey(param1))
         {
            param1.removeEventListener("rollOver",this.onMouseOver);
            param1.removeEventListener("rollOut",this.onMouseOut);
