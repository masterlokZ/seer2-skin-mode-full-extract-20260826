package com.taomee.seer2.core.map
{
   ...
   public class MapModel extends EventDispatcher implements IMapModel
   {
      ...
      public function complete() : void
      {
         ...
         dispatchEvent(new SceneEvent("mapComplete"));
      }
      ...
      {
         var _loc4_:int = param1 / this.gridSize;
         var _loc3_:int = param2 / this.gridSize;
         if(_loc4_ < 0 || _loc4_ >= this._assetExtractor.gridX)
         {
            return false;
         }
         if(_loc3_ < 0 || _loc3_ >= this._assetExtractor.gridY)
         {
            return false;
         }
         return this.data[_loc4_][_loc3_];
      }
