   ...
   internal class QueueLoaderImpl
   {
      ...
      public function load(param1:String, param2:String, param3:Function, param4:Function = null, param5:* = null, param6:int = 2, param7:Function = null, param8:Function = null, param9:Boolean = false) : void
      {
         ...
         else
         {
            ...
            this._waitList.sortOn("priority",16);
         }
         if(param6 == 0)
         {
            if(this._loader.info.priority != 0)
            {
               this.nextLoad(true);
               return;
            }
      ...
      public function cancel(param1:String, param2:Function) : void
      {
         ...
         var _loc5_:QueueInfo = this._loader.info;
         if(_loc5_)
         {
      ...
      public function cancelData(param1:String, param2:*, param3:String = null) : void
      {
         ...
         _loc4_ = this._loader.info;
         if((Boolean(_loc4_)) && _loc4_.data)
         {
            if(param3 == null)
            {
      ...
      private function removeHandler(param1:Function) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            if(_loc3_)
            {
               if(_loc3_.completeHandler == param1)
               {
                  this._waitList.splice(_loc4_,1);
                  _loc4_--;
                  _loc3_.dispose();
      ...
      {
         var _loc4_:QueueInfo = null;
         var _loc6_:int = int(this._waitList.length);
         var _loc5_:int = 0;
         while(_loc5_ < _loc6_)
         {
            _loc4_ = this._waitList[_loc5_];
            if((Boolean(_loc4_)) && _loc4_.data)
            {
               if(param3 == null)
               {
      ...
      private function onTimeout() : void
      {
         ...
         {
            if(this._loader.info.timeCount >= 2)
            {
