package com.taomee.seer2.core.module
{
   ...
   public class Module extends Sprite
   {
      ...
      public function align() : void
      {
         ...
         var _loc2_:int = 0;
         var _loc1_:int = 0;
         this._rootRect = new Rectangle(0,0,1200,660);
         if(!this._isAlignContent)
         {
            DisplayUtil.align(this,4,this._rootRect,this._offset);
         }
         if(this.width >= 1200)
         {
            _loc2_ = int(LayerManager.stage.stageWidth <= 960 ? 960 : LayerManager.stage.stageWidth);
            _loc1_ = int(LayerManager.stage.stageHeight <= 560 ? 560 : LayerManager.stage.stageHeight);
         }
         else
         {
            _loc2_ = LayerManager.stage.stageWidth < this.width ? int(this.width) : LayerManager.stage.stageWidth;
            _loc1_ = LayerManager.stage.stageHeight < this.height ? int(this.height) : LayerManager.stage.stageHeight;
         }
         this.x += (_loc2_ - 1200) / 2;
         this.y += (_loc1_ - 660) / 2;
         this._isAlign = true;
      }
      ...
      protected function setBackGround() : void
      {
         ...
         if(this._hideMap && !ModuleManager.hasHideMap)
         {
            ...
            this.backData = new BitmapData(1200,660,false,4278190080);
      ...
      private function createShadow() : void
      {
         if(!this._shadow)
         {
            ...
            this._shadow.graphics.drawRect(0,0,1200,660);
      ...
      private function initEventListener() : void
      {
         ...
         if(this._dragSprite != null)
         {
            ...
            this._dragSprite.addEventListener("mouseDown",this.onDragStart);
            this._dragSprite.addEventListener("mouseUp",this.onDragEnd);
         }
      }
