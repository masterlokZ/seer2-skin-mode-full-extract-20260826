package com.taomee.seer2.core.module
{
   ...
   public class ModuleManager
   {
      ...
      public static function getModuleStatus(param1:String, param2:String = "") : String
      {
         ...
         if(_loc3_)
         {
            return _loc3_.hasParent ? "show" : "hide";
         }
         return "close";
      }
      ...
      {
         var _loc5_:ModuleProxy = null;
         _loc5_ = _moduleMap.getValue(URLUtil.getFileName(param1) + param4);
         if(_loc5_ != null)
         {
            _loc5_.init(param3);
            _loc5_.show();
      ...
      private static function createModule(param1:String, param2:String, param3:Object = null, param4:String = "") : void
      {
         ...
         var _loc5_:ModuleProxy = null;
         _loc6_ = param1.replace("module/app/","");
         _loc6_ = _loc6_.slice(0,_loc6_.indexOf("."));
         if(ModulesToRemoveXMLInfo.checkIsModuleToRemove(_loc6_))
         {
            return;
         }
         _loc5_ = new ModuleProxy(param1,param2,param4);
         _loc5_.init(param3);
         _loc5_.show();
         ...
         _moduleMap.add(_loc7_ + param4,_loc5_);
      }
      ...
      public static function closeAll() : void
      {
         ...
         {
            if(param1.lifecycleType == "nonce" || param1.lifecycleType == "map")
            {
               param1.dispose();
            }
            else
      ...
      {
         _eventDispatcher.addEventListener(param1 + "_" + param2,param3,param4,param5,param6);
      }
      ...
      {
         if(_eventDispatcher.hasEventListener(param1 + "_" + param2))
         {
            _eventDispatcher.dispatchEvent(new ModuleEvent(param1,param2,param3));
         }
      }
