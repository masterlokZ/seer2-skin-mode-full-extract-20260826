package com.taomee.seer2.core.ui
{
   ...
   public class ImagePanel
   {
      ...
      private static function initClearMode() : void
      {
         ...
         _fightMcOnBtn.addEventListener("click",onClearClick);
         _fightMcOffBtn.addEventListener("click",onClearClick);
      }
      
      private static function onClearClick(param1:MouseEvent) : void
      {
         var clearMode:int = param1.target == _fightMcOnBtn ? 0 : 1;
         var _loc3_:SharedObject = SharedObjectManager.getUserSharedObject("userSetting");
         _loc3_.data["clear"] = clearMode;
      ...
      private static function initAutobs() : void
      {
         ...
         _autobsOnBtn.addEventListener("click",onAutobsClick);
         _autobsOffBtn.addEventListener("click",onAutobsClick);
      }
      ...
      private static function initHitDmg() : void
      {
         ...
         _hitDmgOnBtn.addEventListener("click",onHitDmgClick);
         _hitDmgOffBtn.addEventListener("click",onHitDmgClick);
      }
