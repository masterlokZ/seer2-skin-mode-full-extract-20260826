package com.taomee.seer2.app.component
{
   ...
   public class TextScroller extends Scroller
   {
      ...
      {
         this._textField.addEventListener("scroll",this.onTextScroll);
      }
      ...
      {
         addEventListener("start",this.onScrollStart);
         addEventListener("move",this.onScrollerMove);
         addEventListener("end",this.onScrollEnd);
      }
      ...
      {
         this._textField.removeEventListener("scroll",this.onTextScroll);
         super.dispose();
      }
   }
}
