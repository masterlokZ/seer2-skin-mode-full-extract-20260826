package com.taomee.seer2.app.component
{
   ...
   public class ProgressiveAnimationPlayer extends Sprite
   {
      ...
      {
         this._loader.contentLoaderInfo.addEventListener("complete",this.onLoadComplete);
      ...
      private function onLoadComplete(param1:Event) : void
      {
         ...
         this._mc.addEventListener("enterFrame",this.onAnimationPlay);
         this._mc.addEventListener("close",this.onAnimationClose);
      ...
      private function onAnimationPlay(param1:Event) : void
      {
         ...
         {
            this._mc.stop();
            this._mc.removeEventListener("enterFrame",this.onAnimationPlay);
