package com.taomee.seer2.app.component
{
   ...
   public class Combobox extends Sprite
   {
      ...
      {
         this._dropBtn.addEventListener("click",this.onDropBtn);
      }
      ...
      public function addScrollerListener(param1:Function) : void
      {
         ...
         this._listScroller.addEventListener("end",this.updateItmeInfo);
         this._listScroller.addEventListener("move",this.updateItmeInfo);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this._dropBtn)
         {
            this._dropBtn.removeEventListener("click",this.onDropBtn);
            this._dropBtn = null;
         }
      }
   }
