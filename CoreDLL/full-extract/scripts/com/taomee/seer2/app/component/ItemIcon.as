   ...
   public class ItemIcon extends Sprite
   {
      ...
      public function update(param1:String, param2:int) : void
      {
         ...
         if(param1 != "")
         {
            ...
            if(this._num >= 1)
            {
               _loc4_ = UINumberGenerator.generateItemNumber(this._num);
               this._numContainer.addChild(_loc4_);
               addChild(this._numContainer);
               _loc3_ = this._numContainer.getBounds(this._numContainer);
               this._numContainer.x = this._maxWidth - _loc3_.width + 2;
               this._numContainer.y = this._maxHeight - _loc3_.height + 3;
            }
         }
      }
