package com.taomee.seer2.app.gameRule.door.util
{
   ...
   public class Door21LevelUtil
   {
      ...
      {
         var _loc7_:Array = Door21LevelConstant.GUARD_NPCS[param3 - 1];
         var _loc5_:Vector.<PetInfo> = new Vector.<PetInfo>();
         var _loc4_:uint = _loc7_.length;
         var _loc6_:uint = 0;
         while(_loc6_ < _loc4_)
         {
            if(_loc7_[_loc6_].level == param1)
            {
               _loc5_.push(parseToPetInfo(_loc7_[_loc6_],param2));
            }
            _loc6_++;
         }
         return _loc5_;
      ...
      {
         var _loc4_:Array = GUARD_MC_LABELS;
         var _loc3_:uint = getGuardIndex(param1);
