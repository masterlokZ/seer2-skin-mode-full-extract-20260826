package com.taomee.seer2.app.gameRule.door.alone
{
   ...
   public class AloneDoorUIController
   {
      ...
      private function initUI() : void
      {
         ...
         this._content.gotoAndStop(5);
         this._roundMC.gotoAndStop(5);
      }
      ...
      public function updateLevel(param1:uint, param2:Function = null) : void
      {
         ...
         {
            _content.removeEventListener("enterFrame",onEnterFrame);
            _npcStage = _content["npcStage"];
            _npcStage.addEventListener("enterFrame",onNPCStageEnterFrame);
         ...
         onNPCStageEnterFrame = function(param1:Event):void
         {
            ...
            {
               _npcStage.removeEventListener("enterFrame",onNPCStageEnterFrame);
               if(onComplete != null)
               {
                  onComplete();
               }
         ...
         this.npcDispose();
         this._content.addEventListener("enterFrame",onEnterFrame);
