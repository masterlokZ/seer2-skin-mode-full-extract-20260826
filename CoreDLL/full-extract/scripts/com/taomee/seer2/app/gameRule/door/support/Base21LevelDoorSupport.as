package com.taomee.seer2.app.gameRule.door.support
{
   ...
   public class Base21LevelDoorSupport implements IUpDoorSupport
   {
      ...
      protected function setTrialLevel(param1:uint) : void
      {
         ...
         this._guard_mc.addEventListener("appear_end",this.onGuardAppear);
         this.updateGuardStatus(0);
      ...
      public function dispose() : void
      {
         ...
         this._guard_mc.removeEventListener("click",this.onGuardClick);
         this._guard = null;
      }
      ...
      {
         this._guard_mc.removeEventListener("appear_end",this.onGuardAppear);
         this._guard.buttonMode = true;
         this._guard.useHandCursor = true;
         if(this._supportInfo.doorRule == 3)
         {
            this._guard_mc.buttonMode = true;
            this._guard_mc.useHandCursor = true;
            this._guard_mc.addEventListener("click",this.onGuardClick);
         }
         else
         {
