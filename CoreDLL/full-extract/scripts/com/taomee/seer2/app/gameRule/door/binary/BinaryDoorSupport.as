package com.taomee.seer2.app.gameRule.door.binary
{
   ...
   public class BinaryDoorSupport implements IUpDoorSupport, IMultiSelectable, IDoorServerPetable
   {
      ...
      {
         super();
         this._supportInfo = new DoorSupportInfo(5,0,420,"BinaryDoorStartPanel");
      }
      ...
      private function playAnimation(param1:Function) : void
      {
         ...
         onAnimationEnd = function(param1:Event):void
         {
            ...
            _animationPlayer.removeEventListener("end",onAnimationEnd);
         ...
         if(animationName != "")
         {
            ...
            this._animationPlayer.addEventListener("end",onAnimationEnd);
      ...
      private function initUI() : void
      {
         ...
         this._guard.addEventListener("click",this.onGuardClick);
      ...
      private function updateGuardStatus(param1:Function) : void
      {
         ...
         {
            _guard.removeEventListener("enterFrame",onEnterFrame);
         ...
         this._guard.addEventListener("enterFrame",onEnterFrame);
      ...
      public function dispose() : void
      {
         ...
         this._guard.removeEventListener("click",this.onGuardClick);
         this._guard = null;
      }
      ...
      private function reward_type1() : void
      {
         if(this._rewardId != 0)
         {
            this._rewardIDList = Vector.<ServerReward>([new ServerReward(200213,2),new ServerReward(200214,2),new ServerReward(200002,2)]);
      ...
      private function reward_type2() : void
      {
         if(this._rewardId != 0)
         {
            this._rewardIDList = Vector.<ServerReward>([new ServerReward(200214,2),new ServerReward(200221,2),new ServerReward(200003,2)]);
            AlertManager.showDoorReward(true,this._supportInfo.doorType,this._supportInfo.doorRule,this._rewardId,this._rewardIDList,this.rewardComplete);
         }
         else
         {
      ...
      private function clearServerGive() : void
      {
         ...
         {
            _supportInfo.targetMapId = 421;
            SceneManager.changeScene(1,421,440,480);
         };
         this._petId = 0;
         this._resourceId = 0;
         ...
         {
            this._supportInfo.targetMapId = 420;
         }
      }
