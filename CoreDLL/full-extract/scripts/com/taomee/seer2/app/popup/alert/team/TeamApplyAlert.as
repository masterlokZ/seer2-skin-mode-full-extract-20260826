package com.taomee.seer2.app.popup.alert.team
{
   ...
   public class TeamApplyAlert extends Sprite implements IAlert
   {
      ...
      {
         this._infoBtn.addEventListener("click",this.onInfo);
         this._confirmBtn.addEventListener("click",this.onConfirmClick);
         this._cancelBtn.addEventListener("click",this.onCancelClick);
         this._mainUI.addEventListener("mouseDown",function():void
         {
            _mainUI.startDrag();
         });
         this._mainUI.addEventListener("mouseUp",function():void
         {
            _mainUI.stopDrag();
         });
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this._rejectUI.removeEventListener("click",this.onClick);
            DisplayUtil.removeForParent(this._rejectUI);
            this._rejectUI = null;
         }
         this._infoBtn.removeEventListener("click",this.onInfo);
      ...
      private function onCancelClick(param1:MouseEvent) : void
      {
         if(this._rejectUI == null)
         {
            ...
            this._rejectUI.addEventListener("click",this.onClick);
         }
