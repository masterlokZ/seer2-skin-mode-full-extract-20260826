   ...
   public class SelectPetAlert extends Sprite implements IAlert
   {
      ...
      private function setup() : void
      {
         ...
         while(_loc1_ < 6)
         {
            ...
            (this._ui["cell_" + _loc1_] as MovieClip).addEventListener("click",this.onMouseCell);
            (this._ui["cell_" + _loc1_]["light"] as MovieClip).gotoAndStop(1);
            (this._ui["cell_" + _loc1_] as MovieClip).addEventListener("mouseOver",this.onMouseOver);
            (this._ui["cell_" + _loc1_] as MovieClip).addEventListener("mouseOut",this.onMouseOut);
         ...
         this._confirmBtn.addEventListener("click",this.okBtn);
      ...
      private function createPets() : void
      {
         ...
         var _loc1_:uint = 0;
         while(_loc1_ < this._petInfoVec.length)
         {
            (this._ui["cell_" + _loc1_] as MovieClip).visible = true;
            (this._ui["cell_" + _loc1_]["selector"] as MovieClip).visible = false;
            _loc2_ = new IconDisplayer();
            _loc2_.scaleY = _loc2_.scaleX = 1.5;
            _loc2_.x = _loc2_.y = -40;
            _loc2_.setIconUrl(URLUtil.getPetIcon(this._petInfoVec[_loc1_].resourceId));
            (this._ui["cell_" + _loc1_] as MovieClip).addChildAt(_loc2_,1);
            (this._ui["cell_" + _loc1_]["levelTxt"] as TextField).text = this._petInfoVec[_loc1_].level.toString();
            (this._ui["cell_" + _loc1_]["studyTxt"] as TextField).text = "" + this._petInfoVec[_loc1_].learningInfo.pointTotal();
            _loc3_ = new PetPotentialityIcon();
            _loc3_.x = 15;
            _loc3_.y = 3;
            (this._ui["cell_" + _loc1_] as MovieClip).addChild(_loc3_);
            _loc3_.visible = true;
            _loc3_.setPotential(this._petInfoVec[_loc1_].potential,this._petInfoVec[_loc1_].isAggraisal);
            _loc1_++;
         }
      ...
      private function onMouseOver(param1:MouseEvent) : void
      {
         ...
         this._curtLight.addEventListener("enterFrame",this.onLightMcEnter);
      ...
      private function onLightMcEnter(param1:Event) : void
      {
         if(this._curtLight)
         {
            ...
            {
               this._curtLight.removeEventListener("enterFrame",this.onLightMcEnter);
      ...
      public function dispose() : void
      {
         ...
         while(_loc1_ < 6)
         {
            (this._ui["cell_" + _loc1_] as MovieClip).removeEventListener("click",this.onMouseCell);
            (this._ui["cell_" + _loc1_] as MovieClip).removeEventListener("mouseOver",this.onMouseOver);
            (this._ui["cell_" + _loc1_] as MovieClip).removeEventListener("mouseOut",this.onMouseOut);
            _loc1_++;
         }
         this._confirmBtn.removeEventListener("click",this.okBtn);
