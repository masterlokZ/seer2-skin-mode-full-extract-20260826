package com.taomee.seer2.app.popup.alert
{
   ...
   public class PiggyBankAlert extends Sprite implements IAlert
   {
      ...
      public function dispose() : void
      {
         ...
         this._cancelBtn.removeEventListener("click",this.onCancel);
         this._putMoneyBtn.removeEventListener("click",this.onPutMoney);
      ...
      private function initialize() : void
      {
         ...
         this._cancelBtn.addEventListener("click",this.onCancel);
         this._putMoneyBtn.addEventListener("click",this.onPutMoney);
      }
      ...
      private function updateContent() : void
      {
         ...
         {
            case 0:
               this._contentTxt.htmlText = "        部落的人说，有一种谜一样的小精灵。清脆的铃声能把它引出来哦。要扔" + _loc1_ + "试试吗？";
               break;
            case 1:
               this._contentTxt.htmlText = "        要满足小精灵的要求吗？再扔" + _loc1_ + "把它引出来？";
               break;
            case 2:
               this._contentTxt.htmlText = "        再扔" + _loc1_ + "把它引下来吧？部落的人说这种小精灵会带来财运哦！";
         }
      }
      ...
      private function onPutMoney(param1:MouseEvent) : void
      {
         ...
         SwapManager.swapItem(40,1,this.onReduceMoney);
      }
