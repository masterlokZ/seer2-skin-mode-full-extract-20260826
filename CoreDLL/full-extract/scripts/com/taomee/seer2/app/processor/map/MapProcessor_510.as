package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_510 extends MapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         StatisticsManager.sendNovice("0x1003342E");
      }
      
      private function isShowActivityPanel() : Boolean
      {
         if(QuestManager.getQuest(21).status == 1)
         {
            return false;
         }
      ...
      private function showActivityPanel() : void
      {
         ...
         this._yesBtn.addEventListener("click",this.onYes);
         this._noBtn.addEventListener("click",this.onNo);
      }
      
      private function onYes(param1:MouseEvent) : void
      {
         this._yesBtn.removeEventListener("click",this.onYes);
         this._noBtn.removeEventListener("click",this.onNo);
         this._activityDialogPanel.visible = false;
      ...
      private function showVoidPanel() : void
      {
         ...
         this._yesVoidBtn.addEventListener("click",this.onVoidYes);
      }
      
      private function onVoidYes(param1:MouseEvent) : void
      {
         this._yesVoidBtn.removeEventListener("click",this.onVoidYes);
         this._activityVoidPanel.visible = false;
      }
      ...
      private function initBucket() : void
      {
         ...
         this._bucket.addEventListener("click",this.onBucketClick);
      }
      
      private function onBucketClick(param1:MouseEvent) : void
      {
         this._bucket.removeEventListener("click",this.onBucketClick);
      ...
      private function initSpade() : void
      {
         ...
         this._spade.addEventListener("click",this.onSpadeClick);
      }
      
      private function onSpadeClick(param1:MouseEvent) : void
      {
         this._spade.removeEventListener("click",this.onSpadeClick);
