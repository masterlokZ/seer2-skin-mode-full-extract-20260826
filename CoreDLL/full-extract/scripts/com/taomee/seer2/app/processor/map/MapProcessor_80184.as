package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80184 extends MapProcessor
   {
      ...
      {
         (_map.front["openVipBtn"] as SimpleButton).addEventListener("click",this.onOpenVip);
      }
      ...
      {
         this.addOpenVip();
         if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord.initData.positionIndex == 945)
         {
            ActiveCountManager.requestActiveCountList([204082,204086],function(param1:Parser_1142):void
            {
      ...
      private function onNpcClick(param1:MouseEvent) : void
      {
         ...
         {
            FightManager.startFightWithWild(945);
         }]);
      }
