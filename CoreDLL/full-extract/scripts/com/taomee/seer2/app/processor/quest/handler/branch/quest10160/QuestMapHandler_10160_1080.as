   ...
   public class QuestMapHandler_10160_1080 extends QuestMapHandler
   {
      ...
      override public function processMapDispose() : void
      {
         ...
         if(this.sMb)
         {
            ...
            this.sMb.removeEventListener("click",this.sDia);
         }
         if(this.kelakeMb)
         {
            this.kelakeMb.removeEventListener("click",this.showKelakeDia);
         }
         if(this.badiMb)
         {
            this.badiMb.removeEventListener("click",this.fightBadi);
            this.badiMb.removeOverHeadMark();
         }
         if(this.duoluoMb)
         {
            this.duoluoMb.removeEventListener("click",this.fightDuoluo);
      ...
      private function initStep3() : void
      {
         ...
         this.badiMb.addEventListener("click",this.fightBadi);
      }
      ...
      private function createNpc() : void
      {
         ...
         MobileManager.addMobile(this.kelakeMb,"npc");
         ...
         MobileManager.addMobile(this.badiMb,"npc");
         ...
         MobileManager.addMobile(this.duoluoMb,"npc");
      }
         ...
         NpcDialog.show(11,"多罗",[[0,"战斗还没有结束…为了做你们的领袖…我将不惜一切代价！"]],["痴人说梦！ "],[function():void
         {
            NpcDialog.show(11,"多罗",[[0,"你们这群愚蠢而可怜的家伙…让你们活在世上还不如送你们下地狱…"]],["接招吧！！ "],[function():void
            {
               MovieClipUtil.playFullScreen(URLUtil.getQuestFullScreenAnimation("10160_5"),function():void
               {
                  ...
                  MobileManager.addMobile(sMb,"npc");
                  sMb.x = 410;
                  sMb.y = 345;
                  sMb.height = 100;
                  ...
                  sMb.addEventListener("click",sDia);
               });
            }]);
         }]);
      }
      ...
      private function initStep4() : void
      {
         ...
         this.duoluoMb.addEventListener("click",this.fightDuoluo);
      }
      ...
      private function initStep2() : void
      {
         ...
         this.kelakeMb.addEventListener("click",this.showKelakeDia);
      }
