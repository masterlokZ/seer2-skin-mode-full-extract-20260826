package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_125 extends TitleMapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         super.init();
         DialogPanel.addEventListener("customUnitClick",this.onUnitClick);
      }
      ...
      private function onUnitClick(param1:DialogPanelEvent) : void
      {
         ...
         {
            SceneManager.changeScene(1,1421);
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         DialogPanel.removeEventListener("customUnitClick",this.onUnitClick);
         super.dispose();
      }
   }
}
