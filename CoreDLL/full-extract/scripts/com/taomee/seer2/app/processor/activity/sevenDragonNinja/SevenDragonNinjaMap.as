package com.taomee.seer2.app.processor.activity.sevenDragonNinja
{
   ...
   public class SevenDragonNinjaMap
   {
      ...
      {
         ServerBufferManager.getServerBuffer(131,function(param1:ServerBuffer):void
         {
      ...
      private function addBuy() : void
      {
         ...
         this._buy.addEventListener("click",this.onClickBuy);
      }
      ...
      private function addNpc() : void
      {
         ...
         this._npc.resourceUrl = URLUtil.getNpcSwf(633);
      ...
      private function onNpc(param1:MouseEvent) : void
      {
         ...
         NpcDialog.show(633,"初影尼加",[[0,"忍者无敌，视影为忍者先知，成正果，影必行，接招吧"]],["接受挑战","准备一下","购买捕捉胶囊"],[function():void
         {
            FightManager.startFightWithWild(617);
            if(_bufferCount < 1)
            {
               ServerBufferManager.updateServerBuffer(131,0,1);
            }
         },null,function():void
         {
      ...
      public function dispose() : void
      {
         if(this._buy)
         {
            this._buy.removeEventListener("click",this.onClickBuy);
