package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80441 extends MapProcessor
   {
      ...
      {
         if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord.initData.positionIndex == 1560)
         {
      ...
      private function initSet() : void
      {
         ...
         else
         {
            ...
            (this._vipTip["openVip"] as SimpleButton).addEventListener("click",this.onOpenVip);
         }
         this.updateItem();
      ...
      private function onNpcClick(param1:MouseEvent) : void
      {
         ...
         if(this._canFightNum > 0)
         {
            if(this.isCanFight())
            {
               ...
               {
                  FightManager.startFightWithWild(1668);
               }
               else
               {
                  FightManager.startFightWithWild(1560);
               }
            }
         }
         else
      ...
      private function onActDispose() : void
      {
         ...
         {
            (this._vipTip["openVip"] as SimpleButton).removeEventListener("click",this.onOpenVip);
         }
         this._vipTip = null;
         this._fightNum = null;
         this._itemNum = null;
