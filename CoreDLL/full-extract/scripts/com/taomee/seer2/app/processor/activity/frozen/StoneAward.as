   ...
   public class StoneAward
   {
      ...
      private static function initSoArray() : void
      {
         ...
         for each(_loc1_ in _soArray)
         {
            ...
            _stone["stone" + _loc1_].removeEventListener("click",onStoneClick);
      ...
      private static function initEvent() : void
      {
         ...
         while(_loc1_ < 14)
         {
            ...
            _stoneList[_loc1_].addEventListener("click",onStoneClick);
            _loc1_++;
         }
      }
      ...
      public static function remove() : void
      {
         ...
         {
            _loc1_.removeEventListener("click",onStoneClick);
         }
