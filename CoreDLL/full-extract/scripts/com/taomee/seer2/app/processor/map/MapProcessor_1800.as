package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_1800 extends TitleMapProcessor
   {
      ...
      private function initFunnyCrab() : void
      {
         ...
         this._funnyMC.addEventListener("funnyRewardA",this.onFunnyReward);
      }
      
      private function onFunnyReward(param1:Event) : void
      {
         this._funnyMC.removeEventListener("funnyRewardA",this.onFunnyReward);
      ...
      {
         if(this._funnyMC.hasEventListener("funnyRewardA"))
         {
            this._funnyMC.removeEventListener("funnyRewardA",this.onFunnyReward);
         }
         this._funnyMC = null;
