package com.taomee.seer2.app.processor.activity.frozen
{
   ...
   public class FrozenStatus
   {
      ...
      public static function playAnimation1(param1:Function, param2:MovieClip) : void
      {
         ...
         url = URLUtil.getActivityAnimation("8/1");
         url2 = URLUtil.getActivityAnimation("8/2");
      ...
      {
         ShootController.close();
         var _loc1_:String = URLUtil.getActivityAnimation("8/3");
         MovieClipUtil.playFullScreen(_loc1_,null,false);
      }
      
      public static function clearAnimation() : void
      {
         var _loc1_:String = URLUtil.getActivityAnimation("8/1");
      ...
      public static function playAnimation5(param1:Function) : void
      {
         ...
         {
            url = URLUtil.getActivityAnimation("8/4");
      ...
      {
         ShootController.close();
         var _loc1_:String = URLUtil.getActivityAnimation("8/5");
         MovieClipUtil.playFullScreen(_loc1_,null,false);
      }
      ...
      {
         ShootController.close();
         var _loc2_:String = URLUtil.getActivityAnimation("8/7");
      ...
      public static function getSwfContent(param1:Function) : void
      {
         ...
         {
            QueueLoader.load(URLUtil.getActivityAnimation("8/6"),"domain",function(param1:ContentInfo):void
            {
