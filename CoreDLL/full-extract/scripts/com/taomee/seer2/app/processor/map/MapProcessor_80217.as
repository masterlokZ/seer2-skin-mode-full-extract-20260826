package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80217 extends MapProcessor
   {
      ...
      {
         if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord.initData.positionIndex == 1045)
         {
      ...
      private function onNpcClick(param1:MouseEvent) : void
      {
         if(this.isCanFight())
         {
            FightManager.startFightWithWild(1045);
         }
      }
      ...
      private function isCanFight() : Boolean
      {
         ...
         {
            if([3,5,7,18].indexOf(_loc1_.type) != -1)
            {
               _loc2_ = false;
