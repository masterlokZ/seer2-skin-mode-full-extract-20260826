package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_360 extends TitleMapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         StatisticsManager.sendNovice("0x10033435");
      ...
      private function initFunnyPet() : void
      {
         ...
         this._funnyPet.addEventListener("enterFrame",this.onFunnyPetEnd);
      }
      ...
      private function onFunnyPetEnd(param1:Event) : void
      {
         ...
         {
            this._funnyPet.removeEventListener("enterFrame",this.onFunnyPetEnd);
      ...
      private function initFunnyFlower() : void
      {
         ...
         this._funnyFlower["hotArea"].addEventListener("click",this.onFunnyFlowerClick);
         this._funnyFlower.addEventListener("enterFrame",this.onFunnyFlowerEnd);
      }
      ...
      private function onFunnyFlowerClick(param1:MouseEvent) : void
      {
         ...
         else if(this._funnyFlower.currentFrame == 2)
         {
            ...
            this._funnyFlower["hotArea"].removeEventListener("click",this.onFunnyFlowerClick);
         }
      }
      ...
      private function onFunnyFlowerEnd(param1:Event) : void
      {
         ...
         {
            this._funnyFlower.removeEventListener("enterFrame",this.onFunnyFlowerEnd);
