package com.taomee.seer2.app.processor.quest
{
   ...
   public class QuestProcessor_10018 extends QuestProcessor
   {
      ...
      {
         if(QuestManager.getQuest(10018).status == 1)
         {
            return 10018;
         }
         if(QuestManager.getQuest(10019).status == 1)
         {
            return 10019;
         }
         if(QuestManager.getQuest(10020).status == 1)
         {
            return 10020;
         }
         if(QuestManager.getQuest(10021).status == 1)
         {
            return 10021;
         }
         if(QuestManager.getQuest(10022).status == 1)
         {
            return 10022;
         }
         return 0;
