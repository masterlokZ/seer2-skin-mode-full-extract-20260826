   ...
   public class QuestMapHandler_10040_70 extends QuestMapHandler
   {
      ...
      override public function processMapDispose() : void
      {
         ...
         if(this._giftMc)
         {
            ...
            this._giftMc.removeEventListener("click",this.onGiftMcClick);
         }
         if(this._screenMc)
         {
            this._screenMc.removeEventListener("click",this.onScreenMcClick);
            this._screenMc.removeEventListener("enterFrame",this.onScreenEnterFrame);
         }
      ...
      private function processStep1() : void
      {
         ...
         this._giftMc.addEventListener("click",this.onGiftMcClick);
      }
      ...
      private function onGiftMcClick(param1:MouseEvent) : void
      {
         ...
         MovieClipUtil.getSwfContent(URLUtil.getQuestFullScreenAnimation("10040_0"),function(param1:MovieClip):void
         {
            ...
            _screenMc.addEventListener("click",onScreenMcClick);
            _screenMc.addEventListener("enterFrame",onScreenEnterFrame);
      ...
      private function onScreenEnterFrame(param1:Event) : void
      {
         ...
         else if(this._screenClickCount == 2 && this._screenMc.currentFrame == this._screenMc.totalFrames)
         {
            ...
            SceneManager.changeScene(1,8022);
         }
      }
   }
}
