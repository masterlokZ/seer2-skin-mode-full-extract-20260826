   ...
   public class QuestMapHandler_30007_133 extends QuestMapHandler
   {
      ...
      private function playStory() : void
      {
         MovieClipUtil.playFullScreen(URLUtil.getQuestFullScreenAnimation("30007_0"),function():void
         {
            ...
            fala.addEventListener("click",showFaDia);
      ...
      private function showFaDia(param1:MouseEvent) : void
      {
         ...
         var _loc3_:CustomUnit = new CustomUnit("active","与神的对决","30007_0");
      ...
      private function onUnitClick(param1:FunctionalityBoxEvent) : void
      {
         ...
         this.fala.removeEventListener("click",this.showFaDia);
      ...
      private function initStep1() : void
      {
         ...
         this.fala.addEventListener("click",this.showArmIcon);
      }
      ...
      private function showArmIcon(param1:MouseEvent) : void
      {
         ...
         this.armBtn.addEventListener("click",this.clearSellotape);
         this.fala.removeEventListener("click",this.showArmIcon);
      }
      ...
      private function clearSellotape(param1:MouseEvent) : void
      {
         ...
         this.armBtn.removeEventListener("click",this.clearSellotape);
         ...
         MovieClipUtil.playMc(animation,1,animation.totalFrames,function():void
         {
            ...
            {
               fala.addEventListener("click",showSmile);
            }]);
         });
      }
      ...
      private function showSmile(param1:MouseEvent) : void
      {
         ...
         this.fala.removeEventListener("click",this.showSmile);
         this.face1 = this.fala["Smile"];
         this.face1.addEventListener("click",this.chekFace);
         this.face2 = this.fala["Twat"];
         this.face2.addEventListener("click",this.chekFace);
         this.face3 = this.fala["Terror"];
         this.face3.addEventListener("click",this.chekFace);
      ...
      private function chekFace(param1:MouseEvent) : void
      {
         ...
         else
         {
            ...
            {
               QuestManager.addEventListener("stepComplete",completeStep1);
               QuestManager.completeStep(questId,1);
               face1.removeEventListener("click",chekFace);
               face2.removeEventListener("click",chekFace);
               face3.removeEventListener("click",chekFace);
            });
         }
      }
      ...
      override public function processMapDispose() : void
      {
         ...
         if(this.face1)
         {
            this.face1.removeEventListener("click",this.chekFace);
            this.fala.removeChild(this.face1);
         }
         if(this.face2)
         {
            this.face2.removeEventListener("click",this.chekFace);
            this.fala.removeChild(this.face2);
         }
         if(this.face3)
         {
            this.face3.removeEventListener("click",this.chekFace);
