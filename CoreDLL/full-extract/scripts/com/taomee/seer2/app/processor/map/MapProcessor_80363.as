package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80363 extends MapProcessor
   {
      ...
      {
         if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord.initData.positionIndex == 1378)
         {
      ...
      private function onNpcClick(param1:MouseEvent) : void
      {
         ...
         if(this._canFightNum > 0)
         {
            if(this.isCanFight())
            {
               ...
               {
                  FightManager.startFightWithWild(1378);
               }
            }
         }
         else
