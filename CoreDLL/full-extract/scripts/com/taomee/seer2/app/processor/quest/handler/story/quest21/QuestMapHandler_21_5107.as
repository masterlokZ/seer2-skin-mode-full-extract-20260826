package com.taomee.seer2.app.processor.quest.handler.story.quest21
{
   ...
   public class QuestMapHandler_21_5107 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         if(_quest.status == 1)
         {
            if(_quest.isStepCompete(1) && !_quest.isStepCompete(2))
            {
               this.processStep2();
            }
         }
      ...
      {
         FightManager.removeEventListener("START_SUCCESS",this.onStartSuccess);
         FightManager.removeEventListener("START_ERROR",this.onStartError);
         if(this._landeAnimation)
         {
            this._landeAnimation.removeEventListener("click",this.onLandeClick);
         }
      ...
      {
         if(SceneManager.prevSceneType == 2 && _isFightQuest)
         {
            _isFightQuest = false;
         ...
         else
         {
            ...
            this._landeAnimation.addEventListener("click",this.onLandeClick);
         }
      }
         ...
         NpcDialog.show(51,"兰德",[[2,"真气人！那是蒂萨特给我的礼物，居然被那个贪吃鬼吞了下去！"]],["好好的怎么了呢？"],[function():void
         {
            NpcDialog.show(51,"兰德",[[2,"就在刚才，蒂萨特送给我一个鲁卜利娃娃！我没拿稳掉在了地上，结果……被贪吃鬼格尔西克吞了下去！！"]],["这是什么肠胃啊……"],[function():void
            {
               NpcDialog.show(51,"兰德",[[0,"格尔西克是出名的贪吃鬼……不过，它才吃下去没多久，如果用力打它的肚子，应该还能吐出来……"]],[" ……"],[function():void
               {
                  ...
                  {
                     FightManager.addEventListener("START_ERROR",onStartError);
