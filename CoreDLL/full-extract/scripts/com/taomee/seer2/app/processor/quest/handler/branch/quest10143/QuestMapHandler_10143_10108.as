package com.taomee.seer2.app.processor.quest.handler.branch.quest10143
{
   ...
   public class QuestMapHandler_10143_10108 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         {
            if(SceneManager.prevSceneType == 2 && SceneManager.prevMapID == 100010 && FightManager.currentFightRecord.initData.positionIndex == 235)
            {
               this.addRes2();
            }
            else
      ...
      private function addRes() : void
      {
         ...
         this._npc_mc["Lv"].addEventListener("click",this.onSuerTalkFirstHandler);
      }
      ...
      private function addRes1() : void
      {
         ...
         _loc1_.addEventListener("click",this.onSuerTalkFiveHandler);
      }
      ...
      private function addRes2() : void
      {
         ...
         _loc1_.buttonMode = true;
         this.taskClothState();
         _loc1_.addEventListener("click",this.onSuerTalkFourHandler);
      }
      ...
      private function onSuerTalkFirstHandler(param1:MouseEvent) : void
      {
         ...
         this._npc_mc["Lv"].removeEventListener("click",this.onSuerTalkFirstHandler);
         MovieClipUtil.playFullScreen(URLUtil.getQuestFullScreenAnimation("10143_1"),function():void
         {
            ...
            _npc_mc["suer"]["mark"].visible = true;
            _npc_mc["suer"].addEventListener("click",onSuerTalkSecondHandler);
         },true,false,2);
      }
      ...
      {
         var evt:MouseEvent = param1;
         this._npc_mc["suer"].removeEventListener("click",this.onSuerTalkSecondHandler);
         MovieClipUtil.playFullScreen(URLUtil.getQuestAnimation("sceneTalk/10143_1"),function():void
         {
            _npc_mc["suer"].addEventListener("click",onSuerTalkThirdHandler);
         },false,false,2,false);
      }
      ...
      {
         var evt:MouseEvent = param1;
         this._npc_mc["suer"].removeEventListener("click",this.onSuerTalkThirdHandler);
      ...
      private function onStep2Complete(param1:QuestEvent) : void
      {
         ...
         this._npc_mc["suer"].addEventListener("click",this.onSuerTalkFiveHandler);
      }
      
      private function onSuerTalkFiveHandler(param1:MouseEvent) : void
      {
         var evt:MouseEvent = param1;
         this._npc_mc["suer"].removeEventListener("click",this.onSuerTalkFiveHandler);
         NpcDialog.show(180,"圣诞老人",[[0,"还好我在康特身上挂了一个追踪器，就放在我的大衣口袋…"]],["那快拿出来吧！我们一起去找！"],[function():void
         {
            NpcDialog.show(180,"圣诞老人",[[0,"可是刚刚我晾衣服时我的大衣被身边这群小精灵抢走了，大衣就在身边的精灵身上。"]],["身边的精灵？"],[function():void
            {
               ...
               {
                  _npc_mc["suer"].addEventListener("click",onSuerTalkFourHandler);
                  ActiveCountManager.requestActiveCount(202113,function(param1:uint, param2:uint):void
                  {
                     if(param2 == 5)
                     {
      ...
      private function onSuerTalkFourHandler(param1:MouseEvent) : void
      {
         ...
         ActiveCountManager.requestActiveCount(202113,function(param1:uint, param2:uint):void
         {
            ...
            if(count == 5)
            {
               _npc_mc["suer"].removeEventListener("click",onSuerTalkFourHandler);
               NpcDialog.show(180,"圣诞老人",[[0,"怎么这么慢呀，老夫像是等了一个世纪了。"]],["才过了几分钟啊！"],[function():void
               {
                  NpcDialog.show(180,"圣诞老人",[[0,"快拿出大衣中的跟踪雷达，看看康特现在在什么地方！"]],["好！"],[function():void
                  {
                     ...
                     {
                        _npc_mc["suer"].addEventListener("click",onSuerTalkSixHandler);
                     },true,false,2);
                  }]);
               }]);
            }
      ...
      {
         var evt:MouseEvent = param1;
         this._npc_mc["suer"].removeEventListener("click",this.onSuerTalkSixHandler);
         MovieClipUtil.playFullScreen(URLUtil.getQuestAnimation("sceneTalk/10143_2"),function():void
         {
            QuestManager.addEventListener("complete",onStep3Complete);
      ...
      override public function processMapDispose() : void
      {
         ...
         QuestManager.removeEventListener("stepComplete",this.onStep2Complete);
         QuestManager.removeEventListener("complete",this.onStep3Complete);
      }
   }
}
