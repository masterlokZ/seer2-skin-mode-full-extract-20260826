package com.taomee.seer2.app.processor.quest.handler.main.quest90
{
   ...
   public class QuestMapHandler_90_80375 extends QuestMapHandler
   {
      ...
      private var _tm:Timer = new Timer(5000);
      ...
      {
         this._tm.addEventListener("timer",this.onChangePicture);
         this._tm.start();
         MovieClip(_map.content["picMc"]).gotoAndStop(1);
         MovieClip(_map.content["picMc"]).buttonMode = true;
         MovieClip(_map.content["picMc"]).addEventListener("click",this.onClick);
      }
      ...
      private function initStep2(param1:QuestEvent) : void
      {
         ...
         this._teleport.addEventListener("click",this.onClickTeleport);
      ...
      {
         SceneManager.changeScene(9,80374);
      }
      ...
      override public function processMapDispose() : void
      {
         ...
         ActorManager.getActor().blockNoNo = false;
         this._tm.stop();
         this._tm.removeEventListener("timer",this.onChangePicture);
