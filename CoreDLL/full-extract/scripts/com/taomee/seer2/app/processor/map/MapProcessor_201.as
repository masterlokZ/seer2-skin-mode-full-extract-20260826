package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_201 extends TitleMapProcessor
   {
      ...
      override public function init() : void
      {
         this.initTeleport();
         this.initFunnyCrab();
         StatisticsManager.sendNovice("0x10033427");
      }
      ...
      private function initFunnyCrab() : void
      {
         ...
         this._funnyMC.addEventListener("enterFrame",this.onCrabEnterFrame);
      }
      ...
      private function onCrabEnterFrame(param1:Event) : void
      {
         ...
         {
            this._funnyMC.stop();
            this._funnyMC.removeEventListener("enterFrame",this.onCrabEnterFrame);
      ...
      {
         if(this._funnyMC.hasEventListener("enterFrame"))
         {
            this._funnyMC.removeEventListener("enterFrame",this.onCrabEnterFrame);
         }
