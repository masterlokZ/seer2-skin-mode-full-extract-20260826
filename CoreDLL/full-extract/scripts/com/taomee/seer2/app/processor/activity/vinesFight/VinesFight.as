package com.taomee.seer2.app.processor.activity.vinesFight
{
   ...
   public class VinesFight
   {
      ...
      {
         var url:String = URLUtil.getActivityAnimation("vinesFight/vinesFight");
      ...
      private function initNpc() : void
      {
         ...
         this._bossNpc = MobileManager.getMobile(484,"npc");
         this._noBossNpc = MobileManager.getMobile(490,"npc");
      }
      ...
      private function updateNpc() : void
      {
         ...
         var _loc1_:Number = uint(_loc2_.minutes);
         if(_loc1_ <= 30)
         {
            this._noBossNpc.visible = true;
            DialogPanel.removeEventListener("customUnitClick",this.onNpc);
            DialogPanel.addEventListener("customUnitClick",this.onNpc);
            for each(_loc4_ in this._npcList)
            {
               _loc4_.buttonMode = true;
               _loc4_.addEventListener("click",this.onNpcList);
            }
         }
         else
         {
            ...
            for each(_loc3_ in this._npcList)
            {
               ...
               _loc3_.removeEventListener("click",this.onNpcList);
            }
         }
      }
