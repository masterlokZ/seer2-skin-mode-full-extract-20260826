package com.taomee.seer2.app.processor.quest.handler.branch.quest10145
{
   ...
   public class QuestMapHandler_10145_202 extends QuestMapHandler
   {
      ...
      private function addRes1() : void
      {
         ...
         this._npcAnmiya.addEventListener("click",this.onAnmiyaClick);
      }
      ...
      private function onAnmiyaClick(param1:MouseEvent) : void
      {
         ...
         NpcDialog.show(412,"安迷亚",[[0,"你…你…你们是什么人？你们想干嘛？！"]],["借你的头罩一用吧"],[function():void
         {
            ...
            SceneManager.addEventListener("switchComplete",onSceneSwitchComplete);
         }]);
      }
      
      private function onSceneSwitchComplete(param1:SceneEvent) : void
      {
         if(SceneManager.prevSceneType == 2 && FightManager.fightWinnerSide == 1 && FightManager.currentFightRecord.initData.positionIndex == 241)
         {
            SceneManager.removeEventListener("switchComplete",this.onSceneSwitchComplete);
            DisplayUtil.removeForParent(this._npcAnmiya);
            this._npcAnmiya.removeEventListener("click",this.onAnmiyaClick);
            QuestManager.addEventListener("stepComplete",this.onStepThreeComplete);
      ...
      private function onSceneSwitchComplete1(param1:SceneEvent) : void
      {
         ...
         if(SceneManager.prevSceneType == 2 && FightManager.fightWinnerSide == 1 && FightManager.currentFightRecord.initData.positionIndex == 242)
         {
            SceneManager.removeEventListener("switchComplete",this.onSceneSwitchComplete1);
            DisplayUtil.removeForParent(this._npcLanhujin);
            this._npcLanhujin.removeEventListener("click",this.onLanhujinClick);
            NpcDialog.show(11,"多罗",[[1,"这家伙真硬吧！巴蒂应该也找到东西了！我们现在回雪人村吧！"]],["好！现在就走！"],[function():void
            {
               QuestManager.addEventListener("stepComplete",onStepFourComplete);
      ...
      private function onStepThreeComplete(param1:QuestEvent) : void
      {
         ...
         QuestManager.removeEventListener("stepComplete",this.onStepThreeComplete);
      ...
      {
         QuestManager.removeEventListener("stepComplete",this.onStepFourComplete);
         SceneManager.changeScene(1,10108);
      }
      ...
      private function addRes2() : void
      {
         ...
         this._npcLanhujin.addEventListener("click",this.onLanhujinClick);
      }
      ...
      private function onLanhujinClick(param1:MouseEvent) : void
      {
         ...
         NpcDialog.show(413,"蓝虎鲸",[[0,"你们这是干嘛？我可没空理你们，我还要挑战阿卡纳斯去呢！"]],["嘿嘿，先留下你的硬壳吧。"],[function():void
         {
            ...
            SceneManager.addEventListener("switchComplete",onSceneSwitchComplete1);
         }]);
      }
