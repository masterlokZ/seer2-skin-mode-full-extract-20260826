package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_790 extends TitleMapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         StatisticsManager.sendNovice("0x1003344E");
         this._fishRule = new FishRule_790();
         this._fishRule.init(_map);
         this.checkAnimation();
         _map.content["luoke"].addEventListener("click",this.onLuokeClick);
      }
      
      private function checkAnimation() : void
      {
         ServerBufferManager.getServerBuffer(115,this.onGetServerBuff);
      }
      ...
      private function onGetServerBuff(param1:ServerBuffer) : void
      {
         ...
         if(event.readDataAtPostion(0) != 1)
         {
            ...
            {
               ServerBufferManager.updateServerBuffer(115,0,1);
            },true,false,2);
         }
      }
      ...
      {
         _map.content["luoke"].removeEventListener("click",this.onLuokeClick);
