package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_230 extends TitleMapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         this.initRedFlag();
         this.initFunnyLion();
         StatisticsManager.sendNovice("0x1003343B");
      ...
      private function addKingChar() : void
      {
         ...
         this.mcCar.addEventListener("click",this.onMouseCar);
      ...
      private function onMouseCar(param1:MouseEvent) : void
      {
         ...
         if(this.mcCar.currentFrame == this.mcCar.totalFrames)
         {
            ...
            this.mcCar.removeEventListener("click",this.onMouseCar);
         }
      }
      ...
      private function initFireRaceIntroduce() : void
      {
         ...
         this._fireRaceIntroduceCloseBtn.addEventListener("click",this.onFireRaceIntroduceClose);
      }
      ...
      private function initDiamondVec() : void
      {
         ...
         this._diamond1HotArea.addEventListener("mouseOver",this.onDiamondOneMouseOver);
         this._diamond1HotArea.addEventListener("mouseOut",this.onDiamondOneMouseOut);
         this._diamond1HotArea.addEventListener("click",this.onDiamondOneClick);
         var _loc2_:MovieClip = _map.content["diamond2"];
         this._diamondVec.push(_loc2_);
         var _loc1_:MovieClip = _map.content["diamond3"];
      ...
      private function addDiamondEventListener() : void
      {
         ...
         while(_loc1_ < 2)
         {
            ...
            this._diamondVec[_loc1_].addEventListener("mouseOver",this.onDiamondMouseOver);
            this._diamondVec[_loc1_].addEventListener("mouseOut",this.onDiamondMouseOut);
            this._diamondVec[_loc1_].addEventListener("click",this.onDiamondClick);
            _loc1_++;
         }
      }
      ...
      private function initRedFlag() : void
      {
         ...
         this._redFlagHotArea.addEventListener("mouseOver",this.onRedFlagOver);
         this._redFlagHotArea.addEventListener("mouseOut",this.onRedFlagOut);
      }
      ...
      private function initLittleDuckGame() : void
      {
         ...
         this._littleBoyHotArea.addEventListener("click",this.onLittleGameClick);
      }
      ...
      private function initFunnyLion() : void
      {
         ...
         this._funnyLion.addEventListener("mouseOver",this.onFunnyLionOver);
         this._funnyLion.addEventListener("mouseOut",this.onFunnyLionOut);
      }
      ...
      {
         this._diamond1HotArea.removeEventListener("mouseOver",this.onDiamondOneMouseOver);
         this._diamond1HotArea.removeEventListener("mouseOut",this.onDiamondOneMouseOut);
         this._diamond1HotArea.removeEventListener("click",this.onDiamondOneClick);
         var _loc1_:uint = 0;
         while(_loc1_ < 2)
         {
            this._diamondVec[_loc1_].removeEventListener("mouseOver",this.onDiamondMouseOver);
            this._diamondVec[_loc1_].removeEventListener("mouseOut",this.onDiamondMouseOut);
            this._diamondVec[_loc1_].removeEventListener("click",this.onDiamondClick);
      ...
      override public function dispose() : void
      {
         ...
         this._littleBoyHotArea.removeEventListener("click",this.onLittleGameClick);
         this._littleBoyHotArea = null;
         this._littleDuckGame = null;
         this._funnyLion.removeEventListener("mouseOver",this.onFunnyLionOver);
         this._funnyLion.removeEventListener("mouseOut",this.onFunnyLionOut);
         this._funnyLion = null;
         this._redFlagHotArea.removeEventListener("mouseOver",this.onRedFlagOver);
         this._redFlagHotArea.removeEventListener("mouseOut",this.onRedFlagOut);
