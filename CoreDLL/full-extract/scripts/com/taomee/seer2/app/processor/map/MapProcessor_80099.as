package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80099 extends MapProcessor
   {
      ...
      {
         if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord.initData.positionIndex == 755)
         {
            DayLimitManager.getDoCount(905,function(param1:int):void
            {
               var val:int = param1;
               ActiveCountManager.requestActiveCount(203538,function(param1:uint, param2:uint):void
               {
      ...
      private function onNpcClick(param1:MouseEvent) : void
      {
         ...
         {
            FightManager.startFightWithWild(755);
         }]);
      }
