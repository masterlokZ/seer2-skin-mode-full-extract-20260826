package com.taomee.seer2.app.processor.activity.earthSearchAct
{
   ...
   public class EarthSearchTwoLayer
   {
      ...
      private function onDialogShow(param1:Event) : void
      {
         ...
         {
            DialogPanel.showForSimple(836,"小地兽",[[0,DIALOG_STR[_type] + "你也可以给我<font color=\'#ff3300\'>20</font>个电池直接进入地核层,我知道你现在已经有<font color=\'#ff3300\'>" + getItemNum(ITEM_ID[0]) + "</font>块电池了。"]]," 我准备一下");
            addUinit();
         });
      }
      ...
      private function addUinit() : void
      {
         ...
         var _loc3_:Vector.<String> = Vector.<String>(["电池购买","地幔层规则","进入地核层"]);
         if(this._type <= 2)
         {
      ...
      private function onUint(param1:DialogPanelEvent) : void
      {
         ...
         if(params == "80372")
         {
            ...
            if(num < 20)
            {
               NpcDialog.show(836,"小地兽",[[0,"1、2、3、6、5、9、8……虽然我的数学课是体育老师教的，但是也算的出你给的电池不够啊！ 要不要买点啊？"]],["购买电池 ","知道了"],[function():void
               {
                  ModuleManager.showAppModule("EarthItemBuyPanel");
               }]);
            }
            ...
            {
               SwapManager.swapItem(3540,1,function(param1:IDataInput):void
               {
                  var _loc2_:SwapInfo = new SwapInfo(param1);
                  SceneManager.changeScene(9,80372);
         ...
         if(params == "EarthReadyGo")
         {
            ...
            {
               hideNpc();
               SwapManager.swapItem(3539,1,function(param1:IDataInput):void
               {
      ...
      public function showNpc() : void
      {
         ...
         this._npc.resourceUrl = URLUtil.getNpcSwf(836);
         this._npc.scaleX = -1;
      ...
      public function removeUnit() : void
      {
         ...
         var _loc2_:Vector.<String> = Vector.<String>(["电池购买","地幔层规则","进入地核层","岩石阵挑战开始"," 熔浆阵挑战开始","对流阵挑战开始"]);
