package com.taomee.seer2.app.processor.activity.sourceOfWater
{
   ...
   public class SourceOfWaterManager
   {
      ...
      private var mobileVec:Vector.<Mobile> = new Vector.<Mobile>();
      
      private var mobileIDVec:Array = [550,551,552,553];
      
      private var mobileIDsForBattle:Array = [286,287,288,289];
      
      private var mobileIDsForSearch:Array = [606,607,608,609];
      ...
      private function init() : void
      {
         ...
         this._hitArea.addEventListener("click",this.onBubbleClick);
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this.mobileIDVec.length)
         {
            _loc1_ = MobileManager.getMobile(this.mobileIDVec[_loc2_],"npc");
            this.mobileVec.push(_loc1_);
      ...
      private function checkCount() : void
      {
         ...
         while(_loc1_ < this._countArray.length)
         {
            ...
            else
            {
               ...
               this.mobileVec[_loc1_].addEventListener("click",this.onMobileClick);
            }
            _loc1_++;
         }
         this.checkStatus();
      ...
      private function checkStatus() : void
      {
         ...
         if(this._hasWin == 4)
         {
            if(SceneManager.prevSceneType == 2 && isFightWIthSprite)
            {
      ...
      private function changeScene() : void
      {
         ...
         this._hitArea.removeEventListener("click",this.onBubbleClick);
