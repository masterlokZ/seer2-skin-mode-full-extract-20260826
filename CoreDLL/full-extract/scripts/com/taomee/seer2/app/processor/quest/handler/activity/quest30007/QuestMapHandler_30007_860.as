package com.taomee.seer2.app.processor.quest.handler.activity.quest30007
{
   ...
   public class QuestMapHandler_30007_860 extends QuestMapHandler
   {
      ...
      private function initStep2() : void
      {
         ...
         this.npcStep2.addEventListener("click",this.showNpcDia2);
      }
      ...
      private function battleWin() : void
      {
         ...
         {
            QuestManager.addEventListener("stepComplete",completeStep2);
      ...
      private function completeStep2(param1:QuestEvent) : void
      {
         ...
         {
            this.npcStep2.removeEventListener("click",this.showNpcDia2);
            _map.content.removeChild(this.npcStep2);
            QuestManager.removeEventListener("stepComplete",this.completeStep2);
            this.initStep3();
         }
      }
      ...
      private function initStep3() : void
      {
         ...
         this.stanYin.addEventListener("click",this.stanYinBattle);
      }
      ...
      private function initStep4() : void
      {
         ...
         this.crowMc.addEventListener("click",this.clickCrow);
      ...
      private function clickCrow(param1:MouseEvent) : void
      {
         ...
         {
            QuestManager.addEventListener("complete",completeQuest);
      ...
      private function completeQuest(param1:QuestEvent) : void
      {
         ...
         {
            QuestManager.removeEventListener("complete",this.completeQuest);
            this.crowMc.removeEventListener("click",this.clickCrow);
      ...
      override public function processMapDispose() : void
      {
         ...
         if(this.stanYin)
         {
            this.stanYin.removeEventListener("click",this.stanYinBattle);
