package com.taomee.seer2.app.processor.quest.handler.activity.quest30024
{
   ...
   public class QuestMapHandler_30024_50 extends QuestMapHandler
   {
      ...
      {
         this._duoluo_npc = MobileManager.getMobile(1003,"npc");
      ...
      private function initNpc(param1:int) : void
      {
         if(param1 == 1)
         {
            ...
            if(this._mc_0["duoluo"] != null)
            {
               ...
               this._mcDuoluo.addEventListener("click",this.onDuoluoClick);
            }
            else
            {
               this._mc_0.addEventListener("enterFrame",this.onEnterFrame);
            }
         }
         else if(param1 == 2)
         {
            ...
            this._paLaDing_npc.addEventListener("click",this.onClickPalading);
         }
      }
      ...
      private function onEnterFrame(param1:Event) : void
      {
         if(this._mc_0["duoluo"] != null)
         {
            this._mc_0.removeEventListener("enterFrame",this.onEnterFrame);
            this._mcDuoluo = this._mc_0["duoluo"];
            this._mcDuoluo.buttonMode = true;
            this._mcDuoluo.addEventListener("click",this.onDuoluoClick);
         }
      ...
      private function onDuoluoClick(param1:MouseEvent) : void
      {
         ...
         this._mcDuoluo.removeEventListener("click",this.onDuoluoClick);
