package com.taomee.seer2.app.processor.quest.handler.story.quest47
{
   ...
   public class QuestMapHandler_47_830 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         {
            if(SceneManager.prevSceneType == 2 && this._fightStatus)
            {
               this._fightStatus = false;
               this.FightMovie();
            }
            else if(SceneManager.prevSceneType == 2 && this._fightStatusAgain)
            {
         ...
         {
            DialogPanel.addEventListener("customReplyClick",this.onNpcTalkAgainHandler);
            this.initNpc();
         }
      }
      ...
      private function onNpcTalkAgainHandler(param1:DialogPanelEvent) : void
      {
         ...
         {
            DialogPanel.removeEventListener("customReplyClick",this.onNpcTalkAgainHandler);
