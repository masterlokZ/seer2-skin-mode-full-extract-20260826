package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_8030 extends TitleMapProcessor
   {
      ...
      private function initSupermarket() : void
      {
         ...
         this.btn.addEventListener("click",this.showAct);
         TooltipManager.addCommonTip(this._supermarketBtn,"乐园商城");
         this._supermarketBtn.buttonMode = true;
         this._supermarketBtn.addEventListener("click",this.onOpenSupermarket);
      ...
      {
         this.btn.removeEventListener("click",this.showAct);
         if(this._supermarketBtn)
         {
            this._supermarketBtn.removeEventListener("click",this.onOpenSupermarket);
            TooltipManager.remove(this._supermarketBtn);
            this._supermarketBtn = null;
         }
         if(this._starBtn)
         {
            this._starBtn.removeEventListener("click",this.onOpenStargazerFight);
