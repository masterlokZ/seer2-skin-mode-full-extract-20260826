package com.taomee.seer2.app.processor.quest.handler.story.quest16
{
   ...
   public class QuestMapHandler_16_340 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         if(SceneManager.prevSceneType == 2 && QuestManager.isStepComplete(_quest.id,4) == false && _flghtIndex == 1)
         {
            this.showAnimation();
      ...
      {
         this._npc = MobileManager.getMobile(438,"npc");
         if(this._npc)
         {
         ...
         else
         {
            setTimeout(function():void
            {
               ...
               _mc_7.x = 230;
               _mc_7.y = 190;
               _npc = MobileManager.getMobile(438,"npc");
      ...
      private function startFight() : void
      {
         if(PetInfoManager.getFirstPetInfo().hp <= 1)
         {
            ...
            this._mc_4.addEventListener("click",this.onMC4Click);
            return;
         }
         _flghtIndex = 1;
      ...
      {
         this._mc_4.removeEventListener("click",this.onMC4Click);
         this.startFight();
      }
      ...
      private function noWin() : void
      {
         this._mc_4.buttonMode = true;
         this.addFightMouseClickHint();
         this._mc_4.addEventListener("click",function(param1:MouseEvent):void
         {
            var event:MouseEvent = param1;
            _mc_4.removeEventListener("click",arguments.callee);
