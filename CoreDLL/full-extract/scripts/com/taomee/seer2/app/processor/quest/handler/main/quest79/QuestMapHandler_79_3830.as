package com.taomee.seer2.app.processor.quest.handler.main.quest79
{
   ...
   public class QuestMapHandler_79_3830 extends QuestMapHandler
   {
      ...
      private var fightFirstID:Array = [1334];
      ...
      override public function processMapComplete() : void
      {
         ...
         this._npc1032 = MobileManager.getMobile(1032,"npc");
         ...
         if(QuestManager.isAccepted(questID) && !QuestManager.isStepComplete(questID,1))
         {
            ...
            {
               this.createNpc();
               this._npc.addEventListener("click",this.initDialogNpc);
            }
         }
      ...
      private function onSwitchComplete() : void
      {
         ...
         if(this.fightFirstID.indexOf(FightManager.currentFightRecord.initData.positionIndex) != -1)
         {
            ...
            if(result == 2)
            {
               ...
               {
                  createNpc();
                  _npc.addEventListener("click",initContinue);
               }]);
            }
            else if(result == 1)
            {
      ...
      {
         this._npc1 = MobileManager.getMobile(1017,"npc");
      ...
      {
         MobileManager.removeMobile(this._npc2,"npc");
      ...
      private function createNpc1() : void
      {
         ...
         if(!this._npc)
         {
            this._npc = MobileManager.getMobile(1017,"npc");
            if(this._npc != null)
            {
               _loc2_ = new InProgressMark();
               this._npc.addChild(_loc2_);
               _loc2_.y = -130;
               this._npc.addEventListener("click",this.initStep4);
            }
            else
            {
               this._npc = new Mobile();
      ...
      private function createNpc2() : void
      {
         ...
         if(!this._npc2)
         {
            ...
            _loc1_.y = -100;
            this._npc2.addEventListener("click",this.initStep7);
         }
      }
      ...
      override public function processMapDispose() : void
      {
         if(this._npc)
         {
            this._npc.removeEventListener("click",this.initStep4);
         }
         this._npc = null;
