   ...
   public class MapProcessor_80203 extends MapProcessor_80101
   {
      ...
      private function initSet() : void
      {
         ...
         while(_loc1_ < 5)
         {
            ...
            this._stoneList[_loc1_].addEventListener("click",this.onRandom);
            _loc1_++;
         }
         this.hideLobbyMenu();
      ...
      private function onRandom(param1:MouseEvent) : void
      {
         ...
         if(this.forwardFilter())
         {
            ...
            {
               Connection.send(CommandSet.RANDOM_EVENT_1140,96,0);
            }
         }
         else
         {
      ...
      private function stoneManActDispose() : void
      {
         ...
         if(this._stoneList)
         {
            ...
            {
               _loc1_.removeEventListener("click",this.onRandom);
            }
