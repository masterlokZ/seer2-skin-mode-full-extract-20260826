package com.taomee.seer2.app.processor.quest.handler.branch.quest10160
{
   ...
   public class QuestMapHandler_10160_1071 extends QuestMapHandler
   {
      ...
      override public function processMapDispose() : void
      {
         ...
         if(this.duoluoMb)
         {
            this.duoluoMb.removeEventListener("click",this.showDuoDia);
         }
         if(this.badiMb)
         {
            this.badiMb.removeEventListener("click",this.showDiaBadi);
         }
      }
      ...
      override public function processMapComplete() : void
      {
         if(isNeedToAccept())
         {
            this.s = MobileManager.getMobile(172,"npc");
      ...
      private function initStep6() : void
      {
         ...
         this.badiMb.addEventListener("click",this.showDiaBadi);
      ...
      private function onComplete(param1:QuestEvent) : void
      {
         if(param1.questId == 10160)
         {
            ...
            MobileManager.removeMobile(this.duoluoMb,"npc");
            MobileManager.removeMobile(this.badiMb,"npc");
         }
      }
      ...
      private function onCompleteStep(param1:QuestEvent) : void
      {
         if(param1.questId == questID)
         {
            ...
            if(param1.stepId == 1)
            {
               SceneManager.changeScene(1,1080);
            }
         }
      }
      ...
      private function initStep1() : void
      {
         ...
         MobileManager.addMobile(this.duoluoMb,"npc");
         this.duoluoMb.addEventListener("click",this.showDuoDia);
      }
