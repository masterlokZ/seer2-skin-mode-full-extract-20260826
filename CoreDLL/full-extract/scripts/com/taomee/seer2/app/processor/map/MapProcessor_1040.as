package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_1040 extends MapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         this.initClock();
         StatisticsManager.sendNovice("0x10033297");
      }
      
      private function getCurrentStep() : void
      {
         ServerBufferManager.getServerBuffer(285,function(param1:ServerBuffer):void
         {
      ...
      {
         MobileManager.getMobile(518,"npc").buttonMode = true;
         MobileManager.getMobile(518,"npc").addEventListener("click",this.onNPCTalkHandler);
      }
      
      private function onNPCTalkHandler(param1:MouseEvent) : void
      {
         var evt:MouseEvent = param1;
         if(DateUtil.isInTime(new Date(2014,7,29,6),new Date(2014,8,11,23)) && DateUtil.isInHourScope(14,15,30,30))
         {
            if(_keyCount == 4)
            {
               SceneManager.changeScene(1,1041);
            }
            else
            {
      ...
      private function startPlay() : void
      {
         ...
         this._citieMC.addEventListener("click",this.onClickCitieHandler);
      }
      ...
      private function onClickCitieHandler(param1:MouseEvent) : void
      {
         ...
         this._citieMC.addEventListener("enterFrame",this.onIsHitHandler);
      }
      ...
      private function onIsHitHandler(param1:Event) : void
      {
         ...
         {
            this._citieMC.removeEventListener("enterFrame",this.onIsHitHandler);
            this._citieMC.removeEventListener("click",this.onClickCitieHandler);
            Mouse.show();
      ...
      {
         this.clearPath(1);
         ServerBufferManager.updateServerBuffer(285,1,_keyCount);
         this.initStep2();
      }
      ...
      private function initStep2() : void
      {
         ...
         this._letter1.addEventListener("click",this.openLetterHandler);
      }
      ...
      private function openLetterHandler(param1:MouseEvent) : void
      {
         ...
         closeBtn.addEventListener("click",function(param1:MouseEvent):void
         {
      ...
      private function initDoor() : void
      {
         ...
         this._doorMC.addEventListener("click",this.onOpenDoorHandler);
      }
      ...
      private function initStep3() : void
      {
         ...
         this._btn1MC.addEventListener("click",this.onOpenRoadHandler);
      }
      
      private function onOpenRoadHandler(param1:MouseEvent) : void
      {
         this._btn1MC.removeEventListener("click",this.onOpenRoadHandler);
         this.step3Clear();
         this.clearPath(3);
         ServerBufferManager.updateServerBuffer(285,1,_keyCount);
         this.initStep4();
      ...
      private function initStep4() : void
      {
         ...
         this._letter2.addEventListener("click",this.openLetter2Handler);
      }
      ...
      private function initBtn() : void
      {
         ...
         this._lightBtn1MC.addEventListener("click",this.onCloseLightHandler);
      }
      
      private function onCloseLightHandler(param1:MouseEvent) : void
      {
         this._lightBtn1MC.removeEventListener("click",this.onCloseLightHandler);
         ...
         this._lightBtn2MC.addEventListener("click",this.onOnLightHandler);
      ...
      {
         this._lightBtn2MC.removeEventListener("click",this.onOnLightHandler);
      ...
      private function onClosePanel(param1:ModuleEvent) : void
      {
         ...
         this.clearPath(4);
         ServerBufferManager.updateServerBuffer(285,1,_keyCount);
         StatisticsManager.sendNovice("0x10033398");
      }
      ...
      private function getURL(param1:Function = null) : void
      {
         ...
         var url:String = URLUtil.getActivityAnimation("machine/letter");
