package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_1310 extends TitleMapProcessor
   {
      ...
      private function initMushroom() : void
      {
         ...
         this._mushroomBig.addEventListener("enterFrame",this.onEnterFrame);
         this._mushroomBig.addEventListener("click",this.onClick);
      }
      ...
      private function initEye() : void
      {
         ...
         this._eye.addEventListener("enterFrame",this.onEnterFrame);
         this._eye.addEventListener("mouseOver",this.onEyeOver);
         this._eye.addEventListener("mouseOut",this.onEyeOut);
      }
      
      private function initFruits() : void
      {
         this._fruitsMC = _map.content["fruits"];
         this._fruitsMC.addEventListener("fruitsReward1A",this.onFruitsReward);
      }
      
      private function onFruitsReward(param1:Event) : void
      {
         this._fruitsMC.removeEventListener("fruitsReward1A",this.onFruitsReward);
      ...
      {
         this._mushroomBig.removeEventListener("enterFrame",this.onEnterFrame);
         this._mushroomBig.removeEventListener("click",this.onClick);
         this._eye.removeEventListener("enterFrame",this.onEnterFrame);
         this._eye.removeEventListener("mouseOver",this.onEyeOver);
         this._eye.removeEventListener("mouseOut",this.onEyeOut);
      }
