package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_223 extends DreamMapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         {
            this._dialog.addEventListener("enterFrame",this.onDialogEnd);
      ...
      private function onDialogEnd(param1:Event) : void
      {
         ...
         {
            this._dialog.removeEventListener("enterFrame",this.onDialogEnd);
            this._hotArea.buttonMode = true;
            this._hotArea.addEventListener("click",this.onPetClick);
         }
      }
      ...
      private function startFight() : void
      {
         ...
         Connection.send(CommandSet.GET_DREAM_REWAED_1053,418,_taskId);
      }
      ...
      {
         this._hotArea.removeEventListener("click",this.onPetClick);
         this._hotArea = null;
         this._dialog.removeEventListener("enterFrame",this.onDialogEnd);
         this._dialog = null;
         super.dispose();
