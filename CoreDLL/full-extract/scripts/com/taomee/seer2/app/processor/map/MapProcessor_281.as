package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_281 extends MapProcessor
   {
      ...
      {
         this.initFire();
         StatisticsManager.sendNovice("0x10033440");
      }
      ...
      private function initFire() : void
      {
         ...
         this.fire1MC.addEventListener("fireReward281_1",this.onfireReward1);
         this.fire2MC.addEventListener("fireReward281_2",this.onfireReward2);
      }
      
      private function onfireReward1(param1:Event) : void
      {
         this.fire1MC.removeEventListener("fireReward281_1",this.onfireReward1);
      ...
      {
         this.fire2MC.removeEventListener("fireReward281_2",this.onfireReward2);
