package com.taomee.seer2.app.processor.quest.handler.story.quest13
{
   ...
   public class QuestMapHandler_13_5206 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         if(SceneManager.prevSceneType == 2 && QuestManager.isStepComplete(_quest.id,2) == false && fightIndex == 1)
         {
            if(FightManager.fightWinnerSide == 1 && fightIndex == 1)
            {
               this.win();
            }
            else
      ...
      private function noWin() : void
      {
         ...
         this._mc_6.y = 200;
         _processor.showMouseHintAt(150,30);
         this._mc_6.addEventListener("click",this.onMC6Click);
      }
      ...
      private function onMC6Click(param1:MouseEvent) : void
      {
         ...
         this._mc_6.removeEventListener("click",this.onMC6Click);
      ...
      override public function processMapDispose() : void
      {
         ...
         if(this._mc_6)
         {
            this._mc_6.removeEventListener("click",this.onClickInteractive);
