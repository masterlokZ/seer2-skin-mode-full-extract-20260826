package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_540 extends MapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         var _loc2_:Teleport = AnimateElementManager.getElement(4) as Teleport;
         ...
         StatisticsManager.sendNovice("0x10033446");
      ...
      private function initMika() : void
      {
         ...
         ServerBufferManager.getServerBuffer(193,this.onGetQuestIndex);
      }
      ...
      public function onGetQuestIndex(param1:ServerBuffer) : void
      {
         ...
         if(serverBuffer.readDataAtPostion(5) != 0)
         {
            ...
            this._mika.addEventListener("click",this.mikaFight);
         }
         this._mika.visible = false;
      }
      ...
      private function initBingSwap() : void
      {
         ...
         this._bing1.addEventListener("bingReward540_0",this.onSwap1);
         this._bing2 = _map.content["bing"];
         this._bing2.addEventListener("bingReward540_1",this.onSwap2);
         this._bing3 = _map.content["bing1"];
         this._bing3.addEventListener("bingReward540_2",this.onSwap3);
      }
      
      private function onSwap1(param1:Event) : void
      {
         this._bing1.removeEventListener("bingReward540_0",this.onSwap1);
      ...
      {
         this._bing2.removeEventListener("bingReward540_1",this.onSwap2);
         if(SwapManager.isSwapNumberMax(213))
         {
            SwapManager.entrySwap(213);
         }
      ...
      {
         this._bing3.removeEventListener("bingReward540_2",this.onSwap3);
      ...
      override public function dispose() : void
      {
         ...
         if(this._bing2)
         {
            this._bing2.removeEventListener("bingReward540_2",this.onSwap3);
            this._bing2 = null;
         }
         if(this._PrizeMC)
         {
