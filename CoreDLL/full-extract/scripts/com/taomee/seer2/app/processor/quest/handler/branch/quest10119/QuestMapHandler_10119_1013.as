package com.taomee.seer2.app.processor.quest.handler.branch.quest10119
{
   ...
   public class QuestMapHandler_10119_1013 extends QuestMapHandler
   {
      ...
      private function initUI() : void
      {
         ...
         this._questUi["petking"].addEventListener("click",this.unlockPetKing);
         this._questUi["b1"].addEventListener("click",this.ballStartMove);
         this._questUi["b2"].addEventListener("click",this.ballStartMove);
         this._questUi["b3"].addEventListener("click",this.ballStartMove);
         ...
         if(null == this._timer)
         {
            ...
            this._timer.addEventListener("timer",this.changeProgressBaseState);
         }
      ...
      private function ballStartMove(param1:MouseEvent) : void
      {
         ...
         mc.removeEventListener("click",this.ballStartMove);
