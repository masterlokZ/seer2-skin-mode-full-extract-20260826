package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80341 extends MapProcessor
   {
      ...
      {
         if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord.initData.positionIndex == 1331)
         {
      ...
      {
         ItemManager.addEventListener1("requestSpecialItemSuccess",this.getItemNum);
      ...
      private function getItemNum(param1:ItemEvent) : void
      {
         ...
         ItemManager.removeEventListener1("requestSpecialItemSuccess",this.getItemNum);
      ...
      private function onNpcClick(param1:MouseEvent) : void
      {
         ...
         {
            FightManager.startFightWithWild(1331);
         }
         else
         {
