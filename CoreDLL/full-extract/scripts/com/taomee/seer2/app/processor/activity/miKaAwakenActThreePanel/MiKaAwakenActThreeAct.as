package com.taomee.seer2.app.processor.activity.miKaAwakenActThreePanel
{
   ...
   public class MiKaAwakenActThreeAct
   {
               ...
               this.getURL(function():void
               {
                  ...
                  if(gameHandleState == 2)
                  {
                     ...
                     MovieClipUtil.playMc(_sceneMc,2,32,function():void
                     {
                        ...
                        (_sceneMc["mouse0"] as MovieClip).addEventListener("click",onMouseClick0);
                     },true);
                  }
                  else
                  {
      ...
      private function onMouseClick0(param1:MouseEvent) : void
      {
         ...
         (this._sceneMc["mouse0"] as MovieClip).removeEventListener("click",this.onMouseClick0);
         MovieClipUtil.playMc(this._sceneMc,this._sceneMc.currentFrame,699,function():void
         {
            ...
            (_sceneMc["mouse1"] as MovieClip).addEventListener("click",onMouseClick1);
         },true);
      }
      ...
      {
         var evt:MouseEvent = param1;
         (this._sceneMc["mouse1"] as MovieClip).removeEventListener("click",this.onMouseClick1);
      ...
      private function getURL(param1:Function = null) : void
      {
         ...
         QueueLoader.load(URLUtil.getActivityAnimation("miKaAwakenAct/MiKaAwakenAct3"),"swf",function(param1:ContentInfo):void
         {
