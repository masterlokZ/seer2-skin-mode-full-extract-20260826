package com.taomee.seer2.app.processor.quest.handler.main.quest82
{
   ...
   public class QuestMapHandler_82_80361 extends QuestMapHandler
   {
      ...
      private var fightFirstID:Array = [1372];
      ...
      private function initStep1Complete() : void
      {
         ...
         QuestManager.addEventListener("stepComplete",this.onComplete1);
      }
      
      private function onComplete1(param1:QuestEvent) : void
      {
         QuestManager.removeEventListener("stepComplete",this.onComplete1);
         this.initStep2();
      }
      ...
      private function createNpc() : void
      {
         ...
         if(!this._npc)
         {
            this._npc = MobileManager.getMobile(1021,"npc");
               ...
               NpcDialog.show(400,"小赛尔",[[0,"好……强……"]],["……"],[function():void
               {
                  NpcDialog.show(1022,"阿修雷",[[1,"此战，毁灭者胜！切，你们居然这么弱！好吧，既然这样，你们先和低级的精灵打打吧！"]],["……"],[function():void
                  {
                     MovieClipUtil.playFullScreen(URLUtil.getQuestFullScreenAnimation("82_1"),function():void
                     {
                        ...
                        QuestManager.addEventListener("stepComplete",onComplete2);
                     },false);
                  }]);
               }]);
            }
      ...
      {
         this._mc1 = null;
         QuestManager.removeEventListener("stepComplete",this.onComplete2);
         this.initStep3();
      }
      ...
      private function createNpc1() : void
      {
         ...
         if(!this._npc)
         {
            ...
            _loc1_.y = -120;
            this._npc.addChild(_loc1_);
            this._npc.addEventListener("click",this.initStep3Continue);
         }
      }
      ...
      override public function processMapDispose() : void
      {
         ...
         if(this._npc)
         {
            this._npc.removeEventListener("click",this.initStep2Continue);
         }
         this._npc = null;
