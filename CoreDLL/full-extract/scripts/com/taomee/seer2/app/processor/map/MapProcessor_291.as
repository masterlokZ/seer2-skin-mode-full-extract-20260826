package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_291 extends TitleMapProcessor
   {
      ...
      override public function init() : void
      {
         this.initFire();
         this.initGame();
         StatisticsManager.sendNovice("0x10033444");
      }
      ...
      {
         StatisticsManager.sendNovice("0x1003356C");
         ModuleManager.toggleModule(URLUtil.getAppModule("MiniGameIntroPanel"),"正在打开小游戏...",{"gameId":11});
      }
      ...
      private function initFire() : void
      {
         ...
         this.diamond1MC.addEventListener("diamondReward291_1",this.onDiamondReward1);
         this.diamond3MC.addEventListener("diamondReward291_3",this.onDiamondReward3);
         this.diamond4MC.addEventListener("diamondReward291_4",this.onDiamondReward4);
      }
      
      private function onDiamondReward1(param1:Event) : void
      {
         this.diamond1MC.removeEventListener("diamondReward291_1",this.onDiamondReward1);
      ...
      {
         this.diamond3MC.removeEventListener("diamondReward291_3",this.onDiamondReward3);
      ...
      {
         this.diamond4MC.removeEventListener("diamondReward291_4",this.onDiamondReward4);
