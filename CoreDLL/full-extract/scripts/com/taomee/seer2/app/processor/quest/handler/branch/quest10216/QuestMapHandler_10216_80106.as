   ...
   public class QuestMapHandler_10216_80106 extends QuestMapHandler
   {
      ...
      override public function processMapDispose() : void
      {
         ...
         if(this._forwardBtn)
         {
            ...
            this._forwardBtn.removeEventListener("click",this.forwardHandler);
         }
      }
      ...
      private function createBtn() : void
      {
         ...
         var _loc1_:Mobile = MobileManager.getMobile(684,"npc");
         if(_loc1_)
         {
            _loc1_.visible = false;
         }
         _loc1_ = MobileManager.getMobile(678,"npc");
         if(_loc1_)
         {
            _loc1_.visible = false;
         }
         ...
         if(!this._forwardBtn.hasEventListener("click"))
         {
            this._forwardBtn.addEventListener("click",this.forwardHandler);
         }
