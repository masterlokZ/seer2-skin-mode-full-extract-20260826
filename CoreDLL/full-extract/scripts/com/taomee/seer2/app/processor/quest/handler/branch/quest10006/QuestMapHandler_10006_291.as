package com.taomee.seer2.app.processor.quest.handler.branch.quest10006
{
   ...
   public class QuestMapHandler_10006_291 extends BranchQuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         _npc.removeEventListener("click",this.onQuestClick);
      ...
      {
         _npc.gotoAndPlay(1);
         _npc.addEventListener("enterFrame",this.onNpcFrame);
      }
      ...
      private function onNpcFrame(param1:Event) : void
      {
         ...
         {
            _npc.removeEventListener("enterFrame",this.onNpcFrame);
            _npc.stop();
            this._laugh = _processor.resLib.getMovieClip("mc_1");
            _map.ground.addChild(this._laugh);
            _npc.addEventListener("click",this.onQuestClick);
         }
      }
      ...
      private function openStoneClick() : void
      {
         ...
         {
            this._stoneBtn.addEventListener("click",this.onStoneClick);
      ...
      private function onStoneClick(param1:MouseEvent) : void
      {
         ...
         this._makeStone.addEventListener("close",this.onCloseAnimation);
         this._makeStone.addEventListener("stone",this.onMakeBubbleOver);
      }
      
      private function onCloseAnimation(param1:Event) : void
      {
         this._makeStone.removeEventListener("close",this.onCloseAnimation);
         this._makeStone.removeEventListener("stone",this.onMakeBubbleOver);
      }
      ...
      {
         var _loc1_:String = URLUtil.getQuestFullScreenAnimation("10006_0");
      ...
      private function clearStone() : void
      {
         if(this._stoneBtn)
         {
            this._stoneBtn.removeEventListener("click",this.onStoneClick);
