   ...
   public class QuestMapHandler_17_90 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         if(QuestManager.isStepComplete(_quest.id,2) && QuestManager.isStepComplete(_quest.id,3) == false)
         {
            ...
            this._carpetTrigger.addEventListener("click",this.onClick);
      ...
      {
         this._carpetTrigger.removeEventListener("click",this.onClick);
         _processor.hideMouseClickHint();
         this._carpetMc.addEventListener("enterFrame",this.onEnterFrame);
      }
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         {
            this._carpetMc.removeEventListener("enterFrame",this.onEnterFrame);
