package com.taomee.seer2.app.processor.activity.rainOfSunAct
{
   ...
   public class RainOfSunActThree
   {
      ...
      {
         QueueLoader.load(URLUtil.getActivityAnimation("rainOfSunAct/RainOfSunActThree"),"swf",function(param1:ContentInfo):void
         {
      ...
      {
         this._npc = MobileManager.getMobile(487,"npc");
      ...
      private function isInHourScope(param1:Array, param2:Array) : Boolean
      {
         ...
         var _loc3_:Date = new Date(2013,7,24,14,param2[0],param2[1]);
      ...
      private function onNpcClick(param1:MouseEvent) : void
      {
         ...
         NpcDialog.show(487,"米咔",[[2,"最近听说太阳神出动，天空下着神奇的太阳雨。我这里也恰好捡到一些，和我对战就可以给你一点哟。"]],["开始对战","准备一下"],[function():void
         {
            FightManager.startFightWithWild(572);
         }]);
      }
      ...
      private function blueRainHandleInit() : void
      {
         ...
         ActiveCountManager.requestActiveCount(1,function(param1:int, param2:int):void
         {
            _isGet = Boolean(param2);
            _blueRain.addEventListener("click",onSwap);
         });
      }
      ...
      private function clearBlueRain() : void
      {
         if(this._blueRain)
         {
            this._blueRain.removeEventListener("click",this.onSwap);
      ...
      private function onSwap(param1:MouseEvent) : void
      {
         ...
         if(!this._isGet)
         {
            SwapManager.swapItem(1,1,function(param1:IDataInput):void
            {
               new SwapInfo(param1);
               _isGet = true;
            });
