package com.taomee.seer2.app.processor.activity.xiaolv
{
   ...
   public class XiaolvManager
   {
      ...
      {
         DialogPanel.addEventListener("customUnitClick",showNpcChallengePanel);
         _npc = MobileManager.getMobile(534,"npc");
         _npc.buttonMode = true;
         _npc.addEventListener("click",onNpc,false,1);
      ...
      private static function onNpc(param1:MouseEvent) : void
      {
         ...
         StatisticsManager.sendNovice("0x1003359B");
      }
      ...
      {
         DialogPanel.removeEventListener("customUnitClick",showNpcChallengePanel);
