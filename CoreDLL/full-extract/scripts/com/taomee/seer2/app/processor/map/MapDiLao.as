package com.taomee.seer2.app.processor.map
{
   ...
   public class MapDiLao
   {
      ...
      private static const timeBetweenLayer:Array = [0,5,10,20,30,1440];
      ...
      public function dispose() : void
      {
         ...
         if(this.petList)
         {
            ...
            {
               this.petList[_loc1_].removeEventListener("click",this.toFight);
               MobileManager.removeMobile(this.petList[_loc1_],"modelPet");
               _loc1_++;
            }
         }
      ...
      {
         QueueLoader.load(URLUtil.getActivityAnimation("mapLayerGame/MapLayerGameDiLao"),"swf",function(param1:ContentInfo):void
         {
      ...
      private function test() : void
      {
         ...
         MovieClipUtil.playMc(mc,1,mc.totalFrames,function():void
         {
            ...
            {
               SceneManager.changeScene(1,1221);
            });
         });
      }
      ...
      private function addPets() : void
      {
         ...
         {
            _loc1_ = new Mobile();
            this.petList.push(_loc1_);
            this.petList[_loc3_].resourceUrl = URLUtil.getNpcSwf(_loc2_);
            this.petList[_loc3_].buttonMode = true;
            this.petList[_loc3_].addEventListener("click",this.toFight);
            this.petList[_loc3_].setPostion(Positions[_loc3_]);
            MobileManager.addMobile(this.petList[_loc3_],"npc");
            _loc3_++;
         }
      }
