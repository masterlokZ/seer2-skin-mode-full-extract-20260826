package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80386 extends MapProcessor
   {
      ...
      {
         ActiveCountManager.requestActiveCountList([205469,205472],function(param1:Parser_1142):void
         {
            var par:Parser_1142 = param1;
            itemNum = par.infoVec[1];
            DayLimitManager.getDoCount(1564,function(param1:uint):void
            {
               leftCount = ActsHelperUtil.getCanNum(param1,par.infoVec[0],1);
            });
         });
      }
      ...
      private function initEvent() : void
      {
         ...
         this._hurtBuy.addEventListener("click",this.onHurtBuy);
      ...
      private function removeEvent() : void
      {
         ...
         if(this._hurtBuy)
         {
            this._hurtBuy.removeEventListener("click",this.onHurtBuy);
            this._hurtBuy = null;
         }
         if(this._leave)
         {
      ...
      private function onHurtBuy(param1:MouseEvent) : void
      {
         ...
         ActiveCountManager.requestActiveCount(205471,function(param1:uint, param2:uint):void
         {
            var t:uint = param1;
            var c:uint = param2;
            ...
            {
               ShopManager.buyItemForId(500622,function():void
               {
      ...
      private function onNpcClick(param1:MouseEvent) : void
      {
         ...
         if(this.leftCount <= 0)
         {
            ShopManager.buyItemForId(605374,function():void
            {
               FightManager.startFightWithBoss(1449);
            });
         }
         else
         {
      ...
      {
         var evt:MouseEvent = param1;
         ShopManager.buyItemForId(605375,function():void
         {
