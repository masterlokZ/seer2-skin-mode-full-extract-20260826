package com.taomee.seer2.app.processor.map
{
   ...
   public class HuanBeastChapter2Map extends MapProcessor
   {
      ...
      protected var needGoods:Array = [5,5,10,1];
      
      protected var petIds:Array = [13,72,36,82];
      
      private var items:Array = [400285,400286,400287,400288];
      
      private var fights:Array = [318,319,320,321];
      
      private var maps:Array = [1312,2112,3012,3701];
      ...
      {
         super.dispose();
         ItemManager.removeEventListener("serverItemGiven",this.requestItemNum);
      }
      ...
      private function createMonster() : void
      {
         ...
         while(_loc2_ < 5)
         {
            _loc1_ = new SpawnedPet(this.petIds[this.currentIndex],this.fights[this.currentIndex],0);
