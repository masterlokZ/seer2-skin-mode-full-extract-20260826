package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_193 extends TitleMapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         StatisticsManager.sendNovice("0x10033425");
      }
      ...
      private function reward() : void
      {
         ...
         this._flowerSing.addEventListener("flowerReward3",this.onFlowerReward);
      }
      ...
      private function onFlowerReward(param1:Event) : void
      {
         if(this._flowerSing)
         {
            this._flowerSing.removeEventListener("flowerReward3",this.onFlowerReward);
      ...
      {
         if(this._flowerSing.hasEventListener("flowerReward3"))
         {
            this._flowerSing.removeEventListener("flowerReward3",this.onFlowerReward);
         }
