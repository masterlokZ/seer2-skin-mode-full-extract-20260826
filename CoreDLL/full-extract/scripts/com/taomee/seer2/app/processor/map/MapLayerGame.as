package com.taomee.seer2.app.processor.map
{
   ...
   public class MapLayerGame
   {
      ...
      private static const timeBetweenLayers:Array = [0,5,10,20,30,1440];
      ...
      public function dispose() : void
      {
         if(this._popMc)
         {
            this._popMc.removeEventListener("click",this.onPop);
         ...
         {
            this._skipTimeBtn.removeEventListener("click",this.onSkip);
      ...
      {
         QueueLoader.load(URLUtil.getActivityAnimation("mapLayerGame/MapLayerGame"),"swf",function(param1:ContentInfo):void
         {
      ...
      private function initMap() : void
      {
         ...
         this._popMc.x = 637;
         this._popMc.y = 185;
         this._popMc.addEventListener("click",this.onPop);
         ActiveCountManager.requestActiveCountList([203299,203300],function(param1:Parser_1142):void
         {
      ...
      private function onPop(param1:MouseEvent) : void
      {
         ...
         {
            SceneManager.changeScene(1,mapId[this._currentLayer]);
         }
      }
      ...
      private function addTxtAndBtn() : void
      {
         ...
         this._skipTimeBtn.addEventListener("click",this.onSkip);
      }
      ...
      {
         this.shi = this._timeLeftCount / 3600;
         this.fen = (this._timeLeftCount - 3600 * this.shi) / 60;
