package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80182 extends MapProcessor
   {
      ...
      {
         this.addOpenVip();
         if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord.initData.positionIndex == 943)
         {
            ActiveCountManager.requestActiveCountList([204080,204084],function(param1:Parser_1142):void
            {
      ...
      private function onNpcClick(param1:MouseEvent) : void
      {
         ...
         {
            FightManager.startFightWithWild(943);
         }]);
      }
