package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_192 extends TitleMapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         this.reward();
         this.initGame();
         StatisticsManager.sendNovice("0x10033424");
      }
      ...
      private function initGame() : void
      {
         ...
         this._gameMc.addEventListener("click",this.onGame);
         TooltipManager.addGameTip(this._gameMc,"影子大战");
      }
      
      private function onGame(param1:MouseEvent) : void
      {
         ModuleManager.toggleModule(URLUtil.getAppModule("MiniGameIntroPanel"),"正在打开小游戏...",{"gameId":9});
      }
      ...
      private function initBubbleStone() : void
      {
         ...
         this._bubbleStone.addEventListener("click",this.onStoneClick);
      }
      ...
      private function onStoneClick(param1:MouseEvent) : void
      {
         ...
         this._bubbleStone.removeEventListener("click",this.onStoneClick);
      ...
      private function reward() : void
      {
         ...
         this.flower.addEventListener("flowerReward2",this.onFlowerReward);
      }
      
      private function onFlowerReward(param1:Event) : void
      {
         this.flower.removeEventListener("flowerReward2",this.onFlowerReward);
      ...
      override public function dispose() : void
      {
         ...
         if(this._gameMc)
         {
            ...
            this._gameMc.removeEventListener("click",this.onGame);
         }
         super.dispose();
      }
   }
