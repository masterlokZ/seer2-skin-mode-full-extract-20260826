package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_152 extends TitleMapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         StatisticsManager.sendNovice("0x1003341C");
         this.initFishNpc();
      }
      ...
      private function initFishNpc() : void
      {
         ...
         _loc1_.y -= 90;
         this.npcMobile.addEventListener("click",this.toDia);
         this.npcMobile.setPostion(new Point(530,320));
         MobileManager.addMobile(this.npcMobile,"npc");
      }
      ...
      override public function dispose() : void
      {
         ...
         this.npcMobile.removeEventListener("click",this.toDia);
      }
   }
}
