package com.taomee.seer2.app.processor.quest.handler.branch.quest10002
{
   ...
   public class QuestMapHandler_10002_151 extends BranchQuestMapHandler
   {
      ...
      private function createInteractive() : void
      {
         ...
         var _loc2_:Vector.<Point> = Vector.<Point>([new Point(120,164),new Point(272,204),new Point(170,330),new Point(190,400),new Point(403,367)]);
         ...
         while(_loc1_ < 5)
         {
            ...
            _loc3_.addEventListener("click",this.onStoneClick);
            _loc3_.x = _loc2_[_loc1_].x;
            _loc3_.y = _loc2_[_loc1_].y;
      ...
      private function onStoneClick(param1:MouseEvent) : void
      {
         ...
         if(QuestManager.isAccepted(_questId))
         {
            ...
            _loc2_.removeEventListener("click",this.onStoneClick);
      ...
      private function clearStone() : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this._stoneVec.length)
         {
            _loc1_ = this._stoneVec[_loc2_];
