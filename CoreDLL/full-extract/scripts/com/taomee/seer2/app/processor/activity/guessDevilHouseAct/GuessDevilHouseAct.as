package com.taomee.seer2.app.processor.activity.guessDevilHouseAct
{
   ...
   public class GuessDevilHouseAct
   {
      ...
      private function initSet() : void
      {
         ...
         {
            this._map.content.stage.addEventListener("click",this.onStageClick);
            this._map.content.stage.addEventListener("mouseMove",this.onDragMC);
         }
         this._leave.addEventListener("click",this.onLeave);
         this._pet.addEventListener("click",this.onPet);
      }
      ...
      public function dispose() : void
      {
         ...
         this._pet.removeEventListener("click",this.onPet);
         DisplayObjectUtil.removeFromParent(this._pet);
         if(Boolean(this._map.content) && Boolean(this._map.content.stage))
         {
            this._map.content.stage.removeEventListener("mouseMove",this.onDragMC);
            this._map.content.stage.removeEventListener("click",this.onStageClick);
         }
         this._leave = null;
         if(this._dragMC)
         {
