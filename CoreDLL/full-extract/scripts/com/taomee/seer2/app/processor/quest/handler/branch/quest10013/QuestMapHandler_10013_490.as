package com.taomee.seer2.app.processor.quest.handler.branch.quest10013
{
   ...
   public class QuestMapHandler_10013_490 extends BranchQuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         initNpc(_loc1_);
         tip = "";
         if(SceneManager.prevSceneType == 2 && QuestManager.isAccepted(10013) && QuestManager.isStepComplete(10013,1) == false && _fightIndex == 1)
         {
            if(FightManager.fightWinnerSide == 1 && _fightIndex == 1)
            {
      ...
      {
         var _loc2_:XML = <dialog npcId="436" npcName="砂砂" transport=""><branch id="default"><node emotion="0"><![CDATA[我，我不行的，我果然是一根没用的响尾蛇！]]></node><reply action="close" params="yes"><![CDATA[别放弃，再来一次！]]></reply><reply action="close" params="no"><![CDATA[还是算了。]]></reply></branch></dialog>;
