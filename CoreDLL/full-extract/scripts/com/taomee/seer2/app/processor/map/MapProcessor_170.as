package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_170 extends TitleMapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         this.initOpen();
         this.initTeleport();
         StatisticsManager.sendNovice("0x10033426");
      }
      ...
      private function initOpen() : void
      {
         ...
         this._storeTrigger.addEventListener("click",this.onStoreClick);
      }
      ...
      private function onStoreClick(param1:Event) : void
      {
         ...
         this._pieceTrigger.addEventListener("click",this.onPieceClick);
         closeInteractor(this._storeTrigger);
         this._openSkill.gotoAndPlay("点击");
         this._storeTrigger.removeEventListener("click",this.onStoreClick);
      }
      
      private function onPieceClick(param1:MouseEvent) : void
      {
         closeInteractor(this._pieceTrigger);
         this._pieceTrigger.removeEventListener("click",this.onPieceClick);
      ...
      private function initOctopus() : void
      {
         ...
         this._octopusCrawlTrigger.addEventListener("click",this.onOctopusClick);
         this._octopusCrawl.addEventListener("enterFrame",this.resetOctopus);
      }
      ...
      private function onOctopusClick(param1:MouseEvent) : void
      {
         ...
         this._octopusCrawlTrigger.removeEventListener("click",this.onOctopusClick);
         this._octopusCrawl.gotoAndPlay("跑掉了");
      }
      
      override public function dispose() : void
      {
         this._octopusCrawl.removeEventListener("enterFrame",this.resetOctopus);
