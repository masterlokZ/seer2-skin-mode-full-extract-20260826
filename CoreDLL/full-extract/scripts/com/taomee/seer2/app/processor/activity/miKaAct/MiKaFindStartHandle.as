package com.taomee.seer2.app.processor.activity.miKaAct
{
   ...
   public class MiKaFindStartHandle
   {
      ...
      public function MiKaFindStartHandle(param1:MapModel)
      {
         ...
         if(this.isActTime())
         {
            this.getURL(function():void
            {
               ...
               _mikaMail.x = 928;
               _mikaMail.y = 526;
               _mikaMail.addEventListener("click",onMiKaMailClick);
            });
         }
      }
      ...
      private function getURL(param1:Function = null) : void
      {
         ...
         QueueLoader.load(URLUtil.getActivityAnimation("miKaFindAct/miKaFindActRes0"),"swf",function(param1:ContentInfo):void
         {
      ...
      public function dispose() : void
      {
         if(this._mikaMail)
         {
            this._mikaMail.removeEventListener("click",this.onMiKaMailClick);
            this._mikaMail = null;
         }
         this._map = null;
         this._resLib = null;
