package com.taomee.seer2.app.processor.quest.handler.branch.quest10003
{
   ...
   public class QuestMapHandler_10003_131 extends BranchQuestMapHandler
   {
      ...
      private function addEventListenerColorBtn() : void
      {
         ...
         this._colorBtn.addEventListener("click",this.onColorBtn);
      }
      ...
      private function removeEventListenerColorBtn() : void
      {
         ...
         this._colorBtn.removeEventListener("click",this.onColorBtn);
      }
      ...
      private function onColorBtn(param1:MouseEvent) : void
      {
         ...
         this._makeColor.addEventListener("makeColor",this.onMakeColor);
         this._makeColor.addEventListener("close",this.onCloseAnimation);
      }
      ...
      private function clearMakeColorAnimation() : void
      {
         if(this._makeColor)
         {
            this._makeColor.removeEventListener("makeColor",this.onMakeColor);
            this._makeColor.removeEventListener("close",this.onCloseAnimation);
         }
      }
