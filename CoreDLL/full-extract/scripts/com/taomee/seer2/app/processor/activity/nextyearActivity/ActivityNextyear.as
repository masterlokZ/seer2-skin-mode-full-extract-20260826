package com.taomee.seer2.app.processor.activity.nextyearActivity
{
   ...
   public class ActivityNextyear
   {
      ...
      private var _startDate:uint = new Date(2014,8,9,14).getTime() / 1000;
      
      private var date:Date = new Date(TimeManager.getServerTime() * 1000);
      ...
      {
         this._npc = MobileManager.getMobile(462,"npc");
      }
