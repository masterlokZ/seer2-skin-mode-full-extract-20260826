package com.taomee.seer2.app.processor.quest.handler.branch.quest10009
{
   ...
   public class QuestMapHandler_10009_261 extends BranchQuestMapHandler
   {
      ...
      private function addEventListenerBtn() : void
      {
         ...
         this._leaveAloneBtn.addEventListener("click",this.onBtnClick);
      }
      ...
      private function removeEventListenerBtn() : void
      {
         ...
         this._leaveAloneBtn.gotoAndStop(1);
         this._leaveAloneBtn.removeEventListener("click",this.onBtnClick);
      }
      ...
      private function onBtnClick(param1:MouseEvent) : void
      {
         ...
         this._leaveAloneAnimation.addEventListener("leaveAlone",this.onLeaveAlone);
         this._leaveAloneAnimation.addEventListener("close",this.onCloseAnimation);
      }
      ...
      private function clearAnimation() : void
      {
         ...
         {
            this._leaveAloneAnimation.removeEventListener("leaveAlone",this.onLeaveAlone);
            this._leaveAloneAnimation.removeEventListener("close",this.onCloseAnimation);
         }
      }
