package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80323 extends FeiyuyiteMap
   {
      ...
      private var timeIndex:Array = [2,5,8];
      ...
      {
         var _loc6_:Array = [13,18,21];
         var _loc5_:Date = new Date(TimeManager.getServerTime() * 1000);
         var _loc8_:int = _loc5_.month;
         var _loc7_:int = _loc5_.date;
         ...
         while(_loc3_ < 3)
         {
            if(_loc1_ <= 30 && _loc2_ == _loc6_[_loc3_])
            {
               _loc4_ = true;
               this.index = _loc3_;
            }
      ...
      private function addEvent() : void
      {
         ...
         this._mobiles[0].addEventListener("click",this.toFight);
         this._mobiles[0].setPostion(Positions[0]);
         this._mobiles[0].height = 100;
         MobileManager.addMobile(this._mobiles[0],"npc");
         DayLimitListManager.getDaylimitList([1954,1953],(function():*
         {
