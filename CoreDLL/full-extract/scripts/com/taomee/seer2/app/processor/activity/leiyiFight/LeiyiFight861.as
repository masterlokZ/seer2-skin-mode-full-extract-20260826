package com.taomee.seer2.app.processor.activity.leiyiFight
{
   ...
   public class LeiyiFight861
   {
      ...
      {
         if(PetInfoManager.hasEventListener("serverGetPet") == false)
         {
            PetInfoManager.addEventListener("serverGetPet",this.onServerGetPet);
         }
      ...
      private function onServerGetPet(param1:PetInfoEvent) : void
      {
         ...
         PetInfoManager.removeEventListener("serverGetPet",this.onServerGetPet);
         if(event.content == 90)
         {
      ...
      private function winOne(param1:uint) : void
      {
         ...
         this.playLoad(function():void
         {
            ...
            if(index == 2)
            {
               _leiyi.removeEventListener("click",onLeiyi);
               _leiyi.gotoAndStop(52);
               _leiyi.buttonMode = true;
               _leiyi.addEventListener("click",onLeiyiTwo);
            }
         });
      }
      ...
      {
         ServerBufferManager.getServerBuffer(14,this.getServer,false);
      }
      ...
      private function getServer(param1:ServerBuffer) : void
      {
         ...
         this.playLoad(function():void
         {
            if(bufIndex != 1)
            {
               ...
               {
                  ServerBufferManager.updateServerBuffer(14,0,1);
                  showLeiyi();
               },true,false,2);
            }
            else
      ...
      private function showLeiyi() : void
      {
         ...
         this._leiyi.addEventListener("click",this.onLeiyi);
      }
      ...
      {
         ServerBufferManager.getServerBuffer(14,this.getServerTwo,false);
      }
      ...
      private function getServerTwo(param1:ServerBuffer) : void
      {
         ...
         this.playLoad(function():void
         {
            ...
            if(bufIndex != 1)
            {
               ...
               {
                  ServerBufferManager.updateServerBuffer(14,1,1);
                  _leiyi.buttonMode = true;
                  _leiyi.addEventListener("click",onLeiyiTwo);
               },true);
            }
      ...
      private function playLoad(param1:Function) : void
      {
         ...
         {
            url = URLUtil.getActivityAnimation("leiyiFight/leiyiFight");
      ...
      public function dispose() : void
      {
         ...
         if(this._leiyi)
         {
            this._leiyi.removeEventListener("click",this.onLeiyi);
            this._leiyi.removeEventListener("click",this.onLeiyiTwo);
         }
         DisplayUtil.removeForParent(this._leiyi);
         this._leiyi = null;
         this._cloudMC = null;
