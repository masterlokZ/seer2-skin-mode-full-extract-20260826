package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_8502 extends MapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         this.openPanel.addEventListener("click",this.onopenPanel);
      ...
      {
         ActiveCountManager.requestActiveCountList([203205,203206],function(param1:Parser_1142):void
         {
      ...
      private function checkDisplay() : void
      {
         ...
         {
            this.timeMc.visible = false;
            this.machine.addEventListener("click",this.onClick);
         }
      }
      ...
      private function onTimer(param1:TimerEvent) : void
      {
         ...
         {
            this.shi = this.leftTime / 3600;
            this.fen = (this.leftTime - this.shi * 3600) / 60;
      ...
      private function getSpecialItem(param1:ItemEvent) : void
      {
         ...
         {
            SceneManager.changeScene(1,1900);
         }
      }
      ...
      {
         this.openPanel.removeEventListener("click",this.onopenPanel);
         this.machine.removeEventListener("click",this.onClick);
         if(this.timer)
         {
            this.timer.stop();
            this.timer.removeEventListener("timer",this.onTimer);
