package com.taomee.seer2.app.processor.quest.handler.branch.quest10135
{
   ...
   public class QuestMapHandler_10135_891 extends QuestMapHandler
   {
      ...
      private function addFeetMC() : void
      {
         ...
         this._mc_0.addEventListener("click",this.onClickFeetHandler);
      }
      ...
      private function QAPanel() : void
      {
         ...
         ansB.gotoAndStop(1);
         ansC.gotoAndStop(1);
         ansA.addEventListener("click",function():void
         {
            ansA.gotoAndStop(2);
            QAWrong();
         });
         ansB.addEventListener("click",function():void
         {
            ansB.gotoAndStop(2);
            QAWrong();
         });
         ansC.addEventListener("click",function():void
         {
            ansC.gotoAndStop(2);
            QARight();
         });
         close_Btn.addEventListener("click",function():void
         {
            if(_mc_1)
            {
