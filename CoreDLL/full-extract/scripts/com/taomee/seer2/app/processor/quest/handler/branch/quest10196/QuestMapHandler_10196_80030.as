package com.taomee.seer2.app.processor.quest.handler.branch.quest10196
{
   ...
   public class QuestMapHandler_10196_80030 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         {
            this.addNewNpc();
            if(SceneManager.prevSceneType == 2 && this._fightStatusOne)
            {
         ...
         {
            this.addNewNpc();
            if(SceneManager.prevSceneType == 2 && this._fightStatusTwo)
            {
         ...
         {
            this.addNewNpc();
            if(SceneManager.prevSceneType == 2 && this._fightStatusThree)
            {
      ...
      private function showNpc() : void
      {
         ...
         this._npc.addEventListener("click",this.onNpcTalkHandler);
      }
      ...
      private function addNewNpc() : void
      {
         ...
         _map.content.addChild(this._npc);
         this._npc.buttonMode = true;
         this._npc.addEventListener("click",this.onNewNpcTalkHandler);
      }
      ...
      private function onNewNpcTalkHandler(param1:MouseEvent) : void
      {
         ...
         if(QuestManager.isAccepted(_quest.id) && !QuestManager.isStepComplete(_quest.id,1))
         {
            NpcDialog.show(192,"S",[[0,"刚刚发生了什么！这里怎么会突然有浓雾？"]],[],[function():void
            {
               ...
               {
                  addNote();
                  _note.addEventListener("click",onOpenNoteOneHandler);
               }]);
            }]);
         }
         if(QuestManager.isStepComplete(_quest.id,1) && !QuestManager.isStepComplete(_quest.id,2))
         {
            ...
            {
               addNote();
               _note.addEventListener("click",onOpenNoteTwoHandler);
            }]);
         }
         if(QuestManager.isStepComplete(_quest.id,2) && !QuestManager.isStepComplete(_quest.id,3))
         {
            ...
            {
               addNote();
               _note.addEventListener("click",onOpenNoteThreeHandler);
            }]);
         }
      }
      ...
      private function addNote() : void
      {
         ...
         this._npc.removeEventListener("click",this.onNewNpcTalkHandler);
         this.addMouse();
      ...
      private function onOpenNoteOneHandler(param1:MouseEvent) : void
      {
         ...
         this._mc0["ans1"].addEventListener("click",this.onNoteOneAnsOneHandler);
         this._mc0["ans2"].buttonMode = true;
         this._mc0["ans2"].addEventListener("click",this.onNoteOneAnsTwoHandler);
      }
      ...
      private function someoneTalk() : void
      {
         ...
         {
            QuestManager.addEventListener("stepComplete",onStepOneComplete);
      ...
      {
         QuestManager.removeEventListener("stepComplete",this.onStepOneComplete);
         this.addNoteTwo();
      }
      ...
      private function addNoteTwo() : void
      {
         ...
         _map.front.addChild(this._note);
         this._note.buttonMode = true;
         this._note.addEventListener("click",this.onOpenNoteTwoHandler);
      }
      ...
      private function onOpenNoteTwoHandler(param1:MouseEvent) : void
      {
         ...
         _map.front.addChild(this._mc0);
         this._mc0["ans1"].buttonMode = true;
         this._mc0["ans1"].addEventListener("click",this.onNoteTwoAnsOneHandler);
         this._mc0["ans2"].buttonMode = true;
         this._mc0["ans2"].addEventListener("click",this.onNoteTwoAnsTwoHandler);
      }
      ...
      private function someoneTalkAgain() : void
      {
         ...
         {
            QuestManager.addEventListener("stepComplete",onStepTwoComplete);
      ...
      {
         QuestManager.removeEventListener("stepComplete",this.onStepTwoComplete);
         this.addNoteThree();
      }
      ...
      private function addNoteThree() : void
      {
         ...
         _map.front.addChild(this._note);
         this._note.buttonMode = true;
         this._note.addEventListener("click",this.onOpenNoteThreeHandler);
      }
      ...
      private function onOpenNoteThreeHandler(param1:MouseEvent) : void
      {
         ...
         _map.front.addChild(this._mc0);
         this._mc0["ans1"].buttonMode = true;
         this._mc0["ans1"].addEventListener("click",this.onNoteThreeAnsOneHandler);
         this._mc0["ans2"].buttonMode = true;
         this._mc0["ans2"].addEventListener("click",this.onNoteThreeAnsTwoHandler);
      }
                           ...
                           NpcDialog.show(323,"S爸爸",[[0,"当我的意志彻底消失之时，撒旦内心的恶魔就会复苏！而只有你能够让它恢复平静！"]],[],[function():void
                           {
                              NpcDialog.show(192,"S",[[0,"爸爸不要丢下我们！"]],[],[function():void
                              {
                                 NpcDialog.show(323,"S爸爸",[[0,"我并没有丢下你们，我会一直守护在你们的身边，只是我们要分别一段时间而已，爸爸相信你会是一个真正的男子汉！。"]],[],[function():void
                                 {
                                    ...
                                    {
                                       QuestManager.addEventListener("complete",onStepThreeComplete);
      ...
      {
         QuestManager.removeEventListener("complete",this.onStepThreeComplete);
         if(this._father)
         {
         ...
         SceneManager.changeScene(1,1071);
      }
