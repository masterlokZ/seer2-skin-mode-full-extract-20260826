package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80238 extends MapProcessor
   {
      ...
      {
         if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord.initData.positionIndex == 1135)
         {
      ...
      private function onNpcClick(param1:MouseEvent) : void
      {
         ...
         if(this.isCanFight())
         {
            ...
            {
               FightManager.startFightWithWild(1135);
            }
            else
            {
      ...
      private function isCanFight() : Boolean
      {
         ...
         {
            if([18,12,8].indexOf(_loc1_.type) != -1)
            {
               _loc2_ = false;
