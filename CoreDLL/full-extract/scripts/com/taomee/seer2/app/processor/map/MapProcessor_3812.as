package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_3812 extends MapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         this._xiYa = MobileManager.getMobile(663,"npc");
         this._xiYa.buttonMode = true;
         this._xiYa.addEventListener("click",this.onClick);
      }
      ...
      private function onClick(param1:MouseEvent) : void
      {
         ...
         {
            FightManager.startFightWithWild(733);
         }]);
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this._xiYa)
         {
            this._xiYa.removeEventListener("click",this.onClick);
         }
      }
   }
}
