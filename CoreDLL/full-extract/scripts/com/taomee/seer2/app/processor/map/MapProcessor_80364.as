package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80364 extends MapProcessor
   {
      ...
      private var foreverLimit:Array = [205263,205264,205265,205266,205268,205269];
      
      private var fightID:Array = [1412];
      ...
      private function initMc() : void
      {
         ...
         SimpleButton(this._swapMc["swapBtn"]).addEventListener("click",this.onSwapStone);
         SimpleButton(this._harmMc["exitBtn"]).addEventListener("click",this.onExit);
         SimpleButton(this._exitTipMc["closeBtn"]).addEventListener("click",this.onCloseTip);
         SimpleButton(this._exitTipMc["addBtn"]).addEventListener("click",this.onAddCount);
         SimpleButton(this._exitTipMc["overBtn"]).addEventListener("click",this.onOverFight);
         this._buyBuffBtn.addEventListener("click",this.onBuyBuff);
         this.update();
      }
      ...
      public function LoadSource(param1:Function = null) : void
      {
         ...
         QueueLoader.load(URLUtil.getActivityAnimation("silverriver"),"swf",this.onLoadComplete,null,null,2);
      }
