   ...
   public class QuestMapHandler_9_192 extends QuestMapHandler
   {
      ...
      private function showFightFlag() : void
      {
         MovieClipUtil.getChildList(this._stepAnimation,2,[0],function(param1:Vector.<DisplayObject>):void
         {
            ...
            {
               _stepAnimation.addEventListener("click",onStepAnimationClick1);
      ...
      private function onStepAnimationClick1(param1:MouseEvent) : void
      {
         ...
         this._stepAnimation.removeEventListener("click",this.onStepAnimationClick1);
      ...
      {
         this._stepAnimation.gotoAndStop(3);
         this._stepAnimation.addEventListener("click",this.onStepAnimationClick2);
      ...
      {
         _processor.hideMouseClickHint();
         this._stepAnimation.removeEventListener("click",this.onStepAnimationClick2);
         this._stepAnimation.addEventListener("click",this.onStepAnimationClick3);
