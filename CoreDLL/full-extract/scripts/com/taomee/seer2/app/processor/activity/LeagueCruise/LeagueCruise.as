package com.taomee.seer2.app.processor.activity.LeagueCruise
{
   ...
   public class LeagueCruise
   {
      ...
      public function LeagueCruise(param1:MapModel)
      {
         ...
         this._leagueMC.addEventListener("click",this.onGoLeagueCruise);
      }
      ...
      {
         if(this._leagueMC.hasEventListener("click"))
         {
            this._leagueMC.removeEventListener("click",this.onGoLeagueCruise);
         }
      }
   }
}
