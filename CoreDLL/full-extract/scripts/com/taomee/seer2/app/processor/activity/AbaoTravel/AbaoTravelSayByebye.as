package com.taomee.seer2.app.processor.activity.AbaoTravel
{
   ...
   public class AbaoTravelSayByebye
   {
      ...
      private function initMC() : void
      {
         ...
         this._abaoMC.addEventListener("click",this.onPlayFullHandler);
      }
      ...
      private function onSuccess(param1:IDataInput) : void
      {
         ...
         ServerBufferManager.updateServerBuffer(37,8,1);
      }
      
      private function getURL() : void
      {
         var url:String = URLUtil.getActivityAnimation("AbaoTravel/sayByebye");
