package com.taomee.seer2.app.processor.quest.handler.activity.quest30038
{
   ...
   public class QuestMapHandler_30038_990 extends QuestMapHandler
   {
      ...
      override public function processMapDispose() : void
      {
         ...
         if(this.caoNiMa)
         {
            this.caoNiMa.removeEventListener("click",this.showMaDia);
         }
         if(this.scholarNpc)
         {
            this.scholarNpc.removeEventListener("click",this.showScholarDia);
         }
      }
      ...
      private function initStep3() : void
      {
         ...
         var _loc2_:XML = <npc id="160" resId="160" name="多茨莫博士" dir="1" width="115" height="125" pos="660,288"
                              actorPos="821,288" path=""/>;
         var _loc1_:NpcDefinition = new NpcDefinition(_loc2_);
         this.scholarNpc = MobileManager.createNpc(_loc1_);
         this.scholarNpc.addOverHeadMark(new AcceptableMark());
         this.scholarNpc.buttonMode = true;
         this.scholarNpc.addEventListener("click",this.showScholarDia);
      }
      ...
      private function completeQuest(param1:QuestEvent) : void
      {
         if(param1.questId == 30038)
         {
            ...
            MobileManager.removeMobile(this.scholarNpc,"npc");
            QuestManager.removeEventListener("complete",this.completeQuest);
         }
      }
      ...
      private function initAcceptProcess() : void
      {
         ...
         this.caoNiMa.addEventListener("click",this.showMaDia);
      }
