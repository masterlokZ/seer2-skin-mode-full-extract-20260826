   ...
   public class QuestMapHandler_10129_192 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         if(QuestManager.isCanAccepted(_quest.id))
         {
            ...
            if(SceneManager.prevSceneType == 2 && _loc1_ == 168)
            {
               this.fightOK();
            }
         }
         ...
         {
            QuestManager.addEventListener("complete",this.onStep1CompleteHandler);
      ...
      {
         QuestManager.removeEventListener("complete",this.onStep1CompleteHandler);
