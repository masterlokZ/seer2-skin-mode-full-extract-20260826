package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_160 extends TitleMapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         this.initHandbook();
         this.iniNpc();
         StatisticsManager.sendNovice("0x10033112");
         StatisticsManager.sendNovice("0x1003341D");
      ...
      private function iniNpc() : void
      {
         ...
         this._npc24 = MobileManager.getMobile(24,"npc");
         if(this._npc24 != null)
         {
            this._npc24.action = "站立";
         }
         this.npc = MobileManager.getMobile(23,"npc");
         this.npc.addEventListener("click",this.clickNpc,false,10);
      }
      
      protected function clickNpc(param1:MouseEvent) : void
      {
         this.npc.removeEventListener("click",this.clickNpc);
      ...
      private function initStar() : void
      {
         ...
         this._starHide.addEventListener("click",this.onClick);
      }
      ...
      private function initMountain() : void
      {
         ...
         this._bubbleMountain.addEventListener("click",this.onClick);
      }
      ...
      private function onClick(param1:MouseEvent) : void
      {
         ...
         _loc2_.removeEventListener("click",this.onClick);
         _loc2_.addEventListener("enterFrame",this.onCurrentFrame);
      }
      ...
      private function onCurrentFrame(param1:Event) : void
      {
         ...
         if(_loc2_["currentStarHide"])
         {
            ...
            _loc2_.removeEventListener("enterFrame",this.onCurrentFrame);
      ...
      private function initHandbook() : void
      {
         ...
         this._scrollCloseBtn.addEventListener("click",this.onHandbookClose);
      }
      ...
      private function initScroll() : void
      {
         ...
         initInteractor(this._scrollOpen);
         this._scrollOpen.addEventListener("click",this.onScrollClick);
      }
      ...
      private function onScrollClick(param1:MouseEvent) : void
      {
         ...
         if(_loc2_.currentFrame == 1)
         {
            closeInteractor(_loc2_);
            _loc2_.gotoAndStop(2);
            _loc2_.addEventListener("frameConstructed",this.onScrollFrameConstructed);
         }
         else
         {
      ...
      private function onScrollFrameConstructed(param1:Event) : void
      {
         ...
         _loc2_.removeEventListener("frameConstructed",this.onScrollFrameConstructed);
         if(_loc2_.currentFrame == 2)
         {
            _loc3_ = _loc2_.getChildByName("scrollMc") as MovieClip;
            _loc3_.addEventListener("enterFrame",this.onScrollChildEnterFrame);
         }
      }
      ...
      private function onScrollChildEnterFrame(param1:Event) : void
      {
         ...
         if(_loc2_.currentFrame == _loc2_.totalFrames)
         {
            ...
            initInteractor(this._scrollOpen);
            _loc2_.removeEventListener("enterFrame",this.onScrollChildEnterFrame);
         }
      }
      ...
      private function initRock() : void
      {
         ...
         this._glowRock.addEventListener("mouseOver",this.onRockOver);
         this._glowRock.addEventListener("mouseOut",this.offRockOver);
         this._glowRock.addEventListener("click",this.onRockClick);
      }
      ...
      {
         StatisticsManager.sendNovice("0x10033565");
         SeatTipsManager.removeSeat(new Point(580,210),160);
         this._glowRock.gotoAndStop(3);
         ModuleManager.toggleModule(URLUtil.getAppModule("MiniGameIntroPanel"),"正在打开小游戏...",{"gameId":3});
      }
      
      private function clearEventListener() : void
      {
         if(this._glowRock.hasEventListener("mouseOver"))
         {
            this._glowRock.removeEventListener("mouseOver",this.onRockOver);
            this._glowRock.removeEventListener("mouseOut",this.offRockOver);
            this._glowRock.removeEventListener("click",this.onRockClick);
         }
      }
