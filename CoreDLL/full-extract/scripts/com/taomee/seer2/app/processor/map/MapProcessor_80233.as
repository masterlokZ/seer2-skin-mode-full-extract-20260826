package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80233 extends MapProcessor
   {
      ...
      private var butIDarr:Array = [604041,604041,604042,604043,604044,604045];
      ...
      private function initMc() : void
      {
         ...
         this.oneEnter.addEventListener("click",this.onOneEnter);
         this.checkOpenPanel();
      }
      ...
      {
         ActiveCountManager.requestActiveCountList([204496,204497],function(param1:Parser_1142):void
         {
