package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_30 extends TitleMapProcessor
   {
      ...
      private function initReference() : void
      {
         ...
         var _loc1_:int = 0;
         _loc2_ = Vector.<MovieClip>([this._referenceOne,this._referenceTwo,this._referenceThree,this._referenceFour,this._referenceFive,this._referenceSix]);
         _loc1_ = 0;
         while(_loc1_ < _loc2_.length)
         {
            initInteractor(_loc2_[_loc1_]);
            _loc2_[_loc1_].addEventListener("mouseOver",this.onReferenceOver);
            _loc2_[_loc1_].addEventListener("mouseOut",this.offReferenceOver);
            _loc1_++;
         }
      }
      ...
      private function intScreen() : void
      {
         ...
         this._bigScreen.addEventListener("click",this.screenClick);
      }
      ...
      private function initTwoYearNpcHandle(param1:LogicEvent = null) : void
      {
         ...
         this._oldNpc = MobileManager.getMobile(7,"npc");
         if(this._oldNpc)
         {
         ...
         DayLimitListManager.getDaylimitList(this.DAY_LIST,function(param1:DayLimitListInfo):void
         {
            ...
            {
               if(!MobileManager.getMobile(7,"npc"))
               {
