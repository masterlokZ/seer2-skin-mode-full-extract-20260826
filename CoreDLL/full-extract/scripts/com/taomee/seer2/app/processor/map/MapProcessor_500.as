package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_500 extends MapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         this.initNpc();
         this.initYiteFight();
         StatisticsManager.sendNovice("0x10033431");
      ...
      {
         this._npc = MobileManager.getMobile(429,"npc");
      ...
      private function initInte2() : void
      {
         ...
         this._inte2.addEventListener("click",this.onInte2Click);
      }
      
      private function onInte2Click(param1:MouseEvent) : void
      {
         this._inte2.removeEventListener("click",this.onInte2Click);
