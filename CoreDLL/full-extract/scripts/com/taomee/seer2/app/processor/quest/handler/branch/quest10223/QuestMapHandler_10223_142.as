package com.taomee.seer2.app.processor.quest.handler.branch.quest10223
{
   ...
   public class QuestMapHandler_10223_142 extends QuestMapHandler
   {
      ...
      {
         MobileManager.getMobile(199,"npc").visible = false;
         MobileManager.getMobile(201,"npc").visible = false;
      }
      ...
      private function initStep1() : void
      {
         ...
         this._mc1.addEventListener("enterFrame",this.updateNPC);
         _map.front.addChild(this._mc1);
         MovieClipUtil.playMc(this._mc1,2,this._mc1.totalFrames,function():void
         {
            _mc1.removeEventListener("enterFrame",updateNPC);
            ...
            _mc1["leiyi"].addEventListener("click",onLeiyi);
         },true);
      }
      ...
      private function initStep2() : void
      {
         ...
         MovieClipUtil.playMc(this._mc2,2,this._mc2.totalFrames,function():void
         {
            ...
            _mc2["yandi"].addEventListener("click",onLeiyi2);
            _mc2["leiyi"].addEventListener("click",onLeiyi2);
         },true);
      }
      ...
      private function initStep3() : void
      {
         ...
         {
            ModuleManager.toggleModule(URLUtil.getAppModule("MiniGameConsolePanel"),"正在打开小游戏...",{"gameId":16});
            MiniGameManager.addEventListener("endPlayGame",onPlayEnd);
      ...
      private function onLeiyi(param1:MouseEvent) : void
      {
         ...
         this._mack = null;
         this._mc1["leiyi"].removeEventListener("click",this.onLeiyi);
      ...
      private function onLeiyi2(param1:MouseEvent) : void
      {
         var event:MouseEvent = param1;
         DisplayUtil.removeForParent(this._mack);
         this._mc2["yandi"].removeEventListener("click",this.onLeiyi2);
         this._mc2["leiyi"].removeEventListener("click",this.onLeiyi2);
      ...
      override public function processMapDispose() : void
      {
         ...
         MobileManager.getMobile(199,"npc").visible = true;
         MobileManager.getMobile(201,"npc").visible = true;
         QuestManager.removeEventListener("stepComplete",this.onStepComplete);
         DisplayUtil.removeForParent(this._mc1);
         DisplayUtil.removeForParent(this._mc2);
         DisplayUtil.removeForParent(this._mack);
      ...
      {
         MiniGameManager.removeEventListener("startPlayGame",this.onStartGame);
         MiniGameManager.addEventListener("endPlayGame",this.onPlayEnd);
      }
      
      private function onPlayEnd(param1:MiniGameEvent) : void
      {
         MiniGameManager.removeEventListener("endPlayGame",this.onPlayEnd);
