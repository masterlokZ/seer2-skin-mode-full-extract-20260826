package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_221 extends DreamMapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         this._fireMC.addEventListener("click",this.onFireClick);
      }
      
      private function onFireClick(param1:MouseEvent) : void
      {
         this._fireMC.buttonMode = false;
         this._fireMC.removeEventListener("click",this.onFireClick);
         this._fire.visible = true;
         this._fire.gotoAndPlay(1);
         this._light.buttonMode = true;
         this._light.addEventListener("click",this.onLightClick);
         this._fire.addEventListener("enterFrame",this.onEnterFrame);
      }
      ...
      {
         this._light.removeEventListener("click",this.onLightClick);
         this._fire.removeEventListener("enterFrame",this.onEnterFrame);
         this._fire.visible = false;
