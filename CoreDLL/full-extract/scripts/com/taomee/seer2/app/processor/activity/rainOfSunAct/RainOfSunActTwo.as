package com.taomee.seer2.app.processor.activity.rainOfSunAct
{
   ...
   public class RainOfSunActTwo
   {
      ...
      {
         QueueLoader.load(URLUtil.getActivityAnimation("rainOfSunAct/RainOfSunActTwo"),"swf",function(param1:ContentInfo):void
         {
      ...
      {
         ActiveCountManager.requestActiveCount(203104,function(param1:uint, param2:uint):void
         {
