package com.taomee.seer2.app.processor.activity.deliciousFood
{
   ...
   public class DeliciousFoodTwo
   {
      ...
      private static function onMapSwitchComplete(param1:SceneEvent) : void
      {
         ...
         if(SceneManager.prevSceneType == 2 && _fightIndex == 1)
         {
            _fightIndex = 0;
      ...
      private static function onGetServer(param1:ServerBuffer) : void
      {
         ...
         var _loc2_:int = 0;
         var _loc4_:int = param1.readDataAtPostion(40);
         ...
         if(_loc4_ != 1)
         {
            ...
            while(_loc2_ < 38)
            {
               _loc3_.push(new ServerBufferData(_loc2_,0));
               _loc2_++;
            }
            _loc3_.push(new ServerBufferData(40,1));
            ServerBufferManager.updateServerBufferGroup(DeliciousFoodOnePickup.getServerBuf(),_loc3_);
            return;
         }
         ...
         _loc5_ = param1.readDataAtPostion(6);
         if(_loc5_ == 1)
         {
         ...
         if(_loc5_ == 1 && _currIndex != 1 && SceneManager.active.mapID == mapList[_currTime] && _activityCount < 5)
         {
            showNpc();
         }
      }
      ...
      {
         var _loc2_:DeliciousFoodTime = null;
         var _loc1_:int = 0;
         while(_loc1_ < 11)
         {
            _loc2_ = timeList[_loc1_];
            if(DateUtil.isInHourScope(_loc2_.hours,_loc2_.hours,_loc2_.minutes,_loc2_.minutes + 5))
            {
               return _loc1_;
            }
            _loc1_++;
