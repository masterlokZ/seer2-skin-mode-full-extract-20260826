package com.taomee.seer2.app.processor.quest.handler.branch.quest10005
{
   ...
   public class QuestMapHandler_10005_213 extends BranchQuestMapHandler
   {
      ...
      private function onStoneClick(param1:MouseEvent) : void
      {
         ...
         this._makeBubble.addEventListener("close",this.onCloseAnimation);
         this._makeBubble.addEventListener("makeBubble",this.onMakeBubbleOver);
      }
      
      private function onCloseAnimation(param1:Event) : void
      {
         this._makeBubble.removeEventListener("close",this.onCloseAnimation);
         this._makeBubble.removeEventListener("makeBubble",this.onMakeBubbleOver);
      }
