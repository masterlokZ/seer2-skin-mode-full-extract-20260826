package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80319 extends MapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         this._npc = MobileManager.getMobile(817,"npc");
      }
      ...
      protected function toFight(param1:DialogPanelEvent) : void
      {
         ...
         {
            Connection.addCommandListener(CommandSet.GET_CURR_BLOOD_1231,(function():*
            {
               var getBossHp:Function;
               return getBossHp = function(param1:MessageEvent):void
               {
