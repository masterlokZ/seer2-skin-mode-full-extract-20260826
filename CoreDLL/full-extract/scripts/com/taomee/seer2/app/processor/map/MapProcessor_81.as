package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_81 extends TitleMapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         this._liftDown.addEventListener("click",this.onLiftClick);
         TooltipManager.addCommonTip(this._liftDown,"选择要塞");
         StatisticsManager.sendNovice("0x1003345E");
         this._btn0 = _map.front["btn_0"];
         this._btn1 = _map.front["btn_1"];
         this._btn0.addEventListener("click",this.onBtn0);
         this._btn1.addEventListener("click",this.onBtn1);
      ...
      private function checkTrainerPVP() : void
      {
         ...
         {
            if(FightManager.currentFightRecord && FightManager.currentFightRecord.initData && Boolean(FightManager.currentFightRecord.initData.type) && FightManager.currentFightRecord.initData.type == "fightPVPTrainer")
            {
      ...
      {
         this.onLiftClick(new MouseEvent("click"));
      }
      
      private function initNPC() : void
      {
         this._npc125 = MobileManager.getMobile(125,"npc");
         this._npc125.buttonMode = true;
         this._npc125.addEventListener("click",this.onNpc125,false,1);
         this._npc126 = MobileManager.getMobile(126,"npc");
         this._npc126.buttonMode = true;
         this._npc126.addEventListener("click",this.onNpc126,false,1);
      }
      ...
      override public function dispose() : void
      {
         ...
         this._liftDown = null;
         this._npc125.removeEventListener("click",this.onNpc125);
         this._npc125 = null;
         this._npc126.removeEventListener("click",this.onNpc126);
         this._npc126 = null;
         this._btn0.removeEventListener("click",this.onBtn0);
         this._btn1.removeEventListener("click",this.onBtn1);
