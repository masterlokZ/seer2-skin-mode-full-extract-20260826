package com.taomee.seer2.app.processor.quest.handler.main.quest95
{
   ...
   public class QuestMapHandler_95_3848 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         if(QuestManager.isAccepted(questID) && QuestManager.isComplete(questID) == false)
         {
            ...
            if(QuestManager.isStepComplete(questID,4) && !QuestManager.isStepComplete(questID,5))
            {
               ...
               {
                  DialogPanel.addEventListener("customReplyClick",onCustomReply);
               });
            }
         }
      }
      ...
      private function onCustomReply(param1:DialogPanelEvent) : void
      {
         ...
         {
            NpcDialog.show(3020,"弗雷德",[[0,"我族历史悠久，从世界创造之初就作为原住民守护着阿卡迪亚大地的平衡。"]],["那为什么都没人见过你们呢？"],[function():void
            {
               NpcDialog.show(3020,"弗雷德",[[0,"我们喜欢居住在暗影中，这个世界惧怕黑暗，也惧怕我们，久而久之与我们失去了来往。但我们始终掌握着这个世界的动向，没有我们就没有现在的阿卡迪亚星。"]],["那你问什么要给我出谜语呢？"],[function():void
               {
                  NpcDialog.show(3020,"弗雷德",[[0,"影之誓言是为了寻找最有能力帮助我解决眼前麻烦的勇士，我亲自挑选了12名候选者，你是其中最快破解谜底的人。"]],["哈哈，我多聪明~"],[function():void
                  {
                     NpcDialog.show(3020,"弗雷德",[[0,"我相信你就是那个能帮我们的。"]],["你们遇到什么麻烦了嘛？"],[function():void
                     {
