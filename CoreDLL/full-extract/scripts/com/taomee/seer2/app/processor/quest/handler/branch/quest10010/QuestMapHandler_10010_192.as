package com.taomee.seer2.app.processor.quest.handler.branch.quest10010
{
   ...
   public class QuestMapHandler_10010_192 extends BranchQuestMapHandler
   {
      ...
      private function addInteractive() : void
      {
         ...
         this._findFlower.addEventListener("findDudu",this.onFindFlower);
         this._findFlower.addEventListener("close",this.onCloseAnimation);
      }
      ...
      {
         this._findFlower.removeEventListener("close",this.onCloseAnimation);
         this._findFlower.removeEventListener("findDudu",this.onFindFlower);
      }
