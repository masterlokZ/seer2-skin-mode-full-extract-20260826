package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_10 extends TitleMapProcessor
   {
      ...
      private function initChirs() : void
      {
         ...
         this._chirs.addEventListener("click",this.onChirs);
      }
      ...
      private function initCaptain() : void
      {
         ...
         this._npc179 = MobileManager.getMobile(179,"npc");
         this._npc179.addEventListener("click",this.onNpc179);
      }
      
      private function onNpc179(param1:MouseEvent) : void
      {
         StatisticsManager.sendNovice("0x10033482");
      }
      ...
      private function initleftLCD() : void
      {
         ...
         this._leftLCDTrigger.addEventListener("click",this.onLeftLCDTriggerClick);
      }
      ...
      private function initMidLCD() : void
      {
         ...
         this._midLCDTrigger.addEventListener("click",this.onMidLCDTriggerClick);
      }
      ...
      private function initLawsPoster() : void
      {
         ...
         this._lawsPosterTrigger.addEventListener("mouseOver",this.onLawsPosterTriggerMouseOver);
         this._lawsPosterTrigger.addEventListener("mouseOut",this.onLawsPosterTriggerMouseOut);
      }
      ...
      private function initRightLCD() : void
      {
         ...
         this._rightLCDTrigger.addEventListener("mouseOver",this.onRightLCDTriggerMouseOver);
         this._rightLCDTrigger.addEventListener("mouseOut",this.onRightLCDTriggerMouseOut);
      }
      ...
      private function initBackDoor() : void
      {
         ...
         this._backDoor.addEventListener("click",this.onDoorClick);
      }
      ...
      private function initBackDoorDeferTeleport() : void
      {
         ...
         this._backDoorDeferTeleport.addEventListener("actorArrived",this.onActorArrivedDoor);
      }
      
      private function clearEventListener() : void
      {
         this._rightLCDTrigger.removeEventListener("mouseOver",this.onRightLCDTriggerMouseOver);
         this._rightLCDTrigger.removeEventListener("mouseOut",this.onRightLCDTriggerMouseOut);
         this._lawsPosterTrigger.removeEventListener("mouseOver",this.onLawsPosterTriggerMouseOver);
         this._lawsPosterTrigger.removeEventListener("mouseOut",this.onLawsPosterTriggerMouseOut);
         this._leftLCDTrigger.removeEventListener("click",this.onLeftLCDTriggerClick);
         this._backDoor.removeEventListener("click",this.onDoorClick);
      }
         ...
         if(DateUtil.inInDateScope(5,14,21,14,31))
         {
            ServerBufferManager.getServerBuffer(29,function(param1:ServerBuffer):void
            {
               ...
               if(_loc2_ == 0)
               {
                  ...
                  ServerBufferManager.updateServerBuffer(29,16,1);
               }
            });
         }
      }
      ...
      private function initTwoYearNpcHandle() : void
      {
         ...
         {
            ActiveCountManager.requestActiveCount(202498,function(param1:int, param2:int):void
            {
               var type:int = param1;
               var val:int = param2;
               if(val == 1)
               ...
               if(!MobileManager.getMobile(1,"npc"))
               {
      ...
      {
         this._oldNpc = MobileManager.getMobile(1,"npc");
