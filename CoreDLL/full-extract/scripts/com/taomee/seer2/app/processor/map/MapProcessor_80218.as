package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80218 extends MapProcessor_920
   {
      ...
      private var keyOrder:Array = [2,3,1,4];
      ...
      override public function dispose() : void
      {
         ...
         while(_loc1_ < 5)
         {
            this.keyBtnVec[_loc1_].removeEventListener("click",this.showLight);
            _loc1_++;
         }
         this.keyBtnVec = null;
      ...
      override public function init() : void
      {
         ...
         while(_loc1_ < 5)
         {
            ...
            this.keyBtnVec[_loc1_].addEventListener("click",this.showLight);
      ...
      private function showLight(param1:MouseEvent) : void
      {
         ...
         mc.removeEventListener("click",this.showLight);
         mc.gotoAndStop(3);
