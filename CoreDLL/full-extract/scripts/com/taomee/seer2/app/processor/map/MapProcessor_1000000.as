package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_1000000 extends MapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         ServerBufferManager.getServerBuffer(23,function(param1:ServerBuffer):void
         {
            ...
            if(flag == 0)
            {
               ...
               _yandi_mc.addEventListener("click",beginStoryHandler);
               if(SceneManager.prevSceneType == 2 && _hasFirstFight)
               {
      ...
      private function creatLeiyi() : void
      {
         ...
         this._leiyi_mc.addEventListener("click",this.fightLeiyiHandler);
      }
      ...
      private function win() : void
      {
         ...
         {
            _yandi_mc.removeEventListener("click",beginStoryHandler);
            ServerBufferManager.updateServerBuffer(23,0,1);
            creatLeiyi();
         },true,false,2);
      }
