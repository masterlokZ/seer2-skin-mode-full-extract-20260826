   ...
   public class QuestMapHandler_29_310 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         if(QuestManager.isAccepted(_quest.id) && QuestManager.isStepComplete(_quest.id,1) == false)
         {
            ...
            {
               this._shaNpc.addEventListener("click",this.onShowDialogStep1_0);
            }
            else
            {
               ...
               this._shaNpc.addEventListener("click",this.onShowDialogStep1_1);
            }
         }
      ...
      private function onShowDialogStep1_0(param1:MouseEvent) : void
      {
         ...
         this.clearAskMark();
         this._shaNpc.removeEventListener("click",this.onShowDialogStep1_0);
         NpcDialog.show(56,"神爪财团老板",[[0,"那些粗鬼难道除了动手就没有别的功能了吗？"]],["那就不要动手啊……"],[function():void
         {
            NpcDialog.show(56,"神爪财团老板",[[0,"我本来就不愿意动手，不然这么多年来我如此忍让是为了什么？"]],["大老板英明！"],[function():void
            {
               ...
               MovieClipUtil.playMc(_fightMc,1,_fightMc.totalFrames,function():void
               {
                  ...
                  QuestManager.addEventListener("stepUpdateBuffer",onUpdateStepBufferStep1_1);
      ...
      private function onUpdateStepBufferStep1_1(param1:QuestEvent) : void
      {
         ...
         {
            QuestManager.removeEventListener("stepUpdateBuffer",this.onUpdateStepBufferStep1_1);
            this._shaNpc.addEventListener("click",this.onShowDialogStep1_1);
      ...
      {
         this._shaNpc.removeEventListener("click",this.onShowDialogStep1_1);
         this.clearAskMark();
         this.showDialogStep1_1();
      }
