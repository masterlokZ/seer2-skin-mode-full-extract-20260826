   ...
   public class MapProcessor_80065 extends MapProcessor
   {
      ...
      private function zombieDrActInit() : void
      {
         ...
         while(_loc1_ < 3)
         {
            ...
            this._holeList[_loc1_].addEventListener("click",this.onHoleRandom);
            _loc1_++;
         }
      ...
      private function onEventStart(param1:MessageEvent) : void
      {
         ...
         if(_loc2_.index == 65)
         {
            if(_loc2_.id == 1)
            {
               SceneManager.changeScene(9,80064);
            }
            else if(_loc2_.id == 2)
            {
      ...
      private function onHoleRandom(param1:MouseEvent) : void
      {
         ...
         ActiveCountManager.requestActiveCount(203359,function(param1:uint, param2:uint):void
         {
            ...
            switch(int(val))
            {
               case 0:
                  ...
                  {
                     if(ItemManager.getItemQuantityByReferenceId(400363) > 0)
                     {
                        SwapManager.swapItem(2084,1,function(param1:IDataInput):void
                        {
                           Connection.send(CommandSet.RANDOM_EVENT_1140,65,0);
      ...
      private function zombieDrActDispose() : void
      {
         ...
         if(this._holeList)
         {
            ...
            {
               this._holeList[_loc1_].removeEventListener("click",this.onHoleRandom);
               _loc1_++;
            }
            this._holeList = null;
         }
