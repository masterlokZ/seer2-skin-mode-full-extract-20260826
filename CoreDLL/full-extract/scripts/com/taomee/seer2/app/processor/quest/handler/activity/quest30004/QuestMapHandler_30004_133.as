package com.taomee.seer2.app.processor.quest.handler.activity.quest30004
{
   ...
   public class QuestMapHandler_30004_133 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         if(SceneManager.prevSceneType == 2 && QuestManager.isStepComplete(_quest.id,3) && QuestManager.isStepComplete(_quest.id,4) == false && _fightStatus == 1)
         {
            _fightStatus = 0;
      ...
      private function initNpc(param1:uint = 1) : void
      {
         if(param1 == 1)
         {
            ...
            this._mc_0.addEventListener("click",this.onNpc);
            this._mc_0.x = 182;
            this._mc_0.y = 354;
         ...
         else if(param1 == 2)
         {
            ...
            this._mc_1.addEventListener("click",this.onNpc1);
         }
         else if(param1 == 3)
         {
            ...
            this._mc_2.addEventListener("click",this.onNpc2);
         }
      }
      ...
      private function onNpc(param1:MouseEvent) : void
      {
         ...
         {
            _mc_0.removeEventListener("click",onNpc);
      ...
      {
         var event:MouseEvent = param1;
         this._mc_2.removeEventListener("click",this.onNpc2);
         ...
         MovieClipUtil.playMc(this._mc_2,81,94,function():void
         {
            ...
            MovieClipUtil.playMc(_mcDian,1,_mcDian.totalFrames,function():void
            {
               ...
               NpcDialog.show(NpcUtil.getSeerNpcId(),"我",[[0,"这可不是办法！得让他先停下来！（快用头部射击反击！）"]],["（头部射击在工具条上）"],[function():void
               {
                  ...
                  ToolBar.getBtn("shot").addEventListener("click",onBtn);
               }]);
            },true);
         },true);
      }
      ...
      {
         ToolBar.getBtn("shot").removeEventListener("click",this.onBtn);
      ...
      private function onShootEnd(param1:ShootEvent) : void
      {
         ...
         if(info.userID == ActorManager.actorInfo.id && this._mc_2.hitTestPoint(info.endPos.x,info.endPos.y))
         {
            ...
            {
               ShootController.addEventListener("playEnd",onShootEnd2);
            },true);
         }
      }
      ...
      private function onShootEnd2(param1:ShootEvent) : void
      {
         ...
         if(info.userID == ActorManager.actorInfo.id && this._mc_2.hitTestPoint(info.endPos.x,info.endPos.y))
         {
            ShootController.removeEventListener("playEnd",this.onShootEnd2);
            MovieClipUtil.playMc(this._mc_2,113,130,function():void
            {
               ShootController.addEventListener("playEnd",onShootEnd3);
            },true);
         }
      }
      ...
      private function onShootEnd3(param1:ShootEvent) : void
      {
         ...
         {
            ShootController.removeEventListener("playEnd",this.onShootEnd3);
      ...
      private function onFight(param1:MouseEvent) : void
      {
         ...
         else
         {
            ...
            this._mc_2.buttonMode = true;
            this._mc_2.addEventListener("click",this.onFight);
         }
      }
      ...
      private function win() : void
      {
         MovieClipUtil.playFullScreen(URLUtil.getQuestFullScreenAnimation("30004_3"),function():void
         {
            ...
            _mc_4.addEventListener("click",onClick4);
         },true,false,2);
      }
