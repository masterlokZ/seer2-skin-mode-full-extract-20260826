package com.taomee.seer2.app.processor.quest.handler.branch.quest10125
{
   ...
   public class QuestMapHandler_10125_Peddle extends QuestMapHandler
   {
      ...
      private function onNpcClick(param1:MouseEvent) : void
      {
         ...
         if(this.num != 1)
         {
            if(this.npcid == 23)
            {
               ...
               {
                  num = 1;
                  ServerBufferManager.updateServerBuffer(46,buffPosition,1);
                  checkFull();
               }]);
            }
            if(this.npcid == 28)
      ...
      {
         this.num1 = param1.readDataAtPostion(12);
         this.num2 = param1.readDataAtPostion(13);
         this.num3 = param1.readDataAtPostion(14);
         this.num4 = param1.readDataAtPostion(15);
         switch(this.buffPosition - 12)
         {
            case 0:
               this.num = this.num1;
         ...
         if(this.num < 1)
         {
            this._npc = MobileManager.getMobile(this.npcid,"npc");
            this._npc.removeOverHeadMark();
            this._npc.addOverHeadMark(new AcceptableMark());
            this._npc.addEventListener("click",this.onNpcClick,false,500);
         }
      }
   }
}
