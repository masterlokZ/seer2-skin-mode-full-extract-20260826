   ...
   public class QuestMapHandler_10187_2 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         if(QuestManager.isAccepted(_quest.id) && QuestManager.isStepComplete(_quest.id,1) == false)
         {
            ...
            this._mc_0.addEventListener("click",this.onSTalk);
         }
         if(QuestManager.isStepComplete(_quest.id,1) && QuestManager.isStepComplete(_quest.id,2) == false)
         {
            ...
            this._mc_2.addEventListener("click",this.onTinaTalk);
            this._mc_0 = _processor.resLib.getMovieClip("mc_2");
            _map.content.addChild(this._mc_0);
         }
      }
      ...
      private function onSTalk(param1:MouseEvent) : void
      {
         ...
         NpcDialog.show(192,"S",[[0,"小赛尔，这里很诡异，快帮我一起找找有什么线索，别放过任何地方！"]],["没问题！看！那里有个扳手！"],[function():void
         {
            ...
            _mc_0.removeEventListener("click",onSTalk);
            ...
            _mc_1.addEventListener("click",onOpenPanel);
         }]);
      }
      ...
      private function addElectricWire() : void
      {
         if(ItemManager.getSpecialItem(603085) == null)
         {
            ...
            this._line1.addEventListener("click",this.onPickUpLineOne);
         }
         if(ItemManager.getSpecialItem(603086) == null)
         {
            ...
            this._line2.addEventListener("click",this.onPickUpLineTwo);
         }
         if(ItemManager.getSpecialItem(603087) == null)
         {
            ...
            this._line3.addEventListener("click",this.onPickUpLineThree);
         }
      }
      ...
      {
         var evt:MouseEvent = param1;
         this._line1.removeEventListener("click",this.onPickUpLineOne);
      ...
      {
         var evt:MouseEvent = param1;
         this._line2.removeEventListener("click",this.onPickUpLineTwo);
      ...
      {
         var evt:MouseEvent = param1;
         this._line3.removeEventListener("click",this.onPickUpLineThree);
