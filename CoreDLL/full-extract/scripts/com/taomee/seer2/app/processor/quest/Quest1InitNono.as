   ...
   public class Quest1InitNono
   {
      ...
      public static function setup() : void
      {
         ...
         else
         {
            ...
            {
               if((param1.infoVec[0] & 0x40) == 64 && param1.infoVec[1] == 1)
               {
                  DisplayUtil.removeForParent(ToolBar.getBtn("yueseNono"));
               }
            });
      ...
      private static function processor(param1:MessageEvent) : void
      {
         ...
         setTimeout(function():void
         {
            ...
            {
               if(_loc1_.resourceId == 824 && _loc1_.level >= 60)
               {
                  _loc2_ = true;
               }
            }
            if(_loc2_)
            {
               QuestManager.addEventListener("complete",onStepComplete);
      ...
      private static function onStepComplete(param1:QuestEvent) : void
      {
         ...
         QuestManager.removeEventListener("complete",onStepComplete);
      ...
      private static function onInitLoginGift2(param1:ServerBuffer) : void
      {
         if(param1.readDataAtPostion(0) != 1)
         {
            QueueLoader.load(URLUtil.getRes("quest/sceneAnimation/nono1.swf"),"swf",onResLoaded);
         }
      }
