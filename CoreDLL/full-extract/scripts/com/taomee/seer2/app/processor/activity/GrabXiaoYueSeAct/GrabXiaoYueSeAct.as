package com.taomee.seer2.app.processor.activity.GrabXiaoYueSeAct
{
   ...
   public class GrabXiaoYueSeAct
   {
      ...
      public function setup(param1:MapModel) : void
      {
         ...
         this._map = map;
         ModuleManager.addEventListener("RewardInHatPanel","dispose",(function():*
         {
            var onGameClose:Function;
            return onGameClose = function(param1:ModuleEvent):void
            {
               ModuleManager.removeEventListener("RewardInHatPanel","dispose",onGameClose);
               clearNpc();
            };
         })());
         this.update();
      ...
      private function clearNpc() : void
      {
         if(this._npc)
         {
            this._npc.removeEventListener("click",this.onMark);
      ...
      private function isInAct() : Boolean
      {
         ...
         if(DateUtil.isInTime(new Date(2016,1,5),new Date(2016,1,19)) && DateUtil.isInHourScope(13,14,0,0))
         {
            _loc1_ = true;
         }
         return _loc1_;
