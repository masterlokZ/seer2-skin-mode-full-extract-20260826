package com.taomee.seer2.app.animationInteractive
{
   ...
   public class Interactive_10011 extends BaseAniamationInteractive
   {
      ...
      private var RANDOM_VEC:Vector.<int> = Vector.<int>([1,53,2,53,53,53,2,53,2,53,53]);
      ...
      override protected function paramAnimation() : void
      {
         ...
         this._doorMC.addEventListener("enterFrame",this.onDoor);
      ...
      private function onDoor(param1:Event) : void
      {
         ...
         {
            this._doorMC.removeEventListener("enterFrame",this.onDoor);
      ...
      private function star() : void
      {
         ...
         this._hammer.addEventListener("click",this.onHammerClick);
      }
