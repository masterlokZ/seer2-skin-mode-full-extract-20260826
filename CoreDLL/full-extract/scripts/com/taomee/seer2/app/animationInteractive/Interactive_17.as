package com.taomee.seer2.app.animationInteractive
{
   ...
   public class Interactive_17 extends BaseAniamationInteractive
   {
      ...
      override protected function paramAnimation() : void
      {
         ...
         this._num = 0;
         this._car.addEventListener("click",this.onClick);
      ...
      private function onClick(param1:MouseEvent) : void
      {
         ...
         this._car.addEventListener("enterFrame",this.onEnterFrame);
      }
      ...
      private function onTimer(param1:TimerEvent) : void
      {
         ...
         {
            this._timer.stop();
            this._car.removeEventListener("click",this.onClick);
            this._car.removeEventListener("enterFrame",this.onEnterFrame);
