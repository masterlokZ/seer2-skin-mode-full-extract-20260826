package com.taomee.seer2.app.animationInteractive
{
   ...
   public class MakeColorAniamtion extends BaseAniamationInteractive
   {
      ...
      {
         this._colorPanel.addEventListener("click",this.onColorPanelClick);
         this._colorMouse.addEventListener("enterFrame",this.onColorMouseEnterFrame);
         this._sunflower.addEventListener("enterFrame",this.onSunflowerEnterFrame);
      }
      
      private function closeEventListener() : void
      {
         this._colorPanel.removeEventListener("click",this.onColorPanelClick);
         this._colorMouse.removeEventListener("enterFrame",this.onColorMouseEnterFrame);
         this._sunflower.removeEventListener("enterFrame",this.onSunflowerEnterFrame);
      }
      ...
      {
         this._colorPanel.removeEventListener("click",this.onColorPanelClick);
         this._colorPanel["paletteMC"].addEventListener("enterFrame",this.onPaletteEnterFrame);
      }
      ...
      private function onPaletteEnterFrame(param1:Event) : void
      {
         ...
         {
            _loc2_.removeEventListener("enterFrame",this.onPaletteEnterFrame);
      ...
      private function onSunflowerEnterFrame(param1:Event) : void
      {
         ...
         if(_loc2_.currentFrame >= 75)
         {
            if(this._sunflower.currentFrame == 2)
            {
               ...
               dispatchEvent(new Event("makeColor"));
               this.dispose();
            }
