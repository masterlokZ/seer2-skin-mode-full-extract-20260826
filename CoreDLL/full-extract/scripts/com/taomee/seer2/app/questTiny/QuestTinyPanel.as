package com.taomee.seer2.app.questTiny
{
   ...
   public class QuestTinyPanel extends Sprite
   {
      ...
      {
         var _loc1_:Number = LayerManager.stage.stageWidth;
      ...
      {
         this._switchBtn.removeEventListener("click",this.onSwitch);
      ...
      public function show() : void
      {
         ...
         this._switchBtn.addEventListener("click",this.onSwitch);
         this.update();
      }
