package com.taomee.seer2.app.manager
{
   ...
   public class FireDragonManager
   {
      ...
      private static function canShow() : Boolean
      {
         ...
         var _loc1_:Boolean = !(SceneManager.currentSceneType == 2 || SceneManager.active.mapID >= 400 && SceneManager.active.mapID <= 450);
         var _loc4_:Boolean = TimeManager.getServerTime() < endTime;
         var _loc3_:Boolean = SceneManager.active.type != 3;
