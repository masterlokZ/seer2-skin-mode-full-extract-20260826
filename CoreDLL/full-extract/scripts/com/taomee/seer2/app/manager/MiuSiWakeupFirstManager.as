package com.taomee.seer2.app.manager
{
   ...
   public class MiuSiWakeupFirstManager
   {
      ...
      public function setup() : void
      {
         ...
         {
            if(1624 == FightManager.currentFightRecord.initData.positionIndex)
            {
      ...
      private function createNPC() : void
      {
         ...
         MobileManager.addMobile(this._npc815,"npc");
         this._npc815.addEventListener("click",this.onDialog);
      }
      ...
      private function removeNPC() : void
      {
         if(this._npc815)
         {
            this._npc815.removeEventListener("click",this.onDialog);
            MobileManager.removeMobile(this._npc815,"npc");
            this._npc815 = null;
         }
      }
      ...
      private function onDialog(param1:MouseEvent) : void
      {
         ...
         NpcDialog.show(815,"邪神",[[0,"绝不能让战神们获得神迹之力。"]],["缪斯的觉醒石在你手中吧！"],[function():void
         {
            ...
            {
               FightManager.startFightWithWild(1624);
            }]);
         }]);
      }
