package com.taomee.seer2.app.manager
{
   ...
   public class PetExperenceHelper
   {
      ...
      private static function check() : void
      {
         if(_resultInfo)
         {
            if(_resultInfo.endReason == 107)
            {
               PetInfoManager.dispatchEvent("petLevelUp",null,{
                  "resultInfo":_resultInfo,
                  "revenueInfo":_revenueInfo
               });
            }
            else if(_resultInfo.endReason == 109)
            {
               PetInfoManager.dispatchEvent("hookPetExperenceChange",null,{
                  "resultInfo":_resultInfo,
                  "revenueInfo":_revenueInfo
               });
            }
            else if(_resultInfo.endReason == 106 || _revenueInfo != null)
            {
               PetInfoManager.dispatchEvent("petExperenceChange",null,{
                  "resultInfo":_resultInfo,
                  "revenueInfo":_revenueInfo
               });
            }
