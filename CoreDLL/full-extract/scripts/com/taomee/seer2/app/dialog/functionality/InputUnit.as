package com.taomee.seer2.app.dialog.functionality
{
   ...
   public class InputUnit extends BaseUnit
   {
      ...
      private function init() : void
      {
         ...
         this._inputTxt.type = "input";
         this._inputTxt.selectable = true;
         this._inputTxt.restrict = "0-9";
         this._inputTxt.addEventListener("change",this.onInputChange);
      ...
      {
         if(StringUtil.trim(this._inputTxt.text) == "")
         {
            this._confirmBtn.visible = false;
         }
         else
      ...
      {
         this._inputTxt.removeEventListener("change",this.onInputChange);
