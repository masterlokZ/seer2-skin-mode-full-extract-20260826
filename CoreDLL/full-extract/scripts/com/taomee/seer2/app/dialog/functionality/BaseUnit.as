package com.taomee.seer2.app.dialog.functionality
{
   ...
   public class BaseUnit extends Sprite
   {
      ...
      {
         var _loc2_:Sprite = this.createBtnState(16777113);
         var _loc1_:Sprite = this.createBtnState(9696572);
         var _loc4_:Sprite = this.createBtnState(16777113);
         var _loc3_:Shape = this.createBtnHitState(_loc4_.width);
         this._btn = new SimpleButton(_loc2_,_loc1_,_loc4_,_loc3_);
      ...
      public function createColorBtn(param1:uint) : void
      {
         ...
         var _loc5_:Sprite = this.createBtnState(param1);
         var _loc4_:Sprite = this.createBtnState(param1);
         var _loc2_:Shape = this.createBtnHitState(_loc4_.width);
         this._btn = new SimpleButton(_loc3_,_loc5_,_loc4_,_loc2_);
         this._btn.addEventListener("click",this.onBtnClick);
         this._btn.y = -20;
         this._btn.x = 30;
         addChild(this._btn);
