package com.taomee.seer2.app.rarePet.processor
{
   ...
   public class RarePetProcessor_438 extends BaseRarePetProcessor
   {
      ...
      {
         if(ItemManager.getItemQuantityByReferenceId(400210))
         {
            InteractiveRewardManager.requestReward(26,this.onRequestFightAfroSuccess,this.onRequestFightAfroError);
         }
         else
         {
