package com.taomee.seer2.app.home.panel.buddy
{
   ...
   public class AddBuddyPanel extends Sprite
   {
      ...
      private function initEventListener() : void
      {
         ...
         this._dragMc.addEventListener("mouseDown",this.onDragStart);
         this._dragMc.addEventListener("mouseUp",this.onDragEnd);
      }
      ...
      private function disposeEventListener() : void
      {
         ...
         this._dragMc.removeEventListener("mouseDown",this.onDragStart);
         this._dragMc.removeEventListener("mouseUp",this.onDragEnd);
      }
