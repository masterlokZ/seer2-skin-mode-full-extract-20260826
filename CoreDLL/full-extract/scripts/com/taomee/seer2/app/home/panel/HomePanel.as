package com.taomee.seer2.app.home.panel
{
   ...
   public class HomePanel extends Sprite
   {
      ...
      public function HomePanel()
      {
         ...
         this._selfDataUnit.status = "ready";
      ...
      private function showTool() : void
      {
         ...
         LayerManager.stage.addEventListener("enterFrame",this.onEnter);
      }
      ...
      {
         LayerManager.stage.removeEventListener("enterFrame",this.onEnter);
         MapTitlePanel.hide();
         PetAvatarPanel.hide();
         MinorToolBar.hide();
      ...
      {
         this._featureBar.addEventListener("requestAddBuddy",this.onRequestAddBuddy);
         this._buddyPanel.addEventListener("requestAddBuddy",this.onRequestAddBuddy);
      }
      ...
      private function onRequestAddBuddy(param1:Event) : void
      {
         ...
         this._addBuddyPanel = new ProcessBuddyPanel(0,new Point(330,210));
         addChild(this._addBuddyPanel);
      }
