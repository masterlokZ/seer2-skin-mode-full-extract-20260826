package com.taomee.seer2.app.home.panel.buddy
{
   ...
   public class HomeBuddyFullItem extends HomeBuddyIntroItem
   {
      ...
      {
         this._orderNumber = new HomeNumber(_container["orderNumber"],4);
         this._orderNumber.visible = false;
         addChild(this._orderNumber);
         this._levelNumber = new HomeNumber(_container["levelNumber"],3);
      ...
      override protected function updateDisplay() : void
      {
         ...
         {
            _nickTxt.textColor = 16776960;
         }
         else
         {
            _nickTxt.textColor = 5432825;
         }
         super.updateDisplay();
         if(this._type == 8)
         {
