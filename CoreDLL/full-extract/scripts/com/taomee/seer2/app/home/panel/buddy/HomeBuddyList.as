package com.taomee.seer2.app.home.panel.buddy
{
   ...
   public class HomeBuddyList extends Sprite
   {
      ...
      private function createChildren() : void
      {
         ...
         this._buddyNumber = new HomeNumber(this._container["buddyNumber"],4);
      ...
      private function updateDataUnitIndex(param1:int) : void
      {
         ...
         if(this._dataUnitIndex + 5 > this._dataUnitVec.length)
         {
            this._dataUnitIndex = this._dataUnitVec.length - 5;
         }
      }
      ...
      private function updateDataUnit() : void
      {
         ...
         while(_loc1_ < 5)
         {
            _loc4_ = this._dataUnitIndex + _loc1_;
            if(_loc4_ < _loc2_)
            {
      ...
      {
         var _loc4_:int = param1.userInfo.trainerLevel;
         var _loc3_:int = param2.userInfo.trainerLevel;
         if(_loc4_ < _loc3_)
         {
            return 1;
         }
