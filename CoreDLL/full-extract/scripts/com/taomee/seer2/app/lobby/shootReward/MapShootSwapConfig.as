package com.taomee.seer2.app.lobby.shootReward
{
   ...
   public class MapShootSwapConfig
   {
      ...
      {
         var _loc1_:XML = null;
         var _loc2_:XMLList = _xml.descendants("label");
         for each(_loc1_ in _loc2_)
         {
            _labelMap.add(uint(_loc1_.@shootType),String(_loc1_.@name));
         }
      }
      ...
      private static function initRewardMap() : void
      {
         ...
         var _loc1_:XML = null;
         var _loc3_:XMLList = _xml.descendants("map");
         for each(_loc2_ in _loc3_)
         {
            ...
            {
               _loc5_.add(uint(_loc1_.@shootType),uint(_loc1_.@index));
            }
            _swapMap.add(uint(_loc2_.@id),_loc5_);
         }
      }
