package com.taomee.seer2.app.rightToolbar.toolbar
{
   ...
   public class OnlineRewardToolbar extends RightToolbar
   {
      ...
      private var _dayGetList:Vector.<Boolean> = Vector.<Boolean>([]);
      ...
      private function updateDayOnline() : void
      {
         DayLimitManager.getDoCount(900,function(param1:uint):void
         {
            ...
            _dayGetList[4] = (param1 & 0x10) == 16;
            _dayGetList[5] = (param1 & 0x20) == 32;
            _dayGetList[6] = (param1 & 0x40) == 64;
            setTime();
         });
      }
      ...
      private function setTime() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this._resideLevel)
         {
            if(this._dayGetList[_loc1_] == false)
            {
               _loc2_ = false;
               break;
            }
