package com.taomee.seer2.app.config
{
   ...
   public class VipConfig2
   {
      ...
      public static function setup() : void
      {
         ...
         var _loc2_:XMLList = _xml.descendants("vip");
         for each(_loc1_ in _loc2_)
         {
            _loc3_ = int(_loc1_.attribute("type"));
            switch(_loc3_ - 1)
            {
               case 0:
                  parserSawp(_loc1_);
               ...
               case 2:
                  ...
                  break;
               case 3:
                  parseLuckyGift(_loc1_);
                  break;
               case 4:
                  parseTurnTable(_loc1_);
            }
         }
      }
      ...
      {
         var _loc2_:int = int(param1.attribute("level"));
         var _loc4_:VipTurnTableInfo = new VipTurnTableInfo();
         var _loc3_:String = param1.attribute("rewardIcon");
         _loc4_.rewardIconVec = Vector.<int>(_loc3_.split(","));
         _loc3_ = param1.attribute("count");
         _loc4_.rewardCntVec = Vector.<int>(_loc3_.split(","));
         _turnTableMap.add(_loc2_,_loc4_);
      }
