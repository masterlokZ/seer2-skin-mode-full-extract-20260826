package com.taomee.seer2.app.controls.widget
{
   ...
   public class NewPlayerGetAwardWidgetClick extends Sprite implements IWidgetable
   {
      ...
      private function initSet() : void
      {
         ...
         ActiveCountManager.requestActiveCount(203024,function(param1:int, param2:int):void
         {
            var type:int = param1;
            var val:int = param2;
            if(val == 7)
            ...
            DayLimitManager.getDoCount(770,function(param1:int):void
            {
               if(param1 == 0)
               {
                  _tip.visible = true;
      ...
      {
         this._btn.addEventListener("click",this.onWidgetClick);
      }
