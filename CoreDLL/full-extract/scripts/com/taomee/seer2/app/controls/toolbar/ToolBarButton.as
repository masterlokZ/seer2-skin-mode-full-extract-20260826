package com.taomee.seer2.app.controls.toolbar
{
   ...
   public class ToolBarButton extends Sprite
   {
      ...
      {
         this._button.addEventListener("click",this.onMouseClick);
         this._button.addEventListener("rollOver",this.onMouseRollOver);
         this._button.addEventListener("rollOut",this.onMouseRollOut);
      }
      
      protected function clearEventListener() : void
      {
         this._button.removeEventListener("click",this.onMouseClick);
         this._button.removeEventListener("rollOver",this.onMouseRollOver);
         this._button.removeEventListener("rollOut",this.onMouseRollOut);
      }
