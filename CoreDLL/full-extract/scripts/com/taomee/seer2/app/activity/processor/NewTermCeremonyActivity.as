   ...
   public class NewTermCeremonyActivity extends EventDispatcher
   {
      ...
      public static function showMouseHint() : void
      {
         if(_isFromPanel)
         {
            ...
            _isFromPanel = false;
            ServerBufferManager.getServerBuffer(47,function(param1:ServerBuffer):void
            {
               var _loc2_:int = param1.readDataAtPostion(3);
               if(_loc2_ == 0)
               {
                  ServerBufferManager.updateServerBuffer(47,3,1);
                  DisplayObjectUtil.removeFromParent(_mouseHint);
      ...
      private function init() : void
      {
         ...
         this.getURL();
         DialogPanel.addEventListener("customUnitClick",this.unitClickHandler);
         DialogPanel.addEventListener("dialogShow",this.dialogShowHandler);
      }
      ...
      {
         DialogPanel.removeEventListener("customUnitClick",this.unitClickHandler);
         DialogPanel.removeEventListener("dialogShow",this.dialogShowHandler);
      }
      
      private function trainPanel() : void
      {
         var _loc2_:XML = new XML("<dialog npcId=\"153\" npcName=\"贾斯汀\" transport=\"\"><branch id=\"default\"><node emotion=\"0\"><![CDATA[你好!" + this._nick + "，不知道这个暑假你的精灵训练的怎么样了？就让我和克拉克站长为你的精灵做一次特别训练吧！]]></node>" + "<reply action=\"close\" params=\"kaixue_zizi\"><![CDATA[点击克拉克身旁的装置开始训练]]></reply>" + "<reply action=\"close\" params=\"\"><![CDATA[我不练了，去写作业了]]></reply></branch>" + "</dialog>");
         var _loc1_:DialogDefinition = new DialogDefinition(_loc2_);
         DialogPanel.addEventListener("dialogClosed",this.trainUnitClickHandler);
         DialogPanel.showForCommon(_loc1_);
      }
      
      private function trainUnitClickHandler(param1:DialogPanelEvent) : void
      {
         DialogPanel.removeEventListener("dialogClosed",this.trainUnitClickHandler);
      ...
      {
         var _loc2_:XML = new XML("<dialog npcId=\"153\" npcName=\"贾斯汀\" transport=\"\"><branch id=\"default\"><node emotion=\"0\"><![CDATA[你好！" + this._nick + "，关于赛尔II的知识你掌握了多少？敢不敢让我贾斯汀站长来考验一下？放心，题目不难的，答对有奖。]]></node>" + "<reply action=\"close\" params=\"jinguan_wen\"><![CDATA[好！尽管问！]]></reply>" + "<reply action=\"close\" params=\"wo_hen_ben\"><![CDATA[站长我妈妈说我很笨]]></reply></branch>" + "</dialog>");
         var _loc1_:DialogDefinition = new DialogDefinition(_loc2_);
         DialogPanel.addEventListener("dialogClosed",this.intelligenceUnitClickHandler);
         DialogPanel.showForCommon(_loc1_);
      }
      
      private function intelligenceUnitClickHandler(param1:DialogPanelEvent) : void
      {
         DialogPanel.removeEventListener("dialogClosed",this.intelligenceUnitClickHandler);
      ...
      {
         var _loc2_:XML = <dialog npcId="153" npcName="贾斯汀" transport=""><branch id="default"><node emotion="0"><![CDATA[终于要送出这份大礼了！X龙蛋会孵化出这个宇宙最为神秘的龙系精灵，非常珍贵，这次我只带来50000个，先领先得!]]></node><reply action="close" params="wo_yao_ling"><![CDATA[我要领!]]></reply></branch></dialog>;
         var _loc1_:DialogDefinition = new DialogDefinition(_loc2_);
         DialogPanel.addEventListener("dialogClosed",this.longdanUnitClickHandler);
         DialogPanel.showForCommon(_loc1_);
      }
      ...
      private function longdanUnitClickHandler(param1:DialogPanelEvent) : void
      {
         ...
         DialogPanel.removeEventListener("dialogClosed",this.longdanUnitClickHandler);
      ...
      private function getLongdanSuccess(param1:*) : void
      {
         ...
         ServerBufferManager.updateServerBuffer(47,2,1);
         ...
         DialogPanel.addEventListener("dialogClosed",this.getLongdanUnitClickHandler);
         DialogPanel.showForCommon(_loc3_);
      }
      
      private function getLongdanUnitClickHandler(param1:DialogPanelEvent) : void
      {
         DialogPanel.removeEventListener("dialogClosed",this.getLongdanUnitClickHandler);
      ...
      private function getLongdanFail(param1:*) : void
      {
         ...
         var _loc3_:DialogDefinition = new DialogDefinition(_loc2_);
         DialogPanel.addEventListener("dialogClosed",this.beLateUnitClickHandler);
         DialogPanel.showForCommon(_loc3_);
      }
      
      private function beLateUnitClickHandler(param1:DialogPanelEvent) : void
      {
         DialogPanel.removeEventListener("dialogClosed",this.beLateUnitClickHandler);
      ...
      {
         var _loc2_:XML = <dialog npcId="515" npcName="塔比丘" transport=""><branch id="default"><node emotion="0"><![CDATA[插播广告：9月15日（周六）13:30-14:00，站长离开时还会派发一批龙蛋，运送龙蛋的事情当然就交给我啦！ ]]></node><reply action="close" params="very_good"><![CDATA[太好了！  ]]></reply></branch></dialog>;
         var _loc1_:DialogDefinition = new DialogDefinition(_loc2_);
         DialogPanel.showForCommon(_loc1_);
      }
      ...
      {
         var _loc2_:XML = <dialog npcId="153" npcName="贾斯汀" transport=""><branch id="default"><node emotion="0"><![CDATA[你已经领过喽，每个小赛尔只能领1枚龙蛋哦。 ]]></node><reply action="close" params="ok"><![CDATA[是！站长！ ]]></reply></branch></dialog>;
         var _loc1_:DialogDefinition = new DialogDefinition(_loc2_);
         DialogPanel.showForCommon(_loc1_);
      }
      ...
      {
         var _loc2_:XML = <dialog npcId="153" npcName="贾斯汀" transport=""><branch id="default"><node emotion="0"><![CDATA[X龙蛋会孵化出这个宇宙最为神秘的龙系精灵，这次我只带来50000个，9月1日14:30开始就可以来我这里领取！ ]]></node><reply action="close" params="ok"><![CDATA[知道了。    ]]></reply></branch></dialog>;
         var _loc1_:DialogDefinition = new DialogDefinition(_loc2_);
         DialogPanel.showForCommon(_loc1_);
      }
      ...
      {
         this._box1.addEventListener("click",this.onOpenBoxHandler);
         this._box2.addEventListener("click",this.onOpenBoxHandler);
         this._box3.addEventListener("click",this.onOpenBoxHandler);
      }
      ...
      {
         var url:String = URLUtil.getActivityAnimation("xegg/guess");
