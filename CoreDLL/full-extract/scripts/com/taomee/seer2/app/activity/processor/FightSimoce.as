package com.taomee.seer2.app.activity.processor
{
   ...
   public class FightSimoce
   {
      ...
      private function startFight() : void
      {
         ...
         {
            if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord.initData.positionIndex == 161 && FightManager.fightWinnerSide != 1)
            {
            ...
            else if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord.initData.positionIndex == 162 && FightManager.fightWinnerSide != 1)
            {
