package com.taomee.seer2.app.firstTeach.guide.controller
{
   ...
   public class GudieFightController2 implements IFightController
   {
      ...
      private function parseTurn() : void
      {
         ...
         if(_loc1_)
         {
            if(SceneManager.currentSceneType == 11 && _loc1_.notifyIndex == 1)
            {
               this._scene.fightController.exitFight();
            }
            else if(SceneManager.currentSceneType == 14 && _loc1_.notifyIndex == 1)
            {
               this._scene.fightController.exitFight();
            }
            else if(SceneManager.currentSceneType == 12 && _loc1_.notifyIndex == 1)
            {
               this._scene.fightController.exitFight();
            }
            else if(SceneManager.currentSceneType == 15 && _loc1_.notifyIndex == 1)
            {
               this._scene.fightController.exitFight();
            }
