package com.taomee.seer2.app.actives
{
   ...
   public class KingSoulWithWindAct
   {
      ...
      public function setup() : void
      {
         ...
         {
            SceneManager.addEventListener("switchComplete",this.onChangeMap);
         }
      }
      ...
      private function onChangeMap(param1:SceneEvent) : void
      {
         ...
         {
            SceneManager.removeEventListener("switchComplete",this.onChangeMap);
            return;
         }
         ...
         {
            ActiveCountManager.requestActiveCount(203267,this.getState);
         }
      }
      ...
      private function createSceneMc() : void
      {
         if(!this._ALLMc)
         {
            QueueLoader.load(URLUtil.getActivityAnimation("ShowWindSoul"),"swf",this.getMc);
         }
         else
         {
            this.addMc();
      ...
      private function addMc() : void
      {
         if(this.mailer)
         {
            this.mailer.removeEventListener("click",this.showAd);
         }
         ...
         MovieClipUtil.playMc(this._ALLMc,1,this._ALLMc.totalFrames,function():void
         {
            ...
            mailer.addEventListener("click",showAd);
         });
      }
