package com.taomee.seer2.app.actives
{
   ...
   public class PetKingMatch2ClothAct
   {
      ...
      public function dispose() : void
      {
         ...
         ModuleManager.removeEventListener("PetKingMatch2ClothPanel","dispose",this.diposeModlue);
      ...
      public function setup() : void
      {
         if(this.army == 0)
         {
            ActiveCountManager.requestActiveCount(202997,this.getArmy);
         }
         else
         {
      ...
      private function checkIsGetMap() : void
      {
         ...
         this.currMobile = MobileManager.getMobile(this.MOBILE_IDS[this.setIndex],"npc");
         this.currMobile.removeOverHeadMark();
      ...
      private function onUnit(param1:DialogPanelEvent) : void
      {
         ...
         if(event.content.params == "getCloth")
         {
            ...
            {
               ModuleManager.addEventListener("PetKingMatch2ClothPanel","dispose",diposeModlue);
