package com.taomee.seer2.app.actives
{
   ...
   public class FindMiKaAct
   {
      ...
      public function setup() : void
      {
         ...
         DayLimitManager.getDoCount(1091,this.getLimit);
      }
      ...
      private function getLimit(param1:uint) : void
      {
         if(param1 < 10)
         {
            ...
            Connection.send(CommandSet.RANDOM_EVENT_1140,88,0);
         }
      }
      ...
      private function showPet() : void
      {
         ...
         this._npc.resourceUrl = URLUtil.getNpcSwf(749);
      ...
      protected function onNpcClick(param1:MouseEvent) : void
      {
         ...
         NpcDialog.show(749,"小丑米咔",[[0,"和我一起欢度愚人节吧！"]],[" 嗯嗯！ ","你的帽子真好看"],[function():void
         {
            FightManager.startFightWithWild(938);
         }]);
      }
   }
}
