package com.taomee.seer2.app.actives
{
   ...
   public class TongHunChapter2Support
   {
      ...
      private var mapList:Array = [910,920,950];
      
      private var valueList:Array = [0,1,2];
      
      private var pointList:Array = [new Point(676,193),new Point(819,212),new Point(1057,328)];
      ...
      private function getState(param1:uint, param2:uint) : void
      {
         ...
         if(QuestManager.isComplete(10229) && param2 == this.valueList[this.indexValue])
         {
            ...
            this.gameBtn.addEventListener("click",this.showGame);
      ...
      {
         LoadingBar.show("加载中...");
         QueueLoader.load(URLUtil.getMiniGameSwf("HideAndSeek"),"swf",this.loadComplete);
      }
      ...
      protected function overGame(param1:SyncEvent) : void
      {
         ...
         if(level >= 4)
         {
            ...
            this.gameBtn.removeEventListener("click",this.showGame);
            SwapManager.swapItem(2829,1,function(param1:IDataInput):void
            {
               new SwapInfo(param1);
