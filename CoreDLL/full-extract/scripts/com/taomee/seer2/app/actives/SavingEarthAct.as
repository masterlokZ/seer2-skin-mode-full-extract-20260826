package com.taomee.seer2.app.actives
{
   ...
   public class SavingEarthAct
   {
      ...
      private var _useTimes:Array = [0,60,60,120,120];
      ...
      public function dispose() : void
      {
         ...
         Tick.instance.removeRender(this.lightNpc);
         this.deviceMc.removeEventListener("click",this.showManhua);
         this.justin.removeEventListener("click",this.openPanel);
      }
      ...
      private function initRemove() : void
      {
         ...
         var _loc1_:Date = new Date(2012,12,21,21);
         var _loc3_:Number = _loc1_.getTime() - _loc2_.getTime();
         if(_loc3_ < 0)
         {
            _loc3_ = 0;
         }
      ...
      private function initMobile() : void
      {
         ...
         this.justin.addEventListener("click",this.openPanel);
         this.deviceMc = SceneManager.active.mapModel.content["deviceMc"];
         this.deviceMc.gotoAndStop(1);
         this.deviceMc.buttonMode = true;
         this.deviceMc.addEventListener("click",this.showManhua);
         this.checkTime(0);
      ...
      {
         var _loc2_:Date = new Date(TimeManager.getServerTime() * 1000);
         var _loc4_:Date = new Date(2012,12,21,20);
         var _loc3_:Date = new Date(2012,12,21,21);
