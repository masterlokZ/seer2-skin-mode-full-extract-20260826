package com.taomee.seer2.app.actives
{
   ...
   public class HeBenPetAct
   {
      ...
      public function dispose() : void
      {
         ...
         ModuleManager.removeEventListener("HeBenHurtAlertPanel","dispose",this.closeAlert);
         ModuleManager.removeEventListener("HeBenBuyPanel","dispose",this.closeBuy);
         if(!this.isToFight)
         {
      ...
      private function toFight(param1:MouseEvent) : void
      {
         ...
         {
            this.isToFight = true;
            FightManager.startFightWithBoss(463);
         }
         else
         {
            this.toExit();
      ...
      {
         ModuleManager.addEventListener("HeBenBuyPanel","dispose",this.closeBuy);
      ...
      {
         ModuleManager.addEventListener("HeBenHurtAlertPanel","dispose",this.closeAlert);
      ...
      {
         ActiveCountManager.requestActiveCountList([202312,202315],this.getNewInfo);
      }
