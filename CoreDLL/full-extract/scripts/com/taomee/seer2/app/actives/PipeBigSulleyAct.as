package com.taomee.seer2.app.actives
{
   ...
   public class PipeBigSulleyAct extends BaseActiveProcess
   {
      ...
      public function dispose() : void
      {
         ...
         while(_loc1_ < 3)
         {
            this.birdList[_loc1_].removeEventListener("click",this.getReward);
            _loc1_++;
         }
      }
      ...
      public function setup() : void
      {
         ...
         this.loadResouse(2,this.getRes);
      }
      ...
      private function getRes() : void
      {
         ...
         while(_loc1_ < 3)
         {
            ...
            this.birdList[_loc1_].addEventListener("click",this.getReward);
            _loc1_++;
         }
         ...
         this.birdNest.addEventListener("click",this.showPanel);
         this.birdNest.x = 267;
         this.birdNest.y = 206;
      ...
      private function getReward(param1:MouseEvent) : void
      {
         ...
         MovieClipUtil.playMc(this.outMc,1,this.outMc.totalFrames,function():void
         {
            ...
            MineManger.getMineItem(262,mineComplete);
         },true);
      }
      ...
      private function reqBirdNum(param1:Event = null) : void
      {
         ...
         ActiveCountManager.requestActiveCount(203162,this.getBirdNum);
      }
