package com.taomee.seer2.app.arena.controller
{
   ...
   public class BaseModeChange implements IFighterChange
   {
      ...
      public function changeFighter(param1:uint, param2:uint, param3:uint, param4:uint = 1) : void
      {
         ...
         _loc6_ = this.leftTeam.containsFighter(param1,param2);
         if(_loc6_ == true)
         {
            _loc5_ = this.leftTeam.getFighter(param1,param2);
            if(_loc5_ == null)
            {
               _loc5_ = this.leftTeam.getChangeFighter(param1,param2);
            }
            if(param4 == 1 && this.leftMainFighter.id != param2)
            {
               this.changeLeftMainFighter(_loc5_,param3);
            }
            else if(param4 == 2)
            {
               if(this.leftSubFighter == null || this.leftSubFighter && this.leftSubFighter.id != param2)
               {
                  this.changeLeftSubFighter(_loc5_,param3);
               }
            }
         }
         else if(this.rightTeam.getFighter(param1,param2) != null || this.rightTeam.getChangeFighter(param1,param2) != null)
         {
            ...
            {
               if(param4 == 1 && this.rightMainFighter.id != param2)
               {
            ...
            else if(param4 == 1 && this.rightMainFighter.id != param2)
            {
               this.saveRightFighter(param1,param2,param3,param4);
            }
            else if(param4 == 2 && (this.rightSubFighter && this.rightSubFighter.id != param2))
            {
               this.saveRightFighter(param1,param2,param3,param4);
            }
         }
      ...
      private function saveRightFighter(param1:uint, param2:uint, param3:uint, param4:uint = 1) : void
      {
         ...
         _loc5_ = this.rightTeam.getFighter(param1,param2);
         if(_loc5_ == null)
         {
      ...
      public function checkRightFighterChanged() : void
      {
         ...
         if(this._isRightFighterChanged == true)
         {
            ...
            if(_newRightFighter.fighterInfo.position == 0)
            {
               if(_newPosition == 1)
               {
                  this.rightMainFighter.disappear(2);
                  this.rightTeam.replaceFighterPositionWithActive(1,_newRightFighter);
                  _newRightFighter.updatePosition();
                  this._scene.mapModel.content.addChild(this.rightMainFighter);
               }
               else if(_newPosition == 2)
               {
                  this.rightSubFighter.disappear(2);
                  this.rightTeam.replaceFighterPositionWithActive(2,_newRightFighter);
                  _newRightFighter.updatePosition();
