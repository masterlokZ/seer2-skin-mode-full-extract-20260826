package com.taomee.seer2.app.arena.ui
{
   public class ButtonPanelData
   {
      ...
      {
         this.fightEnabled &&= param1.fightEnabled;
         this.catchEnabled &&= param1.catchEnabled;
         this.itemEnabled &&= param1.itemEnabled;
         this.petEnabled &&= param1.petEnabled;
         this.escapeEnabled &&= param1.escapeEnabled;
      }
