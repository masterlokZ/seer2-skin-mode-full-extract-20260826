package com.taomee.seer2.app.arena.animation.imples
{
   ...
   public class BaoJiHitAnimation extends BaseAnimation
   {
      ...
      override public function play() : void
      {
         ...
         {
            this._animationBaojiHit = FightAnimationResourcePool.checkOutMC("UI_BaoJiSkillHit");
         }
         addChild(this._animationBaojiHit);
         this._moviePlayer = new FighterMoviePlayer(this._animationBaojiHit,this.onAnimationEnd,40);
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this._animationBaojiHit != null)
         {
            FightAnimationResourcePool.checkInMC("UI_BaoJiSkillHit",this._animationBaojiHit);
