package com.taomee.seer2.app.arena.ui.status.substatusbar
{
   ...
   public class SubFighterStatusBar extends Sprite
   {
      ...
      public function update() : void
      {
         ...
         var _loc2_:Number = this._fighter.fighterInfo.hp / this._fighter.fighterInfo.maxHp;
         this._healthBar.initAtPercent(_loc2_);
         var _loc1_:Number = this._fighter.fighterInfo.fightAnger / this._fighter.fighterInfo.maxAnger;
         if(_loc2_ == 0)
         {
            _loc1_ = 0;
         }
         this._angerBar.initAtPercent(_loc1_);
