package com.taomee.seer2.app.arena.ui.status
{
   ...
   public class SkillBubble extends Sprite
   {
      ...
      public function SkillBubble(param1:uint)
      {
         ...
         var _loc2_:String = this._side == 1 ? "UI_FightSkillLeftBubble" : "UI_FightSkillRightBubble";
      ...
      public function dispose() : void
      {
         ...
         var _loc1_:String = this._side == 1 ? "UI_FightSkillLeftBubble" : "UI_FightSkillRightBubble";
