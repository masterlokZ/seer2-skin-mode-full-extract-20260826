package com.taomee.seer2.app.arena.animation.imples
{
   ...
   public class ItemUseAnimation extends BaseAnimation
   {
      ...
      override public function play() : void
      {
         ...
         {
            _loc2_ = this._itemUseResultInfo.hp - this._fighter.fighterInfo.hp;
            this.playHpRecoverAnimation(_loc2_);
         }
         else if(!this._fighter.fighterInfo.checkItemAnger(this._itemUseResultInfo))
         {
            _loc1_ = this._itemUseResultInfo.anger - this._fighter.fighterInfo.fightAnger;
            this.playAngerRecoverAnimation(_loc1_);
         }
      ...
      override public function dispose() : void
      {
         ...
         if(this._animation != null)
         {
            ...
            FightAnimationResourcePool.checkInMC("UI_FightAngerRecover",this._animation);
      ...
      private function playHpRecoverAnimation(param1:int) : void
      {
         if(this._animation == null)
         {
            this._animation = FightAnimationResourcePool.checkOutMC("UI_FightHpRecover");
            this._numContainer = new Sprite();
            addChild(this._numContainer);
         }
         this.deployAnimation(this._animation);
         addChild(this._animation);
         this._moviePlayer = new FighterMoviePlayer(this._animation,this.onAnimationEnd,40,1,this.onAnimationUpdate);
      ...
      private function playAngerRecoverAnimation(param1:int) : void
      {
         if(this._animation == null)
         {
            this._animation = FightAnimationResourcePool.checkOutMC("UI_FightAngerRecover");
         }
      ...
      private function createNumberSprite(param1:String, param2:int) : Sprite
      {
         ...
         while(_loc6_ < _loc7_)
         {
            _loc3_ = UIManager.getSprite(param1 + _loc4_[_loc6_]);
            _loc3_.x = (_loc6_ + 1) * _loc9_;
