package com.taomee.seer2.app.arena
{
   ...
   public class FightManager extends EventDispatcher
   {
      ...
      {
         var _loc5_:IFightRequest = null;
         LogArea.getInstance().addLog("1042协议发送战斗索引:" + param1);
         _loc5_ = new TrainMonster(param2,param3);
         _loc5_.startFight({
            "id":param1,
            "type":"fightTrainer"
         },param4);
      ...
      public static function startFightWithActivityBoss(param1:uint, param2:Function = null, param3:Function = null, param4:ButtonPanelData = null) : Number
      {
         ...
         _loc5_ = new ActivityBoss(param2,param3);
         _loc5_.startFight({"bossId":param1},param4);
         _fightRecords.add(_loc5_.uid,_loc5_.fightRecordData);
         _currentFightRecord = _loc5_.fightRecordData;
         return _loc5_.uid;
      }
      ...
      {
         var _loc4_:IFightRequest = null;
         _loc4_ = new GateMonster(param1,param2);
         _loc4_.startFight({},param3);
      ...
      {
         var _loc5_:IFightRequest = null;
         _loc5_ = new SelectPetCountFight(param2,param3);
         _loc5_.startFight({"type":param1},param4);
         _fightRecords.add(_loc5_.uid,_loc5_.fightRecordData);
         _currentFightRecord = _loc5_.fightRecordData;
         return _loc5_.uid;
      }
      ...
      {
         var _loc5_:IFightRequest = null;
         _loc5_ = new PVPWOHOOFight(param2,param3);
         _loc5_.startFight({
            "type":"fightPVPWohoo",
            "data":param1
         },param4);
      ...
      {
         var _loc5_:IFightRequest = null;
         _loc5_ = new PVPTrainerMatchFight(param2,param3);
         _loc5_.startFight({
            "type":"fightPVPTrainer",
            "data":param1
         },param4);
         _fightRecords.add(_loc5_.uid,_loc5_.fightRecordData);
         _currentFightRecord = _loc5_.fightRecordData;
      ...
      {
         var _loc6_:IFightRequest = null;
         LogArea.getInstance().addLog("1500协议发送战斗索引:" + param1);
         _loc6_ = new WildMonster(param2,param3);
         _loc6_.startFight({
            "positionIndex":param1,
            "type":"fightWild"
         },param4,param5);
      ...
      {
         var _loc4_:IFightRequest = null;
         _loc4_ = new FishBoss(param1,param2);
         _loc4_.startFight({},param3);
         _fightRecords.add(_loc4_.uid,_loc4_.fightRecordData);
         _currentFightRecord = _loc4_.fightRecordData;
         return _loc4_.uid;
      ...
      {
         var _loc9_:IFightRequest = null;
         _loc9_ = new SPTBoss(param3,param4);
         _loc9_.startFight({
            "bossId":param1,
            "params":param2,
            "type":"fightBoss",
      ...
      {
         var _loc7_:IFightRequest = null;
         _loc7_ = new NPCBoss(param4,param5);
         _loc7_.startFight({
            "positionIndex":param1,
            "count":param2,
            "lebData":param3
      ...
      {
         if(SceneManager.prevSceneType == 2 && isWinWar())
         {
            return true;
         }
         return false;
