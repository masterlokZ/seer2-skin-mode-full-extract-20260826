package org.taomee.manager
{
   ...
   public class ToolTipManager
   {
      ...
      {
         param1.addEventListener("rollOver",onOver);
         param1.addEventListener("rollOut",onOut);
         _map.add(param1,{
            "text":param2,
            "wordWrap":param4,
            "width":param3
      ...
      public static function remove(param1:InteractiveObject) : void
      {
         ...
         {
            param1.removeEventListener("rollOver",onOver);
            param1.removeEventListener("rollOut",onOut);
            _map.remove(param1);
         }
         onFinish();
      }
      ...
      {
         PopUpManager.showForMouse(_container,1,5,-5);
      }
      ...
      private static function onOver(param1:MouseEvent) : void
      {
         ...
         PopUpManager.showForMouse(_container,1,5,-5);
         TaomeeManager.stage.addEventListener("mouseMove",onMove);
      }
      
      private static function onFinish() : void
      {
         DisplayUtil.removeForParent(_container);
         TaomeeManager.stage.removeEventListener("mouseMove",onMove);
      }
