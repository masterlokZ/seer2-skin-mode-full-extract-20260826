package org.taomee.data
{
   ...
   public class HashMapProvider extends EventDispatcher
   {
      ...
      protected function dispatchPreChangeEvent(param1:String, param2:Array) : void
      {
         ...
         {
            dispatchEvent(new DataChangeEvent("preDataChange",param1,param2));
         }
      }
      ...
      public function dispatchSelectMulti(param1:IEventDispatcher, param2:Array, param3:Array) : void
      {
         ...
         while(_loc4_ < _loc5_)
         {
            _data.add(param2[_loc4_],param3[_loc4_]);
            _loc4_++;
         }
         param1.dispatchEvent(new DataChangeEvent("dataChange","select",param3.concat()));
      }
      ...
      public function remove(param1:*) : *
      {
         ...
         if(_loc2_)
         {
            dispatchChangeEvent("remove",[_loc2_]);
            return _loc2_;
         }
         return null;
      }
      ...
      public function addMulti(param1:Array, param2:Array) : Array
      {
         ...
         while(_loc4_ < _loc5_)
         {
            _loc3_ = _data.add(param1[_loc4_],param2[_loc4_]);
            if(_loc3_)
            {
               _loc6_.push(_loc3_);
            }
         ...
         dispatchChangeEvent("add",param2.concat());
         return _loc6_;
      }
      ...
      public function removeForValue(param1:*) : *
      {
         ...
         if(_loc2_)
         {
            ...
            if(_loc3_)
            {
               dispatchChangeEvent("remove",[_loc3_]);
               return _loc3_;
            }
         }
         return null;
      ...
      public function removeMulti(param1:Array) : Array
      {
         ...
         if(_loc2_.length > 0)
         {
            dispatchChangeEvent("remove",_loc2_.concat());
         }
         return _loc2_;
      }
      ...
      public function dispatchSelect(param1:IEventDispatcher, param2:*, param3:*) : void
      {
         ...
         param1.dispatchEvent(new DataChangeEvent("dataChange","select",[param3]));
      }
      ...
      public function removeMultiForValue(param1:Array) : Array
      {
         ...
         {
            _loc4_ = _data.getKey(_loc5_);
            if(_loc4_)
            {
               _loc2_ = _data.remove(_loc4_);
               if(_loc2_)
               {
                  _loc3_.push(_loc2_);
               }
         ...
         if(_loc3_.length > 0)
         {
            dispatchChangeEvent("remove",_loc3_.concat());
         }
         return _loc3_;
      }
      ...
      public function upDateForKey(param1:*, param2:*) : void
      {
         ...
         if(_data.containsKey(param1))
         {
            ...
            if(_loc3_)
            {
               dispatchPreChangeEvent("update",[_loc3_]);
            }
            dispatchChangeEvent("update",[param2]);
         }
      }
      ...
      public function add(param1:*, param2:*) : *
      {
         ...
         dispatchChangeEvent("add",[param2]);
         return _loc3_;
      }
      ...
      public function upDateForValue(param1:*, param2:*) : void
      {
         ...
         if(_loc3_)
         {
            ...
            dispatchPreChangeEvent("update",[param1]);
            dispatchChangeEvent("update",[param2]);
         }
      }
      ...
      protected function dispatchChangeEvent(param1:String, param2:Array) : void
      {
         ...
         {
            dispatchEvent(new DataChangeEvent("dataChange",param1,param2));
         }
      }
      ...
      public function removeAll() : void
      {
         ...
         _data.clear();
         dispatchChangeEvent("removeAll",_loc1_);
      }
   }
}
