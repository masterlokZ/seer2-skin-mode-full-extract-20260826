package com.taomee.seer2.app.config
{
   ...
   public class PetConfig
   {
      ...
      public static function getPetDefinitionResourceIds() : Vector.<int>
      {
         var resourceIds:Vector.<int> = new Vector.<int>();
         var keys:Array = _petDefinitionMap.getKeys();
         keys.sort(Array.NUMERIC);
         var i:int = 0;
         while(i < keys.length)
         {
            resourceIds.push(int(keys[i]));
            i++;
         }
         return resourceIds;
      }
