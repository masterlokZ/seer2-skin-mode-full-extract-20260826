package com.taomee.seer2.app.config
{
   ...
   public class SkillConfig
   {
      ...
      {
         var _loc7_:String = "";
         var _loc9_:uint = uint(param1.@ID);
         var _loc8_:String = param1.@Name;
         var _loc4_:uint = uint(param1.@Category);
         var _loc3_:uint = uint(param1.@Type);
         var _loc6_:uint = uint(param1.@Anger);
         var _loc5_:uint = uint(param1.@Power);
         var _loc2_:String = param1.@Tips;
         addSkillDefinition(_loc9_,_loc8_,_loc4_,_loc3_,_loc6_,_loc5_,_loc2_);
      }
