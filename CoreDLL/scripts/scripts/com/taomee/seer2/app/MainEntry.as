package com.taomee.seer2.app
{
   ...
   public class MainEntry
   {
      ...
      private function onSwitchComplete(param1:SceneEvent) : void
      {
         ...
         var dbgToolItem:ContextMenuItem;
         ...
         t.customItems.push(new ContextMenuItem("您的DLL版本：2026-07-12_13:05:46"));
         ...
         dbgToolItem = new ContextMenuItem("调试工具");
         t.customItems.push(dbgToolItem);
         dbgToolItem.addEventListener("menuItemSelect",function(param1:ContextMenuEvent):void
         {
