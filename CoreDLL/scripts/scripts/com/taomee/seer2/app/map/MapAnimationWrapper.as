package com.taomee.seer2.app.map
{
   ...
   public class MapAnimationWrapper
   {
      ...
      {
         this._startLabel = param1 + "_start";
         this._endLabel = param1 + "_end";
         this._loopTotal = 1;
         this._loopedCount = 0;
      ...
      public function loopLabel(param1:String, param2:int = 0, param3:Function = null) : void
      {
         this._startLabel = param1 + "_start";
         this._endLabel = param1 + "_end";
         this._loopTotal = param2 > 0 ? param2 : 2147483647;
         this._loopedCount = 0;
      ...
      {
         if(!this._source.hasEventListener("enterFrame"))
         {
            this._source.addEventListener("enterFrame",this.onSourceUpdate);
         }
      ...
      private function onSourceUpdate(param1:Event) : void
      {
         if(this._source.currentFrameLabel == this._endLabel)
         {
            ...
            {
               this._source.removeEventListener("enterFrame",this.onSourceUpdate);
               this._source.stop();
