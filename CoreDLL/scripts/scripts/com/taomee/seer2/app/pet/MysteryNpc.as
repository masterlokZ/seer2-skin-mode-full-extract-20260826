package com.taomee.seer2.app.pet
{
   ...
   public class MysteryNpc
   {
      ...
      private function onClick(param1:MouseEvent) : void
      {
         ...
         NpcDialog.show(555,"肥鸟",[[0,"哈哈，你被骗了吧，我不是什么神秘伊特哟"]],["气愤！"],[function():void
         {
            NpcDialog.show(555,"肥鸟",[[0,"我只是一只喜欢带着伊特帽子到处晃悠的肥鸟。"]],["啊！大骗子，你是大骗子！"],[function():void
            {
               NpcDialog.show(555,"肥鸟",[[0,"不过真正的神秘伊特也会出现的哟，在伊特锦标赛的闭幕式中，神秘伊特会来给大家见面的。"]],["太好了太好了。"],[function():void
               {
                  NpcDialog.show(555,"肥鸟",[[0,"既然你找到了我，那我就和你来一场战斗，你可以捕捉我哟，不过<font color=\'#ff00ff\'>5回合</font>后我会逃跑。当然，有<font color=\'#ff00ff\'>无敌精灵胶囊</font>会更容易捕捉到我。"]],["开战吧","我准备下"],[function():void
                  {
