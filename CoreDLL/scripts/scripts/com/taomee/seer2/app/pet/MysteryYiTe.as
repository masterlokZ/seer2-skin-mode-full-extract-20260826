   ...
   public class MysteryYiTe
   {
      ...
      private function onClick(param1:MouseEvent) : void
      {
         ...
         DayLimitManager.getDoCount(629,function(param1:int):void
         {
            ...
            var index1:int = date1 / 60 / 15;
            var index2:int = date2 / 60 / 15;
            hasFight = index1 == index2 ? true : false;
            if(hasFight)
            {
               NpcDialog.show(556,"神伊特",[[0,"你已经挑战过我了哟，等我下一次藏好之后你再来找我吧，找到了我就让你和我再对战一次。快去准备一下吧。"]],["过会再来找你"],[null]);
            }
            else
            {
               NpcDialog.show(556,"神伊特",[[0,"被你发现了，好吧，我就是伊特家族第12个伊特——神伊特！"]],["找的就是你！"],[function():void
               {
                  NpcDialog.show(556,"神伊特",[[0,"那帮伊特家伙都不是我的对手，要不要给你一个打败我的机会，赢了就可以得到我偷来的宝贝。"]],["快来战斗吧","我准备一下"],[function():void
                  {
