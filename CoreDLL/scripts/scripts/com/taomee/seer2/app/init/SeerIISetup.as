package com.taomee.seer2.app.init
{
   ...
   public class SeerIISetup extends BaseBean
   {
      ...
      override public function start() : void
      {
         ...
         LayerManager.stage.addEventListener("mouseMove",this.onMove);
         finish();
      }
      ...
      private function onMove(param1:MouseEvent) : void
      {
         ...
         this._time = setTimeout(this.outTime,300000);
      }
      ...
      private function outTime() : void
      {
         ...
         if(SceneManager.currentSceneType == 11)
         {
            return;
         }
         if(SceneManager.currentSceneType == 12)
         {
            return;
         }
         if(SceneManager.currentSceneType == 13)
         {
            return;
         }
         ...
         if(SceneManager.currentSceneType == 15)
         {
            return;
         }
         if(SceneManager.currentSceneType == 16)
         {
            return;
         }
      ...
      private function checkCover() : void
      {
         ...
         if(this._coverUI == null)
         {
            ...
            this._coverUI.addEventListener("click",this.onCover);
         }
      }
      ...
      private function onCover(param1:MouseEvent) : void
      {
         ...
         {
            this.open();
            this.onMove(new MouseEvent("mouseMove"));
         }
      }
