package com.taomee.seer2.app.manager
{
   ...
   public class WebJumpManager
   {
      ...
      public static function toBBSForId(param1:uint) : void
      {
         ...
         {
            var _loc2_:uint = WebJumpConfig.Instance.getInfo(id).tid;
            var _loc1_:String = currType + "?username=" + userId + "&gid=" + ClientConfig.productID + "&session=" + GlobalsManager.session + "&fid=37" + "&tid=" + _loc2_;
