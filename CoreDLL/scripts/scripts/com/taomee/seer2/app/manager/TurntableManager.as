package com.taomee.seer2.app.manager
{
   ...
   public class TurntableManager
   {
      ...
      public function start() : void
      {
         ...
         this._objectRotation.addEventListener("enterFrame",this.Onrotation);
      }
      
      public function over() : void
      {
         this._objectRotation.removeEventListener("enterFrame",this.Onrotation);
      }
      ...
      {
         var _loc10_:Number = 360 * (Math.floor(Math.random() * (param4 - param3)) + param3);
         var _loc8_:Number = 360 / param1 * param2;
         var _loc7_:Number = 360 / param1 * param5;
         var _loc9_:Number = Math.floor(Math.random() * (360 / param1) * (1 - 2 * param6)) + 360 / param1 * param6;
         return _loc10_ + _loc8_ + _loc7_ + _loc9_;
      }
   }
}
