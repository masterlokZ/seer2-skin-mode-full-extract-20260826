package com.taomee.seer2.app.manager
{
   ...
   public class FengHuangEvolutionManager
   {
      ...
      public static function init(param1:MapModel) : void
      {
         ...
         QueueLoader.load(URLUtil.getActivityAnimation("fenghuangevolutionAct/fenghuangevolutionAct"),"swf",function(param1:ContentInfo):void
         {
            ...
            _petMc.addEventListener("click",onNpcClick);
            ...
            {
               vipMc.gotoAndStop(2);
               SimpleButton(vipMc["addVipBtn"]).addEventListener("click",onAddVip);
            }
            updateDate();
         });
      }
      ...
      private static function onNpcClick(param1:MouseEvent) : void
      {
         ...
         ServerBufferManager.getServerBuffer(366,function(param1:ServerBuffer):void
         {
            var server:ServerBuffer = param1;
            var _isPlay:Boolean = Boolean(server.readDataAtPostion(1));
            if(!_isPlay)
            {
               ServerBufferManager.updateServerBuffer(366,1,1);
