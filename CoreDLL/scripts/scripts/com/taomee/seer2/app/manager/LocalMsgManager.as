package com.taomee.seer2.app.manager
{
   ...
   public class LocalMsgManager
   {
      ...
      {
         ServerBufferManager.getServerBuffer(21,this.getBuffer);
      }
      ...
      private function getBuffer(param1:ServerBuffer) : void
      {
         ...
         _loc2_ = param1.readDataAtPostion(1);
         if(_loc2_ == 0)
         {
         }
         _loc2_ = param1.readDataAtPostion(2);
         QueueLoader.load(URLUtil.getNoticeSetting(),"text",this.onSettingDataLoaded);
      ...
      {
         var _loc3_:Object = null;
         var _loc2_:uint = uint(this._noticeSettingData.@version);
         var _loc1_:String = this._noticeSettingData.elements("content");
         if(_loc2_ > this._curtVersion)
         {
         }
      }
   }
