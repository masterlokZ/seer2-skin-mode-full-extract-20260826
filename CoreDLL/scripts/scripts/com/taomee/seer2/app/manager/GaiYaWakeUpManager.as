package com.taomee.seer2.app.manager
{
   ...
   public class GaiYaWakeUpManager
   {
      ...
      private static var npcArr:Array = [];
      ...
      public static function init() : void
      {
         ...
         ToolBar.show();
         QueueLoader.load(URLUtil.getActivityAnimation("gaiyawakeup/gaiyawakeupfirst"),"swf",onResLoaded);
      }
         ...
         ActiveCountManager.requestActiveCountList([250315],function(param1:Parser_1142):void
         {
            ...
            DayLimitManager.getDoCount(5119,function(param1:int):void
            {
               ...
               else
               {
                  ...
                  MobileManager.addMobile(_npcBoss,"npc");
                  _npcBoss.addEventListener("click",onFightBoss);
               }
            });
         });
      }
      ...
      private static function onSure(param1:EventWithString) : void
      {
         ...
         DayLimitManager.getDoCount(5120,function(param1:int):void
         {
            ...
            else
            {
               ...
               _resMc6["boomBtn"].addEventListener("click",onBoom);
               _resMc6["itemShop"].addEventListener("click",onItemShop);
               _loc2_ = 0;
      ...
      private static function createNPC(param1:Point) : void
      {
         ...
         npcArr.push(_loc2_);
         _loc2_.addEventListener("click",onFightWild);
      }
      ...
      private static function updateTime1(param1:uint) : void
      {
         ...
         if(leftTime <= 0)
         {
            ...
            MovieClipUtil.playMc(_resMc4,2,_resMc4.totalFrames,function():void
            {
               ...
               _resMc5["btn"].addEventListener("click",onCard);
            });
         }
         else
         {
      ...
      public static function dispose() : void
      {
         ...
         if(_npcBoss)
         {
            MobileManager.removeMobile(_npcBoss,"npc");
            _npcBoss = null;
         }
         if(_resMc5)
         {
