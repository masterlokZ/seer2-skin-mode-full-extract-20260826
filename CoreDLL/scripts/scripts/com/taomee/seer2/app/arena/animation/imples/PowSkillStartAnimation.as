package com.taomee.seer2.app.arena.animation.imples
{
   ...
   public class PowSkillStartAnimation extends BaseAnimation
   {
      ...
      override public function play() : void
      {
         ...
         {
            this._animationSkillStart = FightAnimationResourcePool.checkOutMC("UI_PowerSkillStart");
         }
         ...
         this._moviePlayer = new FighterMoviePlayer(this._animationSkillStart,this.onAnimationEnd,40);
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this._animationSkillStart != null)
         {
            ...
            FightAnimationResourcePool.checkInMC("UI_PowerSkillStart",this._animationSkillStart);
