package com.taomee.seer2.app.arena.cmd
{
   ...
   public class ArenaResourceLoadCMD implements IArenaBaseCMD
   {
      ...
      private function onGetResourceInfo(param1:MessageEvent) : void
      {
         ...
         this._arenaData.fightMode = _loc3_.readUnsignedByte();
         var _loc5_:TeamInfo = new TeamInfo(_loc3_,this._arenaData.fightMode);
         var _loc4_:TeamInfo = new TeamInfo(_loc3_,this._arenaData.fightMode);
         if(_loc5_.clientSide == 1)
         {
            theSide = 1;
            this._arenaData.leftTeam = new FighterTeam(_loc5_);
            this._arenaData.rightTeam = new FighterTeam(_loc4_);
         }
         else
         {
            theSide = 2;
            this._arenaData.rightTeam = new FighterTeam(_loc5_);
         ...
         this._arenaData.fightWeather = _loc3_.readUnsignedByte();
         this._arenaData.canCatch = _loc3_.readUnsignedByte() == 0;
