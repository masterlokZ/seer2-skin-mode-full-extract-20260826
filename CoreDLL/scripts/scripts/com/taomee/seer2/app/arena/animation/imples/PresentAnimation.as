package com.taomee.seer2.app.arena.animation.imples
{
   ...
   public class PresentAnimation extends BaseAnimation
   {
      ...
      override public function initialize() : void
      {
         ...
         {
            this._animation = FightAnimationResourcePool.checkOutMC("UI_FightPresent");
         }
      ...
      {
         this._moviePlayer = new FighterMoviePlayer(this._animation,this.onAnimationEnd,40);
         this._timeOutId = setTimeout(this.onPresent,45 * 40);
      }
      ...
      override public function dispose() : void
      {
         ...
         FightAnimationResourcePool.checkInMC("UI_FightPresent",this._animation);
