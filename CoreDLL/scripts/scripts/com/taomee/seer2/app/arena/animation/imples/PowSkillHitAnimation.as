package com.taomee.seer2.app.arena.animation.imples
{
   ...
   public class PowSkillHitAnimation extends BaseAnimation
   {
      ...
      override public function play() : void
      {
         ...
         {
            this._animationSkillHit = FightAnimationResourcePool.checkOutMC("UI_PowerSkillHit");
         }
         addChild(this._animationSkillHit);
         this._moviePlayer = new FighterMoviePlayer(this._animationSkillHit,this.onAnimationEnd,40);
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this._animationSkillHit != null)
         {
            ...
            FightAnimationResourcePool.checkInMC("UI_PowerSkillHit",this._animationSkillHit);
