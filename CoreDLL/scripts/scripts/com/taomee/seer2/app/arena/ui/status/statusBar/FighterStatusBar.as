package com.taomee.seer2.app.arena.ui.status.statusBar
{
   ...
   public class FighterStatusBar extends Sprite
   {
      ...
      protected function loadIcon() : void
      {
         ...
         var _loc3_:Sprite = this.getCurIconDisplayerParent();
         _loc3_.addChildAt(this._iconDisplayer,_loc3_.numChildren - 2);
      ...
      protected function updateHealthBar() : void
      {
         ...
         this._healthBar.playToPercent(_loc1_);
         this._healthShadowBar.playToPercent(_loc1_);
      }
      
      protected function updateAngerBar() : void
      {
         var _loc2_:FighterInfo = this._fighter.fighterInfo;
         var _loc1_:Number = _loc2_.fightAnger / _loc2_.maxAnger;
         this._angerBar.playToPercent(_loc1_);
      }
