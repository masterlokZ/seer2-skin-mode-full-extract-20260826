package com.taomee.seer2.app.arena.cmd
{
   ...
   public class GudieArenaResourceLoadCMD8 implements IArenaBaseCMD
   {
      ...
      public function send() : void
      {
         ...
         _loc2_.writeUnsignedInt(10043);
         _loc2_.writeUnsignedInt(10044);
         _loc2_.writeUnsignedInt(10045);
         ...
         _loc2_.writeUnsignedInt(500);
         _loc2_.writeUnsignedInt(5);
         _loc2_.writeUnsignedInt(10009);
         _loc2_.writeUnsignedInt(10010);
         _loc2_.writeUnsignedInt(10011);
         _loc2_.writeUnsignedInt(10012);
         _loc2_.writeUnsignedInt(10013);
         _loc2_.writeUnsignedInt(0);
         _loc2_.writeUnsignedInt(0);
         _loc2_.writeByte(0);
         _loc2_.writeByte(0);
