package com.taomee.seer2.app.arena.ui.status.panel
{
   ...
   public class DoubleFightStatusPanel extends FightStatusPanel
   {
      ...
      override public function updatePetPress() : void
      {
         ...
         {
            _loc2_ = uint(PetPressConfig.getPressColor(_arenaData.leftTeam.mainFighter.fighterInfo.typeId,_arenaData.rightTeam.mainFighter.fighterInfo.typeId));
            _leftMainFighterBar.updatePetPress(_loc2_);
         }
         if(_arenaData.leftTeam.subFighter)
         {
            _loc1_ = uint(PetPressConfig.getPressColor(_arenaData.leftTeam.subFighter.fighterInfo.typeId,_arenaData.rightTeam.subFighter.fighterInfo.typeId));
            this._leftSubFighterBar.updatePetPress(_loc1_);
         }
      }
      ...
      override protected function createBuffIconBar(param1:uint) : void
      {
         if(param1 == 1)
         {
            this._leftBuffIconBar = new BuffIconBar(1,5);
            addChild(this._leftBuffIconBar);
         }
         else if(param1 == 2)
         {
            this._rightBuffIconBar = new BuffIconBar(2,5);
