package com.taomee.seer2.app.arena.vibration
{
   ...
   public class VerticalVibration
   {
      ...
      public function vibrate(param1:DisplayObject) : void
      {
         ...
         this._target.addEventListener("enterFrame",this.onTargetEnterFrame);
      }
      ...
      {
         if(this._target.hasEventListener("enterFrame"))
         {
            this._target.removeEventListener("enterFrame",this.onTargetEnterFrame);
