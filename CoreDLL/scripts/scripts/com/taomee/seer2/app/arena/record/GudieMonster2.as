package com.taomee.seer2.app.arena.record
{
   ...
   public class GudieMonster2 implements IFightRequest
   {
      ...
      public function startFight(param1:Object, param2:ButtonPanelData, param3:Number = -1) : void
      {
         ...
         FightManager.dispatchEvent(new FightStartEvent("START_SUCCESS"));
         AlertManager.closeAllPopUp();
         switch(this._gudieIndex)
         {
            case 0:
               SceneManager.changeScene(10,SceneManager.active.fightMapId);
               break;
            case 1:
               SceneManager.changeScene(11,SceneManager.active.fightMapId);
               break;
            case 2:
               SceneManager.changeScene(12,SceneManager.active.fightMapId);
               break;
            case 3:
               SceneManager.changeScene(13,SceneManager.active.fightMapId);
               break;
            case 4:
               SceneManager.changeScene(14,SceneManager.active.fightMapId);
               break;
            case 5:
               SceneManager.changeScene(15,SceneManager.active.fightMapId);
               break;
            case 6:
               SceneManager.changeScene(16,SceneManager.active.fightMapId);
         }
      }
   }
}
