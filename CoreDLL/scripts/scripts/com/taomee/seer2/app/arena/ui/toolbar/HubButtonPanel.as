package com.taomee.seer2.app.arena.ui.toolbar
{
   ...
   public class HubButtonPanel extends Sprite
   {
      ...
      private function addGudie() : void
      {
         ...
         GuideManager.instance.addGuide2Target(this._itemBtn,0,1,new Point(777,527),true,true,9);
         GuideManager.instance.addTarget(this._catchBtn,4);
         GuideManager.instance.addGuide2Target(this._catchBtn,0,4,new Point(870,453),true,true,9);
      }
