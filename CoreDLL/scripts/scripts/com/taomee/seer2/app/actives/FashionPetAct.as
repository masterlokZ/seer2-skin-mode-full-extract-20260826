package com.taomee.seer2.app.actives
{
   ...
   public class FashionPetAct
   {
      ...
      {
         if(SceneManager.active.type == 8 && SceneManager.active.mapID == ActorManager.actorInfo.id)
         {
            this.createNpc();
         }
      }
      ...
      {
         this.npc.removeEventListener("click",this.showPanel);
      }
      ...
      private function createNpc() : void
      {
         ...
         this.npc.addEventListener("click",this.showPanel);
      }
