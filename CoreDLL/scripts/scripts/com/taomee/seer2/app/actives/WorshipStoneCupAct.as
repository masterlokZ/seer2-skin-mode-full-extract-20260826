   ...
   public class WorshipStoneCupAct
   {
      ...
      private function createStoneCup() : void
      {
         if(!this.stoneCup)
         {
            ...
            TooltipManager.addCommonTip(this.stoneCup,"朝拜月神");
         }
      ...
      private function getWorshipState(param1:int, param2:uint) : void
      {
         ...
         var _loc3_:int = 0;
         this.preTime = param2;
         var _loc6_:Number = TimeManager.getServerTime() - this.preTime;
         if(_loc6_ < 600)
         {
            _loc5_ = 600 - _loc6_;
            _loc4_ = _loc5_ / 60;
            _loc3_ = _loc5_ % 60;
            AlertManager.showAlert("你已经朝拜过一次了，离下次朝拜还有" + _loc4_ + "分" + _loc3_ + "秒!");
            return;
         }
      ...
      private function getBuffer(param1:ServerBuffer) : void
      {
         ...
         var state:int = buffer.readDataAtPostion(14);
         if(state == 0)
         {
            MovieClipUtil.playFullScreen(URLUtil.getActivityFullScreen("MoonStoryFull"),function():void
            {
               ...
               ServerBufferManager.updateServerBuffer(57,14,1);
            },true,true);
         }
         else
         {
