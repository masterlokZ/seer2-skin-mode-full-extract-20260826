package com.taomee.seer2.app.actives
{
   ...
   public class MakeSnowmanAct
   {
      ...
      {
         this.createNpc();
         if(SceneManager.prevSceneType == 2 && !FightManager.isWinWar() && FightManager.currentFightRecord.initData.positionIndex == this.fightId)
         {
         ...
         DialogPanel.addEventListener("customReplyClick",this.onReplayClick);
      ...
      private function onReplayClick(param1:DialogPanelEvent) : void
      {
         if((param1.content as DialogPanelEventData).params == "showClickMouse")
         {
            ...
            this.mouseHit.x = 790;
            this.mouseHit.y = 130;
            SceneManager.active.mapModel.content["house"].addEventListener("click",this.hideTips);
      ...
      {
         SceneManager.active.mapModel.content["house"].removeEventListener("click",this.hideTips);
      ...
      private function getSwapCount(param1:int) : void
      {
         if(param1 == 0 && Boolean(this.cap))
         {
            ...
            this.cap.addEventListener("click",this.swapHandler);
         }
         else if(this.cap)
         {
      ...
      public function dispose() : void
      {
         if(this.shovelMobile)
         {
            ...
            this.shovelMobile.removeEventListener("click",this.clickShovel);
            this.shovelMobile.clear();
         }
         if(this.snowpetMobile)
         {
            this.snowpetMobile.removeEventListener("click",this.toDia);
      ...
      private function createNpc() : void
      {
         ...
         this.shovelMobile.addEventListener("click",this.clickShovel);
      ...
      private function isGetHandler(param1:uint = 0) : void
      {
         ...
         else
         {
            ...
            this.snowpetMobile.addEventListener("click",this.toDia);
         }
      }
      ...
      {
         ServerBufferManager.getServerBuffer(57,this.getServerBuffer);
      }
      
      private function getServerBuffer(param1:ServerBuffer) : void
      {
         var buffer:ServerBuffer = param1;
         var isPlay:Boolean = Boolean(buffer.readDataAtPostion(6));
         if(isPlay)
         {
         ...
         else
         {
            ...
            {
               ServerBufferManager.updateServerBuffer(57,6,1);
      ...
      private function showComplete(param1:ModuleEvent) : void
      {
         ...
         MovieClipUtil.playFullScreen(URLUtil.getActivityFullScreen("makeSnowMan"),function():void
         {
            ...
            MovieClipUtil.playFullScreen(URLUtil.getActivityFullScreen("snowPetShow"),function():void
            {
               ...
               snowpetMobile.addEventListener("click",toDia);
            },false,false,1,false);
         },false,false,1,false);
      }
   }
