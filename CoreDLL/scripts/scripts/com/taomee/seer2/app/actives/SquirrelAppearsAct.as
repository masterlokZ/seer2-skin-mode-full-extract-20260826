package com.taomee.seer2.app.actives
{
   ...
   public class SquirrelAppearsAct
   {
      ...
      private var needTimes:Array = [0,300,600];
      ...
      public function dispose() : void
      {
         ...
         if(this.squirrelEat)
         {
            this.squirrelEat.removeEventListener("click",this.showDia);
            MobileManager.removeMobile(this.squirrelEat,"npc");
         }
         if(this.squirrelHouse)
         {
            TooltipManager.remove(this.squirrelHouse);
            this.squirrelHouse.removeEventListener("click",this.showActPanel);
            this.squirrelHouse.removeEventListener("click",this.showDia);
            this.squirrelHouse.removeEventListener("click",this.clickHouse);
            MobileManager.removeMobile(this.squirrelHouse,"npc");
         }
      }
      ...
      private function checkState() : void
      {
         ...
         {
            this.squirrelHouse.addEventListener("click",this.clickHouse);
            return;
         }
         ...
         {
            this.squirrelHouse.addEventListener("click",this.showActPanel);
         }
      }
      ...
      private function showSquirreEat() : void
      {
         ...
         MobileManager.addMobile(this.squirrelEat,"npc");
         this.squirrelEat.addEventListener("click",this.showDia);
         this.squirrelHouse.addEventListener("click",this.showDia);
      }
      ...
      private function createSquirrelHouse() : void
      {
         ...
         MobileManager.addMobile(this.squirrelHouse,"npc");
      }
      
      private function showActPanel(param1:MouseEvent) : void
      {
         ModuleManager.addEventListener("SquirrelAppearsPanel","show",this.showComplete);
      ...
      {
         ModuleManager.removeEventListener("SquirrelAppearsPanel","show",this.showComplete);
