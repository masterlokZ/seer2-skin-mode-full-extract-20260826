package com.taomee.seer2.app.hotheartyanleishaevolutionLei
{
   ...
   public class HotHeartYanLeiShaEvolutionLeiManager
   {
      ...
      private static function createNPCBOSS() : void
      {
         ...
         _npcBOSS.labelPosition = 1;
         _npcBOSS.label = "冥·雷煞";
         _npcBOSS.buttonMode = true;
         MobileManager.addMobile(_npcBOSS,"npc");
         _npcBOSS.addEventListener("click",onBOSSClick);
      }
      ...
      private static function createNPC630() : void
      {
         ...
         _npc630.labelPosition = 1;
         _npc630.label = "雷煞";
         _npc630.buttonMode = true;
         MobileManager.addMobile(_npc630,"npc");
         _npc630.addEventListener("click",onNpcClick);
      }
      ...
      public static function dispose() : void
      {
         if(_npc630)
         {
            _npc630.removeEventListener("click",onNpcClick);
            MobileManager.removeMobile(_npc630,"npc");
            _npc630 = null;
         }
         if(_npcBOSS)
         {
            _npcBOSS.removeEventListener("click",onBOSSClick);
