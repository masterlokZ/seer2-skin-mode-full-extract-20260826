package com.taomee.seer2.app.activity.processor.callLeiyi
{
   ...
   public class ActivityMapHandler_860 extends ActivityMapHandler
   {
      ...
      {
         ServerBufferManager.getServerBuffer(37,function(param1:ServerBuffer):void
         {
      ...
      private function playFullMC() : void
      {
         ...
         {
            ServerBufferManager.updateServerBuffer(37,1,1);
            addSoldiers();
            addMachine();
         },true,false,2);
      }
      ...
      private function playFullMCLast() : void
      {
         ...
         {
            ServerBufferManager.updateServerBuffer(37,2,1);
            addMachine();
         },true,false,2);
      }
      ...
      {
         var _loc1_:ActivityWildPet = null;
         this._activityMonsterVec = new Vector.<ActivityPet>();
         var _loc2_:uint = 0;
         while(_loc2_ < 4)
         {
            _loc1_ = new ActivityWildPet(9);
            _loc1_.addEventListener("click",this.onPet);
      ...
      {
         var _loc2_:int = NumberUtil.random(1,3);
      ...
      private function NpcOneSpeak() : void
      {
         ...
         {
            FightManager.startFightWithWild(151);
         }]);
      }
      ...
      {
         var _loc1_:String = URLUtil.getActivityAnimation("callLeiyi/machine");
      ...
      private function onTakePicLoaded(param1:ContentInfo) : void
      {
         ...
         this._machine.addEventListener("click",this.openPanelHandler);
      }
      ...
      private function removeMonster() : void
      {
         ...
         if(this._activityMonsterVec)
         {
            ...
            {
               this._activityMonsterVec[_loc1_].removeEventListener("click",this.onPet);
               _loc1_++;
            }
            MobileManager.clearMobileVec("activityMonster");
         }
      }
