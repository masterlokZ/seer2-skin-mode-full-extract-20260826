package com.taomee.seer2.app.activity.processor.flameBattle
{
   ...
   public class FlameBattleMapHandler extends ActivityMapHandler
   {
      ...
      private function showLeavingDialog() : void
      {
         ...
         if(blueFraction > redFraction)
         {
            _loc2_ = <dialog npcId="31" npcName="巴拉卡" transport="300,400"><branch id="default"><node emotion="2"><![CDATA[你得勇敢为我们照亮了前进的道路，我尊重你这样的英雄！]]></node><reply action="close" ><![CDATA[点击关闭]]></reply></branch></dialog>;
         }
         else
         {
            _loc2_ = <dialog npcId="32" npcName="洛克" transport="300,400"><branch id="default"><node emotion="4"><![CDATA[只要跟着我混，保管你吃香的喝辣的！下次还要来帮我哦！]]></node><reply action="close" ><![CDATA[点击关闭]]></reply></branch></dialog>;
         }
      ...
      private function onLeavingDialogClosed(param1:DialogCloseEvent) : void
      {
         ...
         SceneManager.changeScene(1,261,470,390);
      }
   }
}
