package com.taomee.seer2.app.activity.summoned
{
   ...
   public class Summoned
   {
      ...
      {
         this._badiMobile.addEventListener("click",this.summonedBadi);
         this._duoluoMobile.addEventListener("click",this.summonedDuoluo);
      }
      ...
      private function initActivityUI() : void
      {
         ...
         this._confirmBtn.addEventListener("click",this.onSend);
      ...
      public function dispostContainer() : void
      {
         if(this._container)
         {
            ...
            Connection.removeCommandListener(CommandSet.ITEM_EXCHANGE_1055,this.onRequestSwap);
            Connection.removeCommandListener(CommandSet.SET_SUMMONED_ID_1077,this.onSetSummonedID);
            this._passwordTxt.removeEventListener("change",this.onPasswordChange);
            this._confirmBtn.removeEventListener("click",this.onSend);
