package com.taomee.seer2.app.activity.processor.PrizeCeremony
{
   ...
   public class FightPrating
   {
         ...
         else
         {
            NpcDialog.show(505,"光系精灵帕拉丁同学",[[0,"圣战赋予我们光芒和荣耀！小赛尔，你已经经历过争霸赛的洗礼，每天的14:30-15:00，我接受你的挑战！ 挑战5次，你就有可能捕捉到我！"]],["好！那就开始吧！","我要准备一下先"],[function():void
            {
               if(DateUtil.inInDateScope(5,14,30,15,1) || DateUtil.inInDateScope(6,14,30,15,1) || DateUtil.inInDateScope(0,14,30,15,1) || DateUtil.inInDateScope(1,14,30,15,1) || DateUtil.inInDateScope(2,14,30,15,1) || DateUtil.inInDateScope(3,14,30,15,1) || DateUtil.inInDateScope(4,14,30,15,1))
               {
                  ...
                  StatisticsManager.sendNovice("0x10033260");
               }
               else
               {
      ...
      private function initResult() : void
      {
         ...
         {
            if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord.initData.positionIndex == 142 && FightManager.fightWinnerSide != 1)
            {
