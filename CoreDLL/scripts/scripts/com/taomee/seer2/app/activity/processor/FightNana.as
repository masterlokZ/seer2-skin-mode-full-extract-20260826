package com.taomee.seer2.app.activity.processor
{
   ...
   public class FightNana
   {
      ...
      private function begainFight() : void
      {
         ...
         if(Boolean(SceneManager.active) && SceneManager.active.mapID == 900)
         {
            if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord.initData.positionIndex == 126 && FightManager.fightWinnerSide != 1)
            {
            ...
            else if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord.initData.positionIndex == 128 && FightManager.fightWinnerSide != 1)
            {
