   ...
   public class QuestMapHandler_30_390 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         if(QuestManager.isCanAccepted(_quest.id) && QuestManager.isAccepted(_quest.id) == false)
         {
            ...
            this._diNpc.addEventListener("click",this.onAcceptClick);
         }
      ...
      {
         if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord && FightManager.currentFightRecord.initData && FightManager.currentFightRecord.initData.positionIndex && FightManager.currentFightRecord.initData.positionIndex == 9 && FightManager.fightWinnerSide == 1)
         {
            this.createNpc_1_1();
            _quest.setStepData(1,0,1);
            QuestManager.setStepBufferServer(_quest.id,1);
            this._aXiuNpc.addEventListener("click",this.onShowDialog_1_1);
            this.showDialog_1_1();
         }
         else if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord && FightManager.currentFightRecord.initData && FightManager.currentFightRecord.initData.positionIndex && FightManager.currentFightRecord.initData.positionIndex == 9 && FightManager.fightWinnerSide == 2)
         {
            this.createNpc_1_1();
            this._shaNpc.addEventListener("click",this.onShowFailDialog_1_0);
            this.showFailDialog_1_0();
         }
         else if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord && FightManager.currentFightRecord.initData && FightManager.currentFightRecord.initData.positionIndex && FightManager.currentFightRecord.initData.positionIndex == 10 && FightManager.fightWinnerSide == 1)
         {
            this.createNpc_1_1();
            _quest.setStepData(1,0,1);
            QuestManager.setStepBufferServer(_quest.id,1);
         ...
         else if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord && FightManager.currentFightRecord.initData && FightManager.currentFightRecord.initData.positionIndex && FightManager.currentFightRecord.initData.positionIndex == 10 && FightManager.fightWinnerSide == 2)
         {
            this.createNpc_1_1();
            this._shaNpc.addEventListener("click",this.onShowFailDialog_1_1);
         ...
         else if(_quest.getStepData(1,0) == 0)
         {
            ...
            this._tinaNpc.addEventListener("click",this.onShowDialog_1_0);
         }
         ...
         else if(_quest.getStepData(1,0) == 2)
         {
            this.createNpc_1_1();
            this.addAskMark(this._tinaNpc);
            this._tinaNpc.addEventListener("click",this.onShowDialog_1_2);
         }
         else if(_quest.getStepData(1,0) == 3)
         {
            this.createNpc_1_1();
            this.addAskMark(this._tinaNpc);
            this._tinaNpc.addEventListener("click",this.onShowDialog_1_3);
         }
         ...
         else if(_quest.getStepData(1,0) == 5)
         {
            ...
            this._diNpc.addEventListener("click",this.onShowDialog_1_4);
         }
      }
      ...
      {
         this.clearAskMark();
         this._tinaNpc.removeEventListener("click",this.onShowDialog_1_0);
         this.showDialog_1_0();
      }
      ...
      private function showDialog_1_0() : void
      {
         NpcDialog.show(39,"缇娜",[[0,"哈哈，吾等很早以前就想尝试一下博士的新技术了……！阿修！"]],["博士的新技术？"],[function():void
         {
            ...
            {
               FightManager.addEventListener("START_ERROR",onStartFightError_1_0);
               FightManager.addEventListener("START_SUCCESS",onStartFight_1_0);
               FightManager.startFightWithNPC(9);
            }]);
         }]);
      }
      ...
      {
         FightManager.removeEventListener("START_ERROR",this.onStartFightError_1_0);
         FightManager.removeEventListener("START_SUCCESS",this.onStartFight_1_0);
      }
      ...
      {
         this.clearAskMark();
         this._shaNpc.removeEventListener("click",this.onShowFailDialog_1_0);
         this.showFailDialog_1_0();
      }
      ...
      private function showFailDialog_1_0() : void
      {
         ...
         {
            FightManager.addEventListener("START_ERROR",onStartFightError_1_1);
            FightManager.addEventListener("START_SUCCESS",onStartFight_1_1);
            FightManager.startFightWithNPC(10);
         }]);
      }
      
      private function onStartFight_1_1(param1:FightStartEvent) : void
      {
         FightManager.removeEventListener("START_ERROR",this.onStartFightError_1_1);
         FightManager.removeEventListener("START_SUCCESS",this.onStartFight_1_1);
      }
      ...
      {
         this.clearAskMark();
         this._shaNpc.removeEventListener("click",this.onShowFailDialog_1_1);
         this.showFailDialog_1_1();
      }
      ...
      private function showFailDialog_1_1() : void
      {
         ...
         {
            FightManager.addEventListener("START_ERROR",onStartFightError_1_2);
            FightManager.addEventListener("START_SUCCESS",onStartFight_1_2);
            FightManager.startFightWithNPC(10);
         }]);
      }
      ...
      {
         FightManager.removeEventListener("START_ERROR",this.onStartFightError_1_2);
         FightManager.removeEventListener("START_SUCCESS",this.onStartFight_1_2);
      }
      ...
      {
         this.clearAskMark();
         this._aXiuNpc.removeEventListener("click",this.onShowDialog_1_1);
         this.showDialog_1_1();
      }
      ...
      private function showDialog_1_1() : void
      {
         NpcDialog.show(13,"阿修",[[1,"不愧是二大酋长，受伤了仍然有这样的势力。看来不用那个……不行了。"]],["来什么都不怕！！"],[function():void
         {
            MovieClipUtil.playFullScreen(URLUtil.getQuestFullScreenAnimation("30_0"),function():void
            {
               ...
               QuestManager.setStepBufferServer(_quest.id,1);
               _tinaNpc.addEventListener("click",onShowDialog_1_2);
               showDialog_1_2();
            });
         }]);
      }
      ...
      {
         this.clearAskMark();
         this._tinaNpc.removeEventListener("click",this.onShowDialog_1_2);
         this.showDialog_1_2();
      }
                        ...
                        NpcDialog.show(56,"神爪财团老板",[[1,"哈哈，也许我们的确看彼此不顺眼……但是！在面对萨伦帝国的事情上……我们从来都是一致的！！"]],["太好了！！"],[function():void
                        {
                           NpcDialog.show(13,"阿修",[[1,"那你们就……试试看！"]],["上啊！！"],[function():void
                           {
                              MovieClipUtil.playFullScreen(URLUtil.getQuestFullScreenAnimation("30_1"),function():void
                              {
                                 ...
                                 QuestManager.setStepBufferServer(_quest.id,1);
                                 _tinaNpc.addEventListener("click",onShowDialog_1_3);
                                 showDialog_1_3();
                              });
                           }]);
                        }]);
      ...
      {
         this.clearAskMark();
         this._tinaNpc.removeEventListener("click",this.onShowDialog_1_3);
         this.showDialog_1_3();
      }
      ...
      private function processStep_1_4() : void
      {
         ...
         MovieClipUtil.playMc(this._tinaIn,1,this._tinaIn.totalFrames,function():void
         {
            ...
            QuestManager.setStepBufferServer(_quest.id,1);
            _diNpc.addEventListener("click",onShowDialog_1_4);
            showDialog_1_4();
         },true);
      }
      ...
      {
         this.clearAskMark();
         this._diNpc.removeEventListener("click",this.onShowDialog_1_4);
         this.showDialog_1_4();
      }
      ...
      private function onAcceptClick(param1:MouseEvent) : void
      {
         ...
         this._diNpc.removeEventListener("click",this.onAcceptClick);
         NpcDialog.show(55,"神月老大",[[3,"胆敢……愚弄洒家！洒家不会饶恕你们！！"]],["老大你已经受伤了啊！"],[function():void
         {
            NpcDialog.show(56,"神爪财团老板",[[3,"哼……受伤又如何？愚弄我族之人，将我族人的未来玩弄于股掌……如果我不击退他们，我怎么保护我的族人？！我还做什么老板？！！"]],["大老板……！"],[function():void
            {
               ...
               {
                  QuestManager.addEventListener("accept",onAccepted);
