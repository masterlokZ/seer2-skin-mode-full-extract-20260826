package com.taomee.seer2.app.processor.quest.handler.story.quest23
{
   ...
   public class QuestMapHandler_23_3100 extends QuestMapHandler
   {
      ...
      private function processStep1() : void
      {
         ...
         this._mamaNpc["mama"].addEventListener("click",this.onShowDialogStep1_0);
      }
      ...
      private function onShowDialogStep1_0(param1:MouseEvent) : void
      {
         ...
         this._mamaNpc["mama"].removeEventListener("click",this.onShowDialogStep1_0);
      ...
      {
         if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord && FightManager.currentFightRecord.initData && FightManager.currentFightRecord.initData.positionIndex && FightManager.currentFightRecord.initData.positionIndex == 5 && FightManager.fightWinnerSide == 1)
         {
            ...
            this._dishaNpc["sha"].addEventListener("click",this.onDiNpcClickStep2_1);
            this.showStep2_1();
         }
         else if(SceneManager.prevSceneType == 2 && (FightManager.currentFightRecord && FightManager.currentFightRecord.initData && FightManager.currentFightRecord.initData.positionIndex && (FightManager.currentFightRecord.initData.positionIndex == 5 && FightManager.fightWinnerSide == 2 || FightManager.currentFightRecord.initData.positionIndex == 6)))
         {
            this.showStep2_2();
         }
         else
      ...
      private function showStep2_0() : void
      {
         ...
         this._dishaNpc["di"].addEventListener("click",this.onDiNpcClickStep2_0);
      }
      
      private function onDiNpcClickStep2_0(param1:MouseEvent) : void
      {
         FightManager.startFightWithNPC(5);
      }
      ...
      private function showStep2_1() : void
      {
         ...
         {
            FightManager.startFightWithNPC(6);
         }]);
      }
      ...
      {
         if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord.initData.positionIndex == 7)
         {
            this.showStep3_1();
         }
         else
      ...
      private function showStep3_0() : void
      {
         ...
         this._xianZhiNpc.addEventListener("click",this.onShowDialogStep3_0);
      }
      ...
      private function onShowDialogStep3_0(param1:MouseEvent) : void
      {
         ...
         NpcDialog.show(57,"先知",[[0,"……此人……留不得……必须铲除……"]],["（喂喂！）"],[function():void
         {
            ...
            {
               FightManager.startFightWithNPC(7);
            }]);
         }]);
      }
      ...
      private function onCompleteStep3(param1:QuestEvent) : void
      {
         if(param1.questId == _quest.id)
         {
            ...
            SceneManager.changeScene(1,390);
         }
      }
      ...
      private function clearDiShaNpc() : void
      {
         if(this._dishaNpc)
         {
            ...
            this._dishaNpc["sha"].removeEventListener("click",this.onDiNpcClickStep2_1);
            this._dishaNpc["di"].removeEventListener("click",this.onDiNpcClickStep2_0);
      ...
      private function clearXianZhiNpc() : void
      {
         if(this._xianZhiNpc)
         {
            this._xianZhiNpc.removeEventListener("click",this.onShowDialogStep3_0);
