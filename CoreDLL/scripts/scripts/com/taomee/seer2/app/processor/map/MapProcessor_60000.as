package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_60000 extends MapProcessor
   {
      ...
      public function MapProcessor_60000(param1:MapModel)
      {
         ...
         this._btn0.addEventListener("click",this.onTeamBtnClick);
         this._btn1.addEventListener("click",this.onTeamNewsClick);
      }
      ...
      {
         if(!TeamManager.teamEffectStatusArr[5 - 1])
         {
      ...
      override public function dispose() : void
      {
         ...
         this._btn0.removeEventListener("click",this.onTeamBtnClick);
         this._btn1.removeEventListener("click",this.onTeamNewsClick);
         super.dispose();
      }
   }
}
