package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80367 extends MapProcessor
   {
      ...
      private function createNpc() : void
      {
         ...
         this.bossNpc.resourceUrl = URLUtil.getNpcSwf(832);
      ...
      private function toFight(param1:MouseEvent) : void
      {
         ...
         NpcDialog.show(832,"雷小伊",[[0,"你有能力战胜我吗？战胜后有机会获得雷伊石哦！"]],["马上挑战","我是路过的"],[function():void
         {
            FightManager.startFightWithWild(792);
         }]);
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this.bossNpc)
         {
            this.bossNpc.removeEventListener("click",this.toFight);
         }
