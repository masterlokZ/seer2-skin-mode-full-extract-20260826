package com.taomee.seer2.app.processor.quest.handler.story.quest58
{
   ...
   public class QuestMapHandler_58_930 extends QuestMapHandler
   {
      ...
      override public function processMapDispose() : void
      {
         ...
         DialogPanel.removeEventListener("customUnitClick",this.showNpcTalk);
      ...
      {
         var _loc2_:MovieClip = _processor.resLib.getMovieClip("gaspotContainer");
         this.gaspot = new Vector.<MovieClip>();
         _map.content.addChild(_loc2_);
         var _loc1_:int = 0;
         while(_loc1_ < 9)
         {
            this.gaspot.push(_loc2_["gaspot" + _loc1_]);
            this.gaspot[_loc1_].buttonMode = true;
            this.gaspot[_loc1_].mouseChildren = false;
            this.gaspot[_loc1_].mouseEnabled = false;
            this.gaspot[_loc1_].addEventListener("click",this.collectGaspot);
            _loc1_++;
         }
         ...
         _loc2_.addChild(this.clickMark);
      ...
      private function onStep(param1:QuestEvent) : void
      {
         ...
         if(event.questId == _quest.id && event.stepId == 4)
         {
            ...
            {
               SceneManager.changeScene(1,940,444,485);
            });
         }
      }
      ...
      private function initStep1() : void
      {
         MovieClipUtil.playFullScreen(URLUtil.getQuestFullScreenAnimation("58_0"),function():void
         {
            ...
            _npc.addEventListener("click",showDia);
         });
      }
      ...
      private function showDia(param1:MouseEvent) : void
      {
         ...
         DialogPanel.addEventListener("customReplyClick",this.showNpcTalk);
      }
      ...
      private function onCompleteStep(param1:QuestEvent) : void
      {
         ...
         {
            SceneManager.changeScene(1,940);
