package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_3834 extends MapProcessor
   {
      ...
      private var _tm:Timer = new Timer(2500,1);
      ...
      {
         this._tm.removeEventListener("timer",this.onTimer);
      }
      ...
      override public function init() : void
      {
         ...
         (_map.content["npcMc"] as MovieClip).addEventListener("click",this.onDialog);
      }
      ...
      private function animationFunc() : void
      {
         ...
         MovieClip(_map.content["shootMc"]).addEventListener("click",this.onClick);
      }
      ...
      private function onClick(param1:MouseEvent) : void
      {
         this._tm.reset();
         this._tm.start();
         MovieClip(_map.content["shootMc"]).removeEventListener("click",this.onClick);
