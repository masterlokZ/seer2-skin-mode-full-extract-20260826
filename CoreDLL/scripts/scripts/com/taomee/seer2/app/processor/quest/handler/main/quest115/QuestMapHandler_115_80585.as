package com.taomee.seer2.app.processor.quest.handler.main.quest115
{
   ...
   public class QuestMapHandler_115_80585 extends QuestMapHandler
   {
      ...
      private var _dialogs0:Array = [[10,"巴蒂",[[0,"什么嘛！明明计划得那么完美，居然还是晕倒了！现在看着还是感觉很火大啊！"]],["放宽心吧，只要没事就好了。"]],[11,"多罗",[[0,"真……真是有惊无险啊…… "]],["不过为什么巴蒂会晕倒呢？"]],[10,"巴蒂",[[0,"我也纳闷啊！明明从机关那里掉下来都没事！ "]],["现在生气也没有用了，看看之后是怎样的吧。"]],[10,"巴蒂",[[0,"说的也是，我倒要看看究竟是什么居然能让最聪明的我晕倒！"]],["……"]]];
      ...
      private function initStep0() : void
      {
         ...
         {
            SceneManager.changeScene(9,80584);
         });
      }
   }
}
