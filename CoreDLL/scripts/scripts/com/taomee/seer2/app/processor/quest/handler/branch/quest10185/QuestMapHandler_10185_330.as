   ...
   public class QuestMapHandler_10185_330 extends QuestMapHandler
   {
      ...
      private function toStep4() : void
      {
         NpcDialog.show(this.monkeyID,"火爆猴",[[4,"所以我早就忘记什么叫开心了！没什么好开心的！"]],["!!!!"],[function():void
         {
            ...
            {
               ModuleManager.addEventListener("HitMonkeyPanel","dispose",closePanel);
      ...
      {
         ModuleManager.removeEventListener("HitMonkeyPanel","dispose",this.closePanel);
      ...
      private function onComplete(param1:QuestEvent) : void
      {
         if(param1.questId == 10185)
         {
            ...
            MobileManager.removeMobile(this.monkeyMobile,"npc");
            this.monkeyMobile.removeEventListener("click",this.clickMonkey);
