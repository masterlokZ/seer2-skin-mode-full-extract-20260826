package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_980 extends TitleMapProcessor
   {
      ...
      public static const SECONDS_HALF_HOUR:Number = 3600;
      ...
      {
         StatisticsManager.sendNovice("0x10033258");
      ...
      private function checkFightHandler() : void
      {
         ...
         if(_loc1_ == 147)
         {
            ...
            {
               ServerBufferManager.updateServerBuffer(123,15,1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this._bigCar)
         {
            this._bigCar.removeEventListener("click",this.OnBigCarHandler);
            this._bigCar = null;
         }
         if(this._pet)
         {
            this._pet.removeEventListener("click",this.OnPetHandler);
            this._pet = null;
         }
