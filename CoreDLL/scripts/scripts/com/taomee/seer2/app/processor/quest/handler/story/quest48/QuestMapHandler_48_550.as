   ...
   public class QuestMapHandler_48_550 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         if(!QuestManager.isAccepted(_quest.id))
         {
            ...
            _loc2_ = <npc id="114" resId="114" name="蒂芙伦" dir="1" width="25" height="120" pos="421,464"
            ...
            this.stiffNpc = MobileManager.createNpc(new NpcDefinition(_loc2_));
            this.stiffNpc.buttonMode = true;
            _loc1_ = new AcceptableMark();
            this.stiffNpc.addOverHeadMark(_loc1_);
            DialogPanel.addEventListener("customReplyClick",this.playNpcTalk);
         }
      }
      ...
      private function playNpcTalk(param1:DialogPanelEvent) : void
      {
         ...
         {
            DialogPanel.removeEventListener("customReplyClick",this.playNpcTalk);
      ...
      private function onAccept(param1:QuestEvent) : void
      {
         if(param1.questId == _quest.id)
         {
            ...
            SceneManager.changeScene(1,540);
         }
      }
