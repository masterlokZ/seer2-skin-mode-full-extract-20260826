package com.taomee.seer2.app.processor.activity.candyTree
{
   ...
   public class CandyTreeManager
   {
      ...
      {
         this._water.addEventListener("click",this.onWater);
         this._flower.addEventListener("click",this.onFlowe);
         this._staticMC.addEventListener("click",this.onFlowe);
      }
      ...
      {
         PlantMouse.endMouse();
         this._water.removeEventListener("click",this.onWater);
         this._flower.removeEventListener("click",this.onFlowe);
         this._staticMC.removeEventListener("click",this.onFlowe);
         if(this._timer)
         {
            this._timer.stop();
            this._timer.removeEventListener("timer",this.onTimer);
