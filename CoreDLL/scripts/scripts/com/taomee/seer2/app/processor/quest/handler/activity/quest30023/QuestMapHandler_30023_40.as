package com.taomee.seer2.app.processor.quest.handler.activity.quest30023
{
   ...
   public class QuestMapHandler_30023_40 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         {
            DialogPanel.addEventListener("customUnitClick",this.talkCompleteHandler);
         }
      ...
      {
         var _loc2_:BaseUnit = new CustomUnit("quest","我是宣传委员","i_am_commissary_30023_40");
         if(QuestManager.isAccepted(_quest.id) && !QuestManager.isStepComplete(_quest.id,1))
         {
      ...
      private function talkCompleteHandler(param1:DialogPanelEvent) : void
      {
         ...
         if(event.content.params == "i_am_commissary_30023_40")
         {
            if(PetKingTeamAttach.myTeamIndex == 2)
            {
      ...
      private function initMc() : void
      {
         ...
         this._decorateMc.addEventListener("click",this.playProgressbar);
      }
      ...
      private function playProgressbar(param1:MouseEvent) : void
      {
         ...
         this._decorateMc.removeEventListener("click",this.playProgressbar);
      ...
      private function destory(param1:Event = null) : void
      {
         ...
         DialogPanel.removeEventListener("customUnitClick",this.talkCompleteHandler);
      }
   }
}
