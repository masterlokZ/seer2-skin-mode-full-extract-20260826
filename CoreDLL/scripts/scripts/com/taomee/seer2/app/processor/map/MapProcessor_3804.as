package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_3804 extends MapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         {
            MobileManager.removeMobile(MobileManager.getMobile(437,"npc"),"npc");
         ...
         if(!QuestManager.isStepComplete(10188,2))
         {
            if(SceneManager.prevSceneType == 2)
            {
               ...
               {
                  DialogPanel.removeEventListener("customReplyClick",this.onDiaEvent);
                  this.playFull();
               }
               else
               {
            ...
            {
               DialogPanel.addEventListener("customReplyClick",this.onDiaEvent);
            }
         }
      }
