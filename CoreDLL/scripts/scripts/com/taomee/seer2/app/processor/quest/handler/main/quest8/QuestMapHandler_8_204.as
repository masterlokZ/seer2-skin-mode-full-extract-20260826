package com.taomee.seer2.app.processor.quest.handler.main.quest8
{
   ...
   public class QuestMapHandler_8_204 extends QuestMapHandler
   {
      ...
      {
         if(_quest.isStepCompete(4) && !_quest.isStepCompete(5))
         {
            this.extractAssets();
         }
      }
      ...
      private function processStep5() : void
      {
         ...
         this._haimaPet.addEventListener("click",this.onClickHaima1);
      }
         ...
         TweenLite.to(this._haimaPet,1,{
            ...
            "onComplete":function():void
            {
               ...
               else
               {
                  ...
                  _haimaPet.removeEventListener("click",onClickHaima1);
                  _haimaPet.addEventListener("click",onClickHaima2);
                  _rockBtn.addEventListener("click",onClickRockBtn);
                  _ropeBtn.addEventListener("click",onClickRopeBtn);
      ...
      private function onClickRopeBtn(param1:MouseEvent) : void
      {
         ...
         if(this._hasRockDown)
         {
            ...
            this._pullPetClick1.addEventListener("click",this.onClickPullPet);
            this._pullPetClick2.addEventListener("click",this.onClickPullPet);
            this._clickAreaCount = 0;
            if(this._pullTimer == null)
            {
               this._pullTimer = new Timer(5000);
               this._pullTimer.addEventListener("timer",this.onPullTimer);
            }
      ...
      override public function processMapDispose() : void
      {
         if(this._haimaPet != null)
         {
            ...
            this._haimaPet.removeEventListener("click",this.onClickHaima1);
            this._haimaPet.removeEventListener("click",this.onClickHaima2);
            this._rockBtn.removeEventListener("click",this.onClickRockBtn);
            this._ropeBtn.removeEventListener("click",this.onClickRopeBtn);
            this._pullPetClick1.removeEventListener("click",this.onClickPullPet);
            this._pullPetClick2.removeEventListener("click",this.onClickPullPet);
         }
         if(this._pullTimer != null)
         {
            this._pullTimer.stop();
            this._pullTimer.removeEventListener("timer",this.onPullTimer);
         }
      }
   }
}
