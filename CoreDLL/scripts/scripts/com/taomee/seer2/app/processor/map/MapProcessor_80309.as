package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80309 extends MapProcessor
   {
      ...
      private function aKaNaSiSuperProcessActInit() : void
      {
         ...
         {
            DayLimitManager.getDoCount(1327,function(param1:int):void
            {
               var val:int = param1;
               ActiveCountManager.requestActiveCount(204703,function(param1:uint, param2:uint):void
               {
      ...
      private function fightHandle() : void
      {
         ...
         if(!_isFirst)
         {
            ...
            MovieClipUtil.playMc(this._sceneMC,2,this._sceneMC.totalFrames,function():void
            {
               ...
               _water.visible = true;
               _water.addEventListener("click",onWaterClick);
            });
         }
         else
         {
            ...
            this._water.addEventListener("click",this.onWaterClick);
         }
      }
      ...
      private function aKaNaSiSuperProcessActDispose() : void
      {
         ...
         if(this._water)
         {
            this._water.removeEventListener("click",this.onWaterClick);
            this._water = null;
         }
      }
