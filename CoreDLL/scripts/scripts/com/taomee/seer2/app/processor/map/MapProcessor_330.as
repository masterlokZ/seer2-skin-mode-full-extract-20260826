package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_330 extends TitleMapProcessor
   {
      ...
      {
         this.initAdBorad();
         StatisticsManager.sendNovice("0x10033438");
      }
      ...
      private function initAdBorad() : void
      {
         ...
         this._adBoardClick.addEventListener("click",this.onAdBoardClick);
      }
      
      private function onAdBoardClick(param1:MouseEvent) : void
      {
         DisplayObjectUtil.disableSprite(this._adBoardClick);
         this._adBoard.addEventListener("enterFrame",this.onAdBoardEnd);
      ...
      private function onAdBoardEnd(param1:Event) : void
      {
         ...
         {
            this._adBoard.removeEventListener("enterFrame",this.onAdBoardEnd);
            DisplayObjectUtil.enableSprite(this._adBoardClick);
         }
      }
      ...
      {
         this._adBoardClick.removeEventListener("click",this.onAdBoardClick);
         this._adBoard.removeEventListener("enterFrame",this.onAdBoardEnd);
         this._adBoard = null;
