package com.taomee.seer2.app.processor.quest.handler.branch.quest10144
{
   ...
   public class QuestMapHandler_10144_10108 extends QuestMapHandler
   {
      ...
      private function initStep3() : void
      {
         ...
         this.xiaolv.addEventListener("click",this.showDia);
      }
      
      private function showDia(param1:MouseEvent) : void
      {
         var event:MouseEvent = param1;
         this.xiaolv.removeEventListener("click",this.showDia);
      ...
      private function clickCounter(param1:MouseEvent) : void
      {
         ...
         this.counter.removeEventListener("click",this.clickCounter);
      ...
      private function initStep5() : void
      {
         ...
         this.counter.addEventListener("click",this.showDiaCounter);
      }
      
      private function showDiaCounter(param1:MouseEvent) : void
      {
         var event:MouseEvent = param1;
         this.counter.removeEventListener("click",this.showDiaCounter);
      ...
      private function initStep4() : void
      {
         ...
         this.santaClaus.addEventListener("click",this.showSantaClausDia);
      }
      ...
      protected function showSantaClausDia(param1:MouseEvent) : void
      {
         var event:MouseEvent = param1;
         DisplayObjectUtil.removeFromParent(this.mark);
         this.santaClaus.removeEventListener("click",this.showSantaClausDia);
      ...
      private function startCreateShalun() : void
      {
         ...
         LayerManager.stage.addEventListener("mouseMove",this.changeBallSeat);
         this.killNum = 0;
      ...
      private function clearShalun() : void
      {
         ...
         {
            this.runList[_loc1_].removeEventListener("finished",this.onCompleteMove);
            this.runList[_loc1_].removeEventListener("click",this.killShalun);
            MobileManager.removeMobile(this.runList[_loc1_],"pet");
            _loc1_++;
         }
         Mouse.show();
         LayerManager.mapLayer.removeEventListener("mouseMove",this.changeBallSeat);
      ...
      private function createShalun(param1:int) : void
      {
         ...
         _loc2_.addEventListener("finished",this.onCompleteMove);
         _loc2_.addEventListener("click",this.killShalun);
         _loc2_.walkToLocation(645,245);
         MobileManager.addMobile(_loc2_,"pet");
      ...
      private function killShalun(param1:MouseEvent) : void
      {
         ...
         shalun.stand();
         MobileManager.removeMobile(shalun,"pet");
         ++this.killNum;
         if(this.killNum >= 15)
         {
            this.clearShalun();
