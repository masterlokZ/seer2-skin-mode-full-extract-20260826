package com.taomee.seer2.app.processor.quest.handler.story.quest36
{
   ...
   public class QuestMapHandler_36_730 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         if(SceneManager.prevSceneType == 2 && QuestManager.isStepComplete(_quest.id,2) && QuestManager.isStepComplete(_quest.id,3) == false && _fightStatus == 1)
         {
            _fightStatus = 0;
            this.initNpc();
      ...
      {
         var _loc5_:XML = <npc id="95" resId="95" name="" dir="0" width="25" height="90" pos="539,512" actorPos="489,433"
                              path="">
         ...
         this._npcDefinition = new NpcDefinition(_loc5_);
         this._npc = MobileManager.createNpc(this._npcDefinition);
         var _loc4_:XML = <npc id="96" resId="96" name="" dir="1" width="25" height="90" pos="470,543" actorPos="489,433"
                              path="">
         ...
         this._npcDefinition_2 = new NpcDefinition(_loc4_);
         this._npc_2 = MobileManager.createNpc(this._npcDefinition_2);
         var _loc7_:XML = <npc id="97" resId="97" name="" dir="0" width="25" height="90" pos="687,457" actorPos="487,398"
                              path="">
         ...
         this._npcDefinition_3 = new NpcDefinition(_loc7_);
         this._npc_3 = MobileManager.createNpc(this._npcDefinition_3);
         var _loc6_:XML = <npc id="93" resId="93" name="" dir="1" width="25" height="90" pos="639,528" actorPos="478,395"
                              path="">
         ...
         this._npcDefinition_4 = new NpcDefinition(_loc6_);
         this._npc_4 = MobileManager.createNpc(this._npcDefinition_4);
         var _loc2_:XML = <npc id="98" resId="98" name="" dir="1" width="25" height="90" pos="582,421" actorPos="389,438"
                              path="">
         ...
         this._npcDefinition_5 = new NpcDefinition(_loc2_);
         this._npc_5 = MobileManager.createNpc(this._npcDefinition_5);
         var _loc1_:XML = <npc id="99" resId="99" name="" dir="1" width="25" height="90" pos="663,436" actorPos="710,209"
                              path="">
         ...
         this._npcDefinition_6 = new NpcDefinition(_loc1_);
         this._npc_6 = MobileManager.createNpc(this._npcDefinition_6);
         var _loc3_:XML = <npc id="99" resId="99" name="" dir="0" width="25" height="90" pos="772,454" actorPos="710,209"
                              path="">
            <dialog npcId="99" npcName="财务官卫兵" transport="1,300,400">
                <branch id="default">
                    <node emotion="0"><![CDATA[命运与巧合，往往只有一线之差……]]></node>
         ...
         this._npcDefinition_7 = new NpcDefinition(_loc3_);
      ...
      private function initNpcEvent(param1:int) : void
      {
         ...
         else if(param1 == 3)
         {
            ...
            this._npc_3.addEventListener("click",this.onNpc3);
         }
         else if(param1 == 4)
         {
            this._npc_4.buttonMode = true;
            this._npc_4.addEventListener("click",this.onNpc4);
         }
         else if(param1 == 5)
         {
            this._npc_5.buttonMode = true;
            this._npc_5.addEventListener("click",this.onNpc5);
         }
      }
