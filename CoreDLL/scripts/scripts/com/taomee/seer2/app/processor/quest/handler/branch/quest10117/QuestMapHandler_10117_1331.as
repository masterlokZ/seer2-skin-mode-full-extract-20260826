   ...
   public class QuestMapHandler_10117_1331 extends QuestMapHandlerDream
   {
      ...
      private function showYulu(param1:MouseEvent) : void
      {
         ...
         if(!this.yuluMc)
         {
            ...
            this.yuluMc.addEventListener("click",this.clickYulu);
         }
         if(!this.click)
         {
      ...
      {
         var event:MouseEvent = param1;
         this.yuluMc.removeEventListener("click",this.clickYulu);
      ...
      private function completeStep1(param1:QuestEvent) : void
      {
         ...
         {
            QuestManager.removeEventListener("stepComplete",this.completeStep1);
            this.initStep2();
         }
      }
      ...
      private function initStep2() : void
      {
         ...
         this.falaMc.addEventListener("click",this.showDia);
      }
      
      private function showDia(param1:MouseEvent) : void
      {
         var event:MouseEvent = param1;
         this.falaMc.removeEventListener("click",this.showDia);
      ...
      {
         this.findMc.dispose();
         this.falaMc.addEventListener("click",this.againFind);
      ...
      {
         var event:MouseEvent = param1;
         this.falaMc.removeEventListener("click",this.againFind);
      ...
      {
         stoneMc.removeEventListener("click",this.clickStone);
      ...
      override public function processMapDispose() : void
      {
         ...
         QuestManager.addEventListener("stepComplete",this.completeStep1);
      }
   }
}
