package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80497 extends MapProcessor
   {
      ...
      {
         this.initSet();
         if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord.initData.positionIndex == 1736)
         {
      ...
      {
         this._openVip.addEventListener("click",this.onOpenVip);
         this._buyHurtItem.addEventListener("click",this.onBuyHurtItem);
         this._openHelp.addEventListener("click",this.onOpenHelp);
      ...
      private function onBuyHurtItem(param1:MouseEvent) : void
      {
         ...
         ItemManager.addEventListener1("requestSpecialItemSuccess",(function():*
         {
            ...
            return itemHandle = function(param1:ItemEvent):void
            {
               var miNum:int;
               var evt:ItemEvent = param1;
               ItemManager.removeEventListener1("requestSpecialItemSuccess",itemHandle);
               miNum = int(ItemManager.getSpecialItem(MI_ID_LIST[0]) != null ? int(ItemManager.getSpecialItem(MI_ID_LIST[0]).quantity) : 0);
               if(miNum > 0)
               {
      ...
      private function onNpcClick(param1:MouseEvent) : void
      {
         ...
         NpcDialog.show(3086,"萨特",[[0,"我就是绝望之主·萨特！ 绝望来袭受死吧！"]],["我不怕！","我好怕你"],[function():void
         {
            ...
            FightManager.startFightWithWild(1736);
         }]);
      }
