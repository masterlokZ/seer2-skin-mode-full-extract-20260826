package com.taomee.seer2.app.processor.quest.handler.story.quest59
{
   ...
   public class QuestMapHandler_59_930 extends QuestMapHandler
   {
      ...
      override public function processMapDispose() : void
      {
         ...
         if(this.phoneCall)
         {
            this.phoneCall.removeEventListener("click",this.showNpcTalk);
         }
         if(this.toBtn)
         {
            this.toBtn.removeEventListener("click",this.showMonsterDia);
         }
         if(this.duoluo)
         {
            this.duoluo.removeEventListener("click",this.showDuoDia);
         }
         this.mark = null;
      }
      ...
      private function initAccept() : void
      {
         ...
         this.phoneCall.addEventListener("click",this.showNpcTalk);
      }
      ...
      private function initQuestStep1() : void
      {
         ...
         this.duoluo.x = 120;
         this.duoluo.y = 100;
         this.duoluo.addEventListener("click",this.showDuoDia);
      ...
      private function initStep2() : void
      {
         ...
         this.toBtn.addEventListener("click",this.showMonsterDia,false,1000);
      }
         ...
         NpcDialog.show(519,"奥罗吉尔",[[0,"是谁启动了这里的机关！！！"]],["谁"],[function():void
         {
            NpcDialog.show(519,"奥罗吉尔",[[0,"此山是我开！此树是我栽！要想过此路！留下买路财！"]],["我们要从这里过去"],[function():void
            {
               NpcDialog.show(519,"奥罗吉尔",[[0,"没门！有我在你们就别想过去！哈哈！"]],["看来只能够武力解决咯！一起上！巴蒂！"],[function():void
               {
                  ...
                  {
                     toBtn.addEventListener("click",showMonsterDia,false,1000);
