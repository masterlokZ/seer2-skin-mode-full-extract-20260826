package com.taomee.seer2.app.processor.activity.newAttack
{
   ...
   public class NewAttack500 extends BaseNewAttack
   {
         ...
         if(SceneManager.prevSceneType == 2 && _fightStatus == 1)
         {
            ...
            playLoad(function():void
            {
               ...
               if(FightManager.fightWinnerSide == 1)
               {
                  ...
                  _loc3_.push(new ServerBufferData(4,_loc1_));
                  ServerBufferManager.updateServerBufferGroup(13,_loc3_);
                  win();
               }
               else
               {
      ...
      private function initEvent() : void
      {
         ...
         this._threeYite.addEventListener("click",this.onThreeYite);
      }
      ...
      private function onDialogShow(param1:DialogPanelEvent) : void
      {
         ...
         if(param1.content == 472)
         {
            ...
            _loc2_ = new CustomUnit("quest","新一轮的反攻","xxx");
      ...
      private function noWin() : void
      {
         ...
         },function():void
         {
            ...
            _threeYite.addEventListener("click",onThreeYiteTwo);
         }]);
      }
