package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_3850 extends MapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         (_map.content["leftDoor"] as SimpleButton).addEventListener("click",this.onOpenLeftDoor);
         (_map.content["rightDoor"] as SimpleButton).addEventListener("click",this.onOpenRightDoor);
      ...
      override public function dispose() : void
      {
         ...
         (_map.content["leftDoor"] as SimpleButton).removeEventListener("click",this.onOpenLeftDoor);
         (_map.content["rightDoor"] as SimpleButton).removeEventListener("click",this.onOpenRightDoor);
