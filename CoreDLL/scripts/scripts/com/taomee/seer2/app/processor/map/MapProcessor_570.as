package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_570 extends MapProcessor
   {
      ...
      {
         this.initBingSwap();
         StatisticsManager.sendNovice("0x1003344A");
      }
      
      private function initBingSwap() : void
      {
         this._bing1 = _map.front["petAnimation"];
         this._bing1.addEventListener("bingReward570_0",this.onSwap1);
      }
      
      private function onSwap1(param1:Event) : void
      {
         this._bing1.removeEventListener("bingReward570_0",this.onSwap1);
