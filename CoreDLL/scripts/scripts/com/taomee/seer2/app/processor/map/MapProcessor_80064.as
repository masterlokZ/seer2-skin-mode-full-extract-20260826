   ...
   public class MapProcessor_80064 extends MapProcessor
   {
      ...
      private function getURL() : void
      {
         if(SceneManager.prevSceneType == 2)
         {
            ...
            {
               SceneManager.changeScene(9,80065);
            });
            return;
         }
         QueueLoader.load(URLUtil.getActivityAnimation("zombieDrAct/ZombieDrAct"),"swf",function(param1:ContentInfo):void
         {
      ...
      private function addNpc() : void
      {
         ...
         this._bossNpc.addEventListener("click",this.onNpcClick);
      }
      ...
      private function onNpcClick(param1:MouseEvent) : void
      {
         ...
         {
            FightManager.startFightWithWild(675);
         }]);
      }
      ...
      private function removeBossNpc() : void
      {
         if(this._bossNpc)
         {
            ...
            this._bossNpc.removeEventListener("click",this.onNpcClick);
