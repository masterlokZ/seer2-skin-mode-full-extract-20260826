   ...
   public class QuestProcessor_31 extends QuestProcessor
   {
      ...
      private function playTrainerAni() : void
      {
         ...
         MovieClipUtil.playMc(this._ani,1,this._ani.totalFrames,function():void
         {
            ...
            GuideManager.instance.addGuide2Target(_loc1_,0,0,new Point(1126,6),false,false,9,true);
            GuideManager.instance.startGuide(0);
            ModuleManager.addEventListener("QuestPanel","show",onShowQuest);
      ...
      private function onShowQuest(param1:ModuleEvent) : void
      {
         ...
         if(_quest.id == 31)
         {
            ...
            GuideManager.instance.addGuide2Target(_loc2_,0,1,new Point(636,214),false,false,9,false,true);
      ...
      {
         ModuleManager.removeEventListener("QuestPanel","show",this.onShowQuest);
         SceneManager.removeEventListener("switchStart",this.onSwitchStart);
      ...
      {
         QuestManager.addEventListener("accept",this.onCompleteStep);
         NpcManager.addEventListener("actorArrive",this.onActorArrive);
      }
      ...
      private function onCompleteStep(param1:QuestEvent) : void
      {
         if(_quest.id == param1.questId)
         {
            QuestManager.removeEventListener("accept",this.onCompleteStep);
            NpcManager.removeEventListener("actorArrive",this.onActorArrive);
