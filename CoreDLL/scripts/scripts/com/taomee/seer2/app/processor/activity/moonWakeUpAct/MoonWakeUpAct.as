package com.taomee.seer2.app.processor.activity.moonWakeUpAct
{
   ...
   public class MoonWakeUpAct
   {
      ...
      private function getResMapIdHandle() : void
      {
         ...
         if(SceneManager.prevSceneType == 2 && FightManager.fightWinnerSide == 1 && FightManager.currentFightRecord.initData.positionIndex == 1662)
         {
      ...
      {
         QueueLoader.load(URLUtil.getActivityAnimation("moonWakeUpAct/MoonWakeUpAct"),"swf",function(param1:ContentInfo):void
         {
      ...
      private function onForward(param1:MouseEvent) : void
      {
         ...
         if(this.forwardFilter())
         {
            ...
            ActiveCountManager.requestActiveCount(206038,function(param1:uint, param2:uint):void
            {
               ...
               MovieClipUtil.playMc(_forwardMC,2,_forwardMC.totalFrames,function():void
               {
                  ...
                  else
                  {
                     SwapManager.swapItem(SWAP_LIST[0],1,function(param1:IDataInput):void
                     {
                        ...
                        new SwapInfo(data);
                        ActiveCountManager.requestActiveCountList([206036,206038,206039],function(param1:Parser_1142):void
                        {
                           _par = param1;
      ...
      private function onEventHandleById(param1:int) : void
      {
         ...
         {
            ModuleManager.addEventListener("MoonWakeEventTwoActPanel","dispose",(function():*
            {
               var onEventTwoHide:Function;
               return onEventTwoHide = function(param1:ModuleEvent):void
               {
                  ModuleManager.removeEventListener("MoonWakeEventTwoActPanel","dispose",onEventTwoHide);
                  update();
               };
            })());
         ...
         {
            ModuleManager.addEventListener("MoonWakeEventThreeActPanel","dispose",(function():*
            {
               var onEventThreeHide:Function;
               return onEventThreeHide = function(param1:ModuleEvent):void
               {
                  ModuleManager.removeEventListener("MoonWakeEventThreeActPanel","dispose",onEventThreeHide);
                  update();
               };
            })());
         ...
         {
            ModuleManager.addEventListener("MoonWakeEventFourActPanel","dispose",this.onEventFourHide);
      ...
      private function getCurFightIndex() : int
      {
         ...
         while(_loc1_ < 4)
         {
            if(BitUtil.getBit(this._par.infoVec[2],_loc1_))
            {
               _loc2_ = _loc1_;
               break;
            }
      ...
      {
         ModuleManager.removeEventListener("MoonWakeEventFourActPanel","dispose",this.onEventFourHide);
         this.update();
      }
      ...
      private function update(param1:Function = null) : void
      {
         ...
         ActiveCountManager.requestActiveCountList([206036,206038,206039],function(param1:Parser_1142):void
         {
            ...
            DayLimitManager.getDoCount(1758,function(param1:int):void
            {
               _par = par;
