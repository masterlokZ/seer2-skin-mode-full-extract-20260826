package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_90 extends TitleMapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         StatisticsManager.sendNovice("0x10033111");
         StatisticsManager.sendNovice("0x10033410");
      ...
      private function initCarpet() : void
      {
         ...
         this._carpetMc.addEventListener("enterFrame",this.onCarpetEnterFrame);
         this._carpetTrigger.addEventListener("click",this.onCarpetTriggerClick);
      }
      ...
      {
         this._carpetMc.removeEventListener("enterFrame",this.onCarpetEnterFrame);
         this._carpetMc.removeEventListener("click",this.onCarpetTriggerClick);
         this._carpetMc = null;
