package com.taomee.seer2.app.processor.activity.CandyNightmareAct
{
   ...
   public class CandyNightmareAct
   {
      ...
      public function CandyNightmareAct(param1:MapModel)
      {
         ...
         if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord.initData.positionIndex == 1439)
         {
      ...
      private function init() : void
      {
         ...
         MovieClipUtil.playMc(_scenMc,2,_scenMc.totalFrames,function():void
         {
            ...
            (_scenMc["CandyActHit"] as MovieClip).addEventListener("click",(function():*
            {
               var onClick0:Function;
               return onClick0 = function(param1:MouseEvent):void
               {
                  var evt:MouseEvent = param1;
                  SeatTipsManager.removeSeat(new Point(235,118),ActorManager.actorInfo.id);
                  (_scenMc["CandyActHit"] as MovieClip).removeEventListener("click",onClick0);
                  ...
                  MovieClipUtil.playMc(_scenMc,2,_scenMc.totalFrames,function():void
                  {
                     ...
                     (_scenMc["CandyActHit"] as MovieClip).addEventListener("click",(function():*
                     {
                        ...
                        return onClick1 = function(param1:MouseEvent):void
                        {
                           SeatTipsManager.removeSeat(new Point(74,230),ActorManager.actorInfo.id);
                           (_scenMc["CandyActHit"] as MovieClip).removeEventListener("click",onClick1);
                           DisplayObjectUtil.removeFromParent(_scenMc);
                           _scenMc = null;
                           Connection.blockCommand(CommandSet.ITEM_SERVER_GIVE_1051);
                           Connection.send(CommandSet.RANDOM_EVENT_1140,111,0);
                        };
                     })());
                  },true);
               };
         ...
         if(parser.index == 111)
         {
            ...
            MovieClipUtil.playMc(_scenMc,2,_scenMc.totalFrames,function():void
            {
               ...
               if(parser.id == 4)
               {
                  ...
                  _boss.addEventListener("click",onBoss);
               }
               else
               {
                  SceneManager.changeScene(1,70);
      ...
      {
         FightManager.startFightWithWild(1439);
      }
      ...
      {
         QueueLoader.load(URLUtil.getActivityAnimation("CandyNightmareAct"),"swf",function(param1:ContentInfo):void
         {
      ...
      public function dispose() : void
      {
         ...
         if(this._boss)
         {
            this._boss.removeEventListener("click",this.onBoss);
            this._boss = null;
         }
