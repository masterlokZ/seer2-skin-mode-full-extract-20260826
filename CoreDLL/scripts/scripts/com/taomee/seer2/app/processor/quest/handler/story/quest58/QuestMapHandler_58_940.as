package com.taomee.seer2.app.processor.quest.handler.story.quest58
{
   ...
   public class QuestMapHandler_58_940 extends QuestMapHandler
   {
      ...
      override public function processMapDispose() : void
      {
         ...
         if(this._npc)
         {
            this._npc.removeEventListener("click",this.clickAiLike);
         }
         DialogPanel.removeEventListener("customUnitClick",this.playfull2);
         QuestManager.removeEventListener("complete",this.onComplete);
         if(this.capture)
         {
            this.capture.removeEventListener("click",this.clickAiLike);
            this.capture.removeEventListener("click",this.showGasDia);
         }
      }
      ...
      override public function processMapComplete() : void
      {
         ...
         {
            _loc1_ = MobileManager.getMobile(155,"npc");
      ...
      private function initQuestStep5() : void
      {
         ...
         this.capture.addEventListener("click",this.showGasDia);
      }
      ...
      private function onComplete(param1:QuestEvent) : void
      {
         ...
         {
            QuestManager.removeEventListener("complete",this.onComplete);
            _loc2_ = MobileManager.getMobile(155,"npc");
            _loc2_.visible = true;
         }
      }
      ...
      private function onCompleteStep(param1:QuestEvent) : void
      {
         if(param1.questId == _quest.id)
         {
            ...
            {
               SceneManager.changeScene(1,930,760,440);
            }
            QuestManager.removeEventListener("stepComplete",this.onCompleteStep);
         }
      }
      ...
      private function initQuestStep4() : void
      {
         ...
         MovieClipUtil.playMc(this.capture,1,this.capture.totalFrames,function():void
         {
            ...
            capture.addEventListener("click",clickAiLike);
         },true);
      }
      ...
      private function showDia(param1:MouseEvent) : void
      {
         ...
         DialogPanel.addEventListener("customReplyClick",this.playfull2);
      }
