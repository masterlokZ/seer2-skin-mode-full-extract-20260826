package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80401 extends MapProcessor
   {
      ...
      {
         if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord.initData.positionIndex == 1506)
         {
         ...
         ActiveCountManager.requestActiveCountList(FOR_LIST,function(param1:Parser_1142):void
         {
            ...
            DayLimitListManager.getDaylimitList(DAY_LIST,function(param1:DayLimitListInfo):void
            {
               ...
               else
               {
                  ...
                  _bar = _map.front["bar"];
                  _hurtNum.text = par.infoVec[2].toString() + "/" + 100000.toString();
                  _bar.scaleX = par.infoVec[2] / 100000 > 1 ? 1 : par.infoVec[2] / 100000;
                  initSet();
               }
            });
         });
      ...
      private function initSet() : void
      {
         ...
         if(this._info)
         {
            this._hurtNum.text = this._par.infoVec[2].toString() + "/" + 100000.toString();
            this._bar.scaleX = this._par.infoVec[2] / 100000 > 1 ? 1 : this._par.infoVec[2] / 100000;
         }
         if(this._par)
         {
      ...
      private function onNpcClick(param1:MouseEvent) : void
      {
         ...
         if(this.isCanFight())
         {
            ...
            {
               FightManager.startFightWithWild(1506);
            }
            else
            {
      ...
      private function isCanFight() : Boolean
      {
         ...
         {
            if(PetInfoManager.getPowerByPetInfo(_loc1_) >= 4500)
            {
               _loc2_ = true;
               break;
            }
