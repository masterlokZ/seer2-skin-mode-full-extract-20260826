package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80137 extends CopyMapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         this.itemBtn.addEventListener("click",this.toBuy);
         this.fightItemBtn.addEventListener("click",this.showBox);
         DayLimitManager.getDoCount(988,this.getDayData);
      ...
      private function getDayData(param1:uint) : void
      {
         ...
         ActiveCountManager.requestActiveCountList([203790,203789],this.getHurt);
      }
      ...
      override public function dispose() : void
      {
         ...
         this.itemBtn.removeEventListener("click",this.toBuy);
         this.fightItemBtn.removeEventListener("click",this.showBox);
      ...
      protected function toFight(param1:DialogPanelEvent) : void
      {
         ...
         {
            FightManager.startFightWithBoss(818);
         }
      }
   }
}
