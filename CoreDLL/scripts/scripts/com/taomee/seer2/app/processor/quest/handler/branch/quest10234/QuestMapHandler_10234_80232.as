package com.taomee.seer2.app.processor.quest.handler.branch.quest10234
{
   ...
   public class QuestMapHandler_10234_80232 extends QuestMapHandler
   {
      ...
      {
         if(FightManager.currentFightRecord.initData.positionIndex == 1116 || FightManager.currentFightRecord.initData.positionIndex == 1117)
         {
            if(SceneManager.prevSceneType == 2 && FightManager.fightWinnerSide == 1)
            {
               if(FightManager.currentFightRecord.initData.positionIndex == 1116)
               {
                  this.initStep3();
               }
               else
                  ...
                  NpcDialog.show(766,"小梦",[[0,"师傅给的包裹……居然有这种力量！"]],["来自地球的宝物？"],[function():void
                  {
                     NpcDialog.show(769,"梦魇",[[0,"星…………星……魂…………梦……神…………"]],["星魂？"],[function():void
                     {
                        NpcDialog.show(400,"小赛尔",[[0,"不管怎样！现在正是反败为胜的机会！"]],["趁现在！"],[function():void
                        {
                           ...
                           {
                              haveFight = 1;
                              FightManager.startFightWithWild(1117);
                           }
                        }]);
                     }]);
                  }]);
      ...
      private function toFight() : void
      {
         ...
         haveFight = 1;
         FightManager.startFightWithWild(1116);
      }
