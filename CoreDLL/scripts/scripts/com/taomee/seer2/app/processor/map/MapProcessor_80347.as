package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80347 extends MapProcessor
   {
      ...
      private var _nick:String = ActorManager.actorInfo.nick;
      ...
      {
         QueueLoader.load(URLUtil.getActivityAnimation("cindysMemory/Cindy4"),"swf",this.onLoad);
      ...
      private function createNpc() : void
      {
         if(!this._npc)
         {
            ...
            this._npc.addEventListener("click",this.onClickNpc);
         }
      }
      ...
      private function onComplete1() : void
      {
         if(SceneManager.prevSceneType == 2)
         {
            ...
            {
               _isFight = 0;
               ServerBufferManager.updateServerBuffer(288,2,1);
      ...
      private function onComplete2() : void
      {
         if(SceneManager.prevSceneType == 2)
         {
            if(this.FIGHT_LIST[1] == FightManager.currentFightRecord.initData.positionIndex)
            {
               ...
               {
                  ServerBufferManager.updateServerBuffer(288,2,2);
      ...
      {
         if(SceneManager.prevSceneType == 2 && this.FIGHT_LIST[2] == FightManager.currentFightRecord.initData.positionIndex)
         {
            _isFight = 0;
            NpcDialog.show(1,"辛迪船长",[[0,"英雄也不是无敌的。记住，要活下去！"]],["……"],[function():void
            {
               SwapManager.swapItem(3451,1,function(param1:IDataInput):void
               {
                  ...
                  ServerBufferManager.updateServerBuffer(288,2,0);
                  _npc.visible = false;
