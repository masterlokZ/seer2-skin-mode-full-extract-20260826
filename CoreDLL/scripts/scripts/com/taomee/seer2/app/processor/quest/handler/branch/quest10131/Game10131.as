package com.taomee.seer2.app.processor.quest.handler.branch.quest10131
{
   ...
   public class Game10131
   {
      ...
      public function Game10131(param1:Function)
      {
         ...
         QueueLoader.load(URLUtil.getActivityAnimation("xegg/game3"),"swf",this.onResLoaded);
      }
      ...
      private function initUI() : void
      {
         ...
         this._xiangMC.addEventListener("enterFrame",this.onIsHitHandler);
      }
      ...
      private function onIsHitHandler(param1:Event) : void
      {
         ...
         this._mc1.addEventListener("click",this.onClickMC1Handler);
         this._mc2.addEventListener("click",this.onClickMC2Handler);
         this._mc3.addEventListener("click",this.onClickMC3Handler);
      }
      
      private function onClickMC1Handler(param1:MouseEvent) : void
      {
         this._mc1.removeEventListener("click",this.onClickMC1Handler);
      ...
      {
         this._mc2.removeEventListener("click",this.onClickMC2Handler);
      ...
      {
         this._mc3.removeEventListener("click",this.onClickMC3Handler);
      ...
      private function dispose() : void
      {
         ...
         this._xiangMC.removeEventListener("enterFrame",this.onIsHitHandler);
      }
   }
}
