package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80160 extends MapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         DayLimitManager.getDoCount(958,this.getDayData);
         DialogPanel.addEventListener("customReplyClick",this.toFight);
         this.npc = MobileManager.getMobile(729,"npc");
      ...
      private function getDayData(param1:uint) : void
      {
         ...
         ActiveCountManager.requestActiveCount(203898,this.getBuyCount);
      }
