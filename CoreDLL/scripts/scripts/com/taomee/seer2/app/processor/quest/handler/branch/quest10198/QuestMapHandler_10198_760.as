package com.taomee.seer2.app.processor.quest.handler.branch.quest10198
{
   ...
   public class QuestMapHandler_10198_760 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         {
            if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord.initData.positionIndex == 517)
            {
            ...
            ActiveCountManager.requestActiveCount(202990,this.getData);
         }
      }
      
      private function getData(param1:uint, param2:uint) : void
      {
         if(param1 == 202990 && param2 == 1)
         {
            this.hitTestArea.addEventListener("click",this.onClick);
         }
      }
      ...
      override public function processMapDispose() : void
      {
         if(this.hitTestArea)
         {
            this.hitTestArea.removeEventListener("click",this.onClick);
         }
