package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80483 extends MapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         ServerBufferManager.getServerBuffer(407,function(param1:ServerBuffer):void
         {
            var server:ServerBuffer = param1;
            var _isPlay:Boolean = Boolean(server.readDataAtPostion(_index + 1));
            if(!_isPlay)
            {
               ServerBufferManager.updateServerBuffer(407,_index + 1,1);
               QueueLoader.load(URLUtil.getActivityAnimation("SalensThoseThing/SalensThoseThingGame"),"swf",(function():*
               {
                  var complete:Function;
                  return complete = function(param1:ContentInfo):void
                  {
      ...
      private function completeHandler(param1:ContentInfo) : void
      {
         ...
         MovieClipUtil.playMc(animation,2,animation.totalFrames,(function():*
         {
            var endPlay:Function;
            return endPlay = function():void
            {
      ...
      private function startGame() : void
      {
         ...
         {
            SwapManager.swapItem(this.SWAP_LIST[2 * this._index],1,(function():*
            {
      ...
      private function gameEndCallback(param1:Object) : void
      {
         ...
         SwapManager.swapItem(4189,1,(function():*
         {
            var success:Function;
            return success = function(param1:IDataInput):void
            {
      ...
      private function bibikanGameOver(param1:int) : void
      {
         ...
         SwapManager.swapItem(4191,1,(function():*
         {
            var success:Function;
            return success = function(param1:IDataInput):void
            {
      ...
      private function playFinishMc() : void
      {
         ServerBufferManager.getServerBuffer(407,function(param1:ServerBuffer):void
         {
            ...
            if(!_isPlay)
            {
               ServerBufferManager.updateServerBuffer(407,4,1);
               QueueLoader.load(URLUtil.getActivityAnimation("SalensThoseThing/SalensThoseThingGame"),"swf",(function():*
               {
                  var complete:Function;
                  return complete = function(param1:ContentInfo):void
                  {
                     ...
                     if(_mainMc)
                     {
                        MovieClipUtil.playMc(animation,2,animation.totalFrames,(function():*
                        {
                           var callBanck:Function;
                           return callBanck = function():void
                           {
                              DisplayObjectUtil.removeFromParent(animation);
                              SceneManager.changeScene(1,70);
                              ModuleManager.showAppModule("SalensThoseThingPanel");
