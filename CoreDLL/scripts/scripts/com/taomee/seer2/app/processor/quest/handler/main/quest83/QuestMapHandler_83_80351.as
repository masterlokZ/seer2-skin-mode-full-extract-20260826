   ...
   public class QuestMapHandler_83_80351 extends QuestMapHandler
   {
      ...
      private function nextQuestProcessor() : void
      {
         ...
         else if(QuestManager.isAccepted(questID) && !QuestManager.isStepComplete(questID,10))
         {
            ...
            {
               if((_loc1_.resourceId == 824 || _loc1_.resourceId == 825 || _loc1_.resourceId == 855) && _loc1_.level >= 60)
               {
                  _loc2_ = true;
               }
            }
            if(_loc2_)
            {
               QuestManager.addEventListener("complete",this.onStepComplete);
      ...
      {
         ModuleManager.addEventListener("NewGudiePanel","hide",this.onModule7);
      ...
      private function getMC() : MovieClip
      {
         ...
         switch(_quest.getCurrentOrNextStep().id - 1)
         {
            case 0:
      ...
      private function onStepComplete(param1:QuestEvent) : void
      {
         ...
         else if(param1.stepId == 7)
         {
            _loc2_ = {};
            _loc2_.index = 5;
            ModuleManager.addEventListener("GudieFightCompletePanel","hide",this.onHide);
         ...
         else if(param1.stepId == 9)
         {
            _loc3_ = {};
            _loc3_.index = 7;
            ModuleManager.addEventListener("GudieFightCompletePanel","hide",this.onHide9);
      ...
      {
         ModuleManager.removeEventListener("GudieFightCompletePanel","hide",this.onHide9);
      }
      ...
      {
         ModuleManager.removeEventListener("GudieFightCompletePanel","hide",this.onHide);
         this.quest8();
      }
      ...
      {
         this._npc = this.getMC();
         this._npc.addEventListener("click",this.onNpc9);
      }
      ...
      private function quest4() : void
      {
         ...
         this._mc1.addEventListener("click",this.onMc1);
      ...
      {
         ModuleManager.addEventListener("NewGudiePanel","hide",this.onModule8);
         ModuleManager.showModule(URLUtil.getAppModule("NewGudiePanel"),"");
      }
      ...
      {
         ModuleManager.removeEventListener("NewGudiePanel","hide",this.onModule8);
         if(isClickQuest83)
         {
            this._mc8 = _processor.resLib.getMovieClip("mc8");
            LayerManager.topLayer.addChild(this._mc8);
            this._mc8.addEventListener("click",this.onMC8);
         }
      }
      ...
      private function onMC8(param1:MouseEvent) : void
      {
         ...
         ModuleManager.addEventListener("PetBagPanel","hide",this.onModuleBagHide);
      ...
      {
         ModuleManager.removeEventListener("PetBagPanel","hide",this.onModuleBagHide);
         if(quest8IsOk)
         {
            QuestManager.addEventListener("stepComplete",this.onStepComplete);
            QuestManager.completeStep(_quest.id,9);
      ...
      {
         ModuleManager.removeEventListener("NewGudiePanel","hide",this.onModule7);
         if(isClickQuest83)
         {
      ...
      {
         ModuleManager.addEventListener("MapPanel","hide",this.onShowMapHide7);
      ...
      {
         ModuleManager.removeEventListener("MapPanel","hide",this.onShowMapHide7);
      ...
      {
         ModuleManager.addEventListener("NewGudiePanel","hide",this.onModule);
         ModuleManager.showModule(URLUtil.getAppModule("NewGudiePanel"),"");
      }
      
      private function onModule(param1:ModuleEvent) : void
      {
         ModuleManager.removeEventListener("NewGudiePanel","hide",this.onModule);
         if(isClickQuest83)
         {
            this._mc3 = _processor.resLib.getMovieClip("mc3");
            LayerManager.topLayer.addChild(this._mc3);
            ResContentLibrary.setInitValue(this._mc3);
            ResContentLibrary.updateRes();
            this._mc3.addEventListener("click",this.onMC7);
         }
      }
      ...
      {
         SceneManager.changeScene(9,80353);
      }
