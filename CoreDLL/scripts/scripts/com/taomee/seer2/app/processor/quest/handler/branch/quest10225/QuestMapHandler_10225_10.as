   ...
   public class QuestMapHandler_10225_10 extends QuestMapHandler
   {
      ...
      private function initStep1() : void
      {
         ...
         MovieClipUtil.playMc(this._mc2,2,this._mc2.totalFrames,function():void
         {
            ...
            _mc2["xidi"].addEventListener("click",onClick);
         },true);
      }
      ...
      private function onClick(param1:MouseEvent) : void
      {
         ...
         this._mc2["xidi"].removeEventListener("click",this.onClick);
      ...
      private function onOver(param1:Event) : void
      {
         ...
         {
            SceneManager.removeEventListener("switchComplete",this.onOver);
            this.initStep3();
         }
      }
      ...
      private function initStep2() : void
      {
         ...
         MovieClipUtil.playMc(this._mc3,2,this._mc3.totalFrames,function():void
         {
            ...
            _mc3["star"].addEventListener("click",onClick2);
         },true);
      }
      ...
      {
         var event:MouseEvent = param1;
         this._mc3["star"].removeEventListener("click",this.onClick2);
