package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_3803 extends MapProcessor
   {
               ...
               else
               {
                  ActiveCountManager.requestActiveCount(203306,function(param1:uint, param2:uint):void
                  {
                     ...
                     else
                     {
                        ...
                        MobileManager.addMobile(_pathMobile,"pet");
                        ...
                        _pathMobile.addEventListener("click",onRole);
                     }
                  });
               }
            });
      ...
      private function isBagHave() : Boolean
      {
         ...
         {
            if(_loc1_.resourceId == 269 || _loc1_.resourceId == 270 || _loc1_.resourceId == 271)
            {
               _loc2_ = true;
            }
         }
      ...
      override public function dispose() : void
      {
         if(this._pathMobile)
         {
            MobileManager.removeMobile(this._pathMobile,"pet");
         }
         super.dispose();
      }
   }
