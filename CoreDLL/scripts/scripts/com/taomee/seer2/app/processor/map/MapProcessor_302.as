package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_302 extends TitleMapProcessor
   {
      ...
      {
         this.initPipeVec();
         StatisticsManager.sendNovice("0x1003343D");
      ...
      private function initPipeVec() : void
      {
         ...
         var _loc2_:MovieClip = _map.content["pipe1"];
         var _loc1_:MovieClip = _map.content["pipe2"];
      ...
      private function initPipeInteracter() : void
      {
         ...
         while(_loc1_ < this._pipeVec.length)
         {
            ...
            this._pipeVec[_loc1_].addEventListener("mouseOver",this.onPipeOver);
            this._pipeVec[_loc1_].addEventListener("mouseOut",this.onPipeOut);
            _loc1_++;
         }
         this._pipeVec[0].addEventListener("click",this.onPipeClick);
      }
      ...
      private function closePipeInteracter() : void
      {
         ...
         while(_loc1_ < this._pipeVec.length)
         {
            this._pipeVec[_loc1_].removeEventListener("mouseOver",this.onPipeOver);
            this._pipeVec[_loc1_].removeEventListener("mouseOut",this.onPipeOut);
