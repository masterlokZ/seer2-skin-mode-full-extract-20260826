package com.taomee.seer2.app.processor.quest.handler.story.quest13
{
   ...
   public class QuestMapHandler_13_500 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         {
            this.initAnimation();
            QuestManager.addEventListener("stepComplete",this.onQuestStep);
         }
      ...
      private function initStep4Animation() : void
      {
         ...
         this._mc_10.addEventListener("click",this.onClickMC10);
      }
      
      private function onClickMC10(param1:MouseEvent) : void
      {
         var event:MouseEvent = param1;
         this._mc_10.removeEventListener("click",this.onClickMC10);
      ...
      private function initAnimation() : void
      {
         ...
         this._mc_1.addEventListener("click",this.onClickMC1);
      }
      ...
      override public function processMapDispose() : void
      {
         ...
         if(this._mc_1)
         {
            ...
            {
               this.isCloseMC(this._mc_1,true);
               this._mc_1.removeEventListener("click",this.onClickMC1);
