package com.taomee.seer2.app.processor.quest.handler.main.quest10
{
   ...
   public class QuestGame_10_203 extends QuestGame
   {
      ...
      override public function init() : void
      {
         ...
         var _loc2_:Rectangle = new Rectangle(297,174,605,312);
         var _loc1_:int = 1;
         while(_loc1_ <= 3)
         {
            this._mcWrapperVec.push(new McWrapper(_mc["mc_" + _loc1_],this._petMc,_loc1_,_loc2_,this.checkInteract));
            _loc1_++;
         }
      }
...
class McWrapper
{
   ...
   public function McWrapper(param1:MovieClip, param2:MovieClip, param3:int, param4:Rectangle, param5:Function)
   {
      ...
      this._mc.addEventListener("mouseDown",this.onMcDown);
      this._mc.addEventListener("mouseUp",this.onMcUp);
   }
   ...
   {
      this._mc.removeEventListener("mouseDown",this.onMcDown);
      this._mc.removeEventListener("mouseUp",this.onMcUp);
   }
}
