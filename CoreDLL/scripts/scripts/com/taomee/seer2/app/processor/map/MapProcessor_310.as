package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_310 extends TitleMapProcessor
   {
      ...
      {
         this.initPig();
         StatisticsManager.sendNovice("0x10033433");
      }
      ...
      private function initPig() : void
      {
         ...
         this._light1.addEventListener("click",this.onLight1Click);
      ...
      {
         this._light1.removeEventListener("click",this.onLight1Click);
