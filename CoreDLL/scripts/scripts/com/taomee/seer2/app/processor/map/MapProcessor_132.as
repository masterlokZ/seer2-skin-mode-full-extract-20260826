package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_132 extends TitleMapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         this.initFlower();
         StatisticsManager.sendNovice("0x10033415");
      }
      
      private function initMushroomLeft() : void
      {
         this._mushroomLeft = _map.content["mushroomLeft"];
         this._mushroomLeft.addEventListener("enterFrame",this.onCartoonEnterFrame);
         this._mushroomLeft.addEventListener("click",this.onClick);
      ...
      private function initMushroomMid() : void
      {
         ...
         this._mushroomMiddle.addEventListener("enterFrame",this.onCartoonEnterFrame);
         this._mushroomMiddle.addEventListener("click",this.onClick);
      ...
      private function initFlower() : void
      {
         ...
         this._flower.addEventListener("enterFrame",this.onFlowerEnterFrame);
         this._flower.addEventListener("click",this.onFlowerClick);
      ...
      {
         param1.removeEventListener("enterFrame",this.onCartoonEnterFrame);
      ...
      override public function dispose() : void
      {
         ...
         this._flower.removeEventListener("enterFrame",this.onFlowerEnterFrame);
         this._flower.removeEventListener("click",this.onFlowerClick);
