package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_320 extends TitleMapProcessor
   {
      ...
      {
         this.initGear();
         StatisticsManager.sendNovice("0x10033434");
      ...
      private function initGear() : void
      {
         ...
         this._gearClick.addEventListener("click",this.onGearClick);
      }
      
      private function onGearClick(param1:MouseEvent) : void
      {
         DisplayObjectUtil.disableSprite(this._gearClick);
         this._gear.addEventListener("enterFrame",this.onGearEnd);
      ...
      private function onGearEnd(param1:Event) : void
      {
         ...
         {
            this._gear.removeEventListener("enterFrame",this.onGearEnd);
            DisplayObjectUtil.enableSprite(this._gearClick);
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         this._gearClick.removeEventListener("click",this.onGearClick);
         this._gear.removeEventListener("enterFrame",this.onGearEnd);
         this._gear = null;
