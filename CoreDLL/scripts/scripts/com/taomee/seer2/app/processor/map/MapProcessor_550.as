package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_550 extends MapProcessor
   {
      ...
      {
         this.initBingSwap();
         StatisticsManager.sendNovice("0x10033448");
      ...
      private function initBingSwap() : void
      {
         ...
         this._bing1.addEventListener("bingReward550_0",this.onSwap1);
      }
      
      private function onSwap1(param1:Event) : void
      {
         this._bing1.removeEventListener("bingReward550_0",this.onSwap1);
