package com.taomee.seer2.app.processor.activity.guoNianFangBianPao
{
   ...
   public class GuoNianBianPao
   {
      ...
      public function initBianPao() : void
      {
         ...
         this.bianPaoNpc.resourceUrl = URLUtil.getNpcSwf(353);
         this.bianPaoNpc.buttonMode = true;
         this.bianPaoNpc.setPostion(position_array[map_id_array.indexOf(this.localMap.id)]);
         MobileManager.addMobile(this.bianPaoNpc,"npc");
         this.bianPaoNpc.addEventListener("click",this.onClick);
      }
      ...
      private function onClick(param1:MouseEvent) : void
      {
         ...
         DayLimitManager.getDoCount(982,function(param1:uint):void
         {
            ...
            NpcDialog.show(353,"爆竹",[[0,"祝小赛尔们新年快乐，点燃我获得珍贵道具哦!"]],["点燃爆竹","保护环境，待会再点"],[function():void
            {
               SwapManager.swapItem(2386,1,function(param1:IDataInput):void
               {
      ...
      public function dispose() : void
      {
         if(this.bianPaoNpc)
         {
            ...
            this.bianPaoNpc.removeEventListener("click",this.onClick);
      ...
      private function initResource() : void
      {
         if(resLib == null)
         {
            QueueLoader.load(URLUtil.getActivityAnimation("GuoNianBianPaoRes"),"domain",this.onLoadOver);
         }
      }
