package com.taomee.seer2.app.processor.activity.devilActivityNext
{
   ...
   public class DevilActivityNext
   {
      ...
      private static function onSwitchComplete(param1:SceneEvent) : void
      {
         ...
         {
            TimeManager.addEventListener("timeUpdate",onTimeContent);
         }
      }
      ...
      private static function onLoadComplete() : void
      {
         ...
         eventNpc(_npc2);
         TimeManager.addEventListener("timeUpdate",onTimeUpdate);
         ServerBufferManager.getServerBuffer(32,getServerTime);
      }
      ...
      private static function getServerTime(param1:ServerBuffer) : void
      {
         ...
         ServerBufferManager.getServerBuffer(33,getServerTime2);
      }
      ...
      private static function eventNpc(param1:MovieClip) : void
      {
         ...
         param1.addEventListener("click",onNpc);
      }
      ...
      private static function onNpc(param1:MouseEvent) : void
      {
         ...
         MovieClipUtil.playMc(mc,2,mc.totalFrames,function():void
         {
            ...
            _loc1_.push(new ServerBufferData(_index * 4,_loc2_.getTime() / 1000,4));
            ServerBufferManager.updateServerBufferGroup(serbufType,_loc1_);
            ServerBufferManager.getServerBuffer(31,onDevilactivity);
         });
      }
      ...
      private static function onDevilactivity(param1:ServerBuffer) : void
      {
         ...
         {
            ServerBufferManager.updateServerBuffer(31,0,param1.readDataAtPostion(0) + 1);
            if(_loc2_ >= 9)
            {
               ModuleManager.toggleModule(URLUtil.getAppModule("DevilActivityNextPanel"),"加载素材");
            }
      ...
      private static function onSwitchStart(param1:SceneEvent) : void
      {
         ...
         TimeManager.removeEventListener("timeUpdate",onTimeContent);
         TimeManager.removeEventListener("timeUpdate",onTimeUpdate);
