package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_204 extends TitleMapProcessor
   {
      ...
      {
         this.initFunnyCrab();
         StatisticsManager.sendNovice("0x1003342A");
      ...
      private function initFunnyCrab() : void
      {
         ...
         this._blowBubble.addEventListener("funnyStarReward4",this.onFunnyStarReward);
      }
      
      private function onFunnyStarReward(param1:Event) : void
      {
         this._blowBubble.removeEventListener("funnyStarReward4",this.onFunnyStarReward);
      ...
      {
         if(this._blowBubble.hasEventListener("funnyStarReward4"))
         {
            this._blowBubble.removeEventListener("funnyStarReward4",this.onFunnyStarReward);
         }
