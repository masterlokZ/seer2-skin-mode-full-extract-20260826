package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_520 extends MapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         this.initGoldMine();
         this.initRarePet();
         StatisticsManager.sendNovice("0x10033430");
      }
      
      private function initRope() : void
      {
         this._rope = _map.content["rope"];
         this._rope.addEventListener("click",this.onRopeClick);
      }
      
      private function onRopeClick(param1:MouseEvent) : void
      {
         this._rope.removeEventListener("click",this.onRopeClick);
      ...
      private function initGoldMine() : void
      {
         ...
         this._goldMine.addEventListener("click",this.onGoldMineClick);
      }
      
      private function onGoldMineClick(param1:MouseEvent) : void
      {
         this._goldMine.removeEventListener("click",this.onGoldMineClick);
      ...
      private function initRarePet() : void
      {
         ...
         DialogPanel.addEventListener("customUnitClick",this.onCustomReply);
      }
      ...
      private function showPet(param1:Boolean) : void
      {
         ...
         MovieClipUtil.playMc(this._pet,1,this._pet.totalFrames,function():void
         {
            ...
            _pet.addEventListener("click",onPetClick);
         },true);
      }
      ...
      override public function dispose() : void
      {
         ...
         this._pet.removeEventListener("click",this.onPetClick);
         this._rope.removeEventListener("click",this.onRopeClick);
         this._rope = null;
         this._goldMine.removeEventListener("click",this.onGoldMineClick);
         this._goldMine = null;
