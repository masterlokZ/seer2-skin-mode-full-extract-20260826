   ...
   public class MapProcessor_80148 extends MapProcessor
   {
      ...
      private function getURL() : void
      {
         if(SceneManager.prevSceneType == 2)
         {
            ...
            {
               SceneManager.changeScene(9,80147);
            });
            return;
         }
         QueueLoader.load(URLUtil.getActivityAnimation("miuSiAct/MiuSiAct"),"swf",function(param1:ContentInfo):void
         {
      ...
      private function onNpcClick(param1:MouseEvent) : void
      {
         ...
         NpcDialog.show(705,"缪斯",[[0,"你是小赛尔吧，我常听雷伊、盖亚它们提到你。少主之星会摧毁这个穹顶带我们离开！"]],["少主之星？","女神哇！"],[function():void
         {
            ...
            {
               FightManager.startFightWithWild(825);
            }]);
         }]);
      }
