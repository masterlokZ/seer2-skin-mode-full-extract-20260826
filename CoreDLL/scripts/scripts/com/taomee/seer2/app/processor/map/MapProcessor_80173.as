package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80173 extends MapProcessor
   {
      ...
      {
         this.npc0 = MobileManager.getMobile(734,"npc");
         this.npc1 = MobileManager.getMobile(738,"npc");
      ...
      private function addEvent() : void
      {
         if(this.npc0)
         {
            this.npc0.addEventListener("click",this.onNpc);
         }
         if(this.npc1)
         {
            this.npc1.addEventListener("click",this.onNpc);
         }
         this.getTaiYangShenBtn.addEventListener("click",this.onTaiYangShen);
         this.wuzixiang.addEventListener("click",this.onWuZiXiang);
         this.openVip.addEventListener("click",this.onVip);
      }
      ...
      private function removeEvent() : void
      {
         if(this.npc0)
         {
            this.npc0.removeEventListener("click",this.onNpc);
         }
         if(this.npc1)
         {
            this.npc1.removeEventListener("click",this.onNpc);
         }
         this.getTaiYangShenBtn.removeEventListener("click",this.onTaiYangShen);
         this.wuzixiang.removeEventListener("click",this.onWuZiXiang);
         this.openVip.removeEventListener("click",this.onVip);
      }
