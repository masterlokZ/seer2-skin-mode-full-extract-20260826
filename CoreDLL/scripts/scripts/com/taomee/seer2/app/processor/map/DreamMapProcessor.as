package com.taomee.seer2.app.processor.map
{
   ...
   public class DreamMapProcessor extends MapProcessor
   {
      ...
      {
         StatisticsManager.sendStatisticsByType("enterDream");
         this.hideToolBar();
      ...
      private function initDreamer() : void
      {
         if(_map.content["dreamer"] != null)
         {
            ...
            this._dreamer.addEventListener("mouseOver",this.onDreamerMouseOver);
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this._dreamer)
         {
            this._dreamer.removeEventListener("mouseOver",this.onDreamerMouseOver);
            this._dreamer = null;
         }
         if(this._mouseHint)
         {
