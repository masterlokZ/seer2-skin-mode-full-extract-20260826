   ...
   public class QuestMapHandler_10139_192 extends QuestMapHandler
   {
      ...
      private function onStep(param1:DialogPanelEvent) : void
      {
         if((param1.content as DialogPanelEventData).params == "10139_2")
         {
            ...
            QuestManager.addEventListener("stepComplete",this.onStep4Handler);
            ...
            ItemManager.requestItemList(function():void
            {
               if(ItemManager.getItemByReferenceId(400015))
               {
                  SwapManager.swapItem(712,1,function(param1:IDataInput):void
                  {
                     ...
                     DialogPanel.removeEventListener("customReplyClick",onStep1);
                     NpcDialog.show(31,"巴尔卡",[[0,"麻里麻里哄，霹雳碰隆赤，火幻花快快开吧~"]],["谢谢巴尔卡（获得火幻花）"],[function():void
                     {
                        QuestManager.addEventListener("stepComplete",onStep5CompleteHandler);
      ...
      {
         QuestManager.removeEventListener("stepComplete",this.onStep5CompleteHandler);
         this.npcTalk();
      }
      ...
      private function npcTalk() : void
      {
         ...
         {
            QuestManager.addEventListener("stepComplete",onStep6CompleteHandler);
      ...
      {
         QuestManager.removeEventListener("stepComplete",this.onStep6CompleteHandler);
