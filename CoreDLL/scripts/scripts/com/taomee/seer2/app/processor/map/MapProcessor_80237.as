package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80237 extends MapProcessor
   {
      ...
      {
         if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord.initData.positionIndex == 1134)
         {
      ...
      private function onNpcClick(param1:MouseEvent) : void
      {
         ...
         NpcDialog.show(771,"梦神",[[0,"  是谁！？胆子倒不小，居然敢打搅我的美梦"]],["来战一局灭灭你的威风！","挺吓人的呢"],[function():void
         {
            if(isCanFight())
            {
               FightManager.startFightWithWild(1134);
            }
         }]);
      }
