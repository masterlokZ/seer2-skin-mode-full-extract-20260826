package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_20 extends TitleMapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         this._petPractice.addEventListener("click",this.onPetPractice);
         this.initShopBtn();
         this._petChara = _map.front["charaBtn"];
         TooltipManager.addCommonTip(this._petChara,"性格修炼器");
         this._petChara.addEventListener("click",this.onCharaClick);
         ...
         this._shenMoButton.addEventListener("click",this.onShenMo);
         ...
         ModelLocator.getInstance().addEventListener("holyTowerCrisisUpdate",this.holyTowerCrisisHandle);
      }
      ...
      {
         StatisticsManager.sendNovice("0x1003390B");
      ...
      private function initSuperPrize() : void
      {
         ...
         {
            ServerBufferManager.getServerBuffer(29,this.getBuffer);
         }
      }
      
      private function getBuffer(param1:ServerBuffer) : void
      {
         var _loc2_:Mobile = MobileManager.getMobile(151,"npc");
         var _loc3_:int = param1.readDataAtPostion(10);
         if(_loc3_ == 0)
         {
            _loc2_.visible = true;
            _loc2_.buttonMode = true;
            _loc2_.addEventListener("click",this.OnSuperPrizeHandler);
         }
      }
      ...
      private function OnSuperPrizeHandler(param1:MouseEvent) : void
      {
         ...
         ServerBufferManager.updateServerBuffer(29,10,1);
      ...
      private function inviteFriend() : void
      {
         ...
         StatisticsManager.sendNovice("0x10033479");
      }
      ...
      private function inviteReward() : void
      {
         ...
         StatisticsManager.sendNovice("0x1003347A");
      }
      ...
      private function startHalloweenSwap() : void
      {
         ...
         {
            var _loc1_:uint = uint(ItemManager.getItemQuantityByReferenceId(400211));
            if(_loc1_ >= 100)
            {
               SwapManager.swapItem(107);
            }
            else
            {
      ...
      {
         this._goUnknown.removeEventListener("click",this.onLeftDoorClick);
      ...
      private function initShopBtn() : void
      {
         ...
         this._shopBtn.addEventListener("click",this.onShopClick);
         this._shopBtn.play();
      }
      ...
      private function onShopClick(param1:MouseEvent) : void
      {
         ...
         StatisticsManager.sendNovice("0x10033477");
      }
      ...
      private function onRoateClick(param1:MouseEvent) : void
      {
         ...
         StatisticsManager.sendNovice("0x1003303f");
      ...
      private function initHatch() : void
      {
         ...
         this._spiritHatch.addEventListener("click",this.onHatchClick);
      }
      ...
      private function onHatchClick(param1:MouseEvent) : void
      {
         ...
         StatisticsManager.sendNovice("0x10033478");
      ...
      private function initAddBlood() : void
      {
         ...
         this._addBlood.addEventListener("click",this.onAddBlookClick);
      }
      ...
      private function onAddBlookClick(param1:MouseEvent) : void
      {
         ...
         if(ActorManager.actorInfo.highestPetLevel <= 30)
         {
            ...
            this._petAddBloodAnimation.addEventListener("enterFrame",this.onPetAddBloodEnd);
         }
         else
         {
      ...
      private function onPetAddBloodEnd(param1:Event) : void
      {
         ...
         {
            this._petAddBloodAnimation.removeEventListener("enterFrame",this.onPetAddBloodEnd);
      ...
      private function initNpc2() : void
      {
         ...
         MobileManager.addMobile(this._twoYearNpc1,"npc");
         this._twoYearNpc1.addEventListener("click",this.onTwoYearNpcClick1);
      }
         ...
         NpcDialog.show(400,"小赛尔",[[0,"博士博士！你看我发现了什么？！"]],["这是魔盗团从神迹塔里偷出来的！"],[function():void
         {
            NpcDialog.show(2,"博士伊娃",[[0,"这……真的是从神迹塔里找到的吗？！我需要仔细分析一下！如果那个传说是真的的话~~这怎么可能呢。"]],["究竟是什么呀？！"],[function():void
            {
               NpcDialog.show(2,"博士伊娃",[[0,"这居然是真的！我们找了这么久都没找到！居然被一群窃贼先找到了！这就是传说中的神遁精华！"]],["哇！真的吗？！"],[function():void
               {
                  ...
                  {
                     ServerBufferManager.updateServerBuffer(411,2,1);
      ...
      private function afterFinish1() : void
      {
         ...
         {
            this._twoYearNpc1.removeEventListener("click",this.onTwoYearNpcClick1);
      ...
      private function holyTowerCrisisDispose() : void
      {
         ...
         this._oldNpc1 = null;
         clearInterval(this.timeId1);
         ModelLocator.getInstance().removeEventListener("holyTowerCrisisUpdate",this.holyTowerCrisisHandle);
      }
      
      private function initTwoYearNpcHandle(param1:LogicEvent = null) : void
      {
         var evt:LogicEvent = param1;
         this._oldNpc = MobileManager.getMobile(2,"npc");
         if(this._oldNpc)
         {
