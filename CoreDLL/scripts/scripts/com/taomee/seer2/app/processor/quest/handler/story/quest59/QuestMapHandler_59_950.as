package com.taomee.seer2.app.processor.quest.handler.story.quest59
{
   ...
   public class QuestMapHandler_59_950 extends QuestMapHandler
   {
      ...
      override public function processMapDispose() : void
      {
         ...
         ActorManager.getActor().removeEventListener("finished",this.checkDis);
         if(this.paper)
         {
            this.paper.removeEventListener("click",this.clickPaper);
         }
         if(this.closePaper)
         {
            this.closePaper.addEventListener("click",this.showDia);
         }
      }
      ...
      private function clickPaper(param1:MouseEvent) : void
      {
         ...
         if(_loc2_.isCrack)
         {
            ActorManager.getActor().addEventListener("finished",this.checkDis);
      ...
      private function checkDis(param1:MoveEvent) : void
      {
         ...
         var _loc4_:int = this.paper.y - ActorManager.getActor().y;
         _loc3_ = Math.sqrt(_loc2_ * _loc2_ + _loc4_ * _loc4_);
         if(_loc3_ < 100)
         {
            ActorManager.getActor().removeEventListener("finished",this.checkDis);
      ...
      private function showDia(param1:MouseEvent) : void
      {
         ...
         this.closePaper.removeEventListener("click",this.showDia);
         this.badi.x = 360;
         this.badi.y = 235;
