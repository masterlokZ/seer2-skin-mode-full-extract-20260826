package com.taomee.seer2.app.processor.activity.decoration
{
   ...
   public class DecorationManager
   {
      ...
      public static function getCurrEnd() : Array
      {
         ...
         var _loc1_:uint = _loc2_.month + 1;
         switch(int(_loc1_) - 1)
         {
            case 0:
               _loc3_ = 20;
      ...
      {
         var _loc2_:Date = new Date(TimeManager.getServerTime() * 1000);
         var _loc1_:uint = getConstellation(String(_loc2_.month + 1),String(_loc2_.date));
         var _loc4_:BirthdayInfo = ActorManager.actorInfo.birthdayInfo;
         var _loc3_:uint = getCurDecIndex(String(_loc4_.month),String(_loc4_.day));
         if(_loc1_ == _loc3_)
         {
            return true;
         }
      ...
      {
         var _loc4_:BirthdayInfo = null;
         var _loc3_:Point = new Point();
         _loc3_.x = -1;
         _loc3_.y = -1;
         var _loc2_:Date = new Date(TimeManager.getServerTime() * 1000);
         var _loc5_:uint = _loc2_.month + 1;
         _loc4_ = ActorManager.actorInfo.birthdayInfo;
         var _loc1_:uint = _loc4_.month;
         _loc3_.y = _loc1_;
         if(_loc5_ == _loc1_)
         {
            _loc3_.x = 1;
