   ...
   public class QuestMapHandler_29_390 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         else if(QuestManager.isAccepted(_quest.id) && QuestManager.isStepComplete(_quest.id,1) == false)
         {
            ...
            this._diNpc.addEventListener("click",this.onNpcClick_0_1);
         }
      ...
      {
         if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord && FightManager.currentFightRecord.initData && FightManager.currentFightRecord.initData.positionIndex && FightManager.currentFightRecord.initData.positionIndex == 8 && FightManager.fightWinnerSide == 1)
         {
            _quest.setStepData(2,0,1);
            QuestManager.setStepBufferServer(_quest.id,2);
            this._diNpc.addEventListener("click",this.onShowDialog_2_1);
            this.showDialog_2_1();
         }
         else if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord && FightManager.currentFightRecord.initData && FightManager.currentFightRecord.initData.positionIndex && FightManager.currentFightRecord.initData.positionIndex == 8 && FightManager.fightWinnerSide == 2)
         {
            this._shaNpc.addEventListener("click",this.onShowFailDialog_2_0);
            this.showFailDialog_2_0();
         }
         else if(_quest.getStepData(2,0) == 0)
         {
            this.addAskMark(this._shaNpc);
            this._shaNpc.addEventListener("click",this.onShowDialog_2_0);
         }
         ...
         else if(_quest.getStepData(2,0) == 2)
         {
            ...
            this._tinaNpc.addEventListener("click",this.onShowDialog_2_2);
         }
         else if(_quest.getStepData(2,0) == 3)
         {
            ...
            this.createNpc_2_3();
            this.addAskMark(this._diNpc);
            this._diNpc.addEventListener("click",this.onShowDialog_2_3);
         }
      }
      ...
      {
         this.clearAskMark();
         this._shaNpc.removeEventListener("click",this.onShowDialog_2_0);
         this.showDialog_2_0();
      }
      ...
      private function showDialog_2_0() : void
      {
         ...
         {
            FightManager.addEventListener("START_ERROR",onStartFightError_2_0);
            FightManager.addEventListener("START_SUCCESS",onStartFight_2_0);
            FightManager.startFightWithNPC(8);
         }]);
      }
      
      private function onStartFight_2_0(param1:FightStartEvent) : void
      {
         FightManager.removeEventListener("START_ERROR",this.onStartFightError_2_0);
         FightManager.removeEventListener("START_SUCCESS",this.onStartFight_2_0);
      }
      ...
      {
         this.clearAskMark();
         this._shaNpc.removeEventListener("click",this.onShowFailDialog_2_0);
         this.showFailDialog_2_0();
      }
      ...
      private function showFailDialog_2_0() : void
      {
         ...
         {
            FightManager.addEventListener("START_ERROR",onStartFightError_2_1);
            FightManager.addEventListener("START_SUCCESS",onStartFight_2_1);
            FightManager.startFightWithNPC(8);
         }]);
      }
      ...
      {
         FightManager.removeEventListener("START_ERROR",this.onStartFightError_2_1);
         FightManager.removeEventListener("START_SUCCESS",this.onStartFight_2_1);
      }
      ...
      {
         this.clearAskMark();
         this._diNpc.removeEventListener("click",this.onShowDialog_2_1);
         this.showDialog_2_1();
      }
         ...
         NpcDialog.show(55,"神月老大",[[3,"真看不出来，每天唠叨着风度的大老板不过也是个不打招呼就开打的粗人而已！！洒家甚至比你更有风度，还特地派出使者！"]],["不是你先动手的嘛！"],[function():void
         {
            NpcDialog.show(57,"先知",[[1,"呵呵呵……看来那一招很管用……继续……继续争斗……然后，毁灭吧……！"]],["难道刚才袭击大老板的是你？！"],[function():void
            {
               ...
               MovieClipUtil.playMc(_tinaIn,1,_tinaIn.totalFrames,function():void
               {
                  ...
                  _tinaIn = null;
                  createNpc_2_2();
                  _tinaNpc.addEventListener("click",onShowDialog_2_2);
                  showDialog_2_2();
               },true);
            }]);
         }]);
      ...
      {
         this.clearAskMark();
         this._tinaNpc.removeEventListener("click",this.onShowDialog_2_2);
         this.showDialog_2_2();
      }
            ...
            NpcDialog.show(13,"阿修",[[1,"我的女王，请下达下一步指令。"]],["阿修也来了？怎么回事……"],[function():void
            {
               NpcDialog.show(57,"先知",[[1,"那么，我的使命也达成了。啊~早就想摆脱这个丑陋的外表了！"]],[" ……"],[function():void
               {
                  ...
                  MovieClipUtil.playMc(_tinaIn,1,_tinaIn.totalFrames,function():void
                  {
                     ...
                     _tinaIn = null;
                     createNpc_2_3();
                     _diNpc.addEventListener("click",onShowDialog_2_3);
                     showDialog_2_3();
                  },true);
               }]);
            }]);
      ...
      {
         this.clearAskMark();
         this._diNpc.removeEventListener("click",this.onShowDialog_2_3);
         this.showDialog_2_3();
      }
      ...
      {
         this.clearAskMark();
         this._diNpc.removeEventListener("click",this.onNpcClick_0_1);
         this.showDialog_0_1();
      }
      ...
      private function showDialog_0_1() : void
      {
         ...
         {
            SceneManager.changeScene(1,310);
         }]);
      }
