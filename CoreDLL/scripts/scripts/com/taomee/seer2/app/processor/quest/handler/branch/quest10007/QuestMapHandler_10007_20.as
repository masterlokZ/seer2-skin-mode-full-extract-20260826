package com.taomee.seer2.app.processor.quest.handler.branch.quest10007
{
   ...
   public class QuestMapHandler_10007_20 extends BranchQuestMapHandler
   {
      ...
      private function addFindDuduAnimation() : void
      {
         ...
         this._findDdudu.addEventListener("findDudu",this.onFindDudu);
         this._findDdudu.addEventListener("close",this.onCloseAnimation);
      }
      ...
      {
         this._findDdudu.removeEventListener("close",this.onCloseAnimation);
         this._findDdudu.removeEventListener("findDudu",this.onFindDudu);
      }
