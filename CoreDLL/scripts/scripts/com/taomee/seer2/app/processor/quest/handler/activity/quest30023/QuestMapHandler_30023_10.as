package com.taomee.seer2.app.processor.quest.handler.activity.quest30023
{
   ...
   public class QuestMapHandler_30023_10 extends QuestMapHandler
   {
      ...
      {
         DialogPanel.removeEventListener("customUnitClick",this.onClickDialog);
         DialogPanel.removeEventListener("dialogShow",this.onDialogShow);
      }
      
      private function onDialogShow(param1:Event) : void
      {
         var _loc2_:BaseUnit = new CustomUnit("quest","我是宣传委员","i_am_commissary_30023_10");
         if(QuestManager.isAccepted(_quest.id) && !QuestManager.isStepComplete(_quest.id,1))
         {
            this.joinWhichTeam();
      ...
      private function joinWhichTeam() : void
      {
         ...
         {
            DialogPanel.addEventListener("customUnitClick",this.onClickDialog);
         }
      }
      ...
      {
         var event:DialogPanelEvent = param1;
         if(event.content.params == "i_am_commissary_30023_10")
         {
            NpcDialog.show(1,"船长辛迪",[[0,"赶快去选队伍吧！"]],["（知道了）"],[function():void
            {
            }]);
      ...
      {
         if(param1.content.params == "i_am_commissary_30023_10")
         {
