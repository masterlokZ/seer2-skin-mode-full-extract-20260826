package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80098 extends MapProcessor
   {
      ...
      {
         if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord.initData.positionIndex == 754)
         {
            DayLimitManager.getDoCount(904,function(param1:int):void
            {
               var val:int = param1;
               ActiveCountManager.requestActiveCount(203537,function(param1:uint, param2:uint):void
               {
      ...
      private function onNpcClick(param1:MouseEvent) : void
      {
         ...
         {
            FightManager.startFightWithWild(754);
         }]);
      }
