package com.taomee.seer2.app.processor.quest.handler.activity.quest30020
{
   ...
   public class QuestMapHandler_30020_281 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         if(QuestManager.getQuest(30020).status == 0)
         {
            this.initListener();
         }
      ...
      {
         var _loc1_:int = Math.random() * 1000000 % 3;
         this._correctIndex = _loc1_;
         (this._npc["mc" + _loc1_] as MovieClip).gotoAndPlay(2);
         (this._npc["npc"] as MovieClip).addEventListener("click",this.beginAnswer);
      ...
      private function beginAnswer(param1:MouseEvent) : void
      {
         ...
         (this._npc["npc"] as MovieClip).removeEventListener("click",this.beginAnswer);
         ...
         while(_loc2_ < 3)
         {
            ...
            (this._answerPanel["answer" + _loc2_] as MovieClip).addEventListener("click",this.correctHandler);
            _loc2_++;
         }
      }
      ...
      private function correctHandler(param1:MouseEvent) : void
      {
         if(!this._timer)
         {
            ...
            this._timer.addEventListener("timer",this.startFight);
         }
      ...
      private function removeAnswerBtn() : void
      {
         ...
         while(_loc1_ < 3)
         {
            (this._answerPanel["answer" + _loc1_] as MovieClip).removeEventListener("click",this.correctHandler);
