package com.taomee.seer2.app.processor.quest.handler.branch.quest10141
{
   ...
   public class Game10141
   {
      ...
      private var _myTimer:Timer = new Timer(2000,1);
      ...
      public function Game10141(param1:MovieClip, param2:MovieClip, param3:Function)
      {
         ...
         this._startBtn.addEventListener("click",this.onStartGameHandler);
         this._closeBtn.addEventListener("click",this.onCloseGameHandler);
      }
      ...
      private function onStartGameHandler(param1:MouseEvent) : void
      {
         ...
         this._time_mc.addEventListener("enterFrame",function(param1:Event):void
         {
      ...
      {
         var _loc1_:int = MathUtil.randomRegion(1,3);
      ...
      private function StartFightOne() : void
      {
         ...
         this.addTimeLose();
         this.initBtn();
         this._upBnt.addEventListener("click",this.onClickUpBtnHandler);
         this._leftBnt.addEventListener("click",this.onClickRongBtnHandler);
         this._rightBnt.addEventListener("click",this.onClickRongBtnHandler);
         this._lv.removeEventListener("enterFrame",arguments.callee);
      }
      ...
      private function onClickUpBtnHandler(param1:MouseEvent) : void
      {
         ...
         this._upBnt.gotoAndStop(1);
         this.diposeBtn();
         this._upBnt.removeEventListener("click",this.onClickUpBtnHandler);
         this._leftBnt.removeEventListener("click",this.onClickRongBtnHandler);
         this._rightBnt.removeEventListener("click",this.onClickRongBtnHandler);
         this._game_num += 1;
         this._seer.gotoAndPlay(77);
         this._lv.gotoAndPlay(77);
         this._seer.addEventListener("enterFrame",function(param1:Event):void
         {
            if(_seer.currentFrame == 121)
            {
               _seer.gotoAndStop(1);
               _lv.gotoAndStop(1);
               _seer.removeEventListener("enterFrame",arguments.callee);
               ChooseFight();
            }
         });
      }
      ...
      private function StartFightTwo() : void
      {
         ...
         this.addTimeLose();
         this.initBtn();
         this._leftBnt.addEventListener("click",this.onClickLeftBtnHandler);
         this._upBnt.addEventListener("click",this.onClickRongBtnHandler);
         this._rightBnt.addEventListener("click",this.onClickRongBtnHandler);
         this._lv.removeEventListener("enterFrame",arguments.callee);
      }
      ...
      private function onClickLeftBtnHandler(param1:MouseEvent) : void
      {
         ...
         this._leftBnt.gotoAndStop(1);
         this.diposeBtn();
         this._leftBnt.removeEventListener("click",this.onClickLeftBtnHandler);
         this._upBnt.removeEventListener("click",this.onClickRongBtnHandler);
         this._rightBnt.removeEventListener("click",this.onClickRongBtnHandler);
         this._game_num += 1;
      ...
      private function StartFightThree() : void
      {
         ...
         this.addTimeLose();
         this.initBtn();
         this._rightBnt.addEventListener("click",this.onClickRightBtnHandler);
         this._leftBnt.addEventListener("click",this.onClickRongBtnHandler);
         this._upBnt.addEventListener("click",this.onClickRongBtnHandler);
         this._lv.removeEventListener("enterFrame",arguments.callee);
      }
      ...
      private function onClickRightBtnHandler(param1:MouseEvent) : void
      {
         ...
         this._rightBnt.gotoAndStop(1);
         this.diposeBtn();
         this._rightBnt.removeEventListener("click",this.onClickRightBtnHandler);
         this._leftBnt.removeEventListener("click",this.onClickRongBtnHandler);
         this._upBnt.removeEventListener("click",this.onClickRongBtnHandler);
         this._game_num += 1;
      ...
      {
         this._myTimer.start();
         this._myTimer.addEventListener("timerComplete",this.completeHandler);
      }
