package com.taomee.seer2.app.processor.copy.handler
{
   ...
   public class CopyProcessor_80032 extends CopyProcessor
   {
      ...
      private var TIP:Vector.<String> = Vector.<String>(["是否花费进入至尊挑战，<font color=\'#ff0000\'>获得本场战斗胜利</font>，可在同样的难度下获得<font color=\'#ff0000\'>150倍</font>体力提升","是否花费进入至尊挑战，可在同样的难度下获得<font color=\'#ff0000\'>150倍</font>战斗力提升"]);
      ...
      {
         StatisticsManager.sendNovice("0x1003392E");
      }
      ...
      override public function returnSceneHandle() : void
      {
         if(this._boss1)
         {
            this._boss1.removeEventListener("click",this.onBoss1Click);
            this._boss1.removeEventListener("click",this.onBoss1Click1);
         ...
         if(!isComplete)
         {
            ...
            {
               this._boss1.addEventListener("click",this.onBoss1Click1);
            }
         }
         if(this._npc1)
         {
      ...
      override public function onAnimationLoaded() : void
      {
         ...
         _mapModel.content.addChild(this._npc2);
         this._boss1 = _mapModel.content["boss1"];
         this._boss1.addEventListener("click",this.onBoss1Click);
         this.updateBuffShow();
      }
      ...
      private function onBoss1Click(param1:MouseEvent) : void
      {
         ...
         {
            var anima:* = undefined;
            _boss1.removeEventListener("click",onBoss1Click);
            ...
            MovieClipUtil.playMc(anima,2,anima.totalFrames,function():void
            {
               ...
               _boss4.addEventListener("click",onBoss4Click);
               showMouseHintAtMonster(_boss8);
               _boss8.buttonMode = true;
               _boss8.addEventListener("click",onBoss8Click);
               _boss1Click1 = true;
               _boss1.addEventListener("click",onBoss1Click1);
            });
         }]);
      }
      ...
      private function winHandle(param1:int) : void
      {
         ...
         {
            this._boss4.removeEventListener("click",this.onBoss4Click);
         ...
         {
            this._boss8.removeEventListener("click",this.onBoss8Click);
