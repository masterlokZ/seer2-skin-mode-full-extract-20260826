package com.taomee.seer2.app.processor.copy
{
   ...
   public class CopyProcessor
   {
      ...
      private function addBuyMenu() : void
      {
         ...
         this._fightBuy.addEventListener("click",this.onFightBuy);
      }
      ...
      private function removeBuyMenu() : void
      {
         ...
         if(this._fightBuy)
         {
            this._fightBuy.removeEventListener("click",this.onFightBuy);
      ...
      {
         SceneManager.addEventListener("switchComplete",this.onReturnCopyScene);
      }
      ...
      {
         QueueLoader.load(URLUtil.getCopyAnimation(this._copyItem.animationStr),"swf",function(param1:ContentInfo):void
         {
      ...
      {
         SceneManager.removeEventListener("switchComplete",this.onReturnCopyScene);
         this._copyItem = null;
         this._resLib = null;
         this._mapModel = null;
         Connection.removeCommandListener(CommandSet.CLI_NOTI_COPY_MAP_FIN_1243,this.onCompleteCopy);
