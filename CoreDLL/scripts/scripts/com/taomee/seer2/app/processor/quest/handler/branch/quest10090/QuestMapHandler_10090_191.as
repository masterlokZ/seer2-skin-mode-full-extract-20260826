   ...
   public class QuestMapHandler_10090_191 extends QuestMapHandler
   {
      ...
      private function executeKe() : void
      {
         if(DateUtil.inInDateScope(6,14,30,15,1))
         {
            ...
            if(this._fightNum2 < 5)
            {
               ...
               QuestManager.addEventListener("stepUpdateBuffer",this.onStepUpdateBuffer2);
      ...
      private function onStepUpdateBuffer2(param1:QuestEvent) : void
      {
         if(param1.questId == _quest.id)
         {
            ...
            this._fightNum2 = _quest.getStepData(_quest.getCurrentOrNextStep().id,1);
            QuestManager.removeEventListener("stepUpdateBuffer",this.onStepUpdateBuffer2);
            if(this._fightNum2 < 5)
            {
            ...
            else if(this._fightNum2 == 5)
            {
               ...
               {
                  QuestManager.addEventListener("stepComplete",this.onStep1Complete);
      ...
      private function updatePanel() : void
      {
         ...
         goBtn1.addEventListener("click",function():void
         {
            SceneManager.changeScene(1,212);
         });
         ...
         this._closeBtn1.addEventListener("click",this.onClosePanel1Handler);
      ...
      {
         this._closeBtn1.removeEventListener("click",this.onClosePanel);
      ...
      {
         this._closeBtn.removeEventListener("click",this.onClosePanel);
