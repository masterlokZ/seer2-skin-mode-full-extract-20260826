package com.taomee.seer2.app.processor.quest.handler.branch.quest10221
{
   ...
   public class QuestMapHandler_10221_80143 extends QuestMapHandler
   {
      ...
      {
         this._captain = MobileManager.getMobile(354,"npc");
                              ...
                              NpcDialog.show(6,"卡拉克",[[0,"是圣兽天尊！"]],["又能看到圣兽天尊了，太棒了！"],[function():void
                              {
                                 NpcDialog.show(705,"缪斯",[[0,"对，是圣兽天尊在呼唤我，所以我就从遥远的天蛇星赶来了！"]],["太好了，战神联盟又多了一员猛将啊！"],[function():void
                                 {
                                    NpcDialog.show(702,"天马",[[0,"事不延迟，我们赶快去找拯救王魄吧！"]],["好的，那我们出发吧！"],[function():void
                                    {
                                       ...
                                       _makeStone.addEventListener("close",onCloseAnimation);
                                       _makeStone.addEventListener("stone",onMakeBubbleOver);
                                    }]);
                                 }]);
                              }]);
                           },true);
      ...
      private function onStepComplete(param1:QuestEvent) : void
      {
         ...
         {
            SceneManager.changeScene(9,80144);
         }
         else if(param1.questId == 10221 && param1.stepId == 3)
         {
            SceneManager.changeScene(9,80145);
         }
      }
      ...
      override public function processMapDispose() : void
      {
         ...
         DialogPanel.removeEventListener("dialogShow",onDiaLogShow);
         QuestManager.removeEventListener("stepComplete",this.onStepComplete);
         if(this._makeStone)
         {
            this._makeStone.removeEventListener("close",this.onCloseAnimation);
