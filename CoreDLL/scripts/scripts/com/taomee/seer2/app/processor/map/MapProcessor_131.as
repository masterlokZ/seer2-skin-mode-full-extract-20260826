package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_131 extends TitleMapProcessor
   {
      ...
      {
         this.initFruits();
         StatisticsManager.sendNovice("0x10033417");
      }
      
      private function initFruits() : void
      {
         this._fruitsMC = _map.content["fruits"] as MovieClip;
         this._fruitsMC.addEventListener("fruitsReward1",this.onFruitsReward);
      }
      
      private function onFruitsReward(param1:Event) : void
      {
         this._fruitsMC.removeEventListener("fruitsReward1",this.onFruitsReward);
