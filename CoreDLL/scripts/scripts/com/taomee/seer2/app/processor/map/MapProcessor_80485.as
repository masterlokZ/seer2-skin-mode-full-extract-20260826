package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80485 extends MapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         {
            ServerBufferManager.getServerBuffer(414,function(param1:ServerBuffer):void
            {
               var server:ServerBuffer = param1;
               var _isPlay:Boolean = Boolean(server.readDataAtPostion(1));
               if(!_isPlay)
               {
                  ServerBufferManager.updateServerBuffer(414,1,1);
                  MovieClipUtil.getSwfContent(URLUtil.getActivityAnimation("RabbitMoonLightCapsule/sceneAnimation"),(function():*
                  {
                     ...
                     return callBack = function(param1:MovieClip):void
                     {
                        ...
                        tempNpc = MobileManager.getMobile(3032,"npc");
                        if(tempNpc != null)
                        {
                        ...
                        MovieClipUtil.playMc(movie,2,movie.totalFrames,(function():*
                        {
                           var callBack:Function;
      ...
      private function addNpc(param1:int, param2:Point) : void
      {
         ...
         MobileManager.addMobile(this._boss,"npc");
      ...
      private function onBossClick(param1:MouseEvent) : void
      {
         ...
         SwapManager.swapItem(this.SWAP_LIST[0],1,(function():*
         {
            ...
            return success = function(param1:IDataInput):void
            {
               ...
               {
                  var callBack:Function;
                  return callBack = function(param1:Parser_1142):void
                  {
