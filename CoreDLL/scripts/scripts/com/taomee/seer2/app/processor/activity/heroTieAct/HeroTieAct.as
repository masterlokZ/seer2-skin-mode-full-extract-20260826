package com.taomee.seer2.app.processor.activity.heroTieAct
{
   ...
   public class HeroTieAct
   {
      ...
      {
         QueueLoader.load(URLUtil.getActivityAnimation("heroTieAct/HeroTieAct"),"swf",function(param1:ContentInfo):void
         {
      ...
      private function addTieNpc() : void
      {
         ...
         this._getAward.addEventListener("click",this.onTieClick);
         this._goAct.addEventListener("click",this.onGoAct);
      }
      ...
      private function onTieClick(param1:MouseEvent) : void
      {
         ...
         else
         {
            ...
            if(ActorManager.actorInfo.activityData[11] < 180)
            {
      ...
      public function dispose() : void
      {
         ...
         if(this._getAward)
         {
            this._getAward.removeEventListener("click",this.onTieClick);
            this._getAward = null;
         }
         if(this._goAct)
         {
            this._goAct.removeEventListener("click",this.onGoAct);
            this._goAct = null;
         }
         this._tie = null;
      }
