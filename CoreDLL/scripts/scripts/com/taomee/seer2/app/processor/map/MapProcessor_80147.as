package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80147 extends MapProcessor
   {
      ...
      private function onHoleRandom(param1:MouseEvent) : void
      {
         ...
         ActiveCountManager.requestActiveCount(203793,function(param1:uint, param2:uint):void
         {
            ...
            {
               case 0:
                  SwapManager.swapItem(2429,1,function(param1:IDataInput):void
                  {
                     ...
                     ActiveCountManager.requestActiveCount(203793,function(param1:uint, param2:uint):void
                     {
                        switch(int(param2) - 1)
                        {
                           ...
                           case 1:
                              setHoleBtnEnable(true);
                              SceneManager.changeScene(9,80148);
                        }
                     });
