package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80481 extends MapProcessor
   {
      ...
      private static const SEAT_POS:Vector.<Point> = Vector.<Point>([new Point(715,280),new Point(837,284)]);
      ...
      private function getURL(param1:Function = null) : void
      {
         ...
         QueueLoader.load(URLUtil.getActivityAnimation("leiLuoHomeGloryAct/LeiLuoHomeGloryAct"),"swf",function(param1:ContentInfo):void
         {
      ...
      {
         if(SceneManager.prevSceneType == 2 && FIGHT_LIST[1] == FightManager.currentFightRecord.initData.positionIndex)
         {
      ...
      private function createNpc1() : void
      {
         if(!this._npc1)
         {
            ...
            this._npc1.addEventListener("click",this.onNpcClick1);
         }
      }
      ...
      private function clearNpc1() : void
      {
         if(this._npc1)
         {
            this._npc1.removeEventListener("click",this.onNpcClick1);
