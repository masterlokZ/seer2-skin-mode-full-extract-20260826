package com.taomee.seer2.app.processor.quest.handler.branch.quest10158
{
   ...
   public class QuestMapHandler_10158_800 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         if(QuestManager.isAccepted(_quest.id) && SceneManager.prevSceneType == 2 && (FightManager.currentFightRecord.initData.positionIndex == 86 || FightManager.currentFightRecord.initData.positionIndex == 87))
         {
