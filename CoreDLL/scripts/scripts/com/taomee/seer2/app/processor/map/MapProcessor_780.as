package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_780 extends MapProcessor
   {
      ...
      {
         DialogPanel.addEventListener("customUnitClick",this.onStartFight);
      }
      ...
      private function onStartFight(param1:DialogPanelEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case "fight_npc_780_50":
               FightManager.startFightBinaryWild(59,null,null,_loc3_);
               break;
            case "fight_npc_780_40":
               FightManager.startFightBinaryWild(58,null,null,_loc3_);
               break;
            case "fight_npc_780_30":
               FightManager.startFightBinaryWild(57,null,null,_loc3_);
         }
      }
      
      override public function dispose() : void
      {
         DialogPanel.removeEventListener("customUnitClick",this.onStartFight);
         super.dispose();
      }
   }
}
