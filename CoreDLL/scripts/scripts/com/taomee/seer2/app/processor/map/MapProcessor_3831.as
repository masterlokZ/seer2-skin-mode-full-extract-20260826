package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_3831 extends MapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         (_map.content["door"] as MovieClip).addEventListener("click",this.onOpenDoor);
         (_map.content["goYaoSai"] as MovieClip).buttonMode = true;
         (_map.content["goYaoSai"] as MovieClip).addEventListener("click",this.onGoYaoSai);
      ...
      private function onGoExpDoor(param1:Event) : void
      {
         ...
         MovieClipUtil.playMc(_map.content["door"] as MovieClip,2,(_map.content["door"] as MovieClip).totalFrames,function():void
         {
            ...
            SwapManager.swapItem(3422,1,function(param1:IDataInput):void
            {
               ...
               SceneManager.changeScene(9,80342);
            });
         });
      }
      ...
      {
         (_map.content["door"] as MovieClip).removeEventListener("click",this.onOpenDoor);
         (_map.content["goYaoSai"] as MovieClip).removeEventListener("click",this.onGoYaoSai);
