package com.taomee.seer2.app.processor.quest
{
   ...
   public class QuestProcessor_30001 extends QuestProcessor
   {
      ...
      override public function init() : void
      {
         if(_quest.status == 0)
         {
            QuestManager.addEventListener("accept",this.onAcceptQuest);
         }
         else if(_quest.status == 1)
         {
            this.processStep();
         }
         PetInfoManager.addEventListener("petExperenceChange",this.onExperenceChange);
      }
      
      override public function dispose() : void
      {
         DialogPanel.removeEventListener("questUnitClick",this.onQuestUnitClick);
         DialogPanel.removeEventListener("questUnitClick",this.onQuestUnitClick1);
         QuestManager.removeEventListener("accept",this.onAcceptQuest);
         ...
         QuestManager.removeEventListener("stepComplete",this.onCompleteStep5);
         QuestManager.removeEventListener("stepComplete",this.onCompleteStep6);
         QuestManager.removeEventListener("stepComplete",this.onCompleteStep7);
         SceneManager.removeEventListener("switchComplete",this.onSwitchComplete1);
         SceneManager.removeEventListener("switchComplete",this.onSwitchComplete2);
         SceneManager.removeEventListener("switchComplete",this.onSwitchComplete3);
         MiniGameManager.removeEventListener("endPlayGame",this.onPlayMiniGameEnd);
         ItemManager.removeEventListener1("cookingComplete",this.onCookSuccess);
         ItemManager.removeEventListener1("mineSuccess",this.onMineSuccess);
         PetInfoManager.removeEventListener("petExperenceChange",this.onExperenceChange);
      }
      ...
      {
         DialogPanel.addEventListener("questUnitClick",this.onQuestUnitClick);
      }
                     ...
                     NpcDialog.show(2,"伊娃博士",[[0,"是的！而且雷克是很智慧的精灵，它需要<font color=\'#ffcc00\'>坚毅之芯</font>，才会<font color=\'#ffcc00\'>进化</font>哦！"]],["坚毅之芯？要怎么才能得到？"],[function():void
                     {
                        NpcDialog.show(2,"伊娃博士",[[0,"带雷克去做6件事，每件事都会让雷克成长，并脱落乳牙。带着6颗乳牙再来找我。"]],["哪6件事？"],[function():void
                        {
                           NpcDialog.show(2,"伊娃博士",[[0,"<font color=\'#ffcc00\'>第一件事：带雷克跟随，去战胜幻影崖的小树根！</font>6件事已记录在任务档案中，按照任务档案中的指示去做吧！"]],[" 谢谢，我知道啦！"],[function():void
                           {
                              ...
                              DialogPanel.removeEventListener("questUnitClick",onQuestUnitClick);
      ...
      private function processStep2() : void
      {
         ...
         {
            SceneManager.addEventListener("switchComplete",this.onSwitchComplete1);
         }
      }
      ...
      private function onSwitchComplete1(param1:SceneEvent) : void
      {
         ...
         if(SceneManager.prevSceneType == 2 && FightManager.fightWinnerSide == 1)
         {
            if(FightManager.currentFightRecord && FightManager.currentFightRecord.initData && Boolean(FightManager.currentFightRecord.initData.positionIndex) && Boolean(FightManager.currentFightRecord.initData.type) && FightManager.currentFightRecord.initData.type == "fightWild")
            {
               ...
               if(SceneManager.active.mapID == 141 && position >= 0 && position <= 9)
               {
                  MovieClipUtil.playFullScreen(URLUtil.getQuestFullScreenAnimation("30001_0"),function():void
                  {
                     ...
                     SceneManager.removeEventListener("switchComplete",onSwitchComplete1);
                     writeDateToBuffer(2);
      ...
      private function processStep3() : void
      {
         ...
         {
            MiniGameManager.addEventListener("endPlayGame",this.onPlayMiniGameEnd);
         }
      }
      ...
      private function onPlayMiniGameEnd(param1:MiniGameEvent) : void
      {
         ...
         if(evt.gameId == 3)
         {
            MovieClipUtil.playFullScreen(URLUtil.getQuestFullScreenAnimation("30001_0"),function():void
            {
               ...
               MiniGameManager.removeEventListener("endPlayGame",onPlayMiniGameEnd);
               writeDateToBuffer(3);
      ...
      private function processStep4() : void
      {
         ...
         {
            SceneManager.addEventListener("switchComplete",this.onSwitchComplete3);
         }
      }
      ...
      private function onSwitchComplete3(param1:SceneEvent) : void
      {
         ...
         {
            if(FightManager.currentFightRecord && FightManager.currentFightRecord.initData && Boolean(FightManager.currentFightRecord.initData.type) && FightManager.currentFightRecord.initData.type == "fightTrainer")
            {
               MovieClipUtil.playFullScreen(URLUtil.getQuestFullScreenAnimation("30001_0"),function():void
               {
                  ServerMessager.addMessage("获得第3颗乳牙！带雷克去异蘑世界挖矿！");
                  SceneManager.removeEventListener("switchComplete",onSwitchComplete3);
                  writeDateToBuffer(4);
                  QuestManager.addEventListener("stepComplete",onCompleteStep4);
      ...
      private function onMineSuccess(param1:ItemEvent) : void
      {
         ...
         MovieClipUtil.playFullScreen(URLUtil.getQuestFullScreenAnimation("30001_0"),function():void
         {
            ...
            ItemManager.removeEventListener1("mineSuccess",onMineSuccess);
            writeDateToBuffer(5);
            QuestManager.addEventListener("stepComplete",onCompleteStep5);
      ...
      private function processStep6() : void
      {
         ...
         {
            ItemManager.addEventListener1("cookingComplete",this.onCookSuccess);
         }
      }
      ...
      private function onCookSuccess(param1:ItemEvent) : void
      {
         ...
         if(evt.content.id == 200502 || evt.content.id == 200501 || evt.content.id == 200503)
         {
            MovieClipUtil.playFullScreen(URLUtil.getQuestFullScreenAnimation("30001_0"),function():void
            {
               ServerMessager.addMessage("获得第5颗乳牙！带雷克去巨石洞穴挑战布鲁托！");
               ItemManager.removeEventListener1("cookingComplete",onCookSuccess);
               writeDateToBuffer(6);
               QuestManager.addEventListener("stepComplete",onCompleteStep6);
      ...
      private function processStep7() : void
      {
         ...
         {
            SceneManager.addEventListener("switchComplete",this.onSwitchComplete2);
         }
      }
      ...
      private function onSwitchComplete2(param1:Event) : void
      {
         ...
         if(SceneManager.prevSceneType == 2)
         {
            ...
            {
               if(FightManager.currentFightRecord.initData.bossId == 17)
               {
                  MovieClipUtil.playFullScreen(URLUtil.getQuestFullScreenAnimation("30001_0"),function():void
                  {
                     ServerMessager.addMessage("获得第6颗乳牙！去实验室找伊娃博士吧！");
                     SceneManager.removeEventListener("switchComplete",onSwitchComplete2);
                     writeDateToBuffer(7);
                     QuestManager.addEventListener("stepComplete",onCompleteStep7);
      ...
      {
         DialogPanel.addEventListener("questUnitClick",this.onQuestUnitClick1);
      }
