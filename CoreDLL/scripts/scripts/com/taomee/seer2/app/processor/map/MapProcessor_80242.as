package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80242 extends MapProcessor
   {
      ...
      private function update() : void
      {
         ActiveCountManager.requestActiveCountList(FOR_LIST,function(param1:Parser_1142):void
         {
            ...
            DayLimitListManager.getDaylimitList(DAY_LIST,function(param1:DayLimitListInfo):void
            {
               ...
               _miPass.addEventListener("click",onMiPass);
               _scroe.text = _par.infoVec[1].toString();
               _leaveTime = 300 - (TimeManager.getPrecisionServerTime() - _info.getCount(DAY_LIST[0]));
               if(_leaveTime <= 0)
               {
                  _leaveTime = 0;
               }
      ...
      private function createMonster() : void
      {
         ...
         while(_loc1_ < 3)
         {
            this._monsterList.push(new SpawnedPet(1100,FIGHT_INDEX[ActsHelperUtil.getRandom(0,3)],0));
