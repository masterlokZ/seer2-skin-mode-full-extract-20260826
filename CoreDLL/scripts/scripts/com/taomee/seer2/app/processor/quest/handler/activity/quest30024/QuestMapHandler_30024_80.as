package com.taomee.seer2.app.processor.quest.handler.activity.quest30024
{
   ...
   public class QuestMapHandler_30024_80 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         if(SceneManager.prevSceneType == 2 && QuestManager.isStepComplete(_quest.id,2) && QuestManager.isStepComplete(_quest.id,3) == false && _fightIndex == 1)
         {
            _fightIndex = 0;
            this.afterFight();
            return;
         ...
         if(QuestManager.isStepComplete(_quest.id,1) && !QuestManager.isStepComplete(_quest.id,2))
         {
            this.initMc();
            this.initEvent();
            this._mobileYiwa = MobileManager.getMobile(1001,"npc");
            this._mobileYiwa.visible = false;
            this._mobilePang = MobileManager.getMobile(468,"npc");
      ...
      private function initEvent() : void
      {
         ...
         this._moumou_npc.addEventListener("click",this.onClickNpc1);
      }
      ...
      private function onClickNpc1(param1:MouseEvent) : void
      {
         ...
         this._moumou_npc.removeEventListener("click",this.onClickNpc1);
      ...
      private function initStep2Npc() : void
      {
         ...
         this._palading_npc.addEventListener("click",this.onClickKalaer);
      }
      ...
      override public function processMapDispose() : void
      {
         ...
         {
            this._palading_npc.removeEventListener("click",this.onClickKalaer);
