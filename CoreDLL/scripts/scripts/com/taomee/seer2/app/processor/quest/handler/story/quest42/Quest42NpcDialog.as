package com.taomee.seer2.app.processor.quest.handler.story.quest42
{
   ...
   public class Quest42NpcDialog
   {
      ...
      {
         ServerBufferManager.updateServerBuffer(12,param1,1);
         ServerBufferManager.getServerBuffer(12,getServerBuf,false);
      }
      ...
      {
         QuestManager.removeEventListener("stepComplete",onStepComplete);
