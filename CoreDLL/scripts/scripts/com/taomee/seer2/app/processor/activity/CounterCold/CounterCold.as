package com.taomee.seer2.app.processor.activity.CounterCold
{
   ...
   public class CounterCold
   {
      ...
      private function init() : void
      {
         ...
         {
            _curCount = param1;
            ServerBufferManager.getServerBuffer(65,onGetServer,false);
         });
      }
      ...
      {
         QueueLoader.load(URLUtil.getActivityAnimation("counterCold/CounterCold"),"swf",function(param1:ContentInfo):void
         {
      ...
      private function initHandle() : void
      {
         ...
         this._coldBottle.addEventListener("click",this.onBottleClick);
         this._handItemMc.addEventListener("click",this.onHandItemClick);
      }
      ...
      private function counterStateHandle(param1:IDataInput = null) : void
      {
         ...
         {
            this._hasJoinGame = true;
            ServerBufferManager.updateServerBuffer(65,1,1);
            if(Boolean(this._mouseHint) && Boolean(this._mouseHint.parent))
            {
               DisplayUtil.removeForParent(this._mouseHint);
            }
         ...
         DayLimitManager.getDoCount(DAY_LIMIT[0],function(param1:int):void
         {
            ...
            if(num == 8)
            {
               ...
               _counterState = 0;
               _handItemMc.buttonMode = true;
               _counter.addEventListener("click",onFinishClick);
               return;
            }
      ...
      public function styleChange(param1:int) : String
      {
         ...
         var _loc5_:int = param1 / 3600;
         var _loc6_:int = (param1 - _loc5_ * 3600) / 60;
         var _loc2_:int = param1 - _loc5_ * 3600 - 60 * _loc6_;
         if(_loc5_ <= 9)
         {
            _loc7_ = "0" + String(_loc5_);
         }
         else
         {
         ...
         if(_loc6_ <= 9)
         {
            _loc3_ = "0" + String(_loc6_);
         }
         else
         {
            _loc3_ = String(_loc6_);
         }
         if(_loc2_ <= 9)
         {
      ...
      private function addCounterMouseEvent() : void
      {
         if(Boolean(this._counter) && Boolean(this._counter.parent))
         {
            ...
            this._counter.addEventListener("click",this.onCounterClick);
            this._counter.addEventListener("rollOver",this.onCounterOver);
            this._counter.addEventListener("rollOut",this.onCounterOut);
         }
      }
      ...
      private function removeCounterMouseEvent() : void
      {
         if(Boolean(this._counter) && Boolean(this._counter.parent))
         {
            ...
            this._counter.removeEventListener("click",this.onCounterClick);
            this._counter.removeEventListener("click",this.onCounterOver);
            this._counter.removeEventListener("click",this.onCounterOut);
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(Boolean(this._counter) && Boolean(this._counter.parent))
         {
            ...
            this._counter.removeEventListener("click",this.onCounterOver);
            this._counter.removeEventListener("click",this.onCounterOut);
            this._counter.removeEventListener("click",this.onFinishClick);
         }
         this._counter = null;
         if(Boolean(this._coldBottle) && Boolean(this._coldBottle.parent))
         {
            this._coldBottle.removeEventListener("click",this.onBottleClick);
         ...
         {
            this._handItemMc.removeEventListener("click",this.onHandItemClick);
