   ...
   public class QuestMapHandler_27_390 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         if(QuestManager.isCanAccepted(_quest.id) && QuestManager.isComplete(26))
         {
            ...
            ModuleManager.addEventListener("MapSignPanel","show",this.onMapPanelShow);
            ModuleManager.addEventListener("MapSignPanel","hide",this.onMapPanelHide);
            this.addMouseHint(72,490);
         }
         else if(QuestManager.isCanAccepted(_quest.id))
         {
            QuestManager.addEventListener("complete",this.onRelateQuestComplete);
         }
      }
      ...
      private function onRelateQuestComplete(param1:QuestEvent) : void
      {
         ...
         {
            QuestManager.removeEventListener("complete",this.onRelateQuestComplete);
            this._mousePoint = new Point(412,405);
            ModuleManager.addEventListener("MapSignPanel","show",this.onMapPanelShow);
            ModuleManager.addEventListener("MapSignPanel","hide",this.onMapPanelHide);
            this.addMouseHint(72,490);
      ...
      override public function processMapDispose() : void
      {
         ...
         ModuleManager.removeEventListener("MapSignPanel","show",this.onMapPanelShow);
         ModuleManager.removeEventListener("MapSignPanel","hide",this.onMapPanelHide);
         this.clearMouseHint();
