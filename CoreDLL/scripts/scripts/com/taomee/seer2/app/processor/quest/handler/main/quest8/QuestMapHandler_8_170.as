   ...
   public class QuestMapHandler_8_170 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         else if(_quest.status == 1)
         {
            ...
            if(_quest.isStepCompete(5) && !_quest.isStepCompete(6))
            {
               this.processStep6();
            }
      ...
      private function processStep2() : void
      {
         ...
         this._stepArea1.addEventListener("click",this.onClickStepArea1);
      }
      ...
      private function onClickStepArea1(param1:MouseEvent) : void
      {
         ...
         this._stepArea1.removeEventListener("click",this.onClickStepArea1);
         MovieClipUtil.playFullScreen(URLUtil.getQuestAnimation("8/fullScreen_0"),function():void
         {
            ...
            _npcTalkBtn.x = 790;
            _npcTalkBtn.y = 522;
            UILoader.load(URLUtil.getQuestAnimation("8/npcTalk_0"),"swf",onLoadNpcTalkComplete);
         });
      }
      ...
      private function playNpcTalk() : void
      {
         ...
         {
            switch(this._npcTalkContentIndex - 1)
            {
               case 0:
      ...
      private function playNpcChoose(param1:MovieClip) : void
      {
         ...
         MovieClipUtil.getChildList(mc,"choose",["btn1","btn2","btn3"],function(param1:Vector.<DisplayObject>):void
         {
            ...
            {
               var evt:MouseEvent = param1;
               btn1.removeEventListener("click",onClickBtn);
               btn2.removeEventListener("click",onClickBtn);
               btn3.removeEventListener("click",onClickBtn);
               ...
               MovieClipUtil.playMc(mc,"start" + _npcTalkBtnIndex,"mid" + _npcTalkBtnIndex,function():void
               {
                  ...
                  _npcTalkBtn.addEventListener("click",onClickNpcBtn1);
               });
            };
            ...
            btn2.addEventListener("click",onClickBtn);
            btn3.addEventListener("click",onClickBtn);
         });
      }
      ...
      private function onClickNpcBtn1(param1:MouseEvent) : void
      {
         ...
         this._npcTalkBtn.removeEventListener("click",this.onClickNpcBtn1);
      ...
      private function processStep3() : void
      {
         _processor.showMouseHintOver(this._stepArea1);
         this._stepArea1.buttonMode = true;
         this._stepArea1.addEventListener("click",this.onClickStepArea2);
      }
      ...
      private function onClickStepArea2(param1:MouseEvent) : void
      {
         ...
         _processor.hideMouseClickHint();
         this._stepArea1.buttonMode = false;
         this._stepArea1.removeEventListener("click",this.onClickStepArea2);
