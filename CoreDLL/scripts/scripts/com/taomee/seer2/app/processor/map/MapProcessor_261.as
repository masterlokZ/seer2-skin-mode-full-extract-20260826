package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_261 extends TitleMapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         StatisticsManager.sendNovice("0x10033442");
      }
      ...
      {
         StatisticsManager.sendNovice("0x1003356B");
         ModuleManager.toggleModule(URLUtil.getAppModule("MiniGameIntroPanel"),"正在打开小游戏...",{"gameId":7});
      }
