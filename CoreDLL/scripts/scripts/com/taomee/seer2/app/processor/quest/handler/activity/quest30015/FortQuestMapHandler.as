package com.taomee.seer2.app.processor.quest.handler.activity.quest30015
{
   ...
   public class FortQuestMapHandler extends QuestMapHandler
   {
      ...
      override public function processMapDispose() : void
      {
         ...
         QuestManager.removeEventListener("stepComplete",this.completeQuest);
      ...
      override public function processMapComplete() : void
      {
         ...
         this.npc = MobileManager.getMobile(this.npcId,"npc");
      ...
      protected function toStep4Dia() : void
      {
         NpcDialog.show(this.npcId,this.npcName,[[0,"干得不错哦，来这个给你的奖励。"]],["领取奖励"],[function():void
         {
            ...
            stepId = 4;
            NpcManager.removeEventListener("actorArrive",onActorArriveShow);
      ...
      protected function toStep2Dia() : void
      {
         NpcDialog.show(this.npcId,this.npcName,[[0,"干得不错哦，来这个给你的奖励。"]],["领取奖励"],[function():void
         {
            ...
            NpcManager.addEventListener("actorArrive",onActorArriveShow);
            if(questId == 30019)
            {
               QuestManager.addEventListener("complete",completeQuest);
      ...
      protected function onAccept(param1:QuestEvent) : void
      {
         if(param1.questId == _quest.id)
         {
            ...
            SceneManager.changeScene(1,this.battleScene);
         }
      }
