package com.taomee.seer2.app.processor.quest.handler.main.quest4
{
   ...
   public class QuestMapHandler_4_133 extends QuestMapHandler
   {
      ...
      private function processStep7() : void
      {
         ...
         {
            QuestManager.addEventListener("stepComplete",onStepComplete7);
      ...
      private function onStepComplete7(param1:QuestEvent) : void
      {
         ...
         {
            QuestManager.removeEventListener("stepComplete",this.onStepComplete7);
            this.processStep8();
         }
      }
      ...
      private function processStep8() : void
      {
         ...
         this._leaf133.addEventListener("click",this.onLeafClick);
         this._leaf133.addEventListener("mouseOver",this.onLeafOver);
         this._leaf133.addEventListener("enterFrame",this.onLeafEnterFrame);
      }
      ...
      {
         this._leaf133.removeEventListener("mouseOver",this.onLeafOver);
      ...
      private function onLeafEnterFrame(param1:Event) : void
      {
         ...
         {
            this._leaf133.removeEventListener("enterFrame",this.onLeafEnterFrame);
            ...
            this._quest4Step8Animation133.addEventListener("enterFrame",this.onQuest4Step8AnimationEnd);
         }
      }
      ...
      private function onQuest4Step8AnimationEnd(param1:Event) : void
      {
         if(this._quest4Step8Animation133.currentFrame == this._quest4Step8Animation133.totalFrames)
         {
            ...
            this._quest4Step8Animation133.removeEventListener("enterFrame",this.onQuest4Step8AnimationEnd);
            DisplayObjectUtil.removeFromParent(this._quest4Step8Animation133);
            QuestManager.addEventListener("stepComplete",this.onStepComplete8);
      ...
      private function onStepComplete8(param1:QuestEvent) : void
      {
         if(_quest.id == param1.questId)
         {
            QuestManager.removeEventListener("stepComplete",this.onStepComplete8);
            this.processStep9();
         }
      }
      ...
      private function processStep9() : void
      {
         ...
         {
            QuestManager.addEventListener("stepComplete",onStepComplete9);
      ...
      private function onStepComplete9(param1:QuestEvent) : void
      {
         if(_quest.id == param1.questId)
         {
            QuestManager.removeEventListener("stepComplete",this.onStepComplete9);
      ...
      override public function processMapDispose() : void
      {
         if(this._leaf133)
         {
            this._leaf133.removeEventListener("click",this.onLeafClick);
            this._leaf133.removeEventListener("mouseOver",this.onLeafOver);
            this._leaf133.removeEventListener("enterFrame",this.onLeafEnterFrame);
            DisplayObjectUtil.removeFromParent(this._leaf133);
            this._leaf133 = null;
