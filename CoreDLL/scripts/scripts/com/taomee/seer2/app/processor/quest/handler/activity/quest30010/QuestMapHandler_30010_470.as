package com.taomee.seer2.app.processor.quest.handler.activity.quest30010
{
   ...
   public class QuestMapHandler_30010_470 extends QuestMapHandler
   {
      ...
      private function initStep2() : void
      {
         ...
         DialogPanel.addEventListener("customReplyClick",this.showScrew);
      }
      ...
      private function showScrew(param1:DialogPanelEvent) : void
      {
         ...
         {
            DialogPanel.removeEventListener("customReplyClick",this.showScrew);
            this.repairNum = 0;
            ...
            this.screwMc.addEventListener("click",this.repairScrew);
         }
      }
      ...
      private function repairScrew(param1:MouseEvent) : void
      {
         ...
         else
         {
            ...
            this.screwMc.removeEventListener("click",this.repairScrew);
