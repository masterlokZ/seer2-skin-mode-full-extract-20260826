package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_122 extends TitleMapProcessor
   {
      ...
      {
         this.initBird();
         StatisticsManager.sendNovice("0x10033412");
      ...
      private function initBird() : void
      {
         ...
         this._birdAnimation.addEventListener("click",this.onBirdClick);
      }
      ...
      private function onBirdClick(param1:MouseEvent) : void
      {
         ...
         else if(this._birdClickCount == 1)
         {
            ...
            this._birdAnimation.removeEventListener("click",this.onBirdClick);
         }
      }
      ...
      private function reward() : void
      {
         ...
         {
            SwapEventDispatcher.addEventListener("swapEnd",this.onSwapEnd);
      ...
      override public function dispose() : void
      {
         ...
         if(Boolean(this._birdAnimation) && this._birdAnimation.hasEventListener("click") == false)
         {
            this._birdAnimation.removeEventListener("click",this.onBirdClick);
