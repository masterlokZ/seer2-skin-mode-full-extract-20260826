package com.taomee.seer2.app.processor.quest.handler.branch.quest10162
{
   ...
   public class QuestMapHandler_10162_291 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         if(QuestManager.isAccepted(_quest.id) && QuestManager.isStepComplete(_quest.id,1) == false && SceneManager.prevSceneType == 2 && (FightManager.currentFightRecord.initData.positionIndex == 1 || FightManager.currentFightRecord.initData.positionIndex == 2 || FightManager.currentFightRecord.initData.positionIndex == 3 || FightManager.currentFightRecord.initData.positionIndex == 4 || FightManager.currentFightRecord.initData.positionIndex == 5 || FightManager.currentFightRecord.initData.positionIndex == 6 || FightManager.currentFightRecord.initData.positionIndex == 7 || FightManager.currentFightRecord.initData.positionIndex == 8 || FightManager.currentFightRecord.initData.positionIndex == 9 || FightManager.currentFightRecord.initData.positionIndex == 100006))
         {
      ...
      private function onSwap(param1:IDataInput) : void
      {
         ...
         if(swap.itemCount != 0)
         {
            ...
            {
               ItemManager.addEventListener1("requestSpecialItemSuccess",getItemHandle);
      ...
      private function getItemHandle(param1:ItemEvent) : void
      {
         ...
         ItemManager.removeEventListener1("requestSpecialItemSuccess",this.getItemHandle);
      ...
      {
         ItemManager.removeEventListener("requestSpecialItemSuccess",this.getItemHandle);
      }
   }
}
