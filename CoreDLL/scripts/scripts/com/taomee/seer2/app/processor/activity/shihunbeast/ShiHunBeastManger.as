package com.taomee.seer2.app.processor.activity.shihunbeast
{
   ...
   public class ShiHunBeastManger
   {
      ...
      private var rangePos:Array = [[322,441],[1000,580]];
      
      private var NPCID:Array = [1034,1035,1036];
      ...
      public function init() : void
      {
         ...
         if(this._whitchIndex < 3)
         {
            ...
            MobileManager.addMobile(this.headMc,"npc");
            this.headMc.addEventListener("click",this.onHead);
         }
         if(SceneManager.prevSceneType == 2)
         {
            if(this._fightID == FightManager.currentFightRecord.initData.positionIndex)
            {
               _loc1_ = FightManager.fightWinnerSide;
               if(_loc1_ != 2)
               {
                  if(_loc1_ == 1)
                  {
                     _loc3_ = int(ItemManager.getSpecialItem(605393) != null ? int(ItemManager.getSpecialItem(605393).quantity) : 0);
                     if(_loc3_ >= 8)
                     {
         ...
         var _loc2_:int = int(ItemManager.getSpecialItem(605393) != null ? int(ItemManager.getSpecialItem(605393).quantity) : 0);
         if(_loc2_ >= 10)
         {
            ModuleManager.showAppModule("ShiHunBeastTips2Panel");
         }
      ...
      private function onHead(param1:MouseEvent) : void
      {
         ...
         var num:int = int(ItemManager.getSpecialItem(605393) != null ? int(ItemManager.getSpecialItem(605393).quantity) : 0);
         if(num >= 10)
         {
            ModuleManager.showAppModule("ShiHunBeastTips2Panel");
         }
            ...
            SwapManager.swapItem(3653,1,function(param1:IDataInput):void
            {
               ...
               ActiveCountManager.requestActiveCountList([205488],function(param1:Parser_1142):void
               {
                  ...
                  else if(par.infoVec[0] == 2)
                  {
                     ...
                     num = int(ItemManager.getSpecialItem(605393) != null ? int(ItemManager.getSpecialItem(605393).quantity) : 0);
                     if(num >= 10)
                     {
                        ModuleManager.showAppModule("ShiHunBeastTips2Panel");
                     }
                  ...
                  else if(par.infoVec[0] == 3)
                  {
                     ...
                     num1 = int(ItemManager.getSpecialItem(605392) != null ? int(ItemManager.getSpecialItem(605392).quantity) : 0);
                     if(num1 >= 8)
                     {
      ...
      public function dispose() : void
      {
         if(this.headMc != null)
         {
            MobileManager.removeMobile(this.headMc,"npc");
         }
      }
   }
}
