package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80151 extends MapProcessor
   {
      ...
      private function aKaNaSiSuperProcessActInit() : void
      {
         ...
         {
            DayLimitManager.getDoCount(1015,function(param1:int):void
            {
               var val:int = param1;
               ActiveCountManager.requestActiveCount(203819,function(param1:uint, param2:uint):void
               {
      ...
      {
         Connection.send(CommandSet.RANDOM_EVENT_1140,82,0);
      }
