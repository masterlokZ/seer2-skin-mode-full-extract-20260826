package com.taomee.seer2.app.processor.map
{
   ...
   public class ShuangMianMingWangMap extends MapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         this.npc = MobileManager.getMobile(this.npc_id[this.index],"npc");
      ...
      private function onClick(param1:MouseEvent) : void
      {
         ...
         ActiveCountManager.requestActiveCountList([204140,204136],function(param1:Parser_1142):void
         {
            var par:Parser_1142 = param1;
            buyChance = par.infoVec[0];
            level = par.infoVec[1];
            DayLimitManager.getDoCount(1101,function(param1:uint):void
            {
               haveFight = param1;
               if(level > index)
               {
