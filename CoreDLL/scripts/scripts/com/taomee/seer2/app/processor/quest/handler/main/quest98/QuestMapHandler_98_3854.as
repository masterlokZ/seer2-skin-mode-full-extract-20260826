package com.taomee.seer2.app.processor.quest.handler.main.quest98
{
   ...
   public class QuestMapHandler_98_3854 extends QuestMapHandler
   {
      ...
      private var _fightID:Array = [1670];
      ...
      {
         this._oldNpc = MobileManager.getMobile(3020,"npc");
         ...
         this._newNpc.addEventListener("click",this.onNpc3020Click);
      }
      ...
      private function showDialog() : void
      {
         NpcDialog.show(3020,"费雷德",[[0,"好了~现在我们需要施法召唤暗影守护者！在这期间我需要你们帮我个忙……"]],["要我们做什么尽管说吧！？"],[function():void
         {
            NpcDialog.show(3020,"费雷德",[[0,"我们会在祭坛中使用法典的力量开始召唤仪式？这强大的法力涌动肯定会引起精灵的躁动甚至惊动萨伦帝国……"]],["YE！放心，我会帮你赶跑他们"],[function():void
            {
               ...
               {
                  MovieClipUtil.getSwfContent(URLUtil.getActivityAnimation("DarkDefender"),(function():*
                  {
                     ...
                     return callBack = function(param1:MovieClip):void
                     {
                        ...
                        tempNpc = MobileManager.getMobile(3020,"npc");
                        if(tempNpc)
                        {
                           tempNpc.visible = false;
                        }
                        MovieClipUtil.playMc(_animation,1,_animation.totalFrames,(function():*
                        {
                           var callBack:Function;
      ...
      private function showNpc40() : void
      {
         ...
         this._npc40.addEventListener("click",this.onNpc40Click);
         this.showMouseHintAtMonster(this._npc40);
         MobileManager.addMobile(this._npc40,"npc");
      }
      ...
      {
         this._npc40.removeEventListener("click",this.onNpc40Click);
         this.fightWithWild();
      }
      
      private function onNpc3020Click(param1:MouseEvent) : void
      {
         this._newNpc.removeEventListener("click",this.onNpc3020Click);
         this.afterFinish();
         this.showDialog();
      }
      ...
      private function onCompleteSwitch(param1:SceneEvent) : void
      {
         ...
         if(SceneManager.prevSceneType == 2)
         {
            ...
            if(this._fightID[0] == FightManager.currentFightRecord.initData.positionIndex)
            {
               ...
               {
                  MovieClipUtil.playFullScreen(URLUtil.getActivityFullScreen("DarkDefender1"),(function():*
                  {
                     var callBack:Function;
                     return callBack = function():void
                     {
               ...
               {
                  MovieClipUtil.playFullScreen(URLUtil.getActivityFullScreen("DarkDefender2"),(function():*
                  {
                     var callBack:Function;
                     return callBack = function():void
                     {
