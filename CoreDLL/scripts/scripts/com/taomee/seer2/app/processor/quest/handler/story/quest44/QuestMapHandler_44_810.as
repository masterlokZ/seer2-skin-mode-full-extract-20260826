package com.taomee.seer2.app.processor.quest.handler.story.quest44
{
   ...
   public class QuestMapHandler_44_810 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         if(SceneManager.prevSceneType == 2 && QuestManager.isAccepted(_quest.id) && !QuestManager.isStepComplete(_quest.id,1))
         {
      ...
      {
         DialogPanel.addEventListener("customReplyClick",this.playFullAnimation);
      }
      
      private function initStep2() : void
      {
         DialogPanel.addEventListener("customReplyClick",this.playComic);
      }
      ...
      private function initStep1() : void
      {
         ...
         DialogPanel.addEventListener("customReplyClick",this.onWhaleDia);
      }
      ...
      private function onWhaleDia(param1:DialogPanelEvent) : void
      {
         ...
         {
            DialogPanel.removeEventListener("customReplyClick",this.onWhaleDia);
      ...
      private function playFullAnimation(param1:DialogPanelEvent) : void
      {
         ...
         {
            DialogPanel.removeEventListener("customReplyClick",this.playFullAnimation);
      ...
      private function playComic(param1:DialogPanelEvent) : void
      {
         ...
         {
            DialogPanel.removeEventListener("customReplyClick",this.playComic);
            MovieClipUtil.playNpcTalkNew(URLUtil.getQuestNpcTalkAnimation("44_1"),3,[[1,0]],function():void
            {
               NpcDialog.show(481,"耐普图隆",[[0,"据说，水脉的族人吞下了那颗果实，变成了守护整个氏族的脉灵兽。"]],[" 嗯……洛水也守护着它呢。"],[function():void
               {
                  NpcDialog.show(481,"耐普图隆",[[0,"你知道那里发生的事情？洛水是谁？爱丽斯还好吗？"]],[" 将自己在水脉氏族的经历告诉耐普图隆"],[function():void
                  {
                     ...
                     {
                        QuestManager.addEventListener("stepComplete",onStepComplete2);
