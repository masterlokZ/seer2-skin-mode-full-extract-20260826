package com.taomee.seer2.app.processor.quest.handler.branch.quest10204
{
   ...
   public class QuestMapHandler_10204_60 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         {
            this.kelake = MobileManager.getMobile(6,"npc");
            if(this.kelake)
            {
               this.kelake.addEventListener("click",this.onClick,false,1);
            }
         }
      }
      ...
      override public function processMapDispose() : void
      {
         ...
         if(this.kelake)
         {
            this.kelake.removeEventListener("click",this.onClick);
         }
