   ...
   public class QuestMapHandler_30025_100 extends QuestMapHandler
   {
      ...
      private function initQuest() : void
      {
         ...
         while(_loc1_ < this.pretendPetVec.length)
         {
            ...
            this.pretendPetVec[_loc1_].addEventListener("click",this.onTips);
         ...
         this.standPet.addEventListener("click",this.onStartBattle);
      ...
      private function checkShowPet() : void
      {
         ...
         for(; _loc1_ < 3; _loc1_++)
         {
            _loc3_ = _loc2_ - this.preTimeArr[_loc1_];
            if(_loc3_ > 60)
            {
               this.pretendPetVec[_loc1_].gotoAndPlay(int(Math.random() * 100));
               _map.content.addChild(this.pretendPetVec[_loc1_]);
               continue;
            }
            _loc3_ = 60 - _loc3_;
      ...
      private function onQuestDia(param1:NpcEvent) : void
      {
         ...
         {
            NpcManager.removeEventListener("actorArrive",this.onQuestDia);
      ...
      override public function processMapDispose() : void
      {
         ...
         if(this.standPet)
         {
            this.standPet.removeEventListener("click",this.onStartBattle);
         }
