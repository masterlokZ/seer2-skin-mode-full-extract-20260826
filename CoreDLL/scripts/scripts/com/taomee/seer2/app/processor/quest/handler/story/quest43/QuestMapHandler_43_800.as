package com.taomee.seer2.app.processor.quest.handler.story.quest43
{
   ...
   public class QuestMapHandler_43_800 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         {
            DialogPanel.addEventListener("customReplyClick",this.onScarecrowSayHandler);
         }
         if(QuestManager.isStepComplete(_quest.id,1) && QuestManager.isStepComplete(_quest.id,2) == false)
         {
            DialogPanel.addEventListener("customReplyClick",this.onScarecrowSayAgainHandler);
         }
         if(QuestManager.isStepComplete(_quest.id,2) && QuestManager.isStepComplete(_quest.id,3) == false)
         {
            DialogPanel.addEventListener("customReplyClick",this.onScarecrowThirdHandler);
         }
      }
