package com.taomee.seer2.app.processor.quest.handler.branch.quest10004
{
   ...
   public class QuestMapHandler_10004_20 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         QuestManager.addEventListener("stepComplete",this.onStepQuest);
      ...
      {
         this._puzzleBtn.addEventListener("click",this.onPuzzlePicture);
      }
      
      private function closePuzzleListener() : void
      {
         this._puzzleBtn.removeEventListener("click",this.onPuzzlePicture);
      }
      
      private function onPuzzlePicture(param1:MouseEvent) : void
      {
         this._puzzlePicture.setup("puzzlePicture");
         this._puzzlePicture.addEventListener("puzzlePicture",this.onPuzzleOver);
         this._puzzlePicture.addEventListener("close",this.onCloseAnimation);
      }
      ...
      {
         this._puzzlePicture.removeEventListener("puzzlePicture",this.onPuzzleOver);
         this._puzzlePicture.removeEventListener("close",this.onCloseAnimation);
      ...
      {
         QuestManager.removeEventListener("stepComplete",this.onStepQuest);
