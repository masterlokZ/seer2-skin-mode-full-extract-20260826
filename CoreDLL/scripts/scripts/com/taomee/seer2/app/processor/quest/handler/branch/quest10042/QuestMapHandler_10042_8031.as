package com.taomee.seer2.app.processor.quest.handler.branch.quest10042
{
   ...
   public class QuestMapHandler_10042_8031 extends QuestMapHandler
   {
      ...
      private var _time:uint = new Date(2012,0,1,13).getTime() / 1000;
      
      private var _pt:Point = new Point(335,269);
      ...
      private function addSprite() : void
      {
         ...
         this._sprite.addEventListener("click",this.onClickSprite);
      ...
      private function removeSprite() : void
      {
         if(this._sprite)
         {
            this._sprite.removeEventListener("click",this.onClickSprite);
      ...
      override public function processMapDispose() : void
      {
         ...
         DialogPanel.removeEventListener("customUnitClick",this.onCustomReply);
         this.removeSprite();
      }
   }
}
