package com.taomee.seer2.app.processor.quest.handler.main.quest90
{
   ...
   public class QuestMapHandler_90_80374 extends QuestMapHandler
   {
      ...
      private function createNpc_0() : void
      {
         ...
         MobileManager.addMobile(this._npc_0,"npc");
         var _loc1_:AcceptableMark = new AcceptableMark();
         this._npc_0.addChild(_loc1_);
         _loc1_.y = -130;
         this._npc_0.addEventListener("click",this.dialogShow);
      }
      ...
      private function createNpc_1() : void
      {
         ...
         MobileManager.addMobile(this._npc_1,"npc");
         var _loc1_:AcceptableMark = new AcceptableMark();
         this._npc_1.addChild(_loc1_);
         _loc1_.y = -130;
         this._npc_1.addEventListener("click",this.dialogShow);
      }
      ...
      private function createNpc1() : void
      {
         ...
         _loc1_.y = -160;
         this._npc1.addEventListener("click",this.dialogShow);
      }
      ...
      private function createNpc1_0() : void
      {
         ...
         MobileManager.addMobile(this._npc1_0,"npc");
         var _loc1_:AcceptableMark = new AcceptableMark();
         this._npc1_0.addChild(_loc1_);
         _loc1_.y = -160;
         this._npc1_0.addEventListener("click",this.dialogShow);
      }
      ...
      private function createNpc1_1() : void
      {
         ...
         MobileManager.addMobile(this._npc1_1,"npc");
         var _loc1_:AcceptableMark = new AcceptableMark();
         this._npc1_1.addChild(_loc1_);
         _loc1_.y = -160;
         this._npc1_1.addEventListener("click",this.dialogShow);
      }
