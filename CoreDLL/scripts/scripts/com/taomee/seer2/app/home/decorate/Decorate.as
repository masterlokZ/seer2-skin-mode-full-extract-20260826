package com.taomee.seer2.app.home.decorate
{
   ...
   public class Decorate
   {
      ...
      public function Decorate(param1:DecorateInfo, param2:ResourceLibrary)
      {
         ...
         if(SceneManager.prevSceneType == 2 && FightManager.fightWinnerSide == 1 && FightManager.currentFightRecord.initData.positionIndex == 49)
         {
            ...
            {
               mc.buttonMode = true;
               mc.addEventListener("click",onSuccessPetClick);
               initQuest();
            });
         }
         else if(SceneManager.prevSceneType == 2 && FightManager.fightWinnerSide == 2 && FightManager.currentFightRecord.initData.positionIndex == 49)
         {
      ...
      private function onSuccessPetClick(param1:MouseEvent) : void
      {
         ...
         _loc2_.removeEventListener("click",this.onSuccessPetClick);
      ...
      private function initQuest() : void
      {
         ...
         {
            QuestManager.addEventListener("complete",this.onQuestCompleted);
         ...
         else if(!(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord.initData.positionIndex == 49))
         {
      ...
      private function showSpecialEvent() : void
      {
         MovieClipUtil.playFullScreen(URLUtil.getQuestFullScreenAnimation("10044_0"),function():void
         {
            ...
            _pet.addEventListener("click",onFightPet);
         },true);
      }
      ...
      private function clearPet() : void
      {
         if(this._pet)
         {
            ...
            this._pet.removeEventListener("click",this.onFightPet);
            this._pet = null;
         }
      }
      ...
      private function onFightPet(param1:MouseEvent) : void
      {
         ...
         FightManager.addEventListener("START_ERROR",this.onStartFightError);
         FightManager.addEventListener("START_SUCCESS",this.onStartFightSuccess);
         FightManager.startFightWithWild(49);
      }
      
      private function onStartFightError(param1:FightStartEvent) : void
      {
         FightManager.removeEventListener("START_SUCCESS",this.onStartFightSuccess);
         FightManager.removeEventListener("START_ERROR",this.onStartFightError);
         if(this._pet)
         {
      ...
      private function onQuestCompleted(param1:QuestEvent) : void
      {
         ...
         {
            QuestManager.removeEventListener("complete",this.onQuestCompleted);
      ...
      private function updateNpcMouseEvent() : void
      {
         ...
         {
            this._npc.addEventListener("click",this.onCoverNpcClick,false,1);
         }
         else
         {
            ModuleManager.addEventListener("DecorateQuestPanel","show",this.onQuestPanelShow);
            ModuleManager.addEventListener("DecorateQuestPanel","hide",this.onQuestPanelHide);
         }
      }
      ...
      {
         this._npc.removeEventListener("rollOver",this.onNpcOver);
         this._npc.removeEventListener("click",this.onCoverNpcClick);
         ModuleManager.removeEventListener("DecorateQuestPanel","show",this.onQuestPanelShow);
         ModuleManager.removeEventListener("DecorateQuestPanel","hide",this.onQuestPanelHide);
      }
      ...
      private function processDecorate() : void
      {
         ...
         {
            QueueLoader.load(URLUtil.getQuestAnimation("sceneAnimation/10044"),"domain",this.onLoadComplete);
            return;
         }
      ...
      private function showCompleteLayout(param1:uint) : void
      {
         ...
         switch(int(param1) - 10044)
         {
            case 0:
               DisplayObjectUtil.removeAllChildren(this._groundContainer["quest10044"]);
               this._groundContainer["quest10044"].addChild(this._ornamentResLib.getMovieClip("quest10044"));
               break;
            case 1:
               DisplayObjectUtil.removeAllChildren(this._groundContainer["quest10045"]);
               this._groundContainer["quest10045"].addChild(this._ornamentResLib.getMovieClip("quest10045"));
               break;
            case 2:
               DisplayObjectUtil.removeAllChildren(this._groundContainer["quest10046"]);
               this._groundContainer["quest10046"].addChild(this._ornamentResLib.getMovieClip("quest10046"));
               break;
            case 3:
               _loc2_ = this._ornamentResLib.getMovieClip("quest10047");
               _loc2_.x = 564;
               _loc2_.y = 311;
               SceneManager.active.mapModel.content.addChild(_loc2_);
               break;
            case 4:
               _loc4_ = this._ornamentResLib.getMovieClip("quest10048");
               _loc4_.x = 427;
               _loc4_.y = 246;
               _loc4_.scaleX = -1;
               ...
               break;
            case 5:
               _loc3_ = this._ornamentResLib.getMovieClip("quest10049");
               _loc3_.x = 300;
               _loc3_.y = 410;
               _loc3_.buttonMode = true;
               _loc3_.addEventListener("click",this.onSwap10049);
      ...
      private function onSwap10049(param1:MouseEvent) : void
      {
         ...
         if(SceneManager.active.mapID == ActorManager.actorInfo.id && SwapManager.isSwapNumberMax(212))
         {
            SwapManager.entrySwap(212);
         }
      }
      ...
      private function showCheerIcon() : void
      {
         ...
         this._cheerIcon.addEventListener("rollOut",this.onCheerIconOut);
      ...
      private function clearCheerIcon() : void
      {
         if(this._cheerIcon)
         {
            this._cheerIcon.removeEventListener("rollOut",this.onCheerIconOut);
            (this._cheerIcon["cheerBtn"] as SimpleButton).removeEventListener("click",this.onCheer);
            DisplayObjectUtil.removeFromParent(this._cheerIcon);
      ...
      private function updateTime() : void
      {
         ...
         {
            _loc2_ = this._info.resideTime / 3600;
            _loc1_ = this._info.resideTime % 3600 / 60;
            _loc3_ = this._info.resideTime % 60;
            this._timeMcVec[0].gotoAndStop(uint(_loc2_ / 10) + 1);
            this._timeMcVec[1].gotoAndStop(uint(_loc2_ % 10) + 1);
            this._timeMcVec[2].gotoAndStop(uint(_loc1_ / 10) + 1);
            this._timeMcVec[3].gotoAndStop(uint(_loc1_ % 10) + 1);
      ...
      private function updateCheerStatus() : void
      {
         ...
         if(this._cheerIcon)
         {
            ...
            {
               (this._cheerIcon["cheerBtn"] as SimpleButton).addEventListener("click",this.onCheer);
            }
            else
            {
