package com.taomee.seer2.app.home.training
{
   ...
   public class TrainingPetSceneHandler implements ISceneHandler
   {
      ...
      private function addTrainingPetInternal(param1:TrainingPetInfo) : void
      {
         ...
         var _loc4_:Vector.<String> = TrainingPetHelper.getPetSloganVec();
         var _loc3_:TrainingPet = new TrainingPet(param1,this._homeInfo.userInfo,_loc2_,_loc4_);
         MobileManager.addMobile(_loc3_,"trainingPet");
      }
      
      private function removeTrainingPetInternal(param1:uint) : void
      {
         var _loc2_:TrainingPet = MobileManager.getMobile(param1,"trainingPet") as TrainingPet;
         if(_loc2_)
         {
            TrainingPetHelper.returnPetPostion(_loc2_.position);
            MobileManager.removeMobileById(param1,"trainingPet");
         }
      }
   }
}
