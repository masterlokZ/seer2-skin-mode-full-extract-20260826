package com.taomee.seer2.app.home.data
{
   ...
   public class HomeInfo
   {
      ...
      public function parse1038(param1:IDataInput) : void
      {
         ...
         while(_loc6_ < _loc4_)
         {
            _loc2_ = new TrainingPetInfo(param1);
            _loc2_.maxHp = param1.readUnsignedInt();
            _loc2_.atk = param1.readUnsignedShort();
            _loc2_.specialAtk = param1.readUnsignedShort();
            _loc2_.defence = param1.readUnsignedShort();
            _loc2_.specialDefence = param1.readUnsignedShort();
            _loc2_.speed = param1.readUnsignedShort();
            _loc2_.readSkillInfo(param1);
            _loc2_.parseFlag(param1.readUnsignedInt());
            this._trainingPetInfoVec.push(_loc2_);
            _loc6_++;
         }
