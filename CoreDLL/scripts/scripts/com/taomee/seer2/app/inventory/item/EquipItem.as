package com.taomee.seer2.app.inventory.item
{
   ...
   public class EquipItem extends StackableItem
   {
      ...
      {
         return param1 == 2 || param1 == 6 || param1 == 3;
      }
      ...
      {
         var _loc2_:String = this.suitId.toString();
         var _loc1_:String = Util.pad(_loc2_,"0",3,false);
         var _loc4_:String = this.slotIndex.toString();
         if(this.slotIndex == 10)
         {
            _loc4_ = (2).toString();
         }
         if(this.slotIndex == 9)
         ...
         var _loc3_:String = Util.pad(_loc4_,"0",2,false);
         return "1" + _loc1_ + _loc3_;
      }
