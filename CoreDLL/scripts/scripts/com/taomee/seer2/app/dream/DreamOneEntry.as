package com.taomee.seer2.app.dream
{
   ...
   public class DreamOneEntry
   {
      ...
      {
         ServerBufferManager.updateServerBuffer(350,6,1);
      ...
      private static function startOne() : void
      {
         NpcDialog.show(766,"小梦",[[0,"你好啊，" + ActorManager.actorInfo.nick + "。这里是我们最新发现的一座神殿，我们称之为永恒殿。"]],["我能在这里干什么？？"],[function():void
         {
            ...
            {
               ModuleManager.addEventListener("DreamMainPanel","show",onModuleShow);
            }]);
         }]);
      }
      ...
      {
         ServerBufferManager.updateServerBuffer(350,param1,1);
      }
      ...
      private static function onModuleShow(param1:ModuleEvent) : void
      {
         ...
         {
            ModuleManager.removeEventListener("DreamMainPanel","show",onModuleShow);
            _dreamOneMainMC.visible = false;
         }
      }
      ...
      {
         _back = param1;
         ServerBufferManager.getServerBuffer(350,getServerBuff);
      }
      ...
      private static function getServerBuff(param1:ServerBuffer) : void
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if(param1.readDataAtPostion(_loc3_) != 0)
            {
               _loc4_++;
            }
            _loc3_++;
