package com.taomee.seer2.app.dream
{
   ...
   public class DreamManager extends BaseBean
   {
      ...
      {
         if(SceneManager.active && SceneManager.active.type == 1 && isDreamEntryMap())
         {
      ...
      private static function getAvailableDreamTime() : int
      {
         ...
         var _loc2_:SharedObject = SharedObjectManager.getUserSharedObject("dreaming");
         ...
         return 5 - _loc3_.dreamNum;
      }
      
      public static function addDreamNum(param1:int = 1) : void
      {
         var _loc2_:Object = null;
         var _loc3_:SharedObject = SharedObjectManager.getUserSharedObject("dreaming");
         var _loc5_:String = generateDateKey();
         var _loc4_:String = generateDreamerKey();
         _loc2_ = _loc3_.data[_loc5_][_loc4_];
         if(_loc2_ == null)
         {
            _loc2_ = {};
            _loc3_.data[_loc5_][_loc4_] = _loc2_;
         }
         _loc2_.dreamNum += param1;
