package com.taomee.seer2.app.cmdl
{
   ...
   public class SystemNotifyListener extends BaseBean
   {
      ...
      private static function onData(param1:MessageEvent) : void
      {
         ...
         var _loc4_:Object = {};
         _loc4_.receiveID = _loc2_.readUnsignedInt();
         _loc4_.npcType = _loc2_.readUnsignedInt();
         _loc4_.msgTime = _loc2_.readUnsignedInt();
         var _loc3_:int = int(_loc2_.readUnsignedInt());
         _loc4_.msg = _loc2_.readUTFBytes(_loc3_);
         if(_loc4_.receiveID == 0)
         {
            ServerMessager.addMessage(_loc4_.msg);
         }
         else
         {
            NoticeManager.addSysMsgNotice(_loc4_);
         }
      }
