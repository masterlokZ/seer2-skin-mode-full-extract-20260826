package com.taomee.seer2.app.cmdl
{
   ...
   public class PetLevelUpBean extends BaseBean
   {
      ...
      private function onPetLevelUp(param1:PetInfoEvent) : void
      {
         ...
         if(_loc2_.endReason == 107)
         {
            this._fightResultPanelWrapper = new FightResultPanelWrapper();
            this._fightResultPanelWrapper.addEventListener("complete",this.onFightResultPanelClosed);
      ...
      {
         this._fightResultPanelWrapper.removeEventListener("complete",this.onFightResultPanelClosed);
