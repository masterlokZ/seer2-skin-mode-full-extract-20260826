package com.taomee.seer2.app.gameRule.nono
{
   ...
   public class NonoUtil
   {
      ...
      {
         var _loc2_:NonoInfoEvent = new NonoInfoEvent("NONO_TIMER");
         _loc2_.seconds = 600 - _timer.currentCount;
      ...
      private static function onTimerComplete(param1:TimerEvent) : void
      {
         ...
         _timer = null;
         _timerFlag = true;
         var _loc2_:NonoInfoEvent = new NonoInfoEvent("NONO_TIMER_COMPLETE");
         _loc2_.seconds = 0;
         dispatchEvent(_loc2_);
      }
