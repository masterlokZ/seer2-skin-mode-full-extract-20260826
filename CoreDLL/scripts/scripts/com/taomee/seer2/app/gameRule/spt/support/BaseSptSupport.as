package com.taomee.seer2.app.gameRule.spt.support
{
   ...
   public class BaseSptSupport implements ISupportable
   {
      ...
      protected function initSPTNPC() : void
      {
         if(this._sptNPC)
         {
            this._sptNPC.addEventListener("click",this.onSPTClickHandler);
         }
         this.hideSPT();
      }
      ...
      {
         if(Boolean(this._sptNPC) && this._sptNPC.hasEventListener("click"))
         {
            this._sptNPC.removeEventListener("click",this.onSPTClickHandler);
         }
