package com.taomee.seer2.app.gameRule.door
{
   ...
   public class BaseDoor implements IDoor
   {
      ...
      public function BaseDoor(param1:SimpleButton, param2:uint, param3:uint)
      {
         ...
         {
            this._entryButton.addEventListener("click",this.onDoorEntryClickHandler);
      ...
      {
         var _loc2_:uint = this._doorType == 0 ? uint(this._doorNormalId) : uint(this._door50V50Id);
      ...
      protected function openDoorSupportPanel() : void
      {
         ...
         _loc1_["dailyLimit"] = 5 - this._doorEntryDailyLimit;
      ...
      {
         this._entryButton.removeEventListener("click",this.onDoorEntryClickHandler);
