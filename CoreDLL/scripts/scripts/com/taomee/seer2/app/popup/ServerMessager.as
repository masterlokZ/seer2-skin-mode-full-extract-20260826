package com.taomee.seer2.app.popup
{
   ...
   public class ServerMessager extends Sprite
   {
      ...
      private static function showNextMessage() : void
      {
         ...
         _instance.show(_queue.dequeue(),_loc1_);
         _isShowing = true;
      }
      ...
      {
         _isShowing = false;
         _instance.removeEventListener("messageDispear",onMessageDispear);
         showNextMessage();
      }
      ...
      private function createChildren() : void
      {
         ...
         this._msgTxt.addEventListener("link",this.onTextClick);
         addChild(this._ui);
      }
