package com.taomee.seer2.app.popup.alert
{
   ...
   public class GetPetSpiritAlert extends Sprite implements IAlert
   {
      ...
      {
         var _loc2_:String = URLUtil.getPetSpirtTrainIcon(this._info.referenceId);
         var _loc1_:PetSpirtTrainItemDefinition = ItemConfig.getItemDefinition(this._info.referenceId) as PetSpirtTrainItemDefinition;
         var _loc3_:String = PetConfig.getPetDefinition(_loc1_.breedMonID).name;
         this._iconDisplay.setIconUrl(_loc2_);
         this._contentTxt.htmlText = (_loc1_.type == 23 ? "精元蛋:" : "精元:").toString() + "<font color=\'#ff0000\'>" + _loc3_ + "</font>已经放入精元孵化器";
