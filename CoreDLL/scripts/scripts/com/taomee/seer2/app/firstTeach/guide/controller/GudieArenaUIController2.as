package com.taomee.seer2.app.firstTeach.guide.controller
{
   ...
   public class GudieArenaUIController2 implements IArenaUIController
   {
      ...
      private function updateAnger() : void
      {
         ...
         var _loc3_:Number = 50233;
         var _loc6_:uint = 1;
         var _loc5_:uint = 13119;
         _loc2_ = this._scene.leftTeam.getFighter(_loc3_,_loc6_);
         _loc1_ = _loc2_.fighterInfo.getSkillInfo(_loc5_);
         if(_loc1_ != null)
         {
            _loc2_.fighterInfo.fightAnger -= _loc1_.anger;
         }
      }
      ...
      {
         var _loc4_:Fighter = null;
         _loc4_ = this._scene.arenaData.getFighter(param1,param2);
      ...
      private function parserSpecialDamage4() : void
      {
         ...
         _loc2_.writeUnsignedInt(50);
         _loc2_.position = 0;
         var _loc1_:TurnResultInfo = new TurnResultInfo(_loc2_);
         if(this.checkDummyAtk(_loc1_) == false)
         {
            this._scene.fightController.addTurnResultInfo(_loc1_);
         }
      }
      ...
      private function parserSpecialDamage6() : void
      {
         ...
         _loc2_.writeUnsignedInt(50233);
         _loc2_.writeUnsignedInt(1);
         _loc2_.writeUnsignedInt(10046);
         _loc2_.writeByte(1);
         _loc2_.writeUnsignedInt(450);
         _loc2_.writeUnsignedInt(500);
         _loc2_.writeShort(20);
         _loc2_.writeByte(0);
         _loc2_.writeByte(6);
      ...
      private function parserDamage3() : void
      {
         ...
         _loc2_.writeUnsignedInt(50233);
         _loc2_.writeUnsignedInt(1);
         _loc2_.writeUnsignedInt(PetInfoManager.getFirstPetInfo().skillInfo.skillInfoVec[0].id);
         _loc2_.writeByte(1);
         _loc2_.writeUnsignedInt(PetInfoManager.getFirstPetInfo().maxHp);
         _loc2_.writeUnsignedInt(PetInfoManager.getFirstPetInfo().maxHp);
         _loc2_.writeShort(30);
         _loc2_.writeByte(0);
         _loc2_.writeByte(6);
         _loc2_.writeByte(6);
         _loc2_.writeByte(6);
      ...
      {
         var _loc2_:uint = 2;
         this._scene.arenaData.turnCount = _loc2_;
         var _loc1_:uint = 0;
         this._scene.updateWeather(_loc1_);
         var _loc3_:String = this._scene.fightController.state;
         if(_loc3_ == "changeLeftFighter")
         {
            return;
         }
         if(_loc3_ == "catchFighterFailed")
         {
            return;
         }
      ...
      private function useItem() : void
      {
         ...
         var _loc4_:ByteArray = new ByteArray();
         _loc4_.writeByte(1);
         _loc4_.writeUnsignedInt(50233);
         _loc4_.writeUnsignedInt(1);
         _loc4_.writeUnsignedInt(0);
         _loc4_.writeByte(1);
         _loc4_.writeUnsignedInt(200);
         _loc4_.writeUnsignedInt(200);
         _loc4_.writeShort(100);
         _loc4_.writeByte(0);
         _loc4_.writeByte(6);
         _loc4_.writeByte(6);
         _loc4_.writeByte(6);
         ...
         _loc4_.writeUnsignedInt(0);
         _loc4_.position = 0;
         var _loc3_:ItemUseResultInfo = new ItemUseResultInfo(_loc4_);
         var _loc6_:uint = _loc3_.userId;
         var _loc5_:uint = _loc3_.fighterId;
         _loc2_ = this._scene.arenaData.getFighter(_loc6_,_loc5_);
         if(_loc2_ != null)
         {
            _loc1_ = {
               "fighter":_loc2_,
               "side":_loc2_.fighterSide,
               "itemUseResultInfo":_loc3_
            };
            ArenaAnimationManager.createAnimation("com.taomee.seer2.app.arena.animation.ItemUseAnimation",_loc1_,this.endAnimation);
            this.showSkillPanel();
      ...
      {
         this._scene.fightController.changeFighterState("catchFighterSuccess");
