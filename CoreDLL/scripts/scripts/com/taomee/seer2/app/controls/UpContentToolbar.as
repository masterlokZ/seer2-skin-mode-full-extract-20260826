package com.taomee.seer2.app.controls
{
   ...
   public class UpContentToolbar extends Sprite
   {
      ...
      {
         this._newsBtn.addEventListener("click",this.onNews);
         this._hotBtn.addEventListener("click",this.onHot);
      }
