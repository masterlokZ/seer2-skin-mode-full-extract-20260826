package com.taomee.seer2.app.controls
{
   ...
   public class NewPlayerGuide extends Sprite
   {
      ...
      {
         _mainUI.addEventListener("click",this.onClick);
      }
      ...
      private function removeEvent() : void
      {
         if(_mainUI)
         {
            _mainUI.removeEventListener("click",this.onClick);
         }
      }
      ...
      {
         if(!QuestManager.isComplete(83) && ActorManager.actorInfo.createTime > uint(new Date(2014,8,26).getTime() / 1000))
         {
            addChild(_mainUI);
            this.initEvent();
         }
