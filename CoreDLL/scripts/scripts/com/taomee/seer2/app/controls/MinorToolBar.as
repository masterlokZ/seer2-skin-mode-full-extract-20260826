package com.taomee.seer2.app.controls
{
   ...
   public class MinorToolBar extends Sprite
   {
      ...
      public function MinorToolBar()
      {
         ...
         this.addToolBarWidget("trainer",this._mainPanel["trainerBtn"],this._mainPanel["trainerMc"],"训练师手册",new TrainerWidgetClick());
         this.addToolBarWidget("quest",this._mainPanel["questBtn"],this._mainPanel["questMc"],"任务档案",new QuestWidgetClick());
         this.addToolBarWidget("fortress",this._mainPanel["fortressBtn"],this._mainPanel["fortressMC"],"英格瓦要塞",new FortressWidgetClick());
         this.addToolBarWidget("copy",this._mainPanel["copyBtn"],null,"炼狱",new CopyWidgetClick());
         this.addToolBarWidget("monster",this._mainPanel["monsterBtn"],null,"灵兽",new MonsterWidgetClick());
         ...
         this._skyBtn.addEventListener("click",this.onSky);
         ...
         this._sptBtn.addEventListener("click",this.onSptBtnClick);
      }
      ...
      private function onSky(param1:MouseEvent) : void
      {
         ...
         StatisticsManager.sendNovice("0x1003366B");
      }
      ...
      {
         ToolBarWidget(this._widgetMap.getValue("trainer")).showNotice();
      }
      ...
      {
         StatisticsManager.sendNovice("0x1003361B");
         ModuleManager.toggleModule(URLUtil.getAppModule("SPTPanel"),"正在打开SPT面板...",{});
      }
   }
}
