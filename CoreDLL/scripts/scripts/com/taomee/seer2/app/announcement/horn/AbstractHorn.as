package com.taomee.seer2.app.announcement.horn
{
   ...
   public class AbstractHorn
   {
      ...
      private function init() : void
      {
         ...
         this._contentTxt.autoSize = "left";
      ...
      public function initEvent() : void
      {
         ...
         this._contentMC.addEventListener("click",this.onClick);
      }
      ...
      private function removeEvent() : void
      {
         if(this._closeBtn)
         {
            ...
            this._contentMC.removeEventListener("click",this.onClick);
         }
      }
      
      public function onClick(param1:MouseEvent) : void
      {
         StatisticsManager.sendNoviceAccountHttpd("0x10033044");
      }
      ...
      public function show() : void
      {
         ...
         DisplayUtil.align(this._hornMC,1);
         this._hornMC.y = 100;
      }
