package com.taomee.seer2.app.animationInteractive
{
   ...
   public class DigStoneAnimation extends BaseAniamationInteractive
   {
      ...
      override protected function paramAnimation() : void
      {
         ...
         while(_loc2_ < 3)
         {
            _loc4_ = _animation["ani_" + _loc2_];
            _loc4_.gotoAndStop(1);
            this._aniVec.push(_loc4_);
            _loc2_++;
         }
         ...
         while(_loc1_ < 6)
         {
            _loc3_ = new Stone(_animation["stone_" + _loc1_],this.onClick,_loc1_);
            this._stoneVec.push(_loc3_);
            _loc1_++;
         }
         this._timerTenMC = _animation["timeTenMC"];
         this._timerDigitMC = _animation["timeDigitMC"];
         _animation.addEventListener("enterFrame",this.onEnterFrame);
         this.reset();
      }
      ...
      override public function dispose() : void
      {
         ...
         _animation.removeEventListener("enterFrame",this.onEnterFrame);
         Mouse.show();
         super.dispose();
      }
   }
...
class Stone
{
   ...
   public function Stone(param1:MovieClip, param2:Function, param3:int)
   {
      ...
      this._index = param3;
      this._mc.addEventListener("click",this.onClick);
      this.reset();
   }
   ...
   private function onClick(param1:MouseEvent) : void
   {
      ...
      if(this._clickNum == 4)
      {
         _loc2_ = NumberUtil.random(0,1000);
         if(_loc2_ <= 500)
         {
            this._type = 0;
         }
   ...
   public function dispose() : void
   {
      if(this._mc)
      {
         this._mc.removeEventListener("click",this.onClick);
