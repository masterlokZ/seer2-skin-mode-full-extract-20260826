package com.taomee.seer2.app.animationInteractive
{
   ...
   public class PipeAnimation extends BaseAniamationInteractive
   {
      ...
      {
         this._tryAgainBtn.addEventListener("click",this.onTryAgain);
      ...
      private function openEventListener() : void
      {
         ...
         while(_loc1_ < 7)
         {
            ...
            this._pipeVec_2[_loc1_].addEventListener("click",this.onPipeClick);
            _loc1_++;
         }
         this._pipeClick = 0;
      }
      ...
      private function closeEventListener() : void
      {
         ...
         while(_loc1_ < 7)
         {
            ...
            this._pipeVec_2[_loc1_].removeEventListener("click",this.onPipeClick);
            _loc1_++;
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         this.closeEventListener();
         this._tryAgainBtn.removeEventListener("click",this.onTryAgain);
