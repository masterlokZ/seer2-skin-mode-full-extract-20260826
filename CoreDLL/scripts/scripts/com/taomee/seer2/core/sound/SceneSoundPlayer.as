   ...
   public class SceneSoundPlayer
   {
      ...
      public function play() : void
      {
         ...
         if(this._url != this._info.url)
         {
            ...
            this._sound.addEventListener("complete",this.getOutTime);
            this._sound.addEventListener("ioError",this.stopLoad);
      ...
      {
         this._sound.removeEventListener("complete",this.getOutTime);
         this._sound.removeEventListener("ioError",this.stopLoad);
      }
      ...
      private function rePlay() : void
      {
         if(this._chanel)
         {
            this._chanel.removeEventListener("soundComplete",this.onPlayComplete);
            this._chanel.stop();
         }
      ...
      private function getChannel() : void
      {
         ...
         this._chanel.addEventListener("soundComplete",this.onPlayComplete);
      ...
      public function stop() : void
      {
         ...
         if(this._chanel)
         {
            if(this._oldChanel)
            {
               ...
               this._oldChanel.removeEventListener("soundComplete",this.onPlayComplete);
