package com.taomee.seer2.core.ui
{
   ...
   public class LoadingBar
   {
      ...
      public function LoadingBar()
      {
         ...
         this._container.addEventListener("addedToStage",this.onAddedToStage);
         this._container.addEventListener("removedFromStage",this.onRemovedFromStage);
      ...
      public function dispose() : void
      {
         ...
         this._container.removeEventListener("addedToStage",this.onAddedToStage);
         this._container.removeEventListener("removedFromStage",this.onRemovedFromStage);
      ...
      public function show(param1:DisplayObjectContainer, param2:Boolean = false, param3:Number = NaN, param4:Number = NaN) : void
      {
         ...
         DisplayUtil.align(this._container,4,new Rectangle(0,0,param3,param4));
      }
      ...
      {
         this._titleIndex = 0;
         Tick.instance.addRender(this.onTitleTimer,2000);
      }
