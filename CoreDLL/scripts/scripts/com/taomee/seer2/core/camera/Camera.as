package com.taomee.seer2.core.camera
{
   ...
   public class Camera
   {
      ...
      public function Camera(param1:Number, param2:Number)
      {
         ...
         this._trackRect = new Rectangle(0,0,param1 - 2 * 250,param2 - 2 * 150);
      }
      ...
      public function update() : void
      {
         ...
         this._trackRect.x = this._viewport.x + 250;
         this._trackRect.y = this._viewport.y + 150;
         if(this._trackRect.contains(this._trackTarget.x,this._trackTarget.y))
         {
            return;
         }
         var _loc2_:Number = this._viewport.x;
         var _loc1_:Number = this._viewport.y;
         ...
         if(_loc2_ != this._viewport.x || _loc1_ != this._viewport.y)
         {
