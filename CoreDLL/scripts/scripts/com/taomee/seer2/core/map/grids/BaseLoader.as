package com.taomee.seer2.core.map.grids
{
   ...
   public class BaseLoader extends EventDispatcher
   {
      ...
      {
         this._loader.contentLoaderInfo.addEventListener("progress",this.progressFun);
         this._loader.contentLoaderInfo.addEventListener("complete",this.completeFun);
         this._loader.contentLoaderInfo.addEventListener("ioError",this.ioErrorFun);
      }
      
      protected function delEvent() : void
      {
         this._loader.contentLoaderInfo.removeEventListener("progress",this.progressFun);
         this._loader.contentLoaderInfo.removeEventListener("complete",this.completeFun);
         this._loader.contentLoaderInfo.removeEventListener("ioError",this.ioErrorFun);
      }
