package com.taomee.seer2.core.map.grids
{
   ...
   public class HeptaFishBitMapMC extends BaseDisplayObject
   {
      ...
      public function startMove(param1:uint = 0) : void
      {
         ...
         {
            this._bitMap.addEventListener("enterFrame",this.moveFrameTR);
         }
         else
         {
            ...
            this._bitMap.addEventListener("enterFrame",this.moveFrameLR);
         }
      }
      ...
      public function stopMove() : void
      {
         ...
         if(this._playDirection == 0)
         {
            this._bitMap.removeEventListener("enterFrame",this.moveFrameTR);
         ...
         else
         {
            ...
            this._bitMap.removeEventListener("enterFrame",this.moveFrameLR);
